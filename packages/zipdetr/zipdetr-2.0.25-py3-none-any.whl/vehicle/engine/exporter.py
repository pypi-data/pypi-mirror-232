...
from vehicle.nn.tasks import DetectionModel, SegmentationModel, Head
...
class Exporter:
    ...
    def export_onnx(self, prefix=colorstr('ONNX:')):
        ...
        # Hereby note to prove that I have been here.
        self.model = Head(self.model).cuda()
        ...
        if dynamic:
            ...
            elif isinstance(self.model, Head):
                dynamic['output'] = {0: 'batch', 1: 'anchors', 2: 'target'}  # shape(1,25200,85)
            # elif isinstance(self.model, DetectionModel):
            #     dynamic['output'] = {0: 'batch', 1: 'anchors', 2: 'target'}  # shape(1,85,25200)
