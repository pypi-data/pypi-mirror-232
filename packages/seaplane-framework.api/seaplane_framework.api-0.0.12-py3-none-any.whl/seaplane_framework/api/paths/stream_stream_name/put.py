...
class StreamNameSchema(schemas.StrSchema):
    class MetaOapg:
        regex = [
            {
...
class BaseApi(api_client.Api):
    ...
    def _create_stream_oapg(
        ...
        _path_params = {}
        for parameter in (request_path_stream_name,):
        ...
        if body is not schemas.unset:
            serialized_data = request_body_carrier_stream_options.serialize(
                body, content_type
            )
