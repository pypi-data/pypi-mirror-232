...
# Query params
AllocSchema = schemas.StrSchema


class OutputSchema(schemas.EnumBase, schemas.StrSchema):
    class MetaOapg:
        enum_value_to_name = {
            "stderr": "STDERR",
            "stdout": "STDOUT",
...
class BaseApi(api_client.Api):
    ...
    def _stream_flow_events_oapg(
        ...
        for parameter in (request_header_last_event_id,):
