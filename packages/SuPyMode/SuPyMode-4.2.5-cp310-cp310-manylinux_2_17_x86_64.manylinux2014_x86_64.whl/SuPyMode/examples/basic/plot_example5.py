...
from SuPyMode.workflow import Workflow, fiber_catalogue, Boundaries2D, AlphaProfile, Fused7 as CladStructure
...
workflow = Workflow(
    ...
    clad_structure=CladStructure,   # Cladding structure, if None provided then no cladding is set.
    fusion_degree=0.7,              # Degree of fusion of the structure if applicable.
