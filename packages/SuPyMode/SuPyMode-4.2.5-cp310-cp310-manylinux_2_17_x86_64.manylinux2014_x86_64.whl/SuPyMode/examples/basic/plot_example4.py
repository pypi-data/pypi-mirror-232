...
from SuPyMode.workflow import Workflow, Fused4, fiber_catalogue, Boundaries2D, AlphaProfile
...
workflow = Workflow(
    ...
    clad_structure=Fused4,          # Cladding structure, if None provided then no cladding is set.
