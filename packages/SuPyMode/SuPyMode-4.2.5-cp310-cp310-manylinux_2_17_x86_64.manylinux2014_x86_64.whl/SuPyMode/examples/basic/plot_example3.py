...
from SuPyMode.workflow import Workflow, Fused3, fiber_catalogue, Boundaries2D, AlphaProfile
...
workflow = Workflow(
    ...
    clad_structure=Fused3,          # Cladding structure, if None provided then no cladding is set.
