...
class TestSession():
    ...
    def __init__(self, project_name: str, run_name: str, u_test=False, host=None, access_key=None, secret_key=None, aws_raga_secret_key=None, aws_raga_access_key=None, aws_raga_role_arn=None):
        ...
        self.aws_raga_secret = aws_raga_secret_key if aws_raga_secret_key else get_config_value(config_data, 'default', AWS_RAGA_SECRET_KEY)
        self.aws_raga_access = aws_raga_access_key if aws_raga_access_key else get_config_value(config_data, 'default', AWS_RAGA_ACCESS_KEY)
        self.aws_raga_arn = aws_raga_role_arn if aws_raga_role_arn else get_config_value(config_data, 'default', AWS_RAGA_ROLE_ARN)
