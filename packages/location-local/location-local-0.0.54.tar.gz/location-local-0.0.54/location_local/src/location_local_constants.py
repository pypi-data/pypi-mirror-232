...
class LocationLocalConstants:
    ...
    DEFAULT_STATE_NAME = 'Default'  #Cannot be None because it would result in mysql.connector.errors.IntegrityError: 1048 (23000): Column 'state_name' cannot be null
