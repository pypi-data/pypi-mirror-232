...
class TestDetailedLexical(unittest.TestCase):
    ...
    def test_G_PASSIVE(self):
        ...
        expected_debug = ['is', 'bought', "read", "will", "be", "finished", "had", "been", "saved", "was", "built", "is", "baked"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_G_ACTIVE(self):
        ...
        expected_debug = ['was', "felt", "'ll", "go", "meet", '’ll', "be", "waiting", "Will", "be", "'s", "discovers"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_G_PAST(self):
        ...
        expected_debug = ["had", "seen", "visited", "was", "being", "chased", "bitten", "fell", "did", "do"] 
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_G_FUTURE(self):
        ...
        expected_debug = ["’ll", "come", "wo", "be", "will", "be", "being", "interviewed", "will", "have", "finished"] 
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_G_MODALS_SIMPLE(self):
        ...
        expected_debug = ["can", "do", "should", "be", "must", "smoke", "may", "go", "Could", "help", "might", "go"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_G_MODALS_CONT(self):
        ...
        expected_debug = ["may", "be", "sleeping", "must", "be", "doing", "should", "be", "working", "can", "be", "playing", "Could", "be", "helping"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_G_MODALS_PERFECT(self):
        ...
        expected_debug = ['would', 'have', 'done', 'must', 'have', 'bought', 'might', 'have', 'gone', 'could', 'have', 'missed']
        expected_out = len(expected_debug)/len(test_text.split())
