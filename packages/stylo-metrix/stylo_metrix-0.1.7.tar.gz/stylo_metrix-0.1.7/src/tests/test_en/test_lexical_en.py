...
class TestDetailedLexical(unittest.TestCase):
    ...
    def test_L_TYPE_TOKEN_RATIO_LEMMAS(self):
        ...
        expected_debug = ['in','because','not','passive','be','by','cake','text','bake','example','the','subject','sentence','write','for','but','doer','when','John','action','receiver','of','itself','it','a',
'present']
...
To form the present passive, we use the verb to be in the present tense and the past participle of the main verb."""
    ...
    def test_L_HASHTAG(self):
        ...
        expected_debug = ['#travel', '#winter', '#vibes', '#comments', '#stackoverflow', '#people', '#helpful']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_L_CONT_A(self):
        metric = 'L_CONT_A'
        test_text = test_text = "Text in the present passive is written when the subject of the sentence isn't the doer of the action, but the receiver. For example, The cake is baked by John is a present passive sentence, because the cake is not baking itself, but John is baking it."

        expected_debug = ['Text', 'present', 'passive', 'written', 'subject', 'sentence', 'doer', 'action', 'receiver', 'example', 'cake', 'baked', 'John', 'present', 'passive', 'sentence', 'cake', 'baking', 'John', 'baking']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_L_FUNC_A(self):
        ...
        expected_debug = ['in', 'the', 'is', 'when', 'the', 'of', 'the', 'is', "n't", 'the', 'of', 'the', 'but', 'the', 'For', 'The', 'is', 'by', 'is', 'a', 'because', 'the', 'is', 'not', 'itself', 'but', 'is', 'it']
        expected_out = len(expected_debug)/len(test_text.split())
...
"when"]
    ...
    def test_L_PLURAL_NOUNS(self):
        ...
        expected_debug = ["children", "mice", "people"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_L_SINGULAR_NOUNS(self):
        ...
        test_text = "She was a beautiful girl. My friend is a doctor. A bother and a sister were playing in the garden."

        expected_debug = ["girl", "friend", "doctor", "bother", "sister", "garden"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_L_NOUN_PHRASES(self):
        ...
        expected_debug = ["Mary", "Thomas", "his", "way", "I", "small", "Lidia", "the", "garden"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_PS_CAUSE(self):
        ...
        expected_debug = ["Whenever", "Due", "to", "to", "to", "to", "to", "to", "to", "to", "to", "to"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_PS_LOCATION(self):
        metric = 'PS_LOCATION'
        test_text = "In the middle was a large box. We saw the dog where he was standing"
    ...
    def test_PS_TIME(self):
        metric = 'PS_TIME'
        test_text = "Occasionally, I meet her at the office. As soon as you get there, call me."
