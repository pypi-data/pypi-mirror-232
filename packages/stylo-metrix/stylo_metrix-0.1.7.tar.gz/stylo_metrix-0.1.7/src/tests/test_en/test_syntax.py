...
class TestDetailedLexical(unittest.TestCase):
    ...
    def test_SY_QUESTION(self):
        metric = 'SY_QUESTION'
        test_text = "How have you been? Are you going for a walk? You like her, don't you?"

        expected_debug = ['How', 'have', 'you', 'been?', 'Are', 'you', 'going', 'for', 'a', 'walk?', 'You', 'like', 'her,', "don't", 'you?']
    ...
    def test_SY_NARRATIVE(self):
        metric = 'SY_NARRATIVE'
        test_text = "You can call me by my name. She was tired and upset. Do you like cookies?"

        expected_debug = ['You', 'can', 'call', 'me', 'by', 'my', 'name.', 'She', 'was', 'tired', 'and', 'upset.']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_NEGATIVE_QUESTIONS(self):
        ...
        expected_debug = ["Don't", 'you', 'want', 'to', 'see', 'her?', "Aren't", 'you', 'happy?']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_SPECIAL_QUESTIONS(self):
        ...
        expected_debug = ['How', "can't", 'you', 'recognize', 'him?', 'Who', 'are', 'those', 'guys', 'and', 'what', 'were', 'they', 'doing?']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_TAG_QUESTIONS(self):
        ...
        expected_debug = ['You', "don't", 'want', 'to', 'see', 'her,', 'do', 'you?', 'You', "don't", 'like', 'cookies,', 'do', 'you?']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_GENERAL_QUESTIONS(self):
        ...
        expected_debug = ['been', 'you', 'Have', 'know', 'before?', 'him?', 'there', 'Do']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_EXCLAMATION(self):
        ...
        expected_debug = ['Come', 'I', 'was', 'back', 'her!', 'you', 'that', 'told', 'here!']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_SUBORD_SENT(self):
        ...
        expected_debug = ['I', 'needed', 'to', 'see', 'her', 'because', 'I', 'missed', 'her.', 'Although', 'she', "doesn't", 'look', 'sick,', 'her', 'voice', 'is', 'definitely', 'hoarse.']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_COORD_SENT(self):
        ...
        expected_debug = ['She', 'was', 'smart', 'and', 'beautiful.', 'We', 'can', 'go', 'to', 'the', 'restaurat', 'or', 'to', 'the', 'cinema.', 'I', 'like', 'her,', 'but', 'she', "doesn't", 'like', 'me.']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_SIMPLE_SENT(self):
        ...
        expected_debug = ['The', 'weather', 'is', 'nice.', 'I', 'like', 'her.', 'Winter.', "I'm", 'tired.', "I'm", 'going', 'to', 'sleep.']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_INVERSE_PATTERNS(self):
        ...
        expected_debug = ['Never', 'a', 'day', 'had', 'she', 'missed', 'her', 'lessons.']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_FOS_SIMILE(self):
        metric = 'FOS_SIMILE'
        test_text = "She was as beautiful as ever. He looks like his father. We don't like him."

        expected_debug = ['He', 'looks', 'like', 'his', 'father.', 'She', 'was', 'as', 'beautiful', 'as', 'ever.']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_FOS_FRONTING(self):
        ...
        expected_debug = ['In', 'June', 'came', 'ponderous', 'heat', 'and', 'mornings', 'like', 'eggshells,', 'pale', 'and', 'smooth.', 'Powerful', 'you', 'have', 'become', 'Dooku,', 'the', 'dark', 'side', 'I', 'sense', 'in', 'you.']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_PS_SYNTACTIC_IRRITATION(self):
        ...
        expected_debug = ['She', 'is', 'constantly', 'being', 'late.', 'He', 'was', 'always', 'losing', 'his', 'keys.']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_SY_INTENSIFIER(self):
        ...
        expected_debug = ['You', 'do', 'believe', 'her.', 'He', 'did', 'come', 'to', 'your', 'birthday', 'party.']
        expected_out = len(expected_debug)/len(test_text.split())
