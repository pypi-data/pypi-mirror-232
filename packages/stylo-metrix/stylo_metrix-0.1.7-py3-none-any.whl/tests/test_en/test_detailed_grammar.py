...
class TestDetailedLexical(unittest.TestCase):
    ...
    def test_VT_PRESENT_SIMPLE(self):
        ...
        expected_debug = ['loves', 'do', 'know', 'reads', "cooks", "Do", 'like', "do", 'attend']
    ...
    def test_VT_PRESENT_PROGRESSIVE(self):
        ...
        expected_debug = ["Is", "doing", "are", "going", "are", "doing", "am", "going", "'s", "coming"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_PRESENT_PERFECT(self):
        ...
        test_text = "What have you done? Has she been there? I've never been to the USA."
    ...
    def test_VT_PRESENT_PERFECT_PROGR(self):
        ...
        expected_debug = ["have", "been", "doing", "Has", "been", "staying", "'ve", "been", "listening", "have", "been", "doing"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_PRESENT_PROGR_PASSIVE(self):
        ...
        expected_debug = ["is", "being", "built", "are", "being", "watered", "are", "being", "scanned", "delivered"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_PRESENT_PERFECT_PASSIVE(self):
        ...
        expected_debug = ["has", "been", "baked", "has", "been", "broken", "has", "been", "read"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_PAST_PROGR(self):
        ...
        expected_debug = ["Were", "going", "was", "backing", "singing", "were", "doing", "was", "going"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_PAST_PERFECT(self):
        ...
        test_text = "Had you attended that event before you got to know her? I had never visited to the USA before. They'd done that long time ago. "
        expected_debug = ["Had", "attended", "had", "visited", "'d", "done"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_PAST_PERFECT_PROGRT(self):
        ...
        expected_debug = ["had", "been", "working", "had", "been", "waiting", "'d", "been", "listening"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_PAST_POGR_PASSIVE(self):
        ...
        expected_debug = ["was", "being", "built", "were", "being", "watered", "were", "being", "scanned", "delivered"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_PAST_PERFECT_PASSIVE(self):
        ...
        expected_debug = ["had", "been", "baked", "had", "been", "broken", "had", "been", "read"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_FUTURE_PERFECT(self):
        ...
        expected_debug = ["will", "have", "reached", "will", "have", "learned", "will", "have", "left"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_FUTURE_PERFECT_PROGR(self):
        ...
        expected_debug = ["will", "have", "been", "working", "will", "have", "been", "traveling"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_FUTURE_SIMPLE_PASSIVE(self):
        ...
        expected_debug = ["will", "be", "built", "will", "be", "read", "Will", "be", "invited"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_FUTURE_PROGR_PASSIVE(self):
        ...
        expected_debug = ["will", "be", "being", "repaired", "will", "be", "being", "baked", "eaten"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_FUTURE_PERFECT_PASSIVE(self):
        ...
        expected_debug = ["will", "have", "been", "written", "will", "have", "been", "baked"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_WOULD_PROGRESSIVEE(self):
        ...
        expected_debug = ["'d", "be", "watching", "'d", "be", "working", "'d", "be", "waiting"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_SHOULD_PERFECT_PASSIVE(self):
        ...
        expected_debug = ['should', 'been', 'disappointed', 'should', 'been', 'arrested']
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_MST_PERFECT_PASSIVE(self):
        ...
        expected_debug = ["must", "have", "been", "completed", "must", "have", "been", "arrested"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_COULD(self):
        metric = 'VT_COULD'
        test_text = "Could you help me? Could I ask you a question? You couldn't do that."
    ...
    def test_VT_COULD_PERFECT_PASSIVE(self):
        ...
        expected_debug = ["could", "have", "been", "disappointed", "could", "have", "been", "arrested"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_MIGHT_PERFECT_PASSIVE(self):
        ...
        expected_debug = ["might", "have", "been", "disappointed", "might", "have", "been", "arrested"]
        expected_out = len(expected_debug)/len(test_text.split())
    ...
    def test_VT_MAY_PERFECT_PASSIVE(self):
        ...
        expected_debug = ["may", "have", "been", "completed", "may", "have", "been", "built"]
        expected_out = len(expected_debug)/len(test_text.split())
