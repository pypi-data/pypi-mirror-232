...
class TestDetailedLexical(unittest.TestCase):
    ...
    def test_DDF(self):
        metric = 'DDF'
        test_text = "He looks like a runt. Impaired are ugly. You are an emotional cripple."
    ...
    def test_IS(self):
        metric = 'IS'
        test_text = "That's total impoverishment. Poorness is pervasive in the third countries."
    ...
    def test_OM(self):
        metric = 'OM'
        test_text = "He did it posteriorly. I hate this queerness. Homosexuals are people too."
    ...
    def test_DMC(self):
        metric = 'DMC'
        test_text = "You're a lazybones. Don't be a bastard. He's a faker. She can't be a fool."
    ...
    def test_PA(self):
        metric = 'PA'
        test_text = "You're gonna be a bellboy. She's so pedantic. Stop acting like professors."
