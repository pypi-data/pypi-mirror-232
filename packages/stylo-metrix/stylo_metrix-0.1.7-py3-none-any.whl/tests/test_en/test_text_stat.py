...
I had been aiming to visit Hawaii for a long time, but I never had the chance. She has finished her task. 
...
class TestDetailedLexical(unittest.TestCase):
    ...
    def test_SENT_ST_WRDSPERSENT(self):
        ...
        test_text = TEXT_TEST
        expected_debug = {}
        expected_out = 0.9234285714285714
    ...
    def test_SENT_ST_DIFFERENCE(self):
        ...
        test_text = TEXT_TEST
        expected_debug = {}
        expected_out = 0.08943089430894309
    ...
    def test_ST_REPETITIONS_WORDS(self):
        ...
        test_text = TEXT_TEST
        expected_debug = {}
        expected_out = 0.7208672086720868
    ...
    def test_SENT_D_VP(self):
        ...
        test_text = TEXT_TEST
        expected_debug = {}
        expected_out = 0.7535980217729915
    ...
    def test_SENT_D_NP(self):
        ...
        test_text = TEXT_TEST
        expected_debug = {}
        expected_out = 0.3681069037403824
    ...
    def test_SENT_D_PP(self):
        ...
        test_text = TEXT_TEST
        expected_debug = {}
        expected_out = 0.19871543476615847
    ...
    def test_SENT_D_ADJP(self):
        ...
        test_text = TEXT_TEST
        expected_debug = {}
        expected_out = 0.0011940298507462687
    ...
    def test_SENT_D_ADVP(self):
        ...
        test_text = TEXT_TEST
        expected_debug = {}
        expected_out = 0.05739650086084423
