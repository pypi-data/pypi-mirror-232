...
from respect.logging import set_log_level
...
class Application:
    ...
    async def run(self) -> int:
        ...
        directory: Optional[str] = os.environ.get('RSM_DOT_RSM_DIRECTORY')

        local_envoy: bool = os.environ.get('RSM_DEV_LOCAL_ENVOY',
                                           'false').lower() == 'true'
