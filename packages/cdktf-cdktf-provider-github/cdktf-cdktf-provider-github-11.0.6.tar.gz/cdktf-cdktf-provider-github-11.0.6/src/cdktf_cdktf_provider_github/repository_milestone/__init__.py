...
class RepositoryMilestone(
    ...
    def __init__(
        ...
        *,
        ...
        :param owner: The owner of the GitHub Repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/repository_milestone#owner RepositoryMilestone#owner}
        :param repository: The name of the GitHub Repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/repository_milestone#repository RepositoryMilestone#repository}
        :param title: The title of the milestone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/repository_milestone#title RepositoryMilestone#title}
        :param description: A description of the milestone. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/repository_milestone#description RepositoryMilestone#description}
        :param due_date: The milestone due date. In 'yyyy-mm-dd' format. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/repository_milestone#due_date RepositoryMilestone#due_date}
        ...
        :param state: The state of the milestone. Either 'open' or 'closed'. Default: 'open'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/repository_milestone#state RepositoryMilestone#state}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
