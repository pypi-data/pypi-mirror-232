...
class Issue(
    ...
    def __init__(
        ...
        *,
        ...
        :param repository: The GitHub repository name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/issue#repository Issue#repository}
        :param title: Title of the issue. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/issue#title Issue#title}
        :param assignees: List of Logins to assign to the issue. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/issue#assignees Issue#assignees}
        :param body: Body of the issue. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/issue#body Issue#body}
        ...
        :param labels: List of labels to attach to the issue. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/issue#labels Issue#labels}
        :param milestone_number: Milestone number to assign to the issue. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/issue#milestone_number Issue#milestone_number}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
