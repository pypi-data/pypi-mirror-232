...
class InspectedFile(object):
    ...
    def search_for_patterns_in_whole_file(self, pattern, regex_option=0):
        """
        :param patterns: regex patterns array
        :param exclude_comments: excluded comment from test
        :param regex_option: regex option
    ...
    def search_for_crossline_patterns(self, patterns, exclude_comments=True, cross_line=10):
        """
        :param patterns: regex patterns array
        :param exclude_comments: excluded comment from test
        :return: array of match objects
    ...
    def search_for_crossline_pattern(self, pattern, exclude_comments=True, cross_line=10):
