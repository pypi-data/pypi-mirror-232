...
OUTPUT_FILE_OPTION_HELP_OUTPUT = (
    "This allows the ability to output the results of Splunk AppInspect to the specified file path."
)
...
LOG_FILE_OPTION_HELP_OUTPUT = "This allows the ability to specify a custom log file for Python's logging library."
...
GENERATE_FEEDBACK_OPTION_HELP_OUTPUT = (
    "This allows the ability to generate a .inspect.yml file containing each instance of a manual or failure check."
)
...
@report_cli.command(LIST_COMMAND, short_help="List information about Splunk AppInspect")  # noqa: C901
...
def validate(
    ...
    try:
        ...
        validation_report_summary_has_errors = (
            "error" in validation_report_summary and validation_report_summary["error"] > 0
        )
