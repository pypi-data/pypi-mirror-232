...
class AstAnalyzer(object):
    ...
    def __init__(
        ...
        # python file path
        self._module_name = (
            os.path.splitext(os.path.basename(python_file_path))[0] if python_file_path is not None else None
        )
        # module usage
    ...
    def get_module_all_possible_usage(self, module, lineno_only=False, with_context=False):
        """
    ...
    def get_module_function_call_usage(
        ...
        if not fuzzy:
            ...
            function_nodes = [function_node for function_node in function_nodes if function_filter(function_node)]
    ...
    def get_literal_string_usage(self, search_pattern=".*", flags=0, lineno_only=False, with_context=False):
        """
    ...
    def _collect_modules_import_usage(self, module_string, node, context, alias_name=None):  # noqa: C901
        # from xx import xx
    ...
    def _get_modules_used_in_ast_name_and_attribute_chain(self, node, context):  # noqa: C901
        """
