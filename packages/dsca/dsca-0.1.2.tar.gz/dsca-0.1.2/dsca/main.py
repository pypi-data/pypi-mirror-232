...
def url(endpoint: str = None, prompt: str = None, instruction: str = None):
...
def prompt_evaluator(token: str = None, prompt: str = None, instruction: str = None):
    endpoint = 'evaluator'
    response = url(endpoint, prompt, instruction)
    return response
...
"""
    ...
    response = health_check(prompt=prompt_example, instruction=instruction)
    print(response)