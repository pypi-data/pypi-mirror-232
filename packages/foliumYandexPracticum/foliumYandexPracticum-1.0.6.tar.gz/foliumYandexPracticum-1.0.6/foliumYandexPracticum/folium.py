    ...
    def __init__(
        ...
        if tiles:
            ...
            if tiles == 'OpenStreetMap':
                abs_path = __file__.replace('/folium.py', '')
                use_custom_raster = True
                offline_file_path = os.path.join(abs_path, 'offline')
                tile_path = 'https://s3.mds.yandex.net/praktikum/folium-maps-custom/moscow.mbtiles'
