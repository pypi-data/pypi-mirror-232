...
class V1ClusterStatus(object):
    ...
    swagger_types = {
        ...
        'queue_endpoint': 'str',
        'reason': 'str',
        'slurm_v1_status': 'V1SLURMDirectV1Status',
