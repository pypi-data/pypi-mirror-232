...
class BodyError:
    ...
    :attributes:
        ...
        mixed_tag_found (bool): Indicates if there is a line starting with insensitive tag.
        ...
        impact_tag_line_is_short (bool): Indicates if the impact tag line is too short.
    """
