...
config_path = os.path.join(project_root, "injectorConfig.py")


spec = importlib.util.spec_from_file_location("config_injector", config_path)
config_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(config_module)

MODULE_APPLICATION = config_module.MODULE_APPLICATION
