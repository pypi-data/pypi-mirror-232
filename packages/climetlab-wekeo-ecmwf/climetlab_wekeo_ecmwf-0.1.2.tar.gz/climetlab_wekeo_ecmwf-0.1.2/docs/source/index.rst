Welcome to WEkEO CliMetLab ECMWF Plugin!
================================================

A dataset plugin for `CliMetLab <https://climetlab.readthedocs.io/en/latest/index.html>`_ for the ECMWF datasets available on `WEkEO <https://www.wekeo.eu/>`_.
