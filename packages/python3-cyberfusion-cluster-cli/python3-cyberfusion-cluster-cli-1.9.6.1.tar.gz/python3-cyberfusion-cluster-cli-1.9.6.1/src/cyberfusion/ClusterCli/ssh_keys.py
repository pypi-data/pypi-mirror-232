...
def get_public_key(
    ...
    print_or_write_key(public_key, output_file)
...
def get_private_key(
    ...
    print_or_write_key(private_key, output_file)
...
def print_or_write_key(key: str, output_file: Optional[Path]) -> None:
    """Print or write key to file."""
    if output_file:
