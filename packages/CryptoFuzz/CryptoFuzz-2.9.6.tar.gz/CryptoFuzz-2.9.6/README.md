...
After installation, you can see examples of keys that you can create with CryptoFuzz, you can see from the `example` section with the following `cryptofuzz-example` command in your terminal:
