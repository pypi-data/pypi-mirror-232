...
PYSPARK_PACKAGE = f"pyspark=={johnsnowlabs.settings.raw_version_pyspark}"

if environ.get("PYSPARK_VERSION"):
    PYSPARK_PACKAGE = f"pyspark=={environ.get('PYSPARK_VERSION')}"
