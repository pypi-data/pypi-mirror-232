...
class Experiment(mp.Process):
    ...
    def _construct_experiment(
        self,
    ) -> tuple[list[Agent], MarkovGame, AgentLogger, GameLogger]:
        ...
        return agents, game, agent_logger, game_logger
    ...
    def run(self):
        ...
        agents, game, agent_logger, game_logger = self._construct_experiment()
