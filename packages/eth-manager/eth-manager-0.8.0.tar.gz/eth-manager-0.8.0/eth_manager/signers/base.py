...
class BaseAccount(ABC):
    ...
    def sign_message(self, signable_message: SignableMessage) -> SignedMessage:
        ...
        as in :meth:`~eth_manager.account.Account.sign_message`
    ...
    def signHash(self, message_hash):
        ...
        This uses the same structure
        as in :meth:`~eth_manager.account.Account.signHash`
        but without specifying the private key.

        .. CAUTION:: Deprecated for
            :meth:`~eth_manager.signers.base.BaseAccount.sign_message`.
    ...
    def signTransaction(self, transaction_dict):
        ...
        :meth:`~eth_manager.account.Account.sign_transaction`
        but without specifying the private key.

        .. CAUTION:: Deprecated for
            :meth:`~eth_manager.account.signers.local.sign_transaction`.
