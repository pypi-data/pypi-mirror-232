...
from eth_manager.signers.base import (
    BaseAccount,
)
...
class LocalAccount(BaseAccount):
    ...
    def __init__(self, key, account):
        ...
        :param ~eth_manager.account.Account account: the key-unaware management API
        """
    ...
    def encrypt(self, password, kdf=None, iterations=None):
        ...
        :meth:`~eth_manager.account.Account.encrypt`, but without a
    ...
    def sign_message(self, signable_message):
        ...
        This uses the same structure as in
        :meth:`~eth_manager.account.Account.sign_message`, but without a
        private key argument.
        """
