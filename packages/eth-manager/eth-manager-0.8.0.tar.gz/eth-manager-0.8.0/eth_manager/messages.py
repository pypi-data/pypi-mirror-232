...
from eth_manager._utils.encode_typed_data.encoding_and_hashing import (
    get_primary_type,
    hash_domain,
    hash_eip712_message,
)
from eth_manager._utils.structured_data.hashing import (
    hash_domain as hash_eip712_domain_legacy,
    hash_message as hash_eip712_message_legacy,
    load_and_validate_structured_message,
)
from eth_manager._utils.structured_data.validation import (
    validate_structured_data,
)
from eth_manager._utils.validation import (
    is_valid_address,
)
...
def encode_structured_data(
    ...
    *,
    ...
    .. doctest:: python
        ...
        >>> from eth_manager.messages import encode_structured_data
...
def defunct_hash_message(
    ...
    .. CAUTION:: Intended for use with the deprecated
        :meth:`eth_manager.account.Account.signHash`.
...
def encode_typed_data(
    ...
    .. doctest:: python
        ...
        >>> import json
        >>> from eth_manager import Account
        >>> from eth_manager.messages import encode_typed_data
        >>> # 3-argument usage
