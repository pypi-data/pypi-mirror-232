...
class EvaluateModel():
    def __init__(self, date_true: str, date_pred: str, y_true: str, y_pred: str, upper_95: str, lower_95: str):
        ...
        """
        func_str = 'telemedpredictive.analytics.evaluationMetrics.EvaluateModel.__init__'
        check_not_isinstance(obj = date_true, data_type = str, func= func_str)
        check_not_isinstance(obj = date_pred, data_type = str, func= func_str)
        check_not_isinstance(obj = y_true, data_type = str, func= func_str)
        check_not_isinstance(obj = y_pred, data_type = str, func= func_str)
        check_not_isinstance(obj = upper_95, data_type = str, func= func_str)
        check_not_isinstance(obj = lower_95, data_type = str, func= func_str)
