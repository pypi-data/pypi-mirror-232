...
from xj_thread.models import ThreadCategory, Thread
...
class Enroll(models.Model):
    ...
    reject_reason = models.CharField(verbose_name='拒绝原因', max_length=255, blank=True, null=True, help_text='')
...
class EnrollRecord(models.Model):
    ...
    apply_subitem_ids = models.JSONField(verbose_name='申请分项ID列表', blank=True, null=True, help_text='', default=[])
    ...
    user = models.OneToOneField(BaseInfo, verbose_name='用户', unique=True, db_column="user_id", db_constraint=False,
                                on_delete=models.DO_NOTHING, help_text='用户')
...
class EnrollSubitemRecord(models.Model):
    ...
    reply = models.CharField(verbose_name='填写回复原因', max_length=65535, blank=True, null=True, default="", help_text='')
    remark = models.CharField(verbose_name='备注', max_length=255, blank=True, null=True, help_text='')
