...
class ConnectRequest(Message):
  ...
  @property
  def type(self) -> Union[CreditBasedChannelRequest, ConnectionOrientedChannelRequest, None, FixedChannelRequest]: ...
...
class ConnectResponse(Message):
  ...
  @property
  def result(self) -> Union[CommandRejectReason, None, Channel]: ...
...
class DisconnectResponse(Message):
  ...
  @property
  def result(self) -> Union[CommandRejectReason, empty_pb2.Empty, None]: ...
