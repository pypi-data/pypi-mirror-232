...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_COMMANDREJECTREASON']._serialized_start=1956
  _globals['_COMMANDREJECTREASON']._serialized_end=2058
  _globals['_CHANNEL']._serialized_start=114
  _globals['_CHANNEL']._serialized_end=161
  _globals['_CONNECTIONORIENTEDCHANNELREQUEST']._serialized_start=163
  _globals['_CONNECTIONORIENTEDCHANNELREQUEST']._serialized_end=223
  _globals['_CREDITBASEDCHANNELREQUEST']._serialized_start=225
  _globals['_CREDITBASEDCHANNELREQUEST']._serialized_end=316
  _globals['_FIXEDCHANNELREQUEST']._serialized_start=318
  _globals['_FIXEDCHANNELREQUEST']._serialized_end=352
  _globals['_CONNECTREQUEST']._serialized_start=355
  _globals['_CONNECTREQUEST']._serialized_end=683
  _globals['_CONNECTRESPONSE']._serialized_start=685
  _globals['_CONNECTRESPONSE']._serialized_end=808
  _globals['_ONCONNECTIONREQUEST']._serialized_start=811
  _globals['_ONCONNECTIONREQUEST']._serialized_end=1144
  _globals['_ONCONNECTIONRESPONSE']._serialized_start=1147
  _globals['_ONCONNECTIONRESPONSE']._serialized_end=1275
  _globals['_DISCONNECTREQUEST']._serialized_start=1277
  _globals['_DISCONNECTREQUEST']._serialized_end=1337
  _globals['_DISCONNECTRESPONSE']._serialized_start=1339
  _globals['_DISCONNECTRESPONSE']._serialized_end=1465
  _globals['_WAITDISCONNECTIONREQUEST']._serialized_start=1467
  _globals['_WAITDISCONNECTIONREQUEST']._serialized_end=1534
  _globals['_WAITDISCONNECTIONRESPONSE']._serialized_start=1537
  _globals['_WAITDISCONNECTIONRESPONSE']._serialized_end=1670
  _globals['_RECEIVEREQUEST']._serialized_start=1672
  _globals['_RECEIVEREQUEST']._serialized_end=1729
  _globals['_RECEIVERESPONSE']._serialized_start=1731
  _globals['_RECEIVERESPONSE']._serialized_end=1762
  _globals['_SENDREQUEST']._serialized_start=1764
  _globals['_SENDREQUEST']._serialized_end=1832
  _globals['_SENDRESPONSE']._serialized_start=1834
  _globals['_SENDRESPONSE']._serialized_end=1954
  _globals['_L2CAP']._serialized_start=2061
  _globals['_L2CAP']._serialized_end=2561
def unwrap(x):
  assert x
  return x
...
def _ConnectRequest_type(self: ConnectRequest):
  ...
  if variant == 'fixed': return unwrap(self.fixed)
...
def _ConnectRequest_type_asdict(self: ConnectRequest):
  ...
  if variant == 'fixed': return {'fixed': unwrap(self.fixed)}  # type: ignore
...
def _OnConnectionRequest_type(self: OnConnectionRequest):
  variant = self.type_variant()
  if variant is None: return None
  if variant == 'fixed': return unwrap(self.fixed)
  if variant == 'basic': return unwrap(self.basic)
...
def _OnConnectionRequest_type_variant(self: OnConnectionRequest):
  return self.WhichOneof('type')  # type: ignore

def _OnConnectionRequest_type_asdict(self: OnConnectionRequest):
  variant = self.type_variant()
  if variant is None: return {}
  if variant == 'fixed': return {'fixed': unwrap(self.fixed)}  # type: ignore
  if variant == 'basic': return {'basic': unwrap(self.basic)}  # type: ignore
...
setattr(OnConnectionRequest, 'type', property(_OnConnectionRequest_type))
setattr(OnConnectionRequest, 'type_variant', _OnConnectionRequest_type_variant)
setattr(OnConnectionRequest, 'type_asdict', _OnConnectionRequest_type_asdict)

def _OnConnectionResponse_result(self: OnConnectionResponse):
  variant = self.result_variant()
  if variant is None: return None
  if variant == 'error': return unwrap(self.error)
  if variant == 'channel': return unwrap(self.channel)
...
def _OnConnectionResponse_result_variant(self: OnConnectionResponse):
  return self.WhichOneof('result')  # type: ignore

def _OnConnectionResponse_result_asdict(self: OnConnectionResponse):
  variant = self.result_variant()
  if variant is None: return {}
  if variant == 'error': return {'error': unwrap(self.error)}  # type: ignore
  if variant == 'channel': return {'channel': unwrap(self.channel)}  # type: ignore
...
setattr(OnConnectionResponse, 'result', property(_OnConnectionResponse_result))
setattr(OnConnectionResponse, 'result_variant', _OnConnectionResponse_result_variant)
setattr(OnConnectionResponse, 'result_asdict', _OnConnectionResponse_result_asdict)
