...
class DataTypes(Message):
  ...
  @property
  def shortened_local_name_oneof(self) -> Union[str, bool, None]: ...
  ...
  @property
  def complete_local_name_oneof(self) -> Union[str, bool, None]: ...
  ...
  @property
  def tx_power_level_oneof(self) -> Union[int, None, bool]: ...
  ...
  @property
  def class_of_device_oneof(self) -> Union[int, None, bool]: ...
  ...
  @property
  def advertising_interval_oneof(self) -> Union[int, None, bool]: ...
...
class ConnectResponse(Message):
  ...
  @property
  def result(self) -> Union[empty_pb2.Empty, None, Connection]: ...
