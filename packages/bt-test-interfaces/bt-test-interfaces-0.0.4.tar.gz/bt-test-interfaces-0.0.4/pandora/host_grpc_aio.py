...
class Host:
    ...
    def FactoryReset(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
    ...
    def Reset(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
            '/pandora.Host/Reset',
            request_serializer=empty_pb2.Empty.SerializeToString,  # type: ignore
            response_deserializer=empty_pb2.Empty.FromString  # type: ignore
    ...
    def ReadLocalAddress(self, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[host_pb2.ReadLocalAddressResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def Connect(self, address: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[host_pb2.ConnectResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def WaitConnection(self, address: bytes = b'', wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[host_pb2.WaitConnectionResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def ConnectLE(self, own_address_type: host_pb2.OwnAddressType = PUBLIC, public: Optional[bytes] = None, random: Optional[bytes] = None, public_identity: Optional[bytes] = None, random_static_identity: Optional[bytes] = None, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[host_pb2.ConnectLEResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def Disconnect(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def WaitDisconnection(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetDiscoverabilityMode(self, mode: host_pb2.DiscoverabilityMode = NOT_DISCOVERABLE, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def SetConnectabilityMode(self, mode: host_pb2.ConnectabilityMode = NOT_CONNECTABLE, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[empty_pb2.Empty]:
        return self.channel.unary_unary(  # type: ignore
...
class HostServicer:
    ...
    async def ReadLocalAddress(self, request: empty_pb2.Empty, context: grpc.ServicerContext) -> host_pb2.ReadLocalAddressResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def Connect(self, request: host_pb2.ConnectRequest, context: grpc.ServicerContext) -> host_pb2.ConnectResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def WaitConnection(self, request: host_pb2.WaitConnectionRequest, context: grpc.ServicerContext) -> host_pb2.WaitConnectionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def ConnectLE(self, request: host_pb2.ConnectLERequest, context: grpc.ServicerContext) -> host_pb2.ConnectLEResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
    ...
    async def WaitDisconnection(self, request: host_pb2.WaitDisconnectionRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def Advertise(self, request: host_pb2.AdvertiseRequest, context: grpc.ServicerContext) -> AsyncGenerator[host_pb2.AdvertiseResponse, None]:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
        yield host_pb2.AdvertiseResponse()  # no-op: to make the linter happy

    async def Scan(self, request: host_pb2.ScanRequest, context: grpc.ServicerContext) -> AsyncGenerator[host_pb2.ScanningResponse, None]:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
        yield host_pb2.ScanningResponse()  # no-op: to make the linter happy

    async def Inquiry(self, request: empty_pb2.Empty, context: grpc.ServicerContext) -> AsyncGenerator[host_pb2.InquiryResponse, None]:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
        yield host_pb2.InquiryResponse()  # no-op: to make the linter happy

    async def SetDiscoverabilityMode(self, request: host_pb2.SetDiscoverabilityModeRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def SetConnectabilityMode(self, request: host_pb2.SetConnectabilityModeRequest, context: grpc.ServicerContext) -> empty_pb2.Empty:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")


def add_HostServicer_to_server(servicer: HostServicer, server: grpc.aio.Server) -> None:
    rpc_method_handlers = {
