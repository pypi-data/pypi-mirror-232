...
from django_swagger_utils.server import SERIALIZER
from django_swagger_utils.server import API_URL, API_VIEW
from django_swagger_utils.server import VIEW_SET_URL, VIEW_SET_VIEW
from django_swagger_utils.server import FUNCTION_URL, FUNCTION_VIEW
from django_swagger_utils.server import MODEL_URL, MODEL_VIEW
