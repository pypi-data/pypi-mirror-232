...
class SapGuiPicture(SapGuiShell):
    ...
    def ClickControlArea(self, x: int, y: int) -> None:
        ''' Emula um clique em uma posição específica. As coordenadas devem ser fornecidas em pixels em relação ao controle da imagem conforme exibido na tela.
        '''
        self.component.ClickControlArea(x, y)

    def ClickPictureArea(self, x: int, y: int) -> None:
        ''' Emula um clique em uma posição específica. As coordenadas devem ser fornecidas em pixels em relação ao arquivo de imagem original. Elas podem diferir das coordenadas em pixels da imagem exibida devido ao dimensionamento.
        '''
        self.component.ClickPictureArea(x, y)

    def ContextMenu(self, x: int, y: int) -> None:
        ''' Abre um menu de contexto na posição especificada. As coordenadas devem ser fornecidas em pixels em relação ao controle da imagem conforme exibido na tela.
        '''
    ...
    def DoubleClickControlArea(self, x: int, y: int) -> None:
        ''' Emula um clique duplo em uma posição específica. As coordenadas devem ser fornecidas em pixels
        em relação ao controle da imagem conforme exibido na tela.
        '''
        self.component.DoubleClickControlArea(x, y)

    def DoubleClickPictureArea(self, x: int, y: int) -> None:
        ''' Emula um clique duplo em uma posição específica. As coordenadas devem ser fornecidas em pixels em
        relação ao arquivo de imagem original. Elas podem diferir das coordenadas em pixels da imagem exibida devido ao dimensionamento.
        '''
...
class SapGuiHTMLViewer(SapGuiShell):
    ...
    def ContextMenu(self):
        ...
        não ao menu de contexto local, que é gerado pelo controle HTML.
        '''
        self.component.ContextMenu()

    def SapEvent(self, frame_name: str, post_data: str, url: str):
        ...
        Url: Este é o URL que é enviado para o backend. O nome do protocolo para a string de URL é "sapevent:" 
    ...
    def BrowserHandle(self) -> object:
        return self.component.BrowserHandle

    def DocumentComplete(self) -> int:
