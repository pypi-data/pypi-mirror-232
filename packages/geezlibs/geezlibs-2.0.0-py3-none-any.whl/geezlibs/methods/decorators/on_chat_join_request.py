...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~geezlibs.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezlibs.Client):
                self.add_handler(geezlibs.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezlibs.handlers.ChatJoinRequestHandler(func, self),
