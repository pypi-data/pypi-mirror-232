...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~geezlibs.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezlibs.Client):
                self.add_handler(geezlibs.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezlibs.handlers.CallbackQueryHandler(func, self),
