...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~geezlibs.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezlibs.Client):
                self.add_handler(geezlibs.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezlibs.handlers.ChosenInlineResultHandler(func, self),
