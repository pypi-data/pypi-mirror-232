...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~geezlibs.types.InputMediaPhoto`, :obj:`~geezlibs.types.InputMediaVideo`, :obj:`~geezlibs.types.InputMediaAudio` and :obj:`~geezlibs.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~geezlibs.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from geezlibs.types import InputMediaPhoto, InputMediaVideo
