...
import geezlibs
from geezlibs import StopTransmission
...
class SendVideoNote:
    async def send_video_note(
        ...
        Returns:
            :obj:`~geezlibs.types.Message` | ``None``: On success, the sent video note message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~geezlibs.Client.stop_transmission`, None is
            returned.
