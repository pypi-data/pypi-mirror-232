...
import geezlibs
from geezlibs import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~geezlibs.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~geezlibs.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~geezlibs.types.BotCommand`: On success, the list of bot commands is returned.
