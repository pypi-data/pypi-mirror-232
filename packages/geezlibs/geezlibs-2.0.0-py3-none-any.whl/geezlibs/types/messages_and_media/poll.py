...
import geezlibs
from geezlibs import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~geezlibs.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~geezlibs.types.MessageEntity`, *optional*):
