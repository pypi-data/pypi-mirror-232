...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~geezlibs.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~geezlibs.Client.sign_in` or :meth:`~geezlibs.Client.sign_up`).

        next_type (:obj:`~geezlibs.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~geezlibs.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~geezlibs.Client.resend_code`.
    """
