...
class DeletedMessagesHandler(Handler):
    ...
    (private, group, channel). It is intended to be used with :meth:`~geezlibs.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~geezlibs.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~geezlibs.types.Message`):
    ...
    async def check(self, client: "geezlibs.Client", messages: List[Message]):
