...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        ...
        invite_link (:obj:`~geezlibs.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~geezlibs.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~geezlibs.types.ChatJoinRequest`.
