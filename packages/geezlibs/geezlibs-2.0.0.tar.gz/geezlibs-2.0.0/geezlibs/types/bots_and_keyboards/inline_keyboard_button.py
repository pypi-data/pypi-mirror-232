...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~geezlibs.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~geezlibs.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~geezlibs.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~geezlibs.types.CallbackGame`, *optional*):
