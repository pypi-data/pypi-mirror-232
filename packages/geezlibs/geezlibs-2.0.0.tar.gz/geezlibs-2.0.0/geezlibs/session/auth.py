...
from geezlibs.connection import Connection
from geezlibs.crypto import aes, rsa, prime
from geezlibs.errors import SecurityCheckMismatch
from geezlibs.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "geezlibs.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
