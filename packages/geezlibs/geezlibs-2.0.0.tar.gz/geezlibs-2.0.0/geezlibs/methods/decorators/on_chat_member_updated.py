...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~geezlibs.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezlibs.Client):
                self.add_handler(geezlibs.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezlibs.handlers.ChatMemberUpdatedHandler(func, self),
