...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~geezlibs.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezlibs.Client):
                self.add_handler(geezlibs.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezlibs.handlers.UserStatusHandler(func, self),
