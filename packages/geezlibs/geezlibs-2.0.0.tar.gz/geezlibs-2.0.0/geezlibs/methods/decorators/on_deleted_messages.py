...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~geezlibs.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezlibs.Client):
                self.add_handler(geezlibs.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezlibs.handlers.DeletedMessagesHandler(func, self),
