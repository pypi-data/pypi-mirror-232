...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~geezlibs.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, geezlibs.Client):
                self.add_handler(geezlibs.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        geezlibs.handlers.EditedMessageHandler(func, self),
