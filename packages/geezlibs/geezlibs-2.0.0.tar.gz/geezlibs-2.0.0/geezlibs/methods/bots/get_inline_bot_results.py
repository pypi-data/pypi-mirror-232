...
from geezlibs.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~geezlibs.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <geezlibs.api.types.messages.BotResults>`: On Success.
