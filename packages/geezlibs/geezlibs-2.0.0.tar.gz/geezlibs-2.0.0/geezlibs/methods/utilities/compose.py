...
async def compose(
    ...
    If you want to run a single client, you can use Client's bound method :meth:`~geezlibs.Client.run`.

    Parameters:
        clients (List of :obj:`~geezlibs.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from geezlibs import Client, compose
