...
import geezlibs
from geezlibs.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~geezlibs.Client.start`, :meth:`~geezlibs.idle` and :meth:`~geezlibs.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`geezlibs.compose`.
