...
def eval_with_try(value, vars: None):
    try:
        ...
        # this could happen if there is some dependency on a variable that is not defined
        missing_name = str(e).split("'")[1]
        print(
            f'NameError: Could not evaluate expression {value}, {missing_name}, {e}')
        raise e
        ...
        # The SyntaxError is raised because the string is not enclosed in quotes
