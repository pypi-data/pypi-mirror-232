...
class RNNLM(nn.Module):
    ...
    @classmethod
    def train(dataset, vocab_size, embed_size, hidden_size, num_layers, epochs, batch_size):
    ...
    def generate(model, tokenizer, detokenizer, start_sequence="In the beginning", generate_length=1024,
                 temperature=1.0):
