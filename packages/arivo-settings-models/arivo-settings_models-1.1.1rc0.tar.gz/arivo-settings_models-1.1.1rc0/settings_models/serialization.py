...
from typing import Union, Type, Optional, Any, TypeVar, List
...
from settings_models.settings.apcoa_flow import LaneIdMapping
...
_model_mapping = {
    ...
    "apcoa_flow/location_id": Setting(str, "The location id of the garage in APCOA Flow."),
    "apcoa_flow/lane_id_mapping": Setting(List[LaneIdMapping], "Mapping between our gates and APCOA Flow lanes.")
}
