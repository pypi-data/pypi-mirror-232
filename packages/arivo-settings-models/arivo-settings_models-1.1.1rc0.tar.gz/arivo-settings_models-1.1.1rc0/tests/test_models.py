...
class ParsingTests(TestCase):
    ...
    def test_apcoa_flow_location_id(self):
        setting_str = '"garage1"'
        res = parse_setting("apcoa_flow/location_id", setting_str)
        self.assertEqual(setting_str.encode("utf8"), dump_setting(res))

    def test_apcoa_flow_lane_id_mapping(self):
        setting_str = '[{"lane_id": 1, "gate": "entry", "is_exit": false}, ' \
                      '{"lane_id": 2, "gate": "exit", "is_exit": true}]'
        res = parse_setting("apcoa_flow/lane_id_mapping", setting_str)
        self.assert_result(setting_str, dump_setting(res))
