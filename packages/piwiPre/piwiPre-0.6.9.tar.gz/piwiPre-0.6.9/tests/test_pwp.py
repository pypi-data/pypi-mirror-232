...
class PwpTester:
    ...
    def done(self, name):
        ...
        self.create(f"tests/results/{name}_done.txt")
    ...
    def runner_100(self, album, web, remote_web=None):
        ...
        if remote_web:
            ...
            ACTOR.remote_file_or_dir_exists(remote_web + '/2023/2023-06-Juin-17-Armor-cup/' +           # noqa
    ...
    def program_200(self):
        ...
        LOGGER.msg(f'--------------- starting {mn}')
        LOGGER.msg('------------ Starting tests for --verify-albums')
        LOGGER.msg('')
        LOGGER.msg('sources/TRIAGE -> ALBUM, WEB')
        LOGGER.msg('')
        ACTOR.rmtree("tests/results")
        ...
        self.assert_info("RENAME: 'TRIAGE/Corse/IMG-20200517-WA0000.jpg' : " +  # noqa
                         "'ALBUM/Corsica/2020-05-17-12h00-00-Corsica.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Corse/IMG-20210818-WA0000.jpg' : " +  # noqa
                         "'ALBUM/Corsica/2021-08-18-12h00-00-Corsica.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Corse/IMG-20210819-WA0004 - Copie.jpg' : " +  # noqa
                         "'ALBUM/Corsica/2021-08-19-12h04-00-Corsica.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Corse/IMG-20210819-WA0004.jpg' : " +  # noqa
                         "'ALBUM/Corsica/2021-08-19-12h04-01-Corsica.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Forêt-de-la-Corbière/20230611_162803.jpg' : " +  # noqa
                         "'ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                         "2023-06-11-16h28-04-Forêt-de-la-Corbière.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Forêt-de-la-Corbière/20230611_162811.jpg' : " +  # noqa
                         "'ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                         "2023-06-11-16h28-11-Forêt-de-la-Corbière.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Forêt-de-la-Corbière/20230611_162816.jpg' : " +  # noqa
                         "'ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                         "2023-06-11-16h28-17-Forêt-de-la-Corbière.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Forêt-de-la-Corbière/20230611_170215.jpg' : " +  # noqa
                         "'ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                         "2023-06-11-17h02-16-Forêt-de-la-Corbière.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Forêt-de-la-Corbière/20230611_170225.jpg' : " +  # noqa
                         "'ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                         "2023-06-11-17h02-25-Forêt-de-la-Corbière.jpg'")  # noqa
        self.assert_info("RENAME: 'TRIAGE/Forêt-de-la-Corbière/IMG20230611162736.jpg' : " +  # noqa
                         "'ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                         "2023-06-11-16h27-36-Forêt-de-la-Corbière.jpg'")  # noqa
        self.assert_file('tests/results/ALBUM/Corsica/piwiPre.ini')  # noqa

        jpg = PwpJpg("tests/results/ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                     "2023-06-11-16h28-17-Forêt-de-la-Corbière.jpg")  # noqa
        self.assert_orientation(jpg, 1)
        self.assert_copyright(jpg, '2023')
        self.assert_special(jpg, 'No copy allowed unless explicitly approved by')
    ...
    def program_202(self):
        ...
        ACTOR.move('tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/2023-06-17-11h05-44-Armor-cup.jpg',  # noqa
                   'tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/P1.jpg')                             # noqa
        # next picture has a bad copyright information, without '2023'
        ACTOR.delete('tests/results/ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/' +                     # noqa
                     '2023-06-11-16h27-36-Forêt-de-la-Corbière.jpg')  # noqa
        ACTOR.copy('tests/sources/Modified/2023-06-11-16h27-36-Forêt-de-la-Corbière.jpg',                   # noqa
                   'tests/results/ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/')                        # noqa
        ...
        ACTOR.delete("tests/results/WEB/Corsica/2020-05-17-12h00-00-Corsica-sq.jpg")                        # noqa

        main2 = pwp_init(['--chdir', 'tests/results', '--triage', 'None', '--dryrun',
                          '--verify-albums', '2023/2023-06-Juin-11-Forêt-de-la-Corbière',                   # noqa
                          '--verify-albums', '2023/2023-06-Juin-17-Armor-cup',                              # noqa
                          '--verify-albums', 'Corsica'])                                                    # noqa
        pwp_run(main2)
        self.assert_no_file(
            'tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/2023-06-17-11h05-44-Armor-cup.jpg')  # noqa
        self.assert_no_file('tests/results/WEB/Corsica/2020-05-17-12h00-00-Corsica-sq.jpg')  # noqa
        jpg = PwpJpg("tests/results/ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                     "2023-06-11-16h27-36-Forêt-de-la-Corbière.jpg")  # noqa
    ...
    def program_203(self):
        ...
        # correctly renamed the file
        self.assert_file('tests/results/ALBUM/2023/2023-06-Juin-17-Armor-cup/2023-06-17-11h05-44-Armor-cup.jpg')  # noqa
        # correctly generate lacking thumbnail
        self.assert_file('tests/results/WEB/Corsica/2020-05-17-12h00-00-Corsica-sq.jpg')  # noqa

        jpg = PwpJpg("tests/results/ALBUM/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                     "2023-06-11-16h27-36-Forêt-de-la-Corbière.jpg")  # noqa
        self.assert_copyright(jpg, '2023')
        self.assert_file("tests/results/BACKUP/2023/2023-06-Juin-11-Forêt-de-la-Corbière/" +  # noqa
                         "2023-06-11-16h27-36-Forêt-de-la-Corbière.jpg")  # noqa
        ...
        self.assert_orientation(jpg, 1)
        self.assert_file('tests/results/BACKUP/2023/2023-06-Juin-11-Forêt-de-la-Corbière/' +  # noqa
                         '2023-06-11-16h28-17-Forêt-de-la-Corbière.jpg')  # noqa                                          # noqa
    ...
    def program_204(self):
        ...
        LOGGER.msg('--verify-album, with modification, --dryrun')

        self.create('tests/results/WEB/2023/2023-06-Juin-11-Forêt-de-la-Corbière/foo-sq.jpg')     # noqa
        self.create('tests/results/WEB/2023/2023-06-Juin-11-Forêt-de-la-Corbière/bat-th.jpg')     # noqa

        main2 = pwp_init(['--chdir', 'tests/results', '--triage', 'None', '--dryrun',
                          '--verify-albums', '2023/2023-06-Juin-11-Forêt-de-la-Corbière',                # noqa
                          '--useless-thumbnails-delete'])          # noqa
        pwp_run(main2)
        self.assert_file('tests/results/WEB/2023/2023-06-Juin-11-Forêt-de-la-Corbière/foo-sq.jpg')      # noqa
        self.assert_file('tests/results/WEB/2023/2023-06-Juin-11-Forêt-de-la-Corbière/bat-th.jpg')      # noqa
    ...
    def program_300(self):
        ...
        self.create("tests/results/WEB/2021/2021-08-Août-19-Corse/2021-08-19-12h04-00-Corse-foo.jpg")    # noqa
        self.create("tests/results/WEB/2020/2020-05-Mai-17-Corse/2021-08-19-12h04-00-Corse-sq.jpg")      # noqa
        self.create("tests/results/WEB/2020/2020-05-Mai-17-Corse/foo.txt")                               # noqa
    ...
    def program_400(self):
        ...
        ACTOR.rmtree("tests/results")
        ACTOR.copy("tests/sources/piwiPre-mount.ini", "tests/results/piwiPre.ini")
        self.create("tests/results/dummy.txt")
    ...
    def program_401(self):
        ...
        self.runner_100(album, web, remote_web=remote_web)
