...
class ClickInputListener(object):
    ...
    def __init__(self, server, brick_scene):
        r"""
        __init__(ClickInputListener self, std::shared_ptr< click::Server > & server, std::shared_ptr< Brick::Core::Object > const & brick_scene) -> ClickInputListener
        ...
        """
        _BrickAgxPyApi.ClickInputListener_swiginit(self, _BrickAgxPyApi.new_ClickInputListener(server, brick_scene))
...
class ClickAdapter(object):
    ...
    @staticmethod
    def create_click_listeners(click_server_addr, brick_scene):
        r"""
        create_click_listeners(std::string const & click_server_addr, std::shared_ptr< Brick::Core::Object > const & brick_scene) -> std::pair< BrickAgx::ClickInputListener *,BrickAgx::ClickOutputListener * >
        ...
        """
        return _BrickAgxPyApi.ClickAdapter_create_click_listeners(click_server_addr, brick_scene)
...
def ClickAdapter_create_click_listeners(click_server_addr, brick_scene):
    r"""
    ClickAdapter_create_click_listeners(std::string const & click_server_addr, std::shared_ptr< Brick::Core::Object > const & brick_scene) -> std::pair< BrickAgx::ClickInputListener *,BrickAgx::ClickOutputListener * >
