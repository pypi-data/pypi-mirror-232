...
from umbrella.trailing_objects import TrailingObjects, Token, TrailingTys
...
class TargetGenericRequirementDescriptor(Virtual):
    ...
    class TypeRef:
        ...
        protocol: RelativeIndirectablePointerIntPair[t.Any, Nullable] = csd.csfield(
            RelativeIndirectablePointerIntPair(lambda: swift.TargetProtocolDescriptor, True)
        )
    ...
    def get_protocol(self) -> "swift.TargetProtocolDescriptor":
...
class TrailingGenericContextObjects(
    ...
    def get_generic_context_header(self) -> HeaderTy:
        ...
        return self.getTrailingObjects(Token[header_ty])
    ...
    def get_generic_params(self) -> t.List[GenericParamDescriptor]:
        ...
        params = list(self.getTrailingObjects(Token[GenericParamDescriptor]))
        header = self.get_generic_context_header()
    ...
    def get_generic_pack_shape_header(self) -> GenericPackShapeHeader:
        ...
        return self.getTrailingObjects(Token[GenericPackShapeHeader])
