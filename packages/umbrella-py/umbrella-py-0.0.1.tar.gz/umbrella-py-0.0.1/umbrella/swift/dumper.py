...
class SwiftDumper(IDumper):
    ...
    def dump_protocol(
        self, protocol: abi.TargetProtocolDescriptor, fp=None, depth=None
    ) -> None:
        ...
        :type protocol: abi.TargetProtocolDescriptor
    ...
    def dump_enum(self, enum: abi.TargetEnumDescriptor, fp=None, depth=None) -> None:
        ...
        :type enum: abi.TargetEnumDescriptor
        :param fp: the output stream, defaults to None
        :type fp: io.IOBase, optional
        """
        self._start()
    ...
    def dump_class(self, cls: abi.TargetClassDescriptor, fp=None, depth=None) -> None:
        self.dump(self._dump_class, cls, fp, self.indent, depth)

    def dump_struct(self, cls: abi.TargetClassDescriptor, fp=None, depth=None) -> None:
        self.dump(self._dump_struct, cls, fp, self.indent, depth)

    def _dump_class(self, cls: abi.TargetClassDescriptor) -> None:
        # TODO: implement me
    ...
    def _dump_struct(self, struct: abi.TargetStructDescriptor) -> None:
    ...
    def _get_protocol_signature(self, protocol: abi.TargetProtocolDescriptor) -> str:
        # ---------------------- Protocol-Signature ----------------------
