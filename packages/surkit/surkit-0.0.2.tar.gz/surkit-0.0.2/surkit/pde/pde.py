...
def parse_pde(equation, geo: dict, constant: dict, out_dic: dict, dic: dict):
    """
    ...
    """
    ll = eval_with_vars(equation[0], geo, constant, out_dic, dic)
    rr = eval_with_vars(equation[1], geo, constant, out_dic, dic)
