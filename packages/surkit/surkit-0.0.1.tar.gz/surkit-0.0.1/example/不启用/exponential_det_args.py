...
def parse():
    ...
    parser.add_argument('--transforms', nargs='+', type=str,
                        help='affine layer of the nn. i.e. exp, sin, cos, pow2')
...
def main():
    ...
    train(sampler=sampler, output=args.output_name, net=my_net, iterations=args.max_iteration, target=target,
          optimizer=args.optimizer, lr=args.lr, loss_function=args.loss_function, path=args.save_path, device=args.device,
