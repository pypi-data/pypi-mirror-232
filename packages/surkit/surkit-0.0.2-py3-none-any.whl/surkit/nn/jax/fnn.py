...
class FNN(nn.Module):
    ...
    Args:
        ...
        activation (str): name of an activation function or a callable activation function for pytorch
        in_d (int): input length
        out_d (int): output length
        initializer (str, optional): the function to initialize the weight parameter.
...
class PFNN(nn.Module):
    ...
    Args:
        layers (list[int]): list with numbers output feature at each layer
        activation (str | nn.Module): name of an activation function or a callable activation function for pytorch
        in_d (int): input length
        out_d (int): output length
        initializer (callable, optional): the function to initialize the weight parameter.
        transforms (list[str], optional): perform affine transformations on the input
