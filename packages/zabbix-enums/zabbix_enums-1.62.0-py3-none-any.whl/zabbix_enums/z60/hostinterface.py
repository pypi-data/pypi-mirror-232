"""https://www.zabbix.com/documentation/6.0/en/manual/api/reference/hostinterface/object"""
from zabbix_enums import _ZabbixEnum

class HostInterfaceAvailable(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.0/en/manual/api/reference/hostinterface/object#host-interface
...
class DetailsTagVersion(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.0/en/manual/api/reference/hostinterface/object#details-tag
