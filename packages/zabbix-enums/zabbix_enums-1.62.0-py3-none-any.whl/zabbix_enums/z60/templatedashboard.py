"""https://www.zabbix.com/documentation/6.0/en/manual/api/reference/templatedashboard/object"""
...
class TemplateDashboardAutoStart(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.0/en/manual/api/reference/templatedashboard/object#template-dashboard
...
class TemplateDashboardWidgetType(str, Enum):
    """
    https://www.zabbix.com/documentation/6.0/en/manual/api/reference/templatedashboard/object#template-dashboard-widget
