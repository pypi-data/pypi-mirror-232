"""https://www.zabbix.com/documentation/5.2/en/manual/api/reference/proxy/object"""
...
class ProxyInterfaceUseIp(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/proxy/object#proxy-interface
