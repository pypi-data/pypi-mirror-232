"""https://www.zabbix.com/documentation/6.4/en/manual/api/reference/script/object"""
from zabbix_enums import _ZabbixEnum


class ScriptType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/script/object#script
