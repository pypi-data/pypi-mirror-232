"""https://www.zabbix.com/documentation/6.4/en/manual/api/reference/dashboard/object"""
...
class DashboardPrivate(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/dashboard/object#dashboard
...
class DashboardWidgetType(str, Enum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/dashboard/object#dashboard-widget
...
class DashboardWidgetFieldType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/dashboard/object#dashboard-widget-field
...
class DashboardUserGroupPermission(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/dashboard/object#dashboard-user-group
...
class DashboardUserPermission(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/dashboard/object#dashboard-user
