...
from tyke.agent.config import config_pb2, AgentConfig
...
class AgentInit:  # pylint: disable=R0902,R0903
    ...
    def _auth_token(self):
        auth_token = ""
        try:
            if self._config.agent_config.reporting.token != "":
                token = quote("Basic " + self._config.agent_config.reporting.token)
