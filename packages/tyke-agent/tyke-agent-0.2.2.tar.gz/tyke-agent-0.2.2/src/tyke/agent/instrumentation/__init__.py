'''Base class of all Tyke Instrumentation Wrapper classes'''
import sys
import os.path
import inspect
import traceback
...
# This is a base class for all Tyke Instrumentation wrapper classes
    ...
    def get_content_encoding(self, headers: dict):
        ...
        try:
            ...
            if type(content_encoding) is tuple:
                content_encoding = content_encoding[1]
    ...
    def _generic_handler(self, record_headers: bool, header_prefix: str, # pylint:disable=R0913
        ...
        try:  # pylint: disable=R1702
            ...
            if record_body:
                ...
                content_encoding = self.get_content_encoding(lowercased_headers)

                if content_type is False:
                    return span
                if content_encoding and content_encoding in ['deflate', 'gzip']:
