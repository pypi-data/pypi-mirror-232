...
class ConfigNotFoundError(Exception):
    ...
    def __init__(self):
        ...
        super().__init__(
            "No configuration file found. Run 'validio config edit' to create one or"
            f" set the environment variables '{VALIDIO_ENDPOINT_ENV}',"
            f" '{VALIDIO_ACCESS_KEY_ENV}' and '{VALIDIO_SECRET_ACCESS_KEY_ENV}'"
        )
