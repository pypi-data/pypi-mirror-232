from prompt.retrieval.interface import WeaviateQueryEngine
...
class SimpleWeaviateQueryEngine(WeaviateQueryEngine):
    ...
    def retrieve_document(self, doc_id: str) -> dict:
        ...
        """
        document = WeaviateQueryEngine.client.data_object.get_by_id(
            doc_id,
            class_name="Document",
        )
        return document
    ...
    def add_semantic_cache(self, query: str, results: list[dict], system: str) -> None:
        ...
        with WeaviateQueryEngine.client.batch as batch:
            ...
            WeaviateQueryEngine.client.batch.add_data_object(properties, "Cache")
