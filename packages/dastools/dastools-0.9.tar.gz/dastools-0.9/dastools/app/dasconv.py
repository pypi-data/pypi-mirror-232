...
def main():
    ...
    parser.add_argument('-p', '--processes', type=int, choices=[1, 2, 4, 8, 16, 32],
                        help='Number of threads to spawn when parallelizing the conversion', default=1)
...
def task(filename: str, directory: str, inputfmt: str, networkcode: str, channelcode: str,
