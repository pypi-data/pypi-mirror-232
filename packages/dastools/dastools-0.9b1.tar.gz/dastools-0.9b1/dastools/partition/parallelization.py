...
class Split(metaclass=ABCMeta):
    ...
    def getbatch(self) -> list:
        ...
        :param numprocesses: Number of processes to be
...
class SplitTDMS(Split):
    ...
    def __init__(self, dasfiles: TDMS, outputfmt: str = 'SDS', starttime=None, endtime=None):
...
class SplitOptoDAS(Split):
    ...
    def __init__(self, dasfiles: OptoDAS, outputfmt: str = 'SDS', starttime=None, endtime=None):
        """Get parameters to define a batch of the TDMS dataset
