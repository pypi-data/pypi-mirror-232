...
def read_token_file(exit_on_error=True,tracking_uri=None) -> Tuple[str, str, str, str, str, str, str]:
    ...
    Returns:
        ...
        * {INFINSTOR_REFRESH_TOKEN, INFINSTOR_COGNITO_CLIENTID} is set but empty (when logging in is in progress and the operational mode for token file is these environment variables, these are usually set to empty)
