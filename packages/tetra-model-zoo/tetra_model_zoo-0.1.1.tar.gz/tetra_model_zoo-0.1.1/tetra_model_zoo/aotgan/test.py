...
from tetra_model_zoo.aotgan.model import AOTGAN, MODEL_ASSET_VERSION, MODEL_NAME
...
IMAGE_ADDRESS = f"{MODEL_ZOO_ASSET_PATH}/aotgan/v{MODEL_ASSET_VERSION}/test_images/test_input_image.png"
MASK_ADDRESS = f"{MODEL_ZOO_ASSET_PATH}/aotgan/v{MODEL_ASSET_VERSION}/test_images/test_input_mask.png"
OUTPUT_ADDRESS = (
    f"{MODEL_ZOO_ASSET_PATH}/aotgan/v{MODEL_ASSET_VERSION}/test_images/test_output.png"
)
