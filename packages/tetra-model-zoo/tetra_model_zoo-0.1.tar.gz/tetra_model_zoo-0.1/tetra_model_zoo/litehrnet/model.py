...
class LiteHRNet(torch.nn.Module):
    ...
    @staticmethod
    def from_pretrained(inferencer_arch=DEFAULT_INFERENCER_ARCH) -> LiteHRNet:
    ...
    def get_input_spec(
        ...
        return {"image": ((num_channels, *image_size), "float32")}
