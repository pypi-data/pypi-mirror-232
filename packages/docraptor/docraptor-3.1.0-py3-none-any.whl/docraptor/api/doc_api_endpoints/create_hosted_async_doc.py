...
from docraptor.model.async_doc import AsyncDoc
...
_path = '/hosted_async_docs'
_method = 'POST'
_auth = [
    'basicAuth',
]
SchemaFor200ResponseBodyApplicationJson = AsyncDoc
SchemaFor200ResponseBodyApplicationXml = AsyncDoc
SchemaFor200ResponseBodyApplicationPdf = AsyncDoc
SchemaFor200ResponseBodyApplicationVndMsExcel = AsyncDoc
SchemaFor200ResponseBodyApplicationVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet = AsyncDoc
...
class CreateHostedAsyncDoc(api_client.Api):

    def create_hosted_async_doc(
        self: api_client.Api,
