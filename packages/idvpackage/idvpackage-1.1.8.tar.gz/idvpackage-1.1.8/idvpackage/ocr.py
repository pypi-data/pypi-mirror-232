...
class IdentityVerification:
    ...
    def check_for_liveness(self, similarity, video_bytes):
        ...
        if any(liveness_result_list) and similarity>=0.70:
        ...
        if country == 'UAE':
            ...
            if is_colored1:
                ...
                if identify_front_id(front_id_text):
                    ...
                    front_blurred, front_glare = self.get_blurred_and_glared_for_doc(img)
        ...
        if country=='UAE':
            ...
            if is_colored2:
                ...
                if identify_back_id(text):
                    ...
                    back_blurred, back_glare = self.get_blurred_and_glared_for_doc(img)
