...
T = TypeVar("T", bound="RawDataDatesResponse200ResponseResultItem")


@define
class RawDataDatesResponse200ResponseResultItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        raw_data_dates_response_200_response_result_item = cls(
            datetime_=datetime_,
            value=value,
            field_attr=field_attr,
        )

        raw_data_dates_response_200_response_result_item.additional_properties = d
        return raw_data_dates_response_200_response_result_item
