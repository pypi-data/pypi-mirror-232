...
if TYPE_CHECKING:
    ...
    from ..models.raw_data_node_3_response_200_response_status_item import RawDataNode3Response200ResponseStatusItem
...
class RawDataNode3Response200Response:
    """
    Attributes:
        status (Union[Unset, List['RawDataNode3Response200ResponseStatusItem']]):
        result (Union[Unset, List['RawDataNode3Response200ResponseResultItem']]):
    """

    status: Union[Unset, List["RawDataNode3Response200ResponseStatusItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for status_item_data in _status or []:
            status_item = RawDataNode3Response200ResponseStatusItem.from_dict(status_item_data)
