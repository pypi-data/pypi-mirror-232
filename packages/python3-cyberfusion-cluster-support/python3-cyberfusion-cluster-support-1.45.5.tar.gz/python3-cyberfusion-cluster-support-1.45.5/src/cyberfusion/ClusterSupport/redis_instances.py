...
class RedisInstance(APIObjectInterface):
    ...
    def _set_attributes_from_model(
        ...
        self.primary_node_id = obj["primary_node_id"]
        ...
        self.working_directory = os.path.join(
            os.path.sep, *["var", "lib", "redis", self.name]
        )
        ...
        self.primary_node = self.support.get_nodes(id_=self.primary_node_id)[0]

        self._cluster_name = self.cluster.name
        self._primary_node_hostname = self.primary_node.hostname
