# -*- coding: utf-8 -*-
""" Atomistic data, copied from ASE"""
...
atomic_numbers = dict((symbol, Z) for Z, symbol in enumerate(chemical_symbols))
...
molar_masses = dict(zip(chemical_symbols, atomic_masses))
