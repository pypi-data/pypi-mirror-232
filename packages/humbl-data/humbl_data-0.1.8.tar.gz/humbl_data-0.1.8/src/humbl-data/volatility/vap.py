import pandas as pd
import polars as pl
from humbl-data.orats.data import OratsData
from humbl-data.volatility.estimators import VolatilityEstimators
from humbl-data.volatility.helpers import (
    check_iv_endpoint,
    data_alignment,
    format_date,
    get_price_data,
...
class VolatilityPremium:
    ...
    def calc_vap(
        ...
        **kwargs,
        ...
        Returns:
        --------
        `Self` Object with premia data stored in self.premia_data
        """
        # Setup ----------------------------------------------------------------
        # Assign Ticker
        self.ticker = ticker
    ...
    def signal(
        ...
        **kwargs,
        ...
        """
        This method merges price data and premia data, calculates the signal,
    ...
    def plot(self):
        # Step 1: Run Plotting Engine ------------------------------------------
        # Side-effect assigns:
        # self.plot = VAP plot
        # self.perf_plot = strategy performance plot

        self = plot_engine(self=self, plot_method=self.plot_method)
        return self
