...
from huscy.data_acquisition_methods.mri import __version__
...
setup(
    name='huscy.data-acquisition-methods.mri',
    version=__version__,
    license='AGPLv3+',
    ...
    url='https://bitbucket.org/huscy/data_acquisition_methods.mri',
