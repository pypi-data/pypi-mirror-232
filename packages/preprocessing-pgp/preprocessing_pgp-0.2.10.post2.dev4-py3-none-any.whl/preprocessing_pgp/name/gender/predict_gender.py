...
def process_predict_gender(
    ...
    predicted_name_data["before_fname"] = None
    predicted_name_data.loc[
        predicted_name_data[name_col].str.split().str.len() >= 2, "before_fname"
    ] = (predicted_name_data[name_col].str.split().str.get(-2))
    predicted_name_data.loc[
        predicted_name_data["before_fname"].notna(), "before_fname"
    ] = predicted_name_data["before_fname"].str.lower()
