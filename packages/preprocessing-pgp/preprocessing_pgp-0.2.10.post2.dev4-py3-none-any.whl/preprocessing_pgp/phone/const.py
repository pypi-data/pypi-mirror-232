...
mobi_phone_path = f"{CURRENT_PATH}/../data/mobi_head_code.parquet"
telephone_path = f"{CURRENT_PATH}/../data/tele_head_code.parquet"
...
SUB_MOBI_PHONE_10NUM = sorted(sub_mobi_phone["NewSubPhone"].unique())
