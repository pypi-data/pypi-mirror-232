...
class EmailAddressExtractor:
    ...
    def __generate_norm_dict(self):
        ...
        location_norm.loc[city_mask, "norm_city"] = (
            location_norm.loc[city_mask, "lv1_norm"]
            .str.extract(r"\s(.*)")[0]
        ...
        self.location_norm_dict = location_norm.set_index("norm_city")["lv1"].to_dict()
        # * Additional cities
    ...
    def _get_address(self, email_name: str) -> str:
        """
    ...
    def extract_address(
        ...
        data["address_extracted"] = data[email_name_col].apply(self._get_address)
