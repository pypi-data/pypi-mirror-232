...
class EnrichName:
    ...
    def __init__(
        ...
        self.fname_rb = pd.read_parquet(f"{name_rb_pth}/firstname_dict.parquet")
        self.mname_rb = pd.read_parquet(f"{name_rb_pth}/middlename_dict.parquet")
        self.lname_rb = pd.read_parquet(f"{name_rb_pth}/lastname_dict.parquet")
...
def process_enrich(
    ...
    final_data[["last_name", "middle_name", "first_name"]] = (
        final_data["final"].apply(name_process.split_name).tolist()
    )
