...
from sqlite_dao_ext.kv_dao.kv_dao import KvDao, ONE_THOUSAND_YEAR
from sqlite_dao_ext.kv_dao.kv_data import KvData
...
class SqliteKvDao(SqliteDao, KvDao):
    def __init__(
        self,
