...
class PdfSignaturePosition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["x", "y", "page", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["x", "y", "page", ], str]):
