...
class BaseVisualizer:
    ...
    def captureImage(self, w: Incomplete | None = ..., h: Incomplete | None = ...) -> None: ...
    ...
    def play(self, q_trajectory, dt: Incomplete | None = ..., callback: Incomplete | None = ..., capture: bool = ..., **kwargs): ...
    def create_video_ctx(self, filename: Incomplete | None = ..., fps: int = ..., directory: Incomplete | None = ..., **kwargs): ...
