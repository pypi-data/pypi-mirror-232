...
class RowSyncer:
    ...
    def _remove_extra_rows(self) -> None:
        ...
        for chunk in pg_row_id_chunks:
            ...
            self.logger.info(f'Found {len(extra_row_ids)} rows that need to be destroyed in chunk of 100')
    ...
    def _create_missing_rows_and_update_cell_values(self) -> None:
        ...
        while chunk:
            ...
            self.logger.info(f'Found {len(missing_row_ids)} rows that need to be created in chunk of 100')
