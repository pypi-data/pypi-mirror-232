...
class Handler:
    ...
    def _handle_new_table(self, change: changes.NewTable):
        ...
        view_syncer.ViewSyncer(self.replication, specific_table=change.table.id).sync()
    ...
    def _handle_destroyed_table(self, change: changes.DestroyedTable):
        ...
        view_syncer.ViewSyncer(self.replication, specific_table=change.table_id).sync()
    ...
    def _handle_field_type_change(self, change: changes.FieldTypeChange):
        ...
        view_syncer.ViewSyncer(self.replication, specific_table=change.table_id).drop_views()
