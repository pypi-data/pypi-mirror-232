...
export default class Constants {
  ...
  public static readonly AI_SVG = `<svg width="90" height="100" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  public static readonly COPILOT_BLACK = `<svg width="1784" height="643" viewBox="0 0 1784 643" fill="none" xmlns="http://www.w3.org/2000/svg">
