seqMetadata = {
    ...
    "properties": {
        ...
        "SEQUENCING_REASON": {"enum": ["random", "requested", "other", "clinical"]},
        ...
        "Uploads": {
            ...
            "items": {
                ...
                "properties": {
                    "REPOSITORY_NAME": {
                        "enum": ["GISAID", "ENA", "SRA", "PubMLST", "GenBank", "Other"]
                    },
                    "REPOSITORY_LINK": {
                        "type": "string"
                    },  # TODO do we need to add regex for hyperlink here?
                    "REPOSITORY_ID": {"type": "string"},
                    "UPLOAD_DATE": {"$ref": "#/$defs/date"},
                    "UPLOAD_STATUS": {
                        "enum": ["Accepted", "Planned", "Denied", "Other"]
                    },
        ...
        "Files": {
            ...
            "items": {
                ...
                "properties": {
                    "FILE_NAME": {
                        "type": "string",
                        "pattern": "_R[1|2]_[0-9]{1,3}.fastq.gz$",
                    },
