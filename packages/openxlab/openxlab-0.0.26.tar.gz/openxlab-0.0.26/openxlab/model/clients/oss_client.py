...
class OssClient(object):
    def __init__(self, endpoint, access_key_id, access_key_secret, security_token, bucket_name, part_size=0):
    ...
    def multipart_resume_upload(self, local_file_path, object_key, callback=None, callback_var=None, domain=None):
        ...
        try:
            ...
            # compute part count
            part_count = (total_size + self.part_size - 1) // self.part_size
            ...
            with open(local_file_path, 'rb') as fileobj:
                ...
                for i in range(part_count):
                    ...
                    num_to_upload = min(self.part_size, total_size - offset)
