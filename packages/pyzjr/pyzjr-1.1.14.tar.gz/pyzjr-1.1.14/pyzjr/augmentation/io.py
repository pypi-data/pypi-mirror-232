...
import pathlib
from pyzjr.FM import FileUrl_context
from .utils import is_gray_image,not_rgb_warning
from pyzjr.core._plugins.plugins import call_plugin
...
def imread(filename,is_gray=False):
    """The method of reading functions in the skimage package used here
    从文件路径加载图像
    fmt:RGB 格式
    """
