...
from pyzjr.augmentation.Pixel.pixel import SkeletonMap, incircle
from pyzjr.utils import Boundingbox
from pyzjr.math import EuclideanDis
    ...
    def Eachareas(self, merge_threshold=3, area_threshold=50):
        ...
        for region in region_props:
            ...
            if area_value >= area_threshold:
                ...
                Bbox.putBoxText(self.imgMask, [minc, minr, maxc, maxr],chr(crack_label))
