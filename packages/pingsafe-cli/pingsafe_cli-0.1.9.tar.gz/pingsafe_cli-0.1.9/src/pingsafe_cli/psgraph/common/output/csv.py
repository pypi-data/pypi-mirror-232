...
from pingsafe_cli.psgraph.common.output.common import format_string_to_licenses, is_raw_formatted
...
from pingsafe_cli.psgraph.common.sca.commons import get_fix_version, UNFIXABLE_VERSION
from pingsafe_cli.psgraph.common.util.consts import PINGSAFE_DISPLAY_REGISTRY_URL
...
if PINGSAFE_DISPLAY_REGISTRY_URL:
...
CTA_NO_API_KEY = (
    "SCA, image and runtime findings are only available with PingSafe. Signup at "
    "https://www.pingsafe.cloud/login/signUp and add your API key to include those findings. "
)
