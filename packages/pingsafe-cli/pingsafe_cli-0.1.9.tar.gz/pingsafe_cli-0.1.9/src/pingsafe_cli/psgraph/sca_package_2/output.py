...
from pingsafe_cli.psgraph.common.pingsafe.severities import BcSeverities
from pingsafe_cli.psgraph.common.models.enums import CheckResult
from pingsafe_cli.psgraph.common.output.record import Record, SCA_PACKAGE_SCAN_CHECK_NAME, SCA_LICENSE_CHECK_NAME
from pingsafe_cli.psgraph.common.packaging import version as packaging_version
from pingsafe_cli.psgraph.common.sca.commons import UNFIXABLE_VERSION, get_package_alias
from pingsafe_cli.psgraph.common.typing import _LicenseStatus
from pingsafe_cli.psgraph.common.output.common import compare_table_items_severity
...
def create_fixable_cve_summary_table_part(
    ...
    if cve_count.fixable:
        fixable_table.add_row(
            [f"To fix {cve_count.has_fix}/{cve_count.to_fix} CVEs, go to https://www.pingsafe.cloud/  "])
