...
class BcPlatformIntegration:
    def __init__(self) -> None:
        ...
        self.bc_api_url = normalize_bc_url(os.getenv('BC_API_URL', "https://www.pingsafe.cloud"))
        ...
        if not self.bc_api_key:
                ...
                u"\u2022 " + "Command line docker Image scanning\n"
                             u"\u2022 " + "Software Composition Analysis\n"
                                          u"\u2022 " + "Centralized policy management\n"
                                                       u"\u2022 " + "Free pingsafe.cloud account with API access\n"
            ...
            if reply[:1] == 'y':
                print(Style.BRIGHT + colored("\nOk, let’s get you started on creating your free account! \n"
                                             ...
                                             attrs=['bold']) + colored(
                    " // This will be used as your login at https://pingsafe.cloud.\n", 'green'))
                if not self.bc_api_key:
                    ...
                    if response.status_code == 200:
                        ...
                        print(Style.BRIGHT + colored(
                            "\nPingSafe will automatically check this location for a key.  If you forget it you’ll find it here\nhttps://pingsafe.cloud/integrations/api-token\n\n",
                            'green'))
                        persist_key(self.bc_api_key)
                        print(Style.BRIGHT + colored(
                            "PingSafe Dashboard is configured, opening https://pingsafe.cloud to explore your new powers.",
                            'green', attrs=['bold']))
                    ...
                    webbrowser.open(
                        "https://pingsafe.cloud/?utm_source=cli&utm_medium=organic_oss&utm_campaign=pingsafe")
            else:
                print(
    ...
    def _upload_run(self, args: argparse.Namespace, scan_reports: list[Report]) -> None:
        print(Style.BRIGHT + colored("Connecting to PingSafe.cloud...", 'green',
        ...
        print(Style.BRIGHT + colored(
            "COMPLETE! \nYour results are in your PingSafe dashboard, available here: https://pingsafe.cloud \n",
    ...
    def _create_pingsafe_account(self, email: str, org: str) -> Response:
        ...
        if response.status_code == 200:
            ...
            raise Exception("failed to create a pingsafe account. An organization with this name might already "
                            "exist with this email address. Please login pingsafe.cloud to retrieve access key")
