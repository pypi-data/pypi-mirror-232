...
class RsInstrument:
	"""Root class for remote-controlling instrument with SCPI commands."""
	_driver_version_const = '1.55.0.99'
	...
	def __init__(
		...
		Parameter options tokens examples:
			...
			- ``CmdIdn = ID?`` - defines which SCPI command to use for identification query. Default: ``\*IDN?``
...
"""
	...
	def __enter__(self) -> 'RsInstrument':
		...
		Currently does nothing, and returns the RsInstrument object."""
		return self
