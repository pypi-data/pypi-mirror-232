...
class ComputeOptimalRetentionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["days_to_simulate", b"days_to_simulate", "deck_size", b"deck_size", "max_interval", b"max_interval", "max_minutes_of_study_per_day", b"max_minutes_of_study_per_day", "search", b"search", "weights", b"weights"]) -> None: ...
