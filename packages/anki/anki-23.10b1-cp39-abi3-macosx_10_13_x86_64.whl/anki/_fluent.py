...
learning cards are cards with a current learning step of one or more days. '''
    ...
    def deck_config_compute_optimal_weights(self, ) -> str:
        r''' Compute optimal weights '''
        return self._translate(11, 22, {})


    def deck_config_compute_weights_search(self, ) -> str:
        r''' Search; leave blank for all cards using this preset '''
...
shown. '''
    ...
    def deck_config_limited_history(self, count: int) -> str:
        r''' Only {$count} reviews were found. The custom weights are likely to be inaccurate, and using the defaults instead is recommended. '''
        return self._translate(11, 57, {"count": count})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 98, {"cards": cards, "expected": expected})
...
taking to review each card. '''
    ...
    def deck_config_smaller_is_better(self, ) -> str:
        r''' Smaller numbers indicate better memory estimates. '''
...
newly-learned card will delay the next review by 2.5x the previous delay. '''
    ...
    def deck_config_steps_too_large_for_fsrs(self, ) -> str:
        r''' When FSRS is enabled, interday (re)learning steps are not recommended. '''
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 126, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 127, {"decks": decks})
...
Anki will start removing some of them to free up disk space. '''
    ...
    def preferences_stop_timer_on_answer(self, ) -> str:
...
Please select  before proceeding. '''
    ...
    def statistics_card_difficulty_subtitle(self, ) -> str:
        r''' The higher the difficulty, the more frequently a card will appear. '''
    ...
    def statistics_cards(self, cards: int) -> str:
        r''' {$cards} cards '''
        return self._translate(32, 25, {"cards": cards})


    def statistics_cards_due(self, cards: int) -> str:
        r''' {$cards} cards due '''
        return self._translate(32, 26, {"cards": cards})
    ...
    def statistics_cards_per_min(self, cards_per_minute: float) -> str:
        ...
        return self._translate(32, 28, {"cards-per-minute": cards_per_minute})
    ...
    def statistics_days_ago_range(self, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 40, {"daysStart": days_start, "daysEnd": days_end})


    def statistics_days_ago_single(self, days: int) -> str:
        r''' {$days} days ago '''
        return self._translate(32, 41, {"days": days})
    ...
    def statistics_due_for_new_card(self, number: FluentVariable) -> str:
        r''' New #{$number} '''
        return self._translate(32, 45, {"number": number})
    ...
    def statistics_elapsed_time_days(self, amount: int) -> str:
        r''' {$amount}d '''
        return self._translate(32, 47, {"amount": amount})


    def statistics_elapsed_time_hours(self, amount: int) -> str:
        r''' {$amount}h '''
        return self._translate(32, 48, {"amount": amount})
    ...
    def statistics_intervals_day_range(self, cards: int, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 69, {"cards": cards, "daysStart": days_start, "daysEnd": days_end})


    def statistics_intervals_day_single(self, cards: int, day: FluentVariable) -> str:
        r''' {$cards} cards with a {$day} day interval '''
        return self._translate(32, 70, {"cards": cards, "day": day})
    ...
    def statistics_minutes_per_day(self, count: int) -> str:
        r''' {$count} minutes/day '''
        return self._translate(32, 73, {"count": count})
    ...
    def statistics_retrievability_tooltip(self, cards: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 82, {"cards": cards, "percent": percent})


    def statistics_reviews(self, reviews: int) -> str:
        r''' {$reviews} reviews '''
        return self._translate(32, 83, {"reviews": reviews})
    ...
    def statistics_reviews_per_day(self, count: int) -> str:
        r''' {$count} reviews/day '''
        return self._translate(32, 85, {"count": count})
...
({$secs-per-card}s/card) '''
        return self._translate(32, 93, {"unit": unit, "secs-per-card": secs_per_card, "amount": amount, "cards": cards})
    ...
    def statistics_today_correct_mature(self, correct: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 96, {"correct": correct, "total": total, "percent": percent})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(32, 100, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 22)
    DECK_CONFIG_COMPUTE_WEIGHTS_SEARCH = (11, 23)
    ...
    DECK_CONFIG_LIMITED_HISTORY = (11, 57)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 58)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 59)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 60)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 61)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 62)
    ...
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 70)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 71)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 72)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 73)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 74)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 75)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 76)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 77)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 78)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 79)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 80)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 81)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 82)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 83)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 84)
    DECK_CONFIG_ORDERING_TITLE = (11, 85)
    DECK_CONFIG_RELEARNING_STEPS = (11, 86)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 87)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 88)
    DECK_CONFIG_REMOVE_GROUP = (11, 89)
    DECK_CONFIG_RENAME_GROUP = (11, 90)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 91)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 92)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 93)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 94)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 95)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 96)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 97)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 98)
    DECK_CONFIG_SAVE_BUTTON = (11, 99)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 100)
    DECK_CONFIG_SHARED_PRESET = (11, 101)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 102)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 103)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 104)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 105)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 106)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 107)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 108)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 109)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 110)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 111)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 112)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 113)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 114)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 115)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 116)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 117)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 118)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 119)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 120)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 121)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 122)
    DECK_CONFIG_TIMER_TITLE = (11, 123)
    DECK_CONFIG_TITLE = (11, 124)
    DECK_CONFIG_TODAY_ONLY = (11, 125)
    DECK_CONFIG_UPDATING_CARDS = (11, 126)
    DECK_CONFIG_USED_BY_DECKS = (11, 127)
    DECK_CONFIG_WEIGHTS = (11, 128)
    DECK_CONFIG_WHICH_DECK = (11, 129)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 130)
    ...
    NOTETYPES_IO_SELECT_IMAGE = (25, 31)
    NOTETYPES_NO_OCCLUSION_CREATED = (25, 32)
    NOTETYPES_NO_OCCLUSION_CREATED2 = (25, 33)
    NOTETYPES_NOTE_TYPES = (25, 34)
    NOTETYPES_NOTETYPE = (25, 35)
    NOTETYPES_OCCLUSION = (25, 36)
    NOTETYPES_OCCLUSION_MASK = (25, 37)
    NOTETYPES_OCCLUSION_NOTE = (25, 38)
    NOTETYPES_OPTIONS = (25, 39)
    NOTETYPES_PLEASE_ADD_ANOTHER_NOTE_TYPE_FIRST = (25, 40)
    NOTETYPES_TEXT_FIELD = (25, 41)
    NOTETYPES_TOGGLE_MASKS = (25, 42)
    NOTETYPES_TYPE = (25, 43)
    ...
    PREFERENCES_STOP_TIMER_ON_ANSWER = (26, 61)
    PREFERENCES_STYLE = (26, 62)
    PREFERENCES_SYNCHRONIZATIONNOT_CURRENTLY_ENABLED_CLICK_THE_SYNC = (26, 63)
    PREFERENCES_SYNCHRONIZE_AUDIO_AND_IMAGES_TOO = (26, 64)
    PREFERENCES_TAB_SYNCHRONISATION = (26, 65)
    PREFERENCES_THEME = (26, 66)
    PREFERENCES_THEME_DARK = (26, 67)
    PREFERENCES_THEME_FOLLOW_SYSTEM = (26, 68)
    PREFERENCES_THEME_LIGHT = (26, 69)
    PREFERENCES_TIMEBOX_TIME_LIMIT = (26, 70)
    PREFERENCES_USER_INTERFACE = (26, 71)
    PREFERENCES_USER_INTERFACE_SIZE = (26, 72)
    PREFERENCES_V3_SCHEDULER = (26, 73)
    PREFERENCES_VIDEO_DRIVER = (26, 74)
    PREFERENCES_VIDEO_DRIVER_ANGLE = (26, 75)
    PREFERENCES_VIDEO_DRIVER_DEFAULT = (26, 76)
    PREFERENCES_VIDEO_DRIVER_OPENGL_MAC = (26, 77)
    PREFERENCES_VIDEO_DRIVER_OPENGL_OTHER = (26, 78)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_MAC = (26, 79)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_OTHER = (26, 80)
    PREFERENCES_WEEKLY_BACKUPS = (26, 81)
    PREFERENCES_WHEN_ADDING_DEFAULT_TO_CURRENT_DECK = (26, 82)
    PREFERENCES_YOU_CAN_RESTORE_BACKUPS_VIA_FILESWITCH = (26, 83)
    ...
    STATISTICS_CARDS = (32, 25)
    STATISTICS_CARDS_DUE = (32, 26)
    STATISTICS_CARDS_PER_DAY = (32, 27)
    STATISTICS_CARDS_PER_MIN = (32, 28)
    STATISTICS_COUNTS_BURIED_CARDS = (32, 29)
    STATISTICS_COUNTS_FILTERED_CARDS = (32, 30)
    STATISTICS_COUNTS_LEARNING_CARDS = (32, 31)
    STATISTICS_COUNTS_MATURE_CARDS = (32, 32)
    STATISTICS_COUNTS_NEW_CARDS = (32, 33)
    STATISTICS_COUNTS_RELEARNING_CARDS = (32, 34)
    STATISTICS_COUNTS_SEPARATE_SUSPENDED_BURIED_CARDS = (32, 35)
    STATISTICS_COUNTS_SUSPENDED_CARDS = (32, 36)
    STATISTICS_COUNTS_TITLE = (32, 37)
    STATISTICS_COUNTS_TOTAL_CARDS = (32, 38)
    STATISTICS_COUNTS_YOUNG_CARDS = (32, 39)
    STATISTICS_DAYS_AGO_RANGE = (32, 40)
    STATISTICS_DAYS_AGO_SINGLE = (32, 41)
    STATISTICS_DAYS_STUDIED = (32, 42)
    STATISTICS_DUE_COUNT = (32, 43)
    STATISTICS_DUE_DATE = (32, 44)
    STATISTICS_DUE_FOR_NEW_CARD = (32, 45)
    STATISTICS_DUE_TOMORROW = (32, 46)
    STATISTICS_ELAPSED_TIME_DAYS = (32, 47)
    STATISTICS_ELAPSED_TIME_HOURS = (32, 48)
    STATISTICS_ELAPSED_TIME_MINUTES = (32, 49)
    STATISTICS_ELAPSED_TIME_MONTHS = (32, 50)
    STATISTICS_ELAPSED_TIME_SECONDS = (32, 51)
    STATISTICS_ELAPSED_TIME_YEARS = (32, 52)
    STATISTICS_FUTURE_DUE_SUBTITLE = (32, 53)
    STATISTICS_FUTURE_DUE_TITLE = (32, 54)
    STATISTICS_HOURS_CORRECT = (32, 55)
    STATISTICS_HOURS_CORRECT_REVIEWS = (32, 56)
    STATISTICS_HOURS_RANGE = (32, 57)
    STATISTICS_HOURS_REVIEWS = (32, 58)
    STATISTICS_HOURS_SUBTITLE = (32, 59)
    STATISTICS_HOURS_TITLE = (32, 60)
    STATISTICS_IN_DAYS_RANGE = (32, 61)
    STATISTICS_IN_DAYS_SINGLE = (32, 62)
    STATISTICS_IN_TIME_SPAN_DAYS = (32, 63)
    STATISTICS_IN_TIME_SPAN_HOURS = (32, 64)
    STATISTICS_IN_TIME_SPAN_MINUTES = (32, 65)
    STATISTICS_IN_TIME_SPAN_MONTHS = (32, 66)
    STATISTICS_IN_TIME_SPAN_SECONDS = (32, 67)
    STATISTICS_IN_TIME_SPAN_YEARS = (32, 68)
    STATISTICS_INTERVALS_DAY_RANGE = (32, 69)
    STATISTICS_INTERVALS_DAY_SINGLE = (32, 70)
    STATISTICS_INTERVALS_SUBTITLE = (32, 71)
    STATISTICS_INTERVALS_TITLE = (32, 72)
    STATISTICS_MINUTES_PER_DAY = (32, 73)
    STATISTICS_NO_DATA = (32, 74)
    STATISTICS_RANGE_1_YEAR_HISTORY = (32, 75)
    STATISTICS_RANGE_ALL_HISTORY = (32, 76)
    STATISTICS_RANGE_ALL_TIME = (32, 77)
    STATISTICS_RANGE_COLLECTION = (32, 78)
    STATISTICS_RANGE_DECK = (32, 79)
    STATISTICS_RANGE_SEARCH = (32, 80)
    STATISTICS_RETRIEVABILITY_SUBTITLE = (32, 81)
    STATISTICS_RETRIEVABILITY_TOOLTIP = (32, 82)
    STATISTICS_REVIEWS = (32, 83)
    STATISTICS_REVIEWS_COUNT_SUBTITLE = (32, 84)
    STATISTICS_REVIEWS_PER_DAY = (32, 85)
    STATISTICS_REVIEWS_TIME_CHECKBOX = (32, 86)
    STATISTICS_REVIEWS_TIME_SUBTITLE = (32, 87)
    STATISTICS_REVIEWS_TITLE = (32, 88)
    STATISTICS_RUNNING_TOTAL = (32, 89)
    STATISTICS_SAVE_PDF = (32, 90)
    STATISTICS_SAVED = (32, 91)
    STATISTICS_STATS = (32, 92)
    STATISTICS_STUDIED_TODAY = (32, 93)
    STATISTICS_TITLE = (32, 94)
    STATISTICS_TODAY_AGAIN_COUNT = (32, 95)
    STATISTICS_TODAY_CORRECT_MATURE = (32, 96)
    STATISTICS_TODAY_NO_CARDS = (32, 97)
    STATISTICS_TODAY_NO_MATURE_CARDS = (32, 98)
    STATISTICS_TODAY_TITLE = (32, 99)
    STATISTICS_TODAY_TYPE_COUNTS = (32, 100)
    STATISTICS_TOTAL = (32, 101)
    STUDYING_AGAIN = (33, 0)
