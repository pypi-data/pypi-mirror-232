...
class RustBackendGenerated:
 ...
 if the backup encountered an error."""
    ...
    def compute_optimal_retention(self, *, weights: Iterable[float], deck_size: int, days_to_simulate: int, max_seconds_of_study_per_day: int, max_interval: int, search: str) -> float:
        message = anki.scheduler_pb2.ComputeOptimalRetentionRequest(weights=weights, deck_size=deck_size, days_to_simulate=days_to_simulate, max_seconds_of_study_per_day=max_seconds_of_study_per_day, max_interval=max_interval, search=search)
