...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 100, {"cards": cards, "expected": expected})
    ...
    def deck_config_set_optimal_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 103, {"num": num})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 131, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 132, {"decks": decks})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 93)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 94)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 95)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 96)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 97)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 98)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 99)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 100)
    DECK_CONFIG_SAVE_BUTTON = (11, 101)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 102)
    DECK_CONFIG_SET_OPTIMAL_RETENTION = (11, 103)
    DECK_CONFIG_SHARED_PRESET = (11, 104)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 105)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 106)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 107)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 108)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 109)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 110)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 111)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 112)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 113)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 114)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 115)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 116)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 117)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 118)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 119)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 120)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 121)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 122)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 123)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 124)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 125)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 126)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 127)
    DECK_CONFIG_TIMER_TITLE = (11, 128)
    DECK_CONFIG_TITLE = (11, 129)
    DECK_CONFIG_TODAY_ONLY = (11, 130)
    DECK_CONFIG_UPDATING_CARDS = (11, 131)
    DECK_CONFIG_USED_BY_DECKS = (11, 132)
    DECK_CONFIG_WEIGHTS = (11, 133)
    DECK_CONFIG_WHICH_DECK = (11, 134)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 135)
