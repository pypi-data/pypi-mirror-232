...
class LabeledDrug(Component_Model):
    ...
    def __init__(self, name: str, data: dict):
        ...
        self.assignedEntity = Element.Component(AssignedEntity, "assignedEtnity", data, required=True, as_list=False)
        self.contextControlCode = Element.Attribute("contextControlCode", data, fixed="OP")
        self.typeCode = Element.Attribute("typeCode", data, fixed="LA")
    ...
    def to_dict(cls):
        ...
        return {
            ...
            "assignedEtnity": AssignedEntity.to_dict(),
    ...
    def to_dict_req(cls):
        ...
        return {
            ...
            "assignedEtnity": AssignedEntity.to_dict_req(),
            "contextControlCode": "OP",
            "typeCode": "LA"
        }
