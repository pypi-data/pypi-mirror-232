from .AssociatedEntity import AssociatedEntity
...
class Participant1(Component_Model):
    """Participant1"""
    ...
    def __init__(self, name: str, data: dict):
        ...
        self.associatedEntity = Element.Component(AssociatedEntity, "associatedEntity", data, required=True, as_list=False)
    ...
    def to_dict(cls):
        ...
        return {
            ...
            "associatedEntity": AssociatedEntity.to_dict(),
    ...
    def to_dict_req(cls):
        """to_dict"""
        return {
            "associatedEntity": AssociatedEntity.to_dict_req(),
            "contextControlCode": "OP",
            "typeCode": ""
        }
