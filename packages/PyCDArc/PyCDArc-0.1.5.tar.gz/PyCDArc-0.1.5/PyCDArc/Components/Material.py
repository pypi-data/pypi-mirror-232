...
class Material(Component_Model):
    ...
    def __init__(self, name: str, data: dict):
        ...
        self.code = Element.Component(CE_CodedWithEquivalents, "id", data, as_list=False)
        self._name = Element.Component(EN_GenericName, "name", data, as_list=False)
        self.lotNumberText = Element.Component(ST_String, "lotNumberText", data, as_list=False)
    ...
    def to_dict(cls):
        ...
        return {
            ...
            "id": CE_CodedWithEquivalents.to_dict(),
            "name": EN_GenericName.to_dict(),
            "lotNumberText": ST_String.to_dict(),
            "classCode": "MMAT",
            "determinerCode": "KIND"
        }
