...
from .Component4 import Component4
...
class Organizer(Component_Model):
    """Organizer"""
    ...
    def __init__(self, name: str, data: dict):
        ...
        self.statusCode = Element.Component(CS_CodedSimpleValue, "statusCode", data, required=True, as_list=False)
        ...
        self.component = Element.Component(Component4, "component", data)
