...
class Recognizer():
    ...
    class RecognizerWebSocket(WebSocketClient):
        ...
        def __init__(self, url, headers, recognizer, time_offset=0, segment_offset=0):
    ...
    def __init__(self, speech_config: SpeechConfig, audio_config: Optional[audio.AudioConfig] = None, monitor_session: bool = False, itn: bool = True, punctuation: bool = True):
        ...
        self.ws = self.RecognizerWebSocket(self.__ws_uri, [("sample_rate",self.sample_rate), ("itn",self.itn), ("punctuation",self.punctuation), ("connection-id",self.connection_id)], self, self.seconds_received, self.segment_offset+1)
    ...
    def change_lang(self, lang):
        ...
        ws = self.RecognizerWebSocket(ws_uri, [("sample_rate",self.sample_rate), ("itn",self.itn), ("punctuation",self.punctuation), ("connection-id",self.connection_id)], self, self.seconds_received, self.segment_offset+1)
        ws.connect()
