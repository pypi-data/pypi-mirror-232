...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List["DetailedScenarioList"]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List["DetailedScenarioList"]]:
    return Response(
