...
@action('heaserver-keychain-credentials-get-properties', rel='hea-properties', itemif='type=="heaobject.keychain.Credentials"')
@action('heaserver-keychain-awscredentials-get-properties', rel='hea-properties', itemif='type=="heaobject.keychain.AWSCredentials"')
