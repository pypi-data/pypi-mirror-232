...
class signlanguage:
        ...
        try:
            ...
            for idx, signs_ in enumerate(self.__sign_models):
                if isinstance(signs_, sm.SignTrace) and not isinstance(data, list):
                    ...
                    return self.model_object_result(value_result=results, idx=data[1])
        except Exception as e:
    ...
    def Evaluate(self, data=None):
        ...
        if isinstance(data, list):
            ...
            for idx, rst_exec_ in enumerate(rst_sended):
                print(f"{idx}---------")
                results_data.append(self.Predict(data=rst_exec_))
        else:
