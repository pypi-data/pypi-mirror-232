import { SvelteComponentDev, init, safe_not_equal, dispatch_dev, validate_slots, element, attr_dev, toggle_class, add_location, insert_dev, noop, detach_dev } from '../../../node/dev/svelte-internal.js';

const Html_svelte_svelte_type_style_lang = '';

/* home/runner/work/gradio/gradio/js/html/example/Html.svelte generated by Svelte v4.0.0 */

const file = "home/runner/work/gradio/gradio/js/html/example/Html.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			attr_dev(div, "class", "prose s--U_s7iMJg-uy");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.on_mount.push(function () {
		...
		if (type === undefined && !('type' in $$props || $$self.$$.bound[$$self.$$.props['type']])) {
			console.warn("<Html> was created without expected prop 'type'");
		}
	});
...
export { Html$1 as default };
//# sourceMappingURL=index-0c05fa43.js.map
