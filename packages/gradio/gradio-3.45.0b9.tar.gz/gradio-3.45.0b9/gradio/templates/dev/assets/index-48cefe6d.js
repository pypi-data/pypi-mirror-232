...
/* home/runner/work/gradio/gradio/js/dropdown/example/Dropdown.svelte generated by Svelte v4.0.0 */

const file = "home/runner/work/gradio/gradio/js/dropdown/example/Dropdown.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(/*value*/ ctx[0]);
			attr_dev(div, "class", "s-P-jpCFTWyzUi");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.on_mount.push(function () {
		...
		if (type === undefined && !('type' in $$props || $$self.$$.bound[$$self.$$.props['type']])) {
			console.warn("<Dropdown> was created without expected prop 'type'");
		}
	});
...
//# sourceMappingURL=index-48cefe6d.js.map
