import { SvelteComponentDev, init, safe_not_equal, dispatch_dev, validate_slots, element, text, attr_dev, toggle_class, add_location, insert_dev, append_dev, set_data_dev, noop, detach_dev } from '../../../node/dev/svelte-internal.js';

const Checkbox_svelte_svelte_type_style_lang = '';

/* home/runner/work/gradio/gradio/js/checkbox/example/Checkbox.svelte generated by Svelte v4.0.0 */

const file = "home/runner/work/gradio/gradio/js/checkbox/example/Checkbox.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(t_value);
			attr_dev(div, "class", "s-kagqm3glXen7");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.on_mount.push(function () {
		...
		if (type === undefined && !('type' in $$props || $$self.$$.bound[$$self.$$.props['type']])) {
			console.warn("<Checkbox> was created without expected prop 'type'");
		}
	});
...
//# sourceMappingURL=index-dfb73fce.js.map
