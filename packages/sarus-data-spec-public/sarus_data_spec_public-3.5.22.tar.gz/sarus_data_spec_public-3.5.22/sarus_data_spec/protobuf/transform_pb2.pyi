...
class Transform(google.protobuf.message.Message):
    ...
    class External(google.protobuf.message.Message):
        ...
        class OpIdentifier(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal["imblearn",b"imblearn","numpy",b"numpy","op",b"op","pandas",b"pandas","pandas_profiling",b"pandas_profiling","shap",b"shap","sklearn",b"sklearn","skopt",b"skopt","std",b"std","tensorflow",b"tensorflow","xgboost",b"xgboost"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["imblearn",b"imblearn","numpy",b"numpy","op",b"op","pandas",b"pandas","pandas_profiling",b"pandas_profiling","shap",b"shap","sklearn",b"sklearn","skopt",b"skopt","std",b"std","tensorflow",b"tensorflow","xgboost",b"xgboost"]) -> None: ...
            def WhichOneof(self, oneof_group: typing_extensions.Literal["op",b"op"]) -> typing.Optional[typing_extensions.Literal["std","pandas","numpy","tensorflow","sklearn","pandas_profiling","xgboost","skopt","imblearn","shap"]]: ...
