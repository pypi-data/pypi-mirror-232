...
class LiquidityAnalysis(Analysis):
  ...
  def calculate_trade_info(self, report):
    ...
    adj_trade_price = report.market_info.get_trading_price(report.trade_at)
    adj_previous_close = report.market_info.get_trading_price('close').shift()

    # calculate money flow
    trade_price = report.market_info.get_price('close', adj=False)
