...
class OpenAIFunction(BaseModel, ABC):
	...
	def wrap(app:APIServer) -> APIServer:
		schemas = [i.schema() for i in OpenAIFunction.Metadata.subclasses]  
		app.openapi["components"]["schemas"] = {**app.openapi["components"]["schemas"], **{i["title"]:i for i in schemas}}
		return app
