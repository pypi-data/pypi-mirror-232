...
from pydantic import BaseConfig, BaseModel  # pylint: disable=no-name-in-module
...
class OpenAIFunction(BaseModel, ABC):
	...
	@classmethod
	def from_function(cls:Type["OpenAIFunction"], func: Callable[P, Coroutine[Any, Any, Any]]) -> Type["OpenAIFunction"]:
		"""
