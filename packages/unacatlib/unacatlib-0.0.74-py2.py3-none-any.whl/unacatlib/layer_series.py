...
from unacatlib.unacast.maps.v1 import Layer as v1_Layer, MapLayerSeries as v1_LayerSeries
from unacatlib.unacast.operator.v1 import PrepareLayerSeriesRevisionRequest, PrepareLayerSeriesRevisionResponse, PublishLayerSeriesRevisionRequest, PublishLayerSeriesRevisionResponse
...
class LayerSeries(object):
    ...
    def prepare_revision(self, layer_version: str) -> Tuple[str, Layer]:
    ...
    def publish_version(self, revision_id: str):
      sync(
        self._map_operator_service.publish_layer_series_revision(PublishLayerSeriesRevisionRequest(
          layer_series_id=self._layer_series.id,
          layer_series_revision=revision_id,
        ))
      )
