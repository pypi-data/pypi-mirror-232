...
class GetTopoJsonRequest(betterproto.Message):
    ...
    """
    If set: Overrides the BoundingBox-parameter ´polygon_bound´ with values
    passed as JSON-serialized array of floats. The string format expected is
    "[west, south, east, north]" - each value representing the lat/lon of the
    box-edge
    """
