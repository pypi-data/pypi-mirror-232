...
class PoseMeasure:
    ...
    def getDistanceNum(self, a, b, dimension):
        a = self.pose[a]
        b = self.pose[b]
        aX = abs(a.x - b.x)
        aY = abs(a.y - b.y)
    ...
    def getAngleNum(self, targetPoint, insidePoint, lastPoint, dimension):
        targetPoint = self.pose[targetPoint]
        insidePoint = self.pose[insidePoint]
        lastPoint = self.pose[lastPoint]
        a = self.getDistance(insidePoint, lastPoint, dimension)
        b = self.getDistance(targetPoint, insidePoint, dimension)
        c = self.getDistance(targetPoint, lastPoint, dimension)
        return self.calAngle(a, b, c)
