from flask import request, Flask, redirect, session, render_template, current_app, Blueprint
...
class FlaskIntegration:
    ...
    Args:
        - app: Your Flask app, or your Blueprint
