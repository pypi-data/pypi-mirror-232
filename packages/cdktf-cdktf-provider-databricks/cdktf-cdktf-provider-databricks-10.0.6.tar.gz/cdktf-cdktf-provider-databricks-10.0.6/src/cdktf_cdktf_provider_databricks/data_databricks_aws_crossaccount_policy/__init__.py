...
class DataDatabricksAwsCrossaccountPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param pass_roles: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.27.0/docs/data-sources/aws_crossaccount_policy#pass_roles DataDatabricksAwsCrossaccountPolicy#pass_roles}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
