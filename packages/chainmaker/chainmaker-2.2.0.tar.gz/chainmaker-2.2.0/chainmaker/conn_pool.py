...
DEFAULT_RPC_CLIENT_CONFIG = RPCClientConfig(Defaults.GRPC_MAX_SEND_MESSAGE_LENGTH, Defaults.GRPC_MAX_RECEIVE_MESSAGE_LENGTH)
...
class ConnectionPool:
    ...
    def get_channel(self, node: Node) -> grpc.Channel:
        ...
        :return: Node桩
        """
        max_send_message_size = self.rpc_client_config.max_send_message_size or Defaults.GRPC_MAX_SEND_MESSAGE_LENGTH
        max_receive_message_size = self.rpc_client_config.max_receive_message_size or Defaults.GRPC_MAX_RECEIVE_MESSAGE_LENGTH
        opts = [
