...
def get_logger(name, level, format, datefmt='%Y-%m-%d %H:%M:%S', log_file=None):
...
logger = get_logger('sdk', logging.DEBUG, format='%(asctime)s %(levelname)s %(message)s', log_file=None)
