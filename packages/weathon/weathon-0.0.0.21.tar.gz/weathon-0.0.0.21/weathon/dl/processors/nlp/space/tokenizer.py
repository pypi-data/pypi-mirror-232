    ...
    def convert_tokens_to_ids(self, tokens):
        ...
        if len(ids) > self.max_len:
            logger.warning(
                ...
                ' sequence through BERT will result in indexing error'.format(
...
class GPT2Tokenizer(object):
    ...
    def __init__(self,
        ...
        self.errors = errors  # how to handle error in decoding
    ...
    def convert_tokens_to_ids(self, tokens):
        ...
        if len(ids) > self.max_len:
            logger.warning(
                ...
                ' sequence through the model will result in indexing error'.
