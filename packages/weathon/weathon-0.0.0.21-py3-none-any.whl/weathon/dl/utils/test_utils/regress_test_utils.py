...
class RegressTool:
    ...
    def monitor_module_train(self,
        ...
        assert hasattr(
            trainer, 'model') or 'model' in trainer, 'model must be in trainers'
        ...
        assert hasattr(
            trainer, 'optimizer'
        ) or 'optimizer' in trainer, 'optimizer must be in trainers'
        assert hasattr(
            trainer, 'lr_scheduler'
        ) or 'lr_scheduler' in trainer, 'lr_scheduler must be in trainers'
