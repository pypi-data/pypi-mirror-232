...
class Event:
    ...
    def amend(self, request: operations.AmendEventRequest) -> operations.AmendEventResponse:
        r"""Amend event
    ...
    def close_backfill(self, request: operations.CloseBackfillRequest) -> operations.CloseBackfillResponse:
        r"""Close backfill
    ...
    def ingest(self, request: operations.IngestRequest) -> operations.IngestResponse:
        r"""Ingest events
    ...
    def list_backfills(self, request: operations.ListBackfillsRequest) -> operations.ListBackfillsResponse:
        r"""List backfills
    ...
    def revert_backfill(self, request: operations.RevertBackfillRequest) -> operations.RevertBackfillResponse:
        r"""Revert backfill
    ...
    def search(self, request: operations.SearchEventsRequest) -> operations.SearchEventsResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "event_search_criteria", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
