...
class CustomerBalanceTransaction:
    ...
    credit_note: Optional[CustomerBalanceTransactionCreditNoteMinified] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credit_note'), 'exclude': lambda f: f is None }})
