...
class Subscription:
    ...
    def cancel(self, request: operations.CancelSubscriptionRequest) -> operations.CancelSubscriptionResponse:
    ...
    def fetch(self, request: operations.FetchSubscriptionRequest) -> operations.FetchSubscriptionResponse:
    ...
    def schedule_plan_change(self, request: operations.SchedulePlanChangeRequest) -> operations.SchedulePlanChangeResponse:
    ...
    def unschedule_cancellation(self, request: operations.UnscheduleCancellationRequest) -> operations.UnscheduleCancellationResponse:
    ...
    def unschedule_plan_change(self, request: operations.UnschedulePlanChangeRequest) -> operations.UnschedulePlanChangeResponse:
    ...
    def update_fixed_fee_quantity(self, request: operations.UpdateFixedFeeQuantityRequest) -> operations.UpdateFixedFeeQuantityResponse:
