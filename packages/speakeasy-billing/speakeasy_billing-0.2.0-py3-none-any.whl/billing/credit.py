...
class Credit:
    ...
    def add_by_external_id(self, request: operations.AddLedgerEntryExternalIDRequest) -> operations.AddLedgerEntryExternalIDResponse:
    ...
    def create(self, request: operations.CreateLedgerEntryRequest) -> operations.CreateLedgerEntryResponse:
    ...
    def fetch(self, request: operations.FetchCustomerCreditsRequest) -> operations.FetchCustomerCreditsResponse:
    ...
    def fetch_by_external_id(self, request: operations.FetchCustomerCreditsExternalIDRequest) -> operations.FetchCustomerCreditsExternalIDResponse:
    ...
    def fetch_ledger_external_id(self, request: operations.FetchCustomerCreditsLedgerExternalIDRequest) -> operations.FetchCustomerCreditsLedgerExternalIDResponse:
        r"""Fetch credits ledger by external ID
