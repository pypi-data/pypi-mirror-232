...
@dataclasses.dataclass
class PhaseOverride:
    discount: Optional[PhaseOverrideDiscount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('discount'), 'exclude': lambda f: f is None }})
