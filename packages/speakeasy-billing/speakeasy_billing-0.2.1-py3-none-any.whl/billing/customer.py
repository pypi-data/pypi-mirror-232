...
class Customer:
    ...
    def amend(self, request: operations.AmendUsageRequest) -> operations.AmendUsageResponse:
        r"""Amend usage
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, errors.RequestValidationError)
    ...
    def amend_by_external_id(self, request: operations.AmendUsageExternalCustomerIDRequest) -> operations.AmendUsageExternalCustomerIDResponse:
    ...
    def create_balance_transaction(self, request: operations.CreateCustomerBalanceTransactionRequest) -> operations.CreateCustomerBalanceTransactionResponse:
    ...
    def delete(self, request: operations.DeleteCustomerRequest) -> operations.DeleteCustomerResponse:
        r"""Delete customer
        ...
        **Note**: This operation happens asynchronously and can be expected to take a few minutes to propagate to related resources. However, querying for the customer on subsequent GET requests while deletion is in process will reflect its deletion with a `deleted: true` property. Once the customer deletion has been fully processed, the customer will not be returned in the API.
        ...
        if http_res.status_code == 204:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeleteCustomer204ApplicationJSON])
                res.delete_customer_204_application_json_object = out
            else:
                raise errors.SDKError(f'unknown content-type received: {content_type}', http_res.status_code, http_res.text, http_res)
        elif http_res.status_code >= 400 and http_res.status_code < 500 or http_res.status_code >= 500 and http_res.status_code < 600:
            raise errors.SDKError('API error occurred', http_res.status_code, http_res.text, http_res)
    ...
    def fetch(self, request: operations.FetchCustomerRequest) -> operations.FetchCustomerResponse:
        r"""Fetch customer
    ...
    def fetch_by_external_id(self, request: operations.FetchCustomerExternalIDRequest) -> operations.FetchCustomerExternalIDResponse:
    ...
    def fetch_transactions(self, request: operations.ListBalanceTransactionsRequest) -> operations.ListBalanceTransactionsResponse:
    ...
    def update_by_external_id(self, request: operations.UpdateCustomerExternalIDRequest) -> operations.UpdateCustomerExternalIDResponse:
    ...
    def update_customer(self, request: operations.UpdateCustomerRequest) -> operations.UpdateCustomerResponse:
        r"""Update customer
        This endpoint can be used to update the `payment_provider`, `payment_provider_id`, `name`, `email`, `email_delivery`, `tax_id`, `auto_collection`, `metadata`, `shipping_address`, and `billing_address` of an existing customer.
