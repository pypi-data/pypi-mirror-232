...
class Coupon:
    ...
    def archive(self, request: operations.ArchiveCouponRequest) -> operations.ArchiveCouponResponse:
        r"""Archive coupon
    ...
    def fetch(self, request: operations.FetchCouponRequest) -> operations.FetchCouponResponse:
        r"""Fetch coupon
    ...
    def list(self, request: operations.ListCouponsRequest) -> operations.ListCouponsResponse:
        r"""List coupons
    ...
    def list_subscriptions(self, request: operations.ListCouponSubscriptionsRequest) -> operations.ListCouponSubscriptionsResponse:
