...
class KaruoFlow:
    ...
    def _QueryApplySets(self, user_id: str, catalog:str = None, subflow:str=None, closed_label: str=None, result=None, page=1, size=30, supervisor_users: List=[], abstract: str = ""):
        """
    ...
    def QueryApplyListInDoing(self, user_id, catalog: str=None, subflow: str=None, page=0, size=0, supervisor_users: List = [], abstract: str = ""):
        """
        查询用户发起的正在进行中的审批记录
        """
        return self._QueryApplySets(user_id, catalog, subflow, '0', None, page, size, supervisor_users, abstract)

    def QueryApplyListClosed(self, user_id, catalog: str=None, subflow: str=None, page=0, size=0, supervisor_users: List = [], abstract: str = ""):
        """
        查询用户发起的已经结束的审批记录
        """
        return self._QueryApplySets(user_id, catalog, subflow, '1', None, page, size, supervisor_users, abstract)

    def QueryApplyListSuccessed(self, user_id, catalog: str=None, subflow: str=None, page=0, size=0, supervisor_users: List = [], abstract: str = ""):
        """
        查询用户发起的已经流转完成，并审核批准的申请记录
        :param user_id 申请人编号
        :param catalog 申请类别
        """
        return self._QueryApplySets(user_id, catalog, subflow, '1', '1', page, size, supervisor_users, abstract)

    def QueryApplyListRefused(self, user_id, catalog: str=None, subflow: str=None, page=0, size=0, supervisor_users: List = [], abstract: str = ""):
        """
        查询用户发起的已经流转完成，并审核拒绝的申请记录
        :param user_id 申请人编号
        :param catalog 申请类别
        """
        return self._QueryApplySets(user_id, catalog, subflow, '1', '0', page, size, supervisor_users, abstract)
