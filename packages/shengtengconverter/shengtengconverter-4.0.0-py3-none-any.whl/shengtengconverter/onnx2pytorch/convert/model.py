...
from shengtengconverter.onnx2pytorch.constants import (
    COMPOSITE_LAYERS,
    MULTIOUTPUT_LAYERS,
    STANDARD_LAYERS,
)
from shengtengconverter.onnx2pytorch.convert.debug import debug_model_conversion
from shengtengconverter.onnx2pytorch.convert.operations import (
    convert_operations,
    get_buffer_name,
    get_init_parameter,
    Loop,
