...
from shengtengconverter.onnx2pytorch.operations.base import Operator
from shengtengconverter.onnx2pytorch.utils import assign_values_to_dim, get_selection
