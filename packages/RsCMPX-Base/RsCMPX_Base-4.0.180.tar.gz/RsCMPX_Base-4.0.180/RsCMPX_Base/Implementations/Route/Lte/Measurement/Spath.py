...
class SpathCls:
	...
	def get_count(self) -> int:
		...
		Snippet: value: int = driver.route.lte.measurement.spath.get_count() \n
	...
	def get_value(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.route.lte.measurement.spath.get_value() \n
		No command help available \n
	...
	def set_value(self, signal_path: List[str]) -> None:
		"""SCPI: ROUTe:LTE:MEASurement<Instance>:SPATh \n
		Snippet: driver.route.lte.measurement.spath.set_value(signal_path = ['1', '2', '3']) \n
		No command help available \n
