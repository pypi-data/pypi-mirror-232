...
from pyprocessors_openai_completion.openai_completion import (
    ...
    DeepInfraOpenAICompletionProcessor, OpenAICompletionParametersBase,
)
...
def test_openai_completion_basic():
    ...
    model_class = model.construct().__class__
    assert model_class == OpenAICompletionParametersBase
...
def test_azure_endpoint():
    parameters = OpenAICompletionParametersBase(
        max_tokens=1000,
        best_of=3,
        n=3,
        completion_altText="completion",
