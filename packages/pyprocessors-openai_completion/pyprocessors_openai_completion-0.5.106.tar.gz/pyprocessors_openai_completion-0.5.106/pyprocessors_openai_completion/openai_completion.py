...
class OpenAICompletionParametersBase(ProcessorParameters):
    model_str: str = Field(
        None, extra="internal"
    )
...
class OpenAICompletionParameters(OpenAICompletionParametersBase):
...
class OpenAICompletionProcessorBase(ProcessorBase):
    ...
    def compute_args(self, params: OpenAICompletionParametersBase, prompt: str
                     ) -> Dict[str, Any]:
        kwargs = {
    ...
    def process(
        ...
        params: OpenAICompletionParametersBase = cast(
            OpenAICompletionParametersBase, parameters
        )
    ...
    def get_model(cls) -> Type[BaseModel]:
        return OpenAICompletionParametersBase
