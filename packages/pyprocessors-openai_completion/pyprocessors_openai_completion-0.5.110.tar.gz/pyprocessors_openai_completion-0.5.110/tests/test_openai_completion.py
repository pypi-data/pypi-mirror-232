...
from pyprocessors_openai_completion.openai_completion import (
    ...
    DeepInfraOpenAICompletionProcessor, OpenAICompletionBaseParameters,
)
...
def test_openai_completion_basic():
    ...
    model_class = model.construct().__class__
    assert model_class == OpenAICompletionBaseParameters
...
def test_azure_endpoint():
    parameters = OpenAICompletionBaseParameters(
        max_tokens=1000,
        best_of=3,
        n=3,
        completion_altText="completion",
