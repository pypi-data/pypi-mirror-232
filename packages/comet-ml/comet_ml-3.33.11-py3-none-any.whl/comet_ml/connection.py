...
def get_retry_strategy(
    ...
    if status_forcelist is None:
        status_forcelist = STATUS_FORCELIST_FULL
...
class LowLevelHTTPClient(object):
    ...
    def __init__(
        ...
        self.retry_session = get_http_session(
            retry_strategy=get_retry_strategy(), verify_tls=self.verify_tls
        )
...
class RestServerConnection(object):
    ...
    def get_run_id(self, project_name, workspace, offline=False):
        ...
        session = get_http_session(
            retry_strategy=get_retry_strategy(STATUS_FORCELIST_NO_AUTH_ERRORS),
