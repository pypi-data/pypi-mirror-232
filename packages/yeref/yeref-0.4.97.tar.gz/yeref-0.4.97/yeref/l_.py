...
l_emoji_text = {
    'ru': "{0} <b>Текущая</b> эмоджи-реакция на #<u>{1}</u>-пост: {2}",
...
l_timer_text = {
    'ru': "{0} <b>Таймер</b> авто-удаления (в днях) для #<u>{1}</u>-поста: {2}",
...
l_theme_text = {
    'ru': "{0} <b>Текущая</b> тема приватного диалога для #<u>{1}</u>-поста: {2}\n\n👩🏽‍💻 <b>Прикрепи</b> фоновое фото диалога\n👩🏽‍💻 <b>Текущее</b> фоновое фото: {3}",
