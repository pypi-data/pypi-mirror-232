...
def uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_c2pa_checksum_func_sdk_version() != 32199:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_c2pa_checksum_func_verify_from_file_json() != 43954:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_c2pa_checksum_func_ingredient_from_file_json() != 50330:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_c2pa_checksum_func_add_manifest_to_file_json() != 57402:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniFFILib.uniffi_c2pa_fn_func_verify_from_file_json.argtypes = (
    RustBuffer,
    ctypes.POINTER(RustCallStatus),
)
_UniFFILib.uniffi_c2pa_fn_func_verify_from_file_json.restype = RustBuffer
_UniFFILib.uniffi_c2pa_fn_func_ingredient_from_file_json.argtypes = (
    RustBuffer,
    RustBuffer,
    ctypes.POINTER(RustCallStatus),
)
_UniFFILib.uniffi_c2pa_fn_func_ingredient_from_file_json.restype = RustBuffer
_UniFFILib.uniffi_c2pa_fn_func_add_manifest_to_file_json.argtypes = (
    RustBuffer,
    RustBuffer,
    RustBuffer,
    RustBuffer,
...
_UniFFILib.uniffi_c2pa_fn_func_add_manifest_to_file_json.restype = RustBuffer
...
_UniFFILib.uniffi_c2pa_checksum_func_verify_from_file_json.argtypes = (
)
_UniFFILib.uniffi_c2pa_checksum_func_verify_from_file_json.restype = ctypes.c_uint16
_UniFFILib.uniffi_c2pa_checksum_func_ingredient_from_file_json.argtypes = (
)
_UniFFILib.uniffi_c2pa_checksum_func_ingredient_from_file_json.restype = ctypes.c_uint16
_UniFFILib.uniffi_c2pa_checksum_func_add_manifest_to_file_json.argtypes = (
)
_UniFFILib.uniffi_c2pa_checksum_func_add_manifest_to_file_json.restype = ctypes.c_uint16
...
class SignerInfo:
    ...
    def __init__(self, signcert, pkey, alg, tsa_url):
    ...
    def __str__(self):
        return "SignerInfo(signcert={}, pkey={}, alg={}, tsa_url={})".format(self.signcert, self.pkey, self.alg, self.tsa_url)

    def __eq__(self, other):
        if self.signcert != other.signcert:
            return False
        if self.pkey != other.pkey:
            return False
        if self.alg != other.alg:
            return False
        if self.tsa_url != other.tsa_url:
            return False
        return True
...
class FfiConverterTypeSignerInfo(FfiConverterRustBuffer):
    ...
    def read(buf):
        return SignerInfo(
            signcert=FfiConverterSequenceUInt8.read(buf),
            pkey=FfiConverterSequenceUInt8.read(buf),
            alg=FfiConverterString.read(buf),
            tsa_url=FfiConverterOptionalString.read(buf),
        )

    @staticmethod
    def write(value, buf):
        FfiConverterSequenceUInt8.write(value.signcert, buf)
        FfiConverterSequenceUInt8.write(value.pkey, buf)
        FfiConverterString.write(value.alg, buf)
        FfiConverterOptionalString.write(value.tsa_url, buf)
...
class Error:  # type: ignore
    ...
    class Sdk(UniFFITempError):
        def __repr__(self):
            return "Error.Sdk({})".format(repr(str(self)))
    UniFFITempError.Sdk = Sdk  # type: ignore
...
def verify_from_file_json(path: "str"):
    
    return FfiConverterString.lift(rust_call_with_error(FfiConverterTypeError,_UniFFILib.uniffi_c2pa_fn_func_verify_from_file_json,
        FfiConverterString.lower(path)))


def ingredient_from_file_json(path: "str",data_dir: "str"):
    
    
    return FfiConverterString.lift(rust_call_with_error(FfiConverterTypeError,_UniFFILib.uniffi_c2pa_fn_func_ingredient_from_file_json,
        FfiConverterString.lower(path),
        FfiConverterString.lower(data_dir)))


def add_manifest_to_file_json(source: "str",dest: "str",manifest: "str",signer_info: "SignerInfo",side_car: "bool",remote_url: "typing.Optional[str]"):
    ...
    return FfiConverterSequenceUInt8.lift(rust_call_with_error(FfiConverterTypeError,_UniFFILib.uniffi_c2pa_fn_func_add_manifest_to_file_json,
        FfiConverterString.lower(source),
        FfiConverterString.lower(dest),
        FfiConverterString.lower(manifest),
        FfiConverterTypeSignerInfo.lower(signer_info),
        FfiConverterBool.lower(side_car),
        FfiConverterOptionalString.lower(remote_url)))
...
__all__ = [
    ...
    "version",
    "sdk_version",
    "verify_from_file_json",
    "ingredient_from_file_json",
    "add_manifest_to_file_json",
]
