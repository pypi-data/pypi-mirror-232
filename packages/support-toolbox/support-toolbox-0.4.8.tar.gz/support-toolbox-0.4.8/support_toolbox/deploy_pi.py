...
from support_toolbox.utils.entitlements import update_org_entitlements, get_entitlements, get_offering_id, update_default_plan, ORG_DEFAULT_ENTITLEMENTS, USER_DEFAULT_ENTITLEMENTS
...
def config_site(admin_token):
    ...
    org_values = get_offering_id(admin_token, "organization")
    ...
    user_values = get_offering_id(admin_token, "user")
