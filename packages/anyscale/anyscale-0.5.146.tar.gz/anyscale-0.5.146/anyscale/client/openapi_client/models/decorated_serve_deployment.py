...
class DecoratedServeDeployment(object):
    ...
    def __init__(self, id=None, status=None, name=None, application_name=None, cluster_id=None, job_id=None, creator_id=None, namespace_id='DEPRECATED_NAMESPACE_ID', created_at=None, finished_at=None, http_route=None, grafana_dashboard_url=None, class_name=None, grafana_dashboard_state=None, version=None, cluster=None, creator=None, namespace=None, num_actors=0, fast_api_docs_url=None, local_vars_configuration=None):  # noqa: E501
