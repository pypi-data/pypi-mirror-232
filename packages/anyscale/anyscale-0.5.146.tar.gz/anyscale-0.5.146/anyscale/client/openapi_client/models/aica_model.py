...
class AicaModel(object):
    ...
    @property
    def name(self):
        """Gets the name of this AicaModel.  # noqa: E501

        Name of the model to be created.  # noqa: E501

        :return: The name of this AicaModel.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AicaModel.

        Name of the model to be created.  # noqa: E501

        :param name: The name of this AicaModel.  # noqa: E501
        :type: str
        """
