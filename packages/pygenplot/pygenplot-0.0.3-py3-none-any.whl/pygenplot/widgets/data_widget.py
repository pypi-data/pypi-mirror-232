...
from pygenplot.models.data_tree_model import DataTreeModel
...
class DataWidget(QtWidgets.QWidget):
    ...
    def get_selected_dataset_info(self, add_data: bool = True) -> Dict[str, Any]:
    ...
    def on_open_contextual_menu(self, point: QtCore.QPoint):
        ...
        plot_on_new_tab_action = menu.addAction(ICONS["data"], "Plot in new figure")
        plot_on_new_tab_action.triggered.connect(self.on_plot_on_new_tab)
        if dataset_info["dimension"] == 1:
            plot_on_current_tab_action = menu.addAction(ICONS["data"], "Plot in current figure")
