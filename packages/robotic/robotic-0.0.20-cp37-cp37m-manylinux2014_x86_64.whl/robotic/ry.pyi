...
class Config():
    ...
    def addFile(self, filename: str, namePrefix: str = '') -> None: 
        """
...
class KOMO():
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, config: Config, phases: float, stepsPerPhase: int, k_order: int, enableCollisions: bool) -> None: ...
    ...
    def setTiming(self, phases: float, stepsPerPhase: int, durationPerPhase: float, k_order: int) -> None: ...
