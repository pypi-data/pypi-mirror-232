...
class TablePSF:
    ...
    def plot_psf_vs_rad(self, ax=None, energy=None, **kwargs):
        """Plot PSF vs radius.
        ...
        ax.set_yscale("log")
        ax.set_xlabel("Radius, [deg]", fontsize=label_fontsize)
        ax.set_ylabel("PSF, [sr-1]", fontsize=label_fontsize)
        ax.tick_params(axis="both", which="major", labelsize=tick_fontsize)

        ax.text(
            0.46,
            0.93,
            f"energy = {str(energy.value)} {energy.unit}",
