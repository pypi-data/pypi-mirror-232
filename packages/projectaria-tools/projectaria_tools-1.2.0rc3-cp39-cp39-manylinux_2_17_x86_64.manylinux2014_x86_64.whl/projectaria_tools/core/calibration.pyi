...
def device_calibration_from_json_string(arg0: str) -> DeviceCalibration | None:
    ...
    """
@typing.overload
def distort_by_calibration(arg0: numpy.ndarray[numpy.uint8], arg1: CameraCalibration, arg2: CameraCalibration) -> numpy.ndarray[numpy.uint8] | numpy.ndarray[numpy.float32] | numpy.ndarray[numpy.uint16] | numpy.ndarray[numpy.uint64] | numpy.ndarray[...]:
    """
    Distorts an input image to swap its underlying image distortion model.
    """
@typing.overload
def distort_by_calibration(arg0: numpy.ndarray[numpy.float32], arg1: CameraCalibration, arg2: CameraCalibration) -> numpy.ndarray[numpy.uint8] | numpy.ndarray[numpy.float32] | numpy.ndarray[numpy.uint16] | numpy.ndarray[numpy.uint64] | numpy.ndarray[...]:
    """
    Distorts an input image to swap its underlying image distortion model.
    """
@typing.overload
def distort_by_calibration(arg0: numpy.ndarray[numpy.uint64], arg1: CameraCalibration, arg2: CameraCalibration) -> numpy.ndarray[numpy.uint8] | numpy.ndarray[numpy.float32] | numpy.ndarray[numpy.uint16] | numpy.ndarray[numpy.uint64] | numpy.ndarray[...]:
    """
    Distorts an input image to swap its underlying image distortion model.
    """
def get_linear_camera_calibration(image_width: int, image_height: int, focal_length: float, label: str = ...) -> CameraCalibration:
    """
    Function to create a simple Linear camera calibration object from some parameters.
    """
def get_spherical_camera_calibration(image_width: int, image_height: int, focal_length: float, label: str = ...) -> CameraCalibration:
    """
