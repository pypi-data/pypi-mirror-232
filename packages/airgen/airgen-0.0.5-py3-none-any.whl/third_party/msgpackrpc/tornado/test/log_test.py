...
from msgpackrpc.tornado.log import LogFormatter, define_logging_options, enable_pretty_logging
from msgpackrpc.tornado.options import OptionParser
from msgpackrpc.tornado.test.util import unittest
from msgpackrpc.tornado.util import basestring_type
...
class LoggingOptionTest(unittest.TestCase):
    ...
    def logs_present(self, statement, args=None):
        ...
        # ran.
        IMPORT = 'from msgpackrpc.tornado.options import options, parse_command_line'
