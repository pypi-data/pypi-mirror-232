...
from qiskit_back.c12sim_backend import C12SimBackend
from qiskit_back.exceptions import C12SimApiError
...
class C12SimProvider(ProviderV1):
    ...
    def __init__(self, user_config: UserConfigs):
        ...
        self._request = Request(
            self._user_configs.get_auth_token(), self._user_configs.get_verbose()
        )
    ...
    def get_backend(self, name=None, **kwargs) -> Union[C12SimBackend, None]:
        ...
        if self._user_configs.get_verbose():
