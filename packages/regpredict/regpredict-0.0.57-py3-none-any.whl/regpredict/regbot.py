...
class Regbot:
  ...
  def prepareInput(self):
    try:
      test_data = np.array([[self.opening,self.asks,self.bids,self.ema_26,self.ema_12,self.macd,self.macdsignal,
                            self.macd_histogram,self.low,self.grad_histogram,self.vol_pct_change,self.ratio4,self.rsi_05,self.rsi_15,self.sma_25,
...
def signal(opening,a,b,ema_26,ema_12,macd,macdsignal,macd_histogram,
          low,grad_histogram,vol_pct_change,ratio4,rsi_05,rsi_15,sma_25,close_grad,
          close_grad_neg,grad_sma_25
          ):
  args = [opening,a,b,ema_26,ema_12,macd,macdsignal,macd_histogram, \
          low,grad_histogram,vol_pct_change,ratio4,rsi_05,rsi_15, \
          sma_25,close_grad,close_grad_neg,grad_sma_25
          ]
