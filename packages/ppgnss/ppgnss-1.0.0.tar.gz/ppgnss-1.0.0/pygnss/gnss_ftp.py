...
"""
   ...
   Downloading module of pygnss. Including downloading rinex nav file,
...
def download_brdc(year, doy, local_path="./", local_filename="",
    ...
    be like ``"whu"``, See :func:`pygnss.gnss_ftp.FTPINFO.keys()`
...
def download_sp3_by_doy(year, doy, local_path="./", local_filename="",
    ...
    :param data_center: IGS data center, like ``"whu"``, See :func:`pygnss.gnss_ftp.FTPINFO.keys()`
    :type data_center: string
    :return: Successful or not
    :rtype: bool
