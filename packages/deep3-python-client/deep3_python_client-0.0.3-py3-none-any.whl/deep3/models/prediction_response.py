...
class PredictionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PredictionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PredictionResponse:
        """Create an instance of PredictionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PredictionResponse.parse_obj(obj)

        _obj = PredictionResponse.parse_obj({
            "code": obj.get("code"),
