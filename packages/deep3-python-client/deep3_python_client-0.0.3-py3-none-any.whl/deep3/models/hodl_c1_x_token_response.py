...
class HodlC1XTokenResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HodlC1XTokenResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HodlC1XTokenResponse:
        """Create an instance of HodlC1XTokenResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HodlC1XTokenResponse.parse_obj(obj)

        _obj = HodlC1XTokenResponse.parse_obj({
            "code": obj.get("code"),
