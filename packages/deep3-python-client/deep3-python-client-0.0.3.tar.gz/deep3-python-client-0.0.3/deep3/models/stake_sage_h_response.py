...
class StakeSageHResponse(BaseModel):
    """
    StakeSageHResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StakeSageHResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StakeSageHResponse:
        """Create an instance of StakeSageHResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StakeSageHResponse.parse_obj(obj)

        _obj = StakeSageHResponse.parse_obj({
            "code": obj.get("code"),
