...
class HodlC1Response(BaseModel):
    """
    HodlC1Response
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HodlC1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HodlC1Response:
        """Create an instance of HodlC1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HodlC1Response.parse_obj(obj)

        _obj = HodlC1Response.parse_obj({
            "code": obj.get("code"),
