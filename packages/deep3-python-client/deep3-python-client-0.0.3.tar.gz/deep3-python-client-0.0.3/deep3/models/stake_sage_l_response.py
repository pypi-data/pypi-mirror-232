...
class StakeSageLResponse(BaseModel):
    """
    StakeSageLResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StakeSageLResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StakeSageLResponse:
        """Create an instance of StakeSageLResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StakeSageLResponse.parse_obj(obj)

        _obj = StakeSageLResponse.parse_obj({
            "code": obj.get("code"),
