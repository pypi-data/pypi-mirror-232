...
class PlaygroundApp:
    ...
    def add_routes(self):
        ...
        head_switcher.install_to_flask(self.frontend_assets, self.app)
    ...
    def load_frontend(self):
        self.frontend_assets = head_switcher.load_from_package_resources('slambda_playground.assets', 'app.frontend')
