...
if __name__ == "__main__":
    ...
    boxes = [['引线', 0.8566556572914124, 257.13018798828125, 125.12631225585938, 489.832275390625, 242.6492156982422],
             ['引线', 0.14764441549777985, 5.5301032066345215, 0.20269323885440826, 635.6176147460938, 136.02064514160156],
             ['普通钢筋大样图', 0.4559200406074524, 12.950339317321777, 110.76360321044922, 632.5936279296875, 294.2719421386719],
             ['普通钢筋大样图', 0.4087512791156769, 5.5301032066345215, 0.20269323885440826, 635.6176147460938, 136.02064514160156],
             ['普通钢筋大样图', 0.7765374183654785, 15.904788970947266, 1.2800637483596802, 627.498291015625, 300.8186950683594]]
    bb_nms = multi_nms(boxes=boxes, iou_thresh=0.4)
    print(bb_nms)
