...
font_dirs = ['webssh_embedded', 'static', 'css', 'fonts']
...
def get_app_settings(options):
    settings = dict(
        template_path=os.path.join(base_dir, 'webssh_embedded', 'templates'),
        static_path=os.path.join(base_dir, 'webssh_embedded', 'static'),
