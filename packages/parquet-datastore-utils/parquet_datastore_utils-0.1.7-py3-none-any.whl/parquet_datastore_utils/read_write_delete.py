...
def read(uri: str, columns: list = None, types_dict: dict = None, merge_schemas: bool = None, **kwargs) -> pd.DataFrame:
    """
...
def write(data: pd.DataFrame, uri: str, partition_cols: list = None, overwrite_period: bool = False) -> None:
    """
    ...
    if data.index.tzinfo is None:
        ...
        # Convert to and store data in UTC
...
def delete_between(uri: str, start: dict, end: dict, partition_cols: List[str] = None) -> None:
    """
