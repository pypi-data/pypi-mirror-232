...
class SequenceCollection (  IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SequenceCollection_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SequenceCollection_Add(self.Ptr, intPtrshape)
    ...
    <param name="item">Sequence to remove.</param>
        ...
        GetDllLibPpt().SequenceCollection_Remove(self.Ptr, intPtritem)
    ...
    <param name="index"></param>
        ...
        GetDllLibPpt().SequenceCollection_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibPpt().SequenceCollection_Clear(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().SequenceCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else AnimationEffectCollection(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().SequenceCollection_GetEnumerator(self.Ptr)
