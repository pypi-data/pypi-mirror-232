...
class PictureData (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PictureData_get_SourceEmbedImage(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().PictureData_get_Url(self.Ptr))
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PictureData_get_ImageTransform(self.Ptr)
