...
class ShapeStyle (  IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_LineColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_LineStyleIndex(self.Ptr)
    ...
    def LineStyleIndex(self, value:'UInt16'):
        ...
        GetDllLibPpt().ShapeStyle_set_LineStyleIndex(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_FillColor(self.Ptr)
        ret = None if intPtr==None else ColorFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_FillStyleIndex(self.Ptr)
    ...
    def FillStyleIndex(self, value:'Int16'):
        ...
        GetDllLibPpt().ShapeStyle_set_FillStyleIndex(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_EffectColor(self.Ptr)
        ret = None if intPtr==None else ColorFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_EffectStyleIndex(self.Ptr)
    ...
    def EffectStyleIndex(self, value:'UInt32'):
        ...
        GetDllLibPpt().ShapeStyle_set_EffectStyleIndex(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_FontColor(self.Ptr)
        ret = None if intPtr==None else ColorFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeStyle_get_FontCollectionIndex(self.Ptr)
    ...
    def FontCollectionIndex(self, value:'FontCollectionIndex'):
        ...
        GetDllLibPpt().ShapeStyle_set_FontCollectionIndex(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ShapeStyle_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_Slide(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().ShapeStyle_get_Presentation(self.Ptr)
