...
class AnimationScale (  CommonBehavior) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationScale_get_ZoomContent(self.Ptr)
    ...
    def ZoomContent(self, value:'TriState'):
        ...
        GetDllLibPpt().AnimationScale_set_ZoomContent(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationScale_get_From(self.Ptr)
    ...
    def From(self, value:'PointF'):
        ...
        GetDllLibPpt().AnimationScale_set_From(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationScale_get_To(self.Ptr)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def To(self, value:'PointF'):
        ...
        GetDllLibPpt().AnimationScale_set_To(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationScale_get_By(self.Ptr)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def By(self, value:'PointF'):
        ...
        GetDllLibPpt().AnimationScale_set_By(self.Ptr, value.Ptr)
