...
class ChartWallsOrFloor (  PptObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartWallsOrFloor_get_Thickness(self.Ptr)
        return ret

    @Thickness.setter
    def Thickness(self, value:int):
        GetDllLibPpt().ChartWallsOrFloor_set_Thickness.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartWallsOrFloor_set_Thickness(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartWallsOrFloor_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartWallsOrFloor_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartWallsOrFloor_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartWallsOrFloor_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartWallsOrFloor_get_PictureType(self.Ptr)
    ...
    def PictureType(self, value:'PictureType'):
        ...
        GetDllLibPpt().ChartWallsOrFloor_set_PictureType(self.Ptr, value.value)
