...
class MasterSlideList (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().MasterSlideList_get_Count(self.Ptr)
        return ret
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().MasterSlideList_get_Item(self.Ptr, index)
    ...
    <param name="value">The master slide to remove from the collection.</param>
        ...
        GetDllLibPpt().MasterSlideList_Remove(self.Ptr, intPtrvalue)
    ...
    <param name="index">The zero-based index of the element to remove.</param>
        ...
        GetDllLibPpt().MasterSlideList_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibPpt().MasterSlideList_CleanupDesigns(self.Ptr)
    ...
    <returns>Index of new slide.</returns>
        ...
        ret = GetDllLibPpt().MasterSlideList_AppendSlide(self.Ptr, intPtrslide)
        return ret
    ...
    def InsertSlide(self ,index:int,slide:'IMasterSlide'):
        ...
        GetDllLibPpt().MasterSlideList_InsertSlide(self.Ptr, index,intPtrslide)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().MasterSlideList_GetEnumerator(self.Ptr)
