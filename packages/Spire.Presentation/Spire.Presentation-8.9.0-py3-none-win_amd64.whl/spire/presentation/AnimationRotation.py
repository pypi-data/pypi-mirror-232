...
class AnimationRotation (  CommonBehavior) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationRotation_get_From(self.Ptr)
        return ret

    @From.setter
    def From(self, value:float):
        GetDllLibPpt().AnimationRotation_set_From.argtypes=[c_void_p, c_float]
        GetDllLibPpt().AnimationRotation_set_From(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationRotation_get_To(self.Ptr)
        return ret

    @To.setter
    def To(self, value:float):
        GetDllLibPpt().AnimationRotation_set_To.argtypes=[c_void_p, c_float]
        GetDllLibPpt().AnimationRotation_set_To(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationRotation_get_By(self.Ptr)
        return ret

    @By.setter
    def By(self, value:float):
        GetDllLibPpt().AnimationRotation_set_By.argtypes=[c_void_p, c_float]
        GetDllLibPpt().AnimationRotation_set_By(self.Ptr, value)
