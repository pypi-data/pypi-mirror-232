...
class EffectDag (  PptObject, IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDag_get_BlendEffect(self.Ptr)
    ...
    def BlendEffect(self, value:'BlendEffect'):
        ...
        GetDllLibPpt().EffectDag_set_BlendEffect(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDag_get_FillOverlayEffect(self.Ptr)
    ...
    def FillOverlayEffect(self, value:'FillOverlayEffect'):
        ...
        GetDllLibPpt().EffectDag_set_FillOverlayEffect(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDag_get_GlowEffect(self.Ptr)
    ...
    def GlowEffect(self, value:'GlowEffect'):
        ...
        GetDllLibPpt().EffectDag_set_GlowEffect(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDag_get_InnerShadowEffect(self.Ptr)
    ...
    def InnerShadowEffect(self, value:'InnerShadowEffect'):
        ...
        GetDllLibPpt().EffectDag_set_InnerShadowEffect(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDag_get_OuterShadowEffect(self.Ptr)
    ...
    def OuterShadowEffect(self, value:'OuterShadowEffect'):
        ...
        GetDllLibPpt().EffectDag_set_OuterShadowEffect(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDag_get_PresetShadowEffect(self.Ptr)
    ...
    def PresetShadowEffect(self, value:'PresetShadow'):
        ...
        GetDllLibPpt().EffectDag_set_PresetShadowEffect(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDag_get_ReflectionEffect(self.Ptr)
    ...
    def ReflectionEffect(self, value:'ReflectionEffect'):
        ...
        GetDllLibPpt().EffectDag_set_ReflectionEffect(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDag_get_SoftEdgeEffect(self.Ptr)
    ...
    def SoftEdgeEffect(self, value:'SoftEdgeEffect'):
        ...
        GetDllLibPpt().EffectDag_set_SoftEdgeEffect(self.Ptr, value.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().EffectDag_Equals(self.Ptr, intPtrobj)
        return ret
