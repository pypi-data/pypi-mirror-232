...
class ChartDataPoint (  PptObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().ChartDataPoint_Creat()
    ...
    def __init__(self,param):
        if isinstance(param, (int,float)):
            ...
            GetDllLibPpt().ChartDataPoint_Creat.restype = c_void_p
            intPtr = GetDllLibPpt().ChartDataPoint_Creat(param.Ptr)
            super(ChartDataPoint, self).__init__(intPtr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataPoint_get_Index(self.Ptr)
        return ret

    @Index.setter
    def Index(self, value:int):
        GetDllLibPpt().ChartDataPoint_set_Index.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartDataPoint_set_Index(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataPoint_get_IsBubble3D(self.Ptr)
        return ret

    @IsBubble3D.setter
    def IsBubble3D(self, value:bool):
        GetDllLibPpt().ChartDataPoint_set_IsBubble3D.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartDataPoint_set_IsBubble3D(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataPoint_get_Distance(self.Ptr)
        return ret

    @Distance.setter
    def Distance(self, value:int):
        GetDllLibPpt().ChartDataPoint_set_Distance.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartDataPoint_set_Distance(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataPoint_get_InvertIfNegative(self.Ptr)
        return ret
    ...
    def InvertIfNegative(self, value:bool):
        ...
        GetDllLibPpt().ChartDataPoint_set_InvertIfNegative(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataPoint_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataPoint_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataPoint_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataPoint_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataPoint_get_MarkerFill(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataPoint_get_MarkerSize(self.Ptr)
        return ret

    @MarkerSize.setter
    def MarkerSize(self, value:int):
        GetDllLibPpt().ChartDataPoint_set_MarkerSize.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartDataPoint_set_MarkerSize(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataPoint_get_MarkerStyle(self.Ptr)
    ...
    def MarkerStyle(self, value:'ChartMarkerType'):
        ...
        GetDllLibPpt().ChartDataPoint_set_MarkerStyle(self.Ptr, value.value)
...
<remarks>Applies only to Waterfall charts.</remarks>
        ...
        ret = GetDllLibPpt().ChartDataPoint_get_SetAsTotal(self.Ptr)
        return ret

    @SetAsTotal.setter
    def SetAsTotal(self, value:bool):
        GetDllLibPpt().ChartDataPoint_set_SetAsTotal.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartDataPoint_set_SetAsTotal(self.Ptr, value)
