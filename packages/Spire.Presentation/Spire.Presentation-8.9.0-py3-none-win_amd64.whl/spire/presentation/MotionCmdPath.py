...
class MotionCmdPath (SpireObject) :
    ...
    def Points(self)->List['PointF']:
        ...
        intPtrArray = GetDllLibPpt().MotionCmdPath_get_Points(self.Ptr)
...
#        GetDllLibPpt().MotionCmdPath_set_Points(self.Ptr, vArray, vCount)
    ...
    def CommandType(self)->'MotionCommandPathType':
        ...
        ret = GetDllLibPpt().MotionCmdPath_get_CommandType(self.Ptr)
    ...
    def CommandType(self, value:'MotionCommandPathType'):
        ...
        GetDllLibPpt().MotionCmdPath_set_CommandType(self.Ptr, value.value)
    ...
    def IsRelative(self)->bool:
        ...
        ret = GetDllLibPpt().MotionCmdPath_get_IsRelative(self.Ptr)
        return ret

    @IsRelative.setter
    def IsRelative(self, value:bool):
        GetDllLibPpt().MotionCmdPath_set_IsRelative.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().MotionCmdPath_set_IsRelative(self.Ptr, value)
    ...
    def PointsType(self)->'MotionPathPointsType':
        ...
        ret = GetDllLibPpt().MotionCmdPath_get_PointsType(self.Ptr)
    ...
    def PointsType(self, value:'MotionPathPointsType'):
        ...
        GetDllLibPpt().MotionCmdPath_set_PointsType(self.Ptr, value.value)
