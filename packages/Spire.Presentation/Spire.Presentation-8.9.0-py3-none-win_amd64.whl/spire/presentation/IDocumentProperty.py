...
class IDocumentProperty (SpireObject) :
    ...
    def Application(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Application(self.Ptr,valuePtr)
    ...
    def Company(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Company(self.Ptr,valuePtr)
    ...
    def Manager(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Manager(self.Ptr,valuePtr)
    ...
    def Format(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Format(self.Ptr,valuePtr)
    ...
    def Template(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Template(self.Ptr,valuePtr)
    ...
    def Title(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Title(self.Ptr,valuePtr)
    ...
    def Subject(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Subject(self.Ptr,valuePtr)
    ...
    def Author(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Author(self.Ptr,valuePtr)
    ...
    def Keywords(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Keywords(self.Ptr,valuePtr)
    ...
    def Comments(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Comments(self.Ptr,valuePtr)
    ...
    def Category(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_Category(self.Ptr,valuePtr)
    ...
    def LastSavedBy(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_LastSavedBy(self.Ptr,valuePtr)
    ...
    def ContentStatus(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_ContentStatus(self.Ptr,valuePtr)
    ...
    def ContentType(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_ContentType(self.Ptr,valuePtr)
    ...
    def HyperlinkBase(self, value:str):
        ...
        GetDllLibPpt().IDocumentProperty_set_HyperlinkBase(self.Ptr,valuePtr)
...
<exception cref="T:System.ArgumentOutOfRangeException">Index is less than zero. Index is equal to or greater than Count.</exception>
    ...
    <returns>Return true if a property was removed, false overwise.</returns>
        ...
        ret = GetDllLibPpt().IDocumentProperty_Remove(self.Ptr,namePtr)
        return ret
    ...
    <returns>Return true if property exists, false overwise.</returns>
        ...
        ret = GetDllLibPpt().IDocumentProperty_Contains(self.Ptr,namePtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IDocumentProperty_get_Item(self.Ptr,namePtr)
    ...
    def set_Item(self ,name:str,value:'SpireObject'):
        ...
        GetDllLibPpt().IDocumentProperty_set_Item(self.Ptr,namePtr,intPtrvalue)
