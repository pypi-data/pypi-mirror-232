...
class NotesSlide (  ActiveSlide) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().NotesSlide_get_NotesTextFrame(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().NotesSlide_get_Theme(self.Ptr)
    ...
    <param name="scheme"></param>
        ...
        GetDllLibPpt().NotesSlide_ApplyTheme(self.Ptr, intPtrscheme)
    ...
    <returns>Bitmap object.</returns>
        ...
        intPtr = GetDllLibPpt().NotesSlide_GetThumbnail(self.Ptr, scaleX,scaleY)
    ...
    <returns>Bitmap object.</returns>
        ...
        intPtr = GetDllLibPpt().NotesSlide_GetThumbnailI(self.Ptr, intPtrimageSize)
        ret = None if intPtr==None else Bitmap(intPtr)
        return ret
