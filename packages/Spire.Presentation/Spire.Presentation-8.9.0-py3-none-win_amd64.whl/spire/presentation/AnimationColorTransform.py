...
class AnimationColorTransform (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationColorTransform_get_Color1(self.Ptr)
        return ret

    @Color1.setter
    def Color1(self, value:float):
        GetDllLibPpt().AnimationColorTransform_set_Color1.argtypes=[c_void_p, c_float]
        GetDllLibPpt().AnimationColorTransform_set_Color1(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationColorTransform_get_Color2(self.Ptr)
        return ret

    @Color2.setter
    def Color2(self, value:float):
        GetDllLibPpt().AnimationColorTransform_set_Color2.argtypes=[c_void_p, c_float]
        GetDllLibPpt().AnimationColorTransform_set_Color2(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationColorTransform_get_Color3(self.Ptr)
        return ret

    @Color3.setter
    def Color3(self, value:float):
        GetDllLibPpt().AnimationColorTransform_set_Color3.argtypes=[c_void_p, c_float]
        GetDllLibPpt().AnimationColorTransform_set_Color3(self.Ptr, value)
