...
class ColorFormat (  PptObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ColorFormat_get_Color(self.Ptr)
    ...
    def Color(self, value:'Color'):
        ...
        GetDllLibPpt().ColorFormat_set_Color(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_ColorType(self.Ptr)
    ...
    def ColorType(self, value:'ColorType'):
        ...
        GetDllLibPpt().ColorFormat_set_ColorType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_KnownColor(self.Ptr)
    ...
    def KnownColor(self, value:'KnownColors'):
        ...
        GetDllLibPpt().ColorFormat_set_KnownColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_SystemColor(self.Ptr)
    ...
    def SystemColor(self, value:'SystemColorType'):
        ...
        GetDllLibPpt().ColorFormat_set_SystemColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_SchemeColor(self.Ptr)
    ...
    def SchemeColor(self, value:'SchemeColor'):
        ...
        GetDllLibPpt().ColorFormat_set_SchemeColor(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_R(self.Ptr)
        return ret

    @R.setter
    def R(self, value:int):
        GetDllLibPpt().ColorFormat_set_R.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ColorFormat_set_R(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_G(self.Ptr)
        return ret

    @G.setter
    def G(self, value:int):
        GetDllLibPpt().ColorFormat_set_G.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ColorFormat_set_G(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_B(self.Ptr)
        return ret

    @B.setter
    def B(self, value:int):
        GetDllLibPpt().ColorFormat_set_B.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ColorFormat_set_B(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_Hue(self.Ptr)
        return ret

    @Hue.setter
    def Hue(self, value:float):
        GetDllLibPpt().ColorFormat_set_Hue.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ColorFormat_set_Hue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_Saturation(self.Ptr)
        return ret

    @Saturation.setter
    def Saturation(self, value:float):
        GetDllLibPpt().ColorFormat_set_Saturation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ColorFormat_set_Saturation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColorFormat_get_Luminance(self.Ptr)
        return ret

    @Luminance.setter
    def Luminance(self, value:float):
        GetDllLibPpt().ColorFormat_set_Luminance.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ColorFormat_set_Luminance(self.Ptr, value)
  ...
  <b>true</b> if the specified ColorFormat is equal to the current ColorFormat; otherwise, <b>false</b>.</returns>
        ...
        ret = GetDllLibPpt().ColorFormat_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibPpt().ColorFormat_GetHashCode(self.Ptr)
        return ret
