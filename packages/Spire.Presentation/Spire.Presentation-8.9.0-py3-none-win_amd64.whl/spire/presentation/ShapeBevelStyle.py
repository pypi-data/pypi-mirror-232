...
class ShapeBevelStyle (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeBevelStyle_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().ShapeBevelStyle_set_Width.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ShapeBevelStyle_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeBevelStyle_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().ShapeBevelStyle_set_Height.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ShapeBevelStyle_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeBevelStyle_get_PresetType(self.Ptr)
    ...
    def PresetType(self, value:'BevelPresetType'):
        ...
        GetDllLibPpt().ShapeBevelStyle_set_PresetType(self.Ptr, value.value)
