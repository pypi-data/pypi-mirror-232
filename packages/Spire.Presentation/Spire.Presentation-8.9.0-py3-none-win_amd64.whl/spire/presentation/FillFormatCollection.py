...
#        GetDllLibPpt().FillFormatCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FillFormatCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FillFormatCollection_get_SyncRoot(self.Ptr)
