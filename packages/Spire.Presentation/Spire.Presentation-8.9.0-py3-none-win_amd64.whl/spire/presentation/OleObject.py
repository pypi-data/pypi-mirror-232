...
class OleObject (  IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().OleObject_get_Name(self.Ptr))
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().OleObject_get_PictureFill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().OleObject_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().OleObject_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().OleObject_get_Properties(self.Ptr)
