...
class EmbedImageList ( SpireObject ) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().EmbedImageList_get_Count(self.Ptr)
        return ret
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().EmbedImageList_get_Item(self.Ptr, index)
    ...
    <returns>Added image.</returns>
        ...
        intPtr = GetDllLibPpt().EmbedImageList_Append(self.Ptr, intPtrembedImage)
        ret = None if intPtr==None else IImageData(intPtr)
        return ret
    ...
    #    intPtr = GetDllLibPpt().EmbedImageList_AppendI(self.Ptr, intPtrimage)
    #    ret = None if intPtr==None else IImageData(intPtr)
    #    return ret
    ...
    <returns>Added image.</returns>
        ...
        intPtr = GetDllLibPpt().EmbedImageList_AppendS(self.Ptr, intPtrstream)
        ret = None if intPtr==None else IImageData(intPtr)
        return ret
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().EmbedImageList_GetEnumerator(self.Ptr)
