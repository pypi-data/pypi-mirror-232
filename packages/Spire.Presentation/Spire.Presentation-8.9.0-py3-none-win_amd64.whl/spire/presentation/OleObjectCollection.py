...
class OleObjectCollection (  ICollection, IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OleObjectCollection_get_Count(self.Ptr)
        return ret
    ...
    <param name="item">A control to remove.</param>
        ...
        GetDllLibPpt().OleObjectCollection_Remove(self.Ptr, intPtritem)
    ...
    <param name="index">Index of a control to remove.</param>
        ...
        GetDllLibPpt().OleObjectCollection_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibPpt().OleObjectCollection_Clear(self.Ptr)
    ...
    <param name="index">Index of a control.</param>
        ...
        intPtr = GetDllLibPpt().OleObjectCollection_get_Item(self.Ptr, index)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().OleObjectCollection_GetEnumerator(self.Ptr)
...
#        GetDllLibPpt().OleObjectCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OleObjectCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().OleObjectCollection_get_SyncRoot(self.Ptr)
