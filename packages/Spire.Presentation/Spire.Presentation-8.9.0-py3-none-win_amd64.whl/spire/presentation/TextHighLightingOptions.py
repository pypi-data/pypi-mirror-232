...
class TextHighLightingOptions (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().TextHighLightingOptions_Create()
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextHighLightingOptions_get_CaseSensitive(self.Ptr)
        return ret

    @CaseSensitive.setter
    def CaseSensitive(self, value:bool):
        GetDllLibPpt().TextHighLightingOptions_set_CaseSensitive.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().TextHighLightingOptions_set_CaseSensitive(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextHighLightingOptions_get_WholeWordsOnly(self.Ptr)
        return ret
    ...
    def WholeWordsOnly(self, value:bool):
        ...
        GetDllLibPpt().TextHighLightingOptions_set_WholeWordsOnly(self.Ptr, value)
