...
class TabStopList (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TabStopList_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TabStopList_get_Item(self.Ptr, index)
    ...
    <returns>The index at which the tab was added.</returns>
        ...
        ret = GetDllLibPpt().TabStopList_Append(self.Ptr, intPtrvalue)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().TabStopList_Clear(self.Ptr)
    ...
    <param name="index">The zero-based index of the element to remove.</param>
        ...
        GetDllLibPpt().TabStopList_RemoveAt(self.Ptr, index)
  ...
  <b>true</b> if the specified Tabs is equal to the current Tabs; otherwise, <b>false</b>.</returns>
        ...
        ret = GetDllLibPpt().TabStopList_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TabStopList_GetHashCode(self.Ptr)
        return ret
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().TabStopList_GetEnumerator(self.Ptr)
