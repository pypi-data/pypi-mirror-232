...
class EffectDataCollection (  ICollection, IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().EffectDataCollection_get_Count(self.Ptr)
        return ret
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().EffectDataCollection_GetEnumerator(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().EffectDataCollection_get_Item(self.Ptr, index)
...
#        GetDllLibPpt().EffectDataCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().EffectDataCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectDataCollection_get_SyncRoot(self.Ptr)
