...
class IMasterLayouts (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IMasterLayouts_get_Count(self.Ptr)
        return ret
    ...
    def get_Item(self ,index:int)->'ILayout':
        ...
        intPtr = GetDllLibPpt().IMasterLayouts_get_Item(self.Ptr, index)
    ...
    def GetByType(self ,type:'SlideLayoutType')->'ILayout':
        ...
        intPtr = GetDllLibPpt().IMasterLayouts_GetByType(self.Ptr, enumtype)
        ret = None if intPtr==None else ILayout(intPtr)
        return ret
    ...
    def RemoveMasterLayout(self ,index:int):
        ...
        GetDllLibPpt().IMasterLayouts_RemoveMasterLayout(self.Ptr, index)
