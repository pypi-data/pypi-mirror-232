...
#        GetDllLibPpt().TagCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TagCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TagCollection_get_SyncRoot(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TagCollection_GetEnumerator(self.Ptr)
