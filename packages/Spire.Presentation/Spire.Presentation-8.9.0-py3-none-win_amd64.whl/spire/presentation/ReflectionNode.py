...
class ReflectionNode (  EffectNode) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_StartPosAlpha(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_EndPosAlpha(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_FadeDirection(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_StartReflectionOpacity(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_EndReflectionOpacity(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_BlurRadius(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_Direction(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_Distance(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_RectangleAlign(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_SkewH(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_SkewV(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_RotateShadowWithShape(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_ScaleH(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionNode_get_ScaleV(self.Ptr)
        return ret
