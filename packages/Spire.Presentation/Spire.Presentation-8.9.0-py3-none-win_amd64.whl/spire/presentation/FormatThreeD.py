...
class FormatThreeD (  PptObject, IActiveSlide) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FormatThreeD_get_Camera(self.Ptr)
    ...
    def Camera(self, value:'Camera'):
        ...
        GetDllLibPpt().FormatThreeD_set_Camera(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FormatThreeD_get_LightRig(self.Ptr)
    ...
    def LightRig(self, value:'LightRig'):
        ...
        GetDllLibPpt().FormatThreeD_set_LightRig(self.Ptr, value.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().FormatThreeD_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def ShapeThreeD(self)->'ShapeThreeD':
        ...
        intPtr = GetDllLibPpt().FormatThreeD_get_ShapeThreeD(self.Ptr)
