...
class ShapeAdjust (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeAdjust_get_Value(self.Ptr)
        return ret

    @Value.setter
    def Value(self, value:float):
        GetDllLibPpt().ShapeAdjust_set_Value.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ShapeAdjust_set_Value(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ShapeAdjust_get_Name(self.Ptr))
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ShapeAdjust_Equals(self.Ptr, intPtrobj)
        return ret
