...
class TextLineFormat (  IActiveSlide, IChartGridLine) :
  ...
  <b>true</b> if the specified LineFormat is equal to the current LineFormat; otherwise, <b>false</b>.</returns>
        ...
        ret = GetDllLibPpt().TextLineFormat_Equals(self.Ptr, intPtrobj)
        return ret
  ...
  <b>true</b> if the specified LineFormat is equal to the current LineFormat; otherwise, <b>false</b>.</returns>
        ...
        ret = GetDllLibPpt().TextLineFormat_EqualsL(self.Ptr, intPtrlf)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextLineFormat_get_FillFormat(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_FillType(self.Ptr)
    ...
    def FillType(self, value:'FillFormatType'):
        ...
        GetDllLibPpt().TextLineFormat_set_FillType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextLineFormat_get_Gradient(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextLineFormat_get_Pattern(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextLineFormat_get_SolidFillColor(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_RotateWithShape(self.Ptr)
    ...
    def RotateWithShape(self, value:'TriState'):
        ...
        GetDllLibPpt().TextLineFormat_set_RotateWithShape(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().TextLineFormat_set_Width.argtypes=[c_void_p, c_double]
        GetDllLibPpt().TextLineFormat_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_DashStyle(self.Ptr)
    ...
    def DashStyle(self, value:'LineDashStyleType'):
        ...
        GetDllLibPpt().TextLineFormat_set_DashStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_CapStyle(self.Ptr)
    ...
    def CapStyle(self, value:'LineCapStyle'):
        ...
        GetDllLibPpt().TextLineFormat_set_CapStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_Style(self.Ptr)
    ...
    def Style(self, value:'TextLineStyle'):
        ...
        GetDllLibPpt().TextLineFormat_set_Style(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'PenAlignmentType'):
        ...
        GetDllLibPpt().TextLineFormat_set_Alignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_JoinStyle(self.Ptr)
    ...
    def JoinStyle(self, value:'LineJoinType'):
        ...
        GetDllLibPpt().TextLineFormat_set_JoinStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_MiterLimit(self.Ptr)
        return ret

    @MiterLimit.setter
    def MiterLimit(self, value:float):
        GetDllLibPpt().TextLineFormat_set_MiterLimit.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextLineFormat_set_MiterLimit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_LineBeginType(self.Ptr)
    ...
    def LineBeginType(self, value:'LineEndType'):
        ...
        GetDllLibPpt().TextLineFormat_set_LineBeginType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_LineEndType(self.Ptr)
        objwraped = LineEndType(ret)
        return objwraped
    ...
    def LineEndType(self, value:'LineEndType'):
        ...
        GetDllLibPpt().TextLineFormat_set_LineEndType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_LineBeginWidth(self.Ptr)
    ...
    def LineBeginWidth(self, value:'LineEndWidth'):
        ...
        GetDllLibPpt().TextLineFormat_set_LineBeginWidth(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_LineEndWidth(self.Ptr)
        objwraped = LineEndWidth(ret)
        return objwraped
    ...
    def LineEndWidth(self, value:'LineEndWidth'):
        ...
        GetDllLibPpt().TextLineFormat_set_LineEndWidth(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_LineBeginLength(self.Ptr)
    ...
    def LineBeginLength(self, value:'LineEndLength'):
        ...
        GetDllLibPpt().TextLineFormat_set_LineBeginLength(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormat_get_LineEndLength(self.Ptr)
        objwraped = LineEndLength(ret)
        return objwraped
    ...
    def LineEndLength(self, value:'LineEndLength'):
        ...
        GetDllLibPpt().TextLineFormat_set_LineEndLength(self.Ptr, value.value)
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibPpt().TextLineFormat_GetHashCode(self.Ptr)
        return ret
