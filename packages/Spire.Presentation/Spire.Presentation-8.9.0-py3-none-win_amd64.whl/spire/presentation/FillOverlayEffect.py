...
class FillOverlayEffect (  ImageTransformBase) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FillOverlayEffect_get_FillFormat(self.Ptr)
    ...
    def FillFormat(self, value:'FillFormat'):
        ...
        GetDllLibPpt().FillOverlayEffect_set_FillFormat(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FillOverlayEffect_get_Blend(self.Ptr)
    ...
    def Blend(self, value:'BlendMode'):
        ...
        GetDllLibPpt().FillOverlayEffect_set_Blend(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().FillOverlayEffect_Equals(self.Ptr, intPtrobj)
        return ret
