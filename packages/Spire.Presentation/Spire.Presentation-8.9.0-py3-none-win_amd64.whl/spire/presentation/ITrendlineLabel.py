...
class ITrendlineLabel (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITrendlineLabel_get_TextFrameProperties(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlineLabel_get_OffsetX(self.Ptr)
        return ret

    @OffsetX.setter
    def OffsetX(self, value:float):
        GetDllLibPpt().ITrendlineLabel_set_OffsetX.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITrendlineLabel_set_OffsetX(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlineLabel_get_OffsetY(self.Ptr)
        return ret

    @OffsetY.setter
    def OffsetY(self, value:float):
        GetDllLibPpt().ITrendlineLabel_set_OffsetY.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITrendlineLabel_set_OffsetY(self.Ptr, value)
