...
class CellRanges (  SpireObject ) :
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().CellRanges_get_Item(self.Ptr, index)
    ...
    <returns>Index of a new added <see cref="T:Spire.Presentation.Charts.CellRange" />.</returns>
        ...
        ret = GetDllLibPpt().CellRanges_Add(self.Ptr, intPtrcellRange)
        return ret
    ...
    <returns>Index of a new added <see cref="T:Spire.Presentation.Charts.CellRange" />.</returns>
        ...
        ret = GetDllLibPpt().CellRanges_AddV(self.Ptr, intPtrvalue)
        return ret
    ...
    <param name="index">Index of a cell to remove.</param>
        ...
        GetDllLibPpt().CellRanges_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().CellRanges_GetEnumerator(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CellRanges_get_Count(self.Ptr)
        return ret
