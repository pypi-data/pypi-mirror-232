...
class TextAnimation (  PptObject) :
    ...
    def ShapeRef(self)->'Shape':
        ...
        intPtr = GetDllLibPpt().TextAnimation_get_ShapeRef(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextAnimation_get_ParagraphBuildType(self.Ptr)
    ...
    def ParagraphBuildType(self, value:'ParagraphBuildType'):
        ...
        GetDllLibPpt().TextAnimation_set_ParagraphBuildType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextAnimation_get_Background(self.Ptr)
    ...
    def Background(self, value:'AnimationEffect'):
        ...
        GetDllLibPpt().TextAnimation_set_Background(self.Ptr, value.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextAnimation_Equals(self.Ptr, intPtrobj)
        return ret
