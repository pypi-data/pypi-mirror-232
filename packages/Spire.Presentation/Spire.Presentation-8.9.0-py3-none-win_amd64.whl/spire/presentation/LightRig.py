...
class LightRig (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LightRig_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'LightingDirectionType'):
        ...
        GetDllLibPpt().LightRig_set_Direction(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LightRig_get_PresetType(self.Ptr)
    ...
    def PresetType(self, value:'PresetLightRigType'):
        ...
        GetDllLibPpt().LightRig_set_PresetType(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibPpt().LightRig_SetRotation(self.Ptr, latitude,longitude,revolution)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibPpt().LightRig_GetRotation(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().LightRig_Equals(self.Ptr, intPtrobj)
        return ret
