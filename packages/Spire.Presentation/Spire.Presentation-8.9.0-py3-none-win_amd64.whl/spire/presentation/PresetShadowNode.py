...
class PresetShadowNode (  EffectNode) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PresetShadowNode_get_Direction(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PresetShadowNode_get_Distance(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PresetShadowNode_get_ShadowColor(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PresetShadowNode_get_Preset(self.Ptr)
