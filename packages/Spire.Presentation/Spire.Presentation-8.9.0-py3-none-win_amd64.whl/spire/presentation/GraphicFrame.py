...
class GraphicFrame (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().GraphicFrame_Create_noagrs()
    ...
    def __init__(self,left:float,top:float,width:float,height:float,hflip:bool,vfilp:bool,rotation:float):
        ...
        intPtr = GetDllLibPpt().GraphicFrame_Create(left,top,width,height,hflip,vfilp,rotation)
        super(GraphicFrame, self).__init__(intPtr)
    """
    <summary>
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_Left(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_Top(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().GraphicFrame_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().GraphicFrame_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_Height(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().GraphicFrame_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().GraphicFrame_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_CenterX(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_CenterY(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_IsFlipX(self.Ptr)
        return ret

    @IsFlipX.setter
    def IsFlipX(self, value:bool):
        GetDllLibPpt().GraphicFrame_set_IsFlipX.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().GraphicFrame_set_IsFlipX(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_get_IsFlipY(self.Ptr)
        return ret

    @IsFlipY.setter
    def IsFlipY(self, value:bool):
        GetDllLibPpt().GraphicFrame_set_IsFlipY.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().GraphicFrame_set_IsFlipY(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GraphicFrame_get_Rectangle(self.Ptr)
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = GetDllLibPpt().GraphicFrame_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,value:'GraphicFrame')->bool:
        ...
        ret = GetDllLibPpt().GraphicFrame_EqualsV(self.Ptr, intPtrvalue)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicFrame_GetHashCode(self.Ptr)
        return ret
