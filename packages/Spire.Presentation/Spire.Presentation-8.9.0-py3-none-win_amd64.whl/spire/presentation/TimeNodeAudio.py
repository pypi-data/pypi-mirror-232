...
#        GetDllLibPpt().TimeNodeAudio_SetAudioData(self.Ptr, intPtrfile)
    ...
    <param name="stream"></param>
        ...
        GetDllLibPpt().TimeNodeAudio_SetAudioDataS(self.Ptr, intPtrstream)
...
#        intPtrArray = GetDllLibPpt().TimeNodeAudio_GetAudioData(self.Ptr)
...
#        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TimeNodeAudio_get_Volume(self.Ptr)
        return ret

    @Volume.setter
    def Volume(self, value:float):
        GetDllLibPpt().TimeNodeAudio_set_Volume.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TimeNodeAudio_set_Volume(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TimeNodeAudio_get_IsMute(self.Ptr)
        return ret

    @IsMute.setter
    def IsMute(self, value:bool):
        GetDllLibPpt().TimeNodeAudio_set_IsMute.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().TimeNodeAudio_set_IsMute(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().TimeNodeAudio_get_SoundName(self.Ptr))
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TimeNodeAudio_Equals(self.Ptr, intPtrobj)
        return ret
