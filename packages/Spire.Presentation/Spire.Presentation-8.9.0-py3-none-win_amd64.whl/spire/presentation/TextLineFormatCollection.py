...
#        GetDllLibPpt().TextLineFormatCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormatCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextLineFormatCollection_get_SyncRoot(self.Ptr)
