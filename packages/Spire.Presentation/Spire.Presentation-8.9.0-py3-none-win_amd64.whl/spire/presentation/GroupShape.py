...
class GroupShape (  Shape, IShape) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GroupShape_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GroupShape_get_ShapeLocking(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GroupShape_get_Shapes(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().GroupShape_Equals(self.Ptr, intPtrobj)
        return ret
