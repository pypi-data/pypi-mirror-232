...
#        intPtrArray = GetDllLibPpt().SlideShowTransition_get_WavData(self.Ptr)
...
#        GetDllLibPpt().SlideShowTransition_set_WavData(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideShowTransition_get_SoundMode(self.Ptr)
    ...
    def SoundMode(self, value:'TransitionSoundMode'):
        ...
        GetDllLibPpt().SlideShowTransition_set_SoundMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideShowTransition_get_BuiltInSound(self.Ptr)
        return ret

    @BuiltInSound.setter
    def BuiltInSound(self, value:bool):
        GetDllLibPpt().SlideShowTransition_set_BuiltInSound.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().SlideShowTransition_set_BuiltInSound(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideShowTransition_get_Loop(self.Ptr)
        return ret

    @Loop.setter
    def Loop(self, value:bool):
        GetDllLibPpt().SlideShowTransition_set_Loop.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().SlideShowTransition_set_Loop(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideShowTransition_get_AdvanceOnClick(self.Ptr)
        return ret
    ...
    def AdvanceOnClick(self, value:bool):
        ...
        GetDllLibPpt().SlideShowTransition_set_AdvanceOnClick(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideShowTransition_get_AdvanceAfterTime(self.Ptr)
        return ret
    ...
    def AdvanceAfterTime(self, value:'int'):
        ...
        GetDllLibPpt().SlideShowTransition_set_AdvanceAfterTime(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideShowTransition_get_Speed(self.Ptr)
    ...
    def Speed(self, value:'TransitionSpeed'):
        ...
        GetDllLibPpt().SlideShowTransition_set_Speed(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideShowTransition_get_Duration(self.Ptr)
        return ret
    ...
    def Duration(self, value:'int'):
        ...
        GetDllLibPpt().SlideShowTransition_set_Duration(self.Ptr, value)
    ...
    <summary>
        ...
        intPtrWithTypeName = GetDllLibPpt().SlideShowTransition_get_Value(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideShowTransition_get_Type(self.Ptr)
    ...
    def Type(self, value:'TransitionType'):
        ...
        GetDllLibPpt().SlideShowTransition_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideShowTransition_get_Option(self.Ptr)
    ...
    def Option(self, value:'SpireObject'):
        ...
        GetDllLibPpt().SlideShowTransition_set_Option(self.Ptr, value.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().SlideShowTransition_Equals(self.Ptr, intPtrobj)
        return ret
