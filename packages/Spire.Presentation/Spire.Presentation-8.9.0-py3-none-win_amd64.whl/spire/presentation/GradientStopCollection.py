...
#        GetDllLibPpt().GradientStopCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GradientStopCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GradientStopCollection_get_SyncRoot(self.Ptr)
