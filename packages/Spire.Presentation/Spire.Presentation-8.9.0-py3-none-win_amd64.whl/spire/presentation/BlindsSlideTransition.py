...
class BlindsSlideTransition (  Transition) :
    ...
    def Direction(self)->'TransitionDirection':
        ...
        ret = GetDllLibPpt().BlindsSlideTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionDirection'):
        ...
        GetDllLibPpt().BlindsSlideTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().BlindsSlideTransition_Equals(self.Ptr, intPtrobj)
        return ret
