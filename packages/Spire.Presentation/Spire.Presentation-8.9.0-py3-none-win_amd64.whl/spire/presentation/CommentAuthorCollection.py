...
#        GetDllLibPpt().CommentAuthorCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CommentAuthorCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().CommentAuthorCollection_get_SyncRoot(self.Ptr)
