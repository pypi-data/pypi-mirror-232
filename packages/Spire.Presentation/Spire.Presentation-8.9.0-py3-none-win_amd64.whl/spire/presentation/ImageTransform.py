...
class ImageTransform (  IEnumerable, IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ImageTransform_get_Count(self.Ptr)
        return ret
    ...
    <param name="index">Index of an image effect that should be deleted.</param>
        ...
        GetDllLibPpt().ImageTransform_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibPpt().ImageTransform_Clear(self.Ptr)
    ...
    <returns>Index of the new image effect in a collection.</returns>
        ...
        ret = GetDllLibPpt().ImageTransform_Add(self.Ptr, intPtrbase)
        return ret
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().ImageTransform_GetEnumerator(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ImageTransform_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ImageTransform_get_Slide(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ImageTransform_get_Presentation(self.Ptr)
