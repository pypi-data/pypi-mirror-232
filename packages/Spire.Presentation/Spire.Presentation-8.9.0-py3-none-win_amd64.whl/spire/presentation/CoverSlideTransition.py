...
class CoverSlideTransition (  Transition) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CoverSlideTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionEightDirection'):
        ...
        GetDllLibPpt().CoverSlideTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().CoverSlideTransition_Equals(self.Ptr, intPtrobj)
        return ret
