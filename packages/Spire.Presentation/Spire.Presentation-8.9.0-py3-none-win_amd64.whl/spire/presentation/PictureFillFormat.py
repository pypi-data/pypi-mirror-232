...
class PictureFillFormat (  IActiveSlide) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PictureFillFormat_get_Dpi(self.Ptr)
        return ret

    @Dpi.setter
    def Dpi(self, value:int):
        GetDllLibPpt().PictureFillFormat_set_Dpi.argtypes=[c_void_p, c_int]
        GetDllLibPpt().PictureFillFormat_set_Dpi(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PictureFillFormat_get_FillType(self.Ptr)
    ...
    def FillType(self, value:'PictureFillType'):
        ...
        GetDllLibPpt().PictureFillFormat_set_FillType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PictureFillFormat_get_Picture(self.Ptr)
    ...
    def FillRectangle(self)->'RelativeRectangle':
        ...
        intPtr = GetDllLibPpt().PictureFillFormat_get_FillRectangle(self.Ptr)
    ...
    def HorizontalOffset(self)->float:
        ...
        ret = GetDllLibPpt().PictureFillFormat_get_HorizontalOffset(self.Ptr)
        return ret
    ...
    def HorizontalOffset(self, value:float):
        ...
        GetDllLibPpt().PictureFillFormat_set_HorizontalOffset(self.Ptr, value)
    ...
    def VerticalOffset(self)->float:
        ...
        ret = GetDllLibPpt().PictureFillFormat_get_VerticalOffset(self.Ptr)
        return ret
    ...
    def VerticalOffset(self, value:float):
        ...
        GetDllLibPpt().PictureFillFormat_set_VerticalOffset(self.Ptr, value)
    ...
    def ScaleX(self)->float:
        ...
        ret = GetDllLibPpt().PictureFillFormat_get_ScaleX(self.Ptr)
        return ret

    @ScaleX.setter
    def ScaleX(self, value:float):
        GetDllLibPpt().PictureFillFormat_set_ScaleX.argtypes=[c_void_p, c_float]
        GetDllLibPpt().PictureFillFormat_set_ScaleX(self.Ptr, value)
    ...
    def ScaleY(self)->float:
        ...
        ret = GetDllLibPpt().PictureFillFormat_get_ScaleY(self.Ptr)
        return ret

    @ScaleY.setter
    def ScaleY(self, value:float):
        GetDllLibPpt().PictureFillFormat_set_ScaleY.argtypes=[c_void_p, c_float]
        GetDllLibPpt().PictureFillFormat_set_ScaleY(self.Ptr, value)
    ...
    def Flip(self)->'TileFlipMode':
        ...
        ret = GetDllLibPpt().PictureFillFormat_get_Flip(self.Ptr)
    ...
    def Flip(self, value:'TileFlipMode'):
        ...
        GetDllLibPpt().PictureFillFormat_set_Flip(self.Ptr, value.value)
    ...
    def Alignment(self)->'RectangleAlignment':
        ...
        ret = GetDllLibPpt().PictureFillFormat_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'RectangleAlignment'):
        ...
        GetDllLibPpt().PictureFillFormat_set_Alignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PictureFillFormat_get_SourceRectangle(self.Ptr)
        ret = None if intPtr==None else RelativeRectangle(intPtr)
        return ret
    ...
    def SourceRectangle(self, value:'RelativeRectangle'):
        ...
        GetDllLibPpt().PictureFillFormat_set_SourceRectangle(self.Ptr, value.Ptr)
    ...
    def Slide(self)->'ActiveSlide':
        ...
        intPtr = GetDllLibPpt().PictureFillFormat_get_Slide(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().PictureFillFormat_get_Presentation(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().PictureFillFormat_GetCropPosition(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().PictureFillFormat_GetPicturePosition(self.Ptr)
        ret = None if intPtr==None else RectangleF(intPtr)
        return ret
