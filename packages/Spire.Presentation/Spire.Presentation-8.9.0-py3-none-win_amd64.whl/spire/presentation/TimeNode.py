...
class TimeNode (SpireObject) :
    ...
    def ChildNodes(self)->'TimeNodes':
        ...
        intPtr = GetDllLibPpt().TimeNode_get_ChildNodes(self.Ptr)
    ...
    def SubNodes(self)->'TimeNodes':
        ...
        intPtr = GetDllLibPpt().TimeNode_get_SubNodes(self.Ptr)
        ret = None if intPtr==None else TimeNodes(intPtr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TimeNode_Equals(self.Ptr, intPtrobj)
        return ret
