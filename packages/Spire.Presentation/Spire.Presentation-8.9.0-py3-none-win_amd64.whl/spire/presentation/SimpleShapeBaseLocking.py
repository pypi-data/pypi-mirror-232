...
class SimpleShapeBaseLocking (  BaseShapeLocking) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_GroupingProtection(self.Ptr)
        return ret
    ...
    def GroupingProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_GroupingProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_SelectionProtection(self.Ptr)
        return ret
    ...
    def SelectionProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_SelectionProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_RotationProtection(self.Ptr)
        return ret
    ...
    def RotationProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_RotationProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_AspectRatioProtection(self.Ptr)
        return ret
    ...
    def AspectRatioProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_AspectRatioProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_PositionProtection(self.Ptr)
        return ret
    ...
    def PositionProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_PositionProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_ResizeProtection(self.Ptr)
        return ret
    ...
    def ResizeProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_ResizeProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_EditPointProtection(self.Ptr)
        return ret
    ...
    def EditPointProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_EditPointProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_AdjustHandlesProtection(self.Ptr)
        return ret
    ...
    def AdjustHandlesProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_AdjustHandlesProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_ArrowheadChangesProtection(self.Ptr)
        return ret
    ...
    def ArrowheadChangesProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_ArrowheadChangesProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SimpleShapeBaseLocking_get_ShapeTypeProtection(self.Ptr)
        return ret
    ...
    def ShapeTypeProtection(self, value:bool):
        ...
        GetDllLibPpt().SimpleShapeBaseLocking_set_ShapeTypeProtection(self.Ptr, value)
