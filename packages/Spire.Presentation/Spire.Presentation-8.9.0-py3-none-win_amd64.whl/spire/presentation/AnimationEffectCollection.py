...
class AnimationEffectCollection ( SpireObject) :
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().AnimationEffectCollection_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationEffectCollection_get_Count(self.Ptr)
        return ret
    ...
    <param name="item">Effect to remove.</param>
        ...
        GetDllLibPpt().AnimationEffectCollection_Remove(self.Ptr, intPtritem)
    ...
    <param name="index"></param>
        ...
        GetDllLibPpt().AnimationEffectCollection_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibPpt().AnimationEffectCollection_Clear(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().AnimationEffectCollection_GetEnumerator(self.Ptr)
    ...
    def TriggerShape(self)->'Shape':
        ...
        intPtr = GetDllLibPpt().AnimationEffectCollection_get_TriggerShape(self.Ptr)
    ...
    def TriggerShape(self, value:'Shape'):
        ...
        GetDllLibPpt().AnimationEffectCollection_set_TriggerShape(self.Ptr, value.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().AnimationEffectCollection_AddEffect(self.Ptr, intPtrshape,enumanimationEffectType)
        ret = None if intPtr==None else AnimationEffect(intPtr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().AnimationEffectCollection_Equals(self.Ptr, intPtrobj)
        return ret
