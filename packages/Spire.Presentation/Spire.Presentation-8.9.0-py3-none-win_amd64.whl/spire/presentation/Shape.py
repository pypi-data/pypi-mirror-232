...
#        GetDllLibPpt().Shape_ReplaceTextWithRegex(self.Ptr, intPtrregex,newValue)
    ...
    <param name="filepath">Video file path</param>
        ...
        GetDllLibPpt().Shape_InsertVideo(self.Ptr,filepathPtr)
    ...
    <param name="filepath">Picture file path</param>
        ...
        GetDllLibPpt().Shape_InsertPictureF(self.Ptr,filepathPtr)
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibPpt().Shape_set_AlternativeText(self.Ptr,valuePtr)
    ...
    def AlternativeTitle(self, value:str):
        ...
        GetDllLibPpt().Shape_set_AlternativeTitle(self.Ptr,valuePtr)
    ...
    def Name(self, value:str):
        ...
        GetDllLibPpt().Shape_set_Name(self.Ptr,valuePtr)
