...
class ColumnList (  SpireObject) :
    ...
    def __getitem__(self, key):
        ...
        intPtr = GetDllLibPpt().ColumnList_get_Item(self.Ptr, key)
    ...
    <summary>
        ...
        GetDllLibPpt().ColumnList_get_Item.argtypes=[c_void_p ,c_int]
        GetDllLibPpt().ColumnList_get_Item.restype=c_void_p
        intPtr = GetDllLibPpt().ColumnList_get_Item(self.Ptr, index)
        ret = None if intPtr==None else TableColumn(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColumnList_get_Count(self.Ptr)
        return ret
    ...
    <param name="template"></param>
        ...
        GetDllLibPpt().ColumnList_Insert(self.Ptr, index,intPtrtemplate)
    ...
    <param name="template"></param>
        ...
        GetDllLibPpt().ColumnList_Add(self.Ptr, intPtrtemplate)
    ...
    <param name="withAttachedRows">True to delete also all attached columns.</param>
        ...
        GetDllLibPpt().ColumnList_RemoveAt(self.Ptr, firstColumnIndex,withAttachedRows)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().ColumnList_GetEnumerator(self.Ptr)
