...
class FillFormat (  IActiveSlide) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FillFormat_get_FillType(self.Ptr)
    ...
    def FillType(self, value:'FillFormatType'):
        ...
        GetDllLibPpt().FillFormat_set_FillType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FillFormat_get_IsGroupFill(self.Ptr)
        return ret

    @IsGroupFill.setter
    def IsGroupFill(self, value:bool):
        GetDllLibPpt().FillFormat_set_IsGroupFill.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().FillFormat_set_IsGroupFill(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FillFormat_get_IsNoFill(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FillFormat_get_SolidColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FillFormat_get_Gradient(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FillFormat_get_Pattern(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FillFormat_get_PictureFill(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FillFormat_get_RotateWithShape(self.Ptr)
    ...
    def RotateWithShape(self, value:'TriState'):
        ...
        GetDllLibPpt().FillFormat_set_RotateWithShape(self.Ptr, value.value)
  ...
  <b>true</b> if the specified FillFormat is equal to the current FillFormat; otherwise, <b>false</b>.</returns>
        ...
        ret = GetDllLibPpt().FillFormat_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibPpt().FillFormat_GetHashCode(self.Ptr)
        return ret
