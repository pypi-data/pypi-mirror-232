...
class SoftEdgeEffect (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SoftEdgeEffect_get_Radius(self.Ptr)
        return ret

    @Radius.setter
    def Radius(self, value:float):
        GetDllLibPpt().SoftEdgeEffect_set_Radius.argtypes=[c_void_p, c_double]
        GetDllLibPpt().SoftEdgeEffect_set_Radius(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().SoftEdgeEffect_Equals(self.Ptr, intPtrobj)
        return ret
