...
class ShredTransition (  Transition) :
    ...
    def Direction(self)->'TransitionShredInOutDirection':
        ...
        ret = GetDllLibPpt().ShredTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionShredInOutDirection'):
        ...
        GetDllLibPpt().ShredTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ShredTransition_Equals(self.Ptr, intPtrobj)
        return ret
