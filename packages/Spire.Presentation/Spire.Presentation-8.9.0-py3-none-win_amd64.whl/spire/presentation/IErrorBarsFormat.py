...
class IErrorBarsFormat (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IErrorBarsFormat_get_ErrorBarvType(self.Ptr)
    ...
    def ErrorBarvType(self, value:'ErrorValueType'):
        ...
        GetDllLibPpt().IErrorBarsFormat_set_ErrorBarvType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IErrorBarsFormat_get_ErrorBarSimType(self.Ptr)
    ...
    def ErrorBarSimType(self, value:'ErrorBarSimpleType'):
        ...
        GetDllLibPpt().IErrorBarsFormat_set_ErrorBarSimType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IErrorBarsFormat_get_ErrorBarVal(self.Ptr)
        return ret

    @ErrorBarVal.setter
    def ErrorBarVal(self, value:float):
        GetDllLibPpt().IErrorBarsFormat_set_ErrorBarVal.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IErrorBarsFormat_set_ErrorBarVal(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IErrorBarsFormat_get_MinusVal(self.Ptr)
        return ret

    @MinusVal.setter
    def MinusVal(self, value:float):
        GetDllLibPpt().IErrorBarsFormat_set_MinusVal.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IErrorBarsFormat_set_MinusVal(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IErrorBarsFormat_get_PlusVal(self.Ptr)
        return ret

    @PlusVal.setter
    def PlusVal(self, value:float):
        GetDllLibPpt().IErrorBarsFormat_set_PlusVal.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IErrorBarsFormat_set_PlusVal(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IErrorBarsFormat_get_ErrorBarNoEndCap(self.Ptr)
        return ret
    ...
    def ErrorBarNoEndCap(self, value:bool):
        ...
        GetDllLibPpt().IErrorBarsFormat_set_ErrorBarNoEndCap(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IErrorBarsFormat_get_Line(self.Ptr)
