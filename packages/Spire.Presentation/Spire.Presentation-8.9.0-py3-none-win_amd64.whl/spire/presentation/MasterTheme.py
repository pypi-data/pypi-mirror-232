...
class MasterTheme (  Theme) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().MasterTheme_get_ColorScheme(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().MasterTheme_get_FontScheme(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().MasterTheme_get_FormatScheme(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().MasterTheme_get_SlideColorSchemes(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().MasterTheme_Equals(self.Ptr, intPtrobj)
        return ret
