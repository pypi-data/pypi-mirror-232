...
class IChartGridLine (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_FillType(self.Ptr)
    ...
    def FillType(self, value:'FillFormatType'):
        ...
        GetDllLibPpt().IChartGridLine_set_FillType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartGridLine_get_FillFormat(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartGridLine_get_Gradient(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartGridLine_get_Pattern(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartGridLine_get_SolidFillColor(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_RotateWithShape(self.Ptr)
    ...
    def RotateWithShape(self, value:'TriState'):
        ...
        GetDllLibPpt().IChartGridLine_set_RotateWithShape(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().IChartGridLine_set_Width.argtypes=[c_void_p, c_double]
        GetDllLibPpt().IChartGridLine_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_DashStyle(self.Ptr)
    ...
    def DashStyle(self, value:'LineDashStyleType'):
        ...
        GetDllLibPpt().IChartGridLine_set_DashStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_CapStyle(self.Ptr)
    ...
    def CapStyle(self, value:'LineCapStyle'):
        ...
        GetDllLibPpt().IChartGridLine_set_CapStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_Style(self.Ptr)
    ...
    def Style(self, value:'TextLineStyle'):
        ...
        GetDllLibPpt().IChartGridLine_set_Style(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'PenAlignmentType'):
        ...
        GetDllLibPpt().IChartGridLine_set_Alignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_JoinStyle(self.Ptr)
    ...
    def JoinStyle(self, value:'LineJoinType'):
        ...
        GetDllLibPpt().IChartGridLine_set_JoinStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_MiterLimit(self.Ptr)
        return ret

    @MiterLimit.setter
    def MiterLimit(self, value:float):
        GetDllLibPpt().IChartGridLine_set_MiterLimit.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IChartGridLine_set_MiterLimit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_LineBeginType(self.Ptr)
    ...
    def LineBeginType(self, value:'LineEndType'):
        ...
        GetDllLibPpt().IChartGridLine_set_LineBeginType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_LineEndType(self.Ptr)
        objwraped = LineEndType(ret)
        return objwraped
    ...
    def LineEndType(self, value:'LineEndType'):
        ...
        GetDllLibPpt().IChartGridLine_set_LineEndType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_LineBeginWidth(self.Ptr)
    ...
    def LineBeginWidth(self, value:'LineEndWidth'):
        ...
        GetDllLibPpt().IChartGridLine_set_LineBeginWidth(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_LineEndWidth(self.Ptr)
        objwraped = LineEndWidth(ret)
        return objwraped
    ...
    def LineEndWidth(self, value:'LineEndWidth'):
        ...
        GetDllLibPpt().IChartGridLine_set_LineEndWidth(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_LineBeginLength(self.Ptr)
    ...
    def LineBeginLength(self, value:'LineEndLength'):
        ...
        GetDllLibPpt().IChartGridLine_set_LineBeginLength(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChartGridLine_get_LineEndLength(self.Ptr)
        objwraped = LineEndLength(ret)
        return objwraped
    ...
    def LineEndLength(self, value:'LineEndLength'):
        ...
        GetDllLibPpt().IChartGridLine_set_LineEndLength(self.Ptr, value.value)
