...
class LineStyleList (  IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LineStyleList_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().LineStyleList_get_Item(self.Ptr, index)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().LineStyleList_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().LineStyleList_GetEnumerator(self.Ptr)
