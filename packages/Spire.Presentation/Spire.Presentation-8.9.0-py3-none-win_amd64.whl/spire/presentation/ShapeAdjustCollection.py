...
#        GetDllLibPpt().ShapeAdjustCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeAdjustCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeAdjustCollection_get_SyncRoot(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeAdjustCollection_GetEnumerator(self.Ptr)
