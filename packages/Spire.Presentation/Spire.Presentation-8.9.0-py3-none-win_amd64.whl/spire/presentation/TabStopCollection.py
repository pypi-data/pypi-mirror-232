...
#        GetDllLibPpt().TabStopCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TabStopCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TabStopCollection_get_SyncRoot(self.Ptr)
