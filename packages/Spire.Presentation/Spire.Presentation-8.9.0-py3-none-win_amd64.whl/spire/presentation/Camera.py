...
class Camera (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Camera_get_PresetType(self.Ptr)
    ...
    def PresetType(self, value:'PresetCameraType'):
        ...
        GetDllLibPpt().Camera_set_PresetType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Camera_get_FieldOfView(self.Ptr)
        return ret

    @FieldOfView.setter
    def FieldOfView(self, value:float):
        GetDllLibPpt().Camera_set_FieldOfView.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Camera_set_FieldOfView(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Camera_get_Zoom(self.Ptr)
        return ret

    @Zoom.setter
    def Zoom(self, value:float):
        GetDllLibPpt().Camera_set_Zoom.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Camera_set_Zoom(self.Ptr, value)
    ...
    <summary>
        ...
        GetDllLibPpt().Camera_SetCameraRotation(self.Ptr, latitude,longitude,revolution)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibPpt().Camera_GetCameraRotations(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().Camera_Equals(self.Ptr, intPtrobj)
        return ret
