...
class CommentList (SpireObject) :
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().CommentList_AppendComment(self.Ptr, intPtrslide,textPtr,x,y)
        ret = None if intPtr==None else Comment(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().CommentList_InsertComment(self.Ptr, intPtrslide,Index,textPtr,x,y)
        ret = None if intPtr==None else Comment(intPtr)
        return ret
