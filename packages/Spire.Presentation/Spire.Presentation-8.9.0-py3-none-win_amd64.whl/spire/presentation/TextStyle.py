...
class TextStyle (  IActiveSlide, IActivePresentation) :
    ...
    <returns>Formatting of level <see cref="T:Spire.Presentation.TextParagraphProperties" />. </returns>
        ...
        intPtr = GetDllLibPpt().TextStyle_GetListLevelTextStyle(self.Ptr, index)
    ...
    <returns>Formatting of level <see cref="T:Spire.Presentation.TextParagraphProperties" />. </returns>
        ...
        intPtr = GetDllLibPpt().TextStyle_GetOrCreateListLevelTextStyle(self.Ptr, index)
        ret = None if intPtr==None else TextParagraphProperties(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextStyle_get_DefaultParagraphStyle(self.Ptr)
        ret = None if intPtr==None else TextParagraphProperties(intPtr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextStyle_Equals(self.Ptr, intPtrobj)
        return ret
