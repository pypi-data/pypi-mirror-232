...
class GradientStopList ( IActiveSlide) :
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().GradientStopList_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GradientStopList_get_Count(self.Ptr)
        return ret
    ...
    <returns>Index of the new gradient stop in the collection.</returns>
        ...
        ret = GetDllLibPpt().GradientStopList_Append(self.Ptr, position,intPtrcolor)
        return ret
    ...
    <returns>Index of the new gradient stop in the collection.</returns>
        ...
        ret = GetDllLibPpt().GradientStopList_AppendPK(self.Ptr, position,enumknownColor)
        return ret
    ...
    <returns>Index of the new gradient stop in the collection.</returns>
        ...
        ret = GetDllLibPpt().GradientStopList_AppendPS(self.Ptr, position,enumschemeColor)
        return ret
    ...
    <param name="color">Color of the new radient stop.</param>
        ...
        GetDllLibPpt().GradientStopList_Insert(self.Ptr, index,position,intPtrcolor)
    ...
    <param name="knownColor">Color of the new radient stop.</param>
        ...
        GetDllLibPpt().GradientStopList_InsertIPK(self.Ptr, index,position,enumknownColor)
    ...
    <param name="schemeColor">Color of the new radient stop.</param>
        ...
        GetDllLibPpt().GradientStopList_InsertIPS(self.Ptr, index,position,enumschemeColor)
    ...
    <param name="index">Index of a gradient stop that should be deleted.</param>
        ...
        GetDllLibPpt().GradientStopList_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibPpt().GradientStopList_RemoveAll(self.Ptr)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().GradientStopList_GetEnumerator(self.Ptr)
