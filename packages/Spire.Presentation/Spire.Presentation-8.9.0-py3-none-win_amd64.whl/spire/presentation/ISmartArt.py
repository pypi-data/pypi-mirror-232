...
class ISmartArt (SpireObject) :
    ...
    def Nodes(self)->'ISmartArtNodeCollection':
        ...
        intPtr = GetDllLibPpt().ISmartArt_get_Nodes(self.Ptr)
    ...
    def ColorStyle(self)->'SmartArtColorType':
        ...
        ret = GetDllLibPpt().ISmartArt_get_ColorStyle(self.Ptr)
    ...
    def ColorStyle(self, value:'SmartArtColorType'):
        ...
        GetDllLibPpt().ISmartArt_set_ColorStyle(self.Ptr, value.value)
    ...
    def LayoutType(self)->'SmartArtLayoutType':
        ...
        ret = GetDllLibPpt().ISmartArt_get_LayoutType(self.Ptr)
    ...
    def Style(self)->'SmartArtStyleType':
        ...
        ret = GetDllLibPpt().ISmartArt_get_Style(self.Ptr)
    ...
    def Style(self, value:'SmartArtStyleType'):
        ...
        GetDllLibPpt().ISmartArt_set_Style(self.Ptr, value.value)
    ...
    def Reset(self):
        ...
        GetDllLibPpt().ISmartArt_Reset(self.Ptr)
