...
class SlideSize (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideSize_get_Size(self.Ptr)
    ...
    def Size(self, value:'SizeF'):
        ...
        GetDllLibPpt().SlideSize_set_Size(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideSize_get_SizeOfPx(self.Ptr)
        ret = None if intPtr==None else SizeF(intPtr)
        return ret
    ...
    def SizeOfPx(self, value:'SizeF'):
        ...
        GetDllLibPpt().SlideSize_set_SizeOfPx(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideSize_get_Type(self.Ptr)
    ...
    def Type(self, value:'SlideSizeType'):
        ...
        GetDllLibPpt().SlideSize_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideSize_get_Orientation(self.Ptr)
    ...
    def Orientation(self, value:'SlideOrienation'):
        ...
        GetDllLibPpt().SlideSize_set_Orientation(self.Ptr, value.value)
