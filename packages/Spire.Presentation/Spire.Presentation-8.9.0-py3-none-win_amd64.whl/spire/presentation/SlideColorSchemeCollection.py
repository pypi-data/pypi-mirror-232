...
class SlideColorSchemeCollection (  ICollection, IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideColorSchemeCollection_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideColorSchemeCollection_get_Item(self.Ptr, index)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().SlideColorSchemeCollection_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <returns>Enumeraton <see cref="T:System.Collections.IEnumerator" />.</returns>
        ...
        intPtr = GetDllLibPpt().SlideColorSchemeCollection_GetEnumerator(self.Ptr)
...
#        GetDllLibPpt().SlideColorSchemeCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideColorSchemeCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideColorSchemeCollection_get_SyncRoot(self.Ptr)
