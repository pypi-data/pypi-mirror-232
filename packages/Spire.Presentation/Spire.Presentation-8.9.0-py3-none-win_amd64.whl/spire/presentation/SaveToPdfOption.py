...
class SaveToPdfOption (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SaveToPdfOption_get_ContainHiddenSlides(self.Ptr)
        return ret

    @ContainHiddenSlides.setter
    def ContainHiddenSlides(self, value:bool):
        GetDllLibPpt().SaveToPdfOption_set_ContainHiddenSlides.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().SaveToPdfOption_set_ContainHiddenSlides(self.Ptr, value)
    ...
    def PageSlideCount(self)->'PageSlideCount':
        ...
        ret = GetDllLibPpt().SaveToPdfOption_get_PageSlideCount(self.Ptr)
    ...
    def PageSlideCount(self, value:'PageSlideCount'):
        ...
        GetDllLibPpt().SaveToPdfOption_set_PageSlideCount(self.Ptr, value.value)
    ...
    def Order(self)->'Order':
        ...
        ret = GetDllLibPpt().SaveToPdfOption_get_Order(self.Ptr)
        objwraped = Order(ret)
        return objwraped
    ...
    def Order(self, value:'Order'):
        ...
        GetDllLibPpt().SaveToPdfOption_set_Order(self.Ptr, value.value)
...
#        ret = GetDllLibPpt().SaveToPdfOption_get_PdfConformanceLevel(self.Ptr)
...
#        GetDllLibPpt().SaveToPdfOption_set_PdfConformanceLevel(self.Ptr, value.value)
...
#        intPtr = GetDllLibPpt().SaveToPdfOption_get_PdfSecurity(self.Ptr)
