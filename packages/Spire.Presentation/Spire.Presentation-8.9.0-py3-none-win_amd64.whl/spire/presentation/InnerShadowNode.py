...
class InnerShadowNode (  EffectNode) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().InnerShadowNode_get_BlurRadius(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().InnerShadowNode_get_Direction(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().InnerShadowNode_get_Distance(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().InnerShadowNode_get_ShadowColor(self.Ptr)
