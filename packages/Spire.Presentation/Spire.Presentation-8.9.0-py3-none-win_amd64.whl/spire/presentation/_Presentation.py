...
#        return ret
    ...
    def LoadFromFile(self ,file:str,fileFormat:FileFormat):
        ...
        GetDllLibPpt()._Presentation_LoadFromFile(self.Ptr,filePtr,enumfileFormat)
    ...
    def LoadFromFile(self ,file:str):
        ...
        GetDllLibPpt()._Presentation_LoadFromFileF(self.Ptr,filePtr)
    ...
    def LoadFromFile(self ,file:str,password:str):
        ...
        GetDllLibPpt()._Presentation_LoadFromFileFP(self.Ptr,filePtr,passwordPtr)
    ...
    def LoadFromFile(self ,file:str,fileFormat:FileFormat,password:str):
        ...
        GetDllLibPpt()._Presentation_LoadFromFileFFP(self.Ptr,filePtr,enumfileFormat,passwordPtr)
    ...
    <param name="password">The password.</param>
        ...
        GetDllLibPpt()._Presentation_LoadFromStreamSFP(self.Ptr, intPtrstream,enumfileFormat,passwordPtr)
    ...
    def SaveToFile(self ,file:str,fileFormat:FileFormat):
        ...
        GetDllLibPpt()._Presentation_SaveToFileFF(self.Ptr,filePtr,enumfileFormat)
