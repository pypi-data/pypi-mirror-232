...
class GraphicAnimationCollection (  ICollection, IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicAnimationCollection_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GraphicAnimationCollection_get_Item(self.Ptr, index)
...
#        intPtrArray = GetDllLibPpt().GraphicAnimationCollection_get_ItemS(self.Ptr, intPtrshape)
...
#        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().GraphicAnimationCollection_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().GraphicAnimationCollection_GetEnumerator(self.Ptr)
...
#        GetDllLibPpt().GraphicAnimationCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicAnimationCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GraphicAnimationCollection_get_SyncRoot(self.Ptr)
