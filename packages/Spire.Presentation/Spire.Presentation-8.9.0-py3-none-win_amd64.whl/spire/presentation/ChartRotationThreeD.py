...
class ChartRotationThreeD (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartRotationThreeD_get_XDegree(self.Ptr)
        return ret

    @XDegree.setter
    def XDegree(self, value:int):
        GetDllLibPpt().ChartRotationThreeD_set_XDegree.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartRotationThreeD_set_XDegree(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartRotationThreeD_get_YDegree(self.Ptr)
        return ret

    @YDegree.setter
    def YDegree(self, value:int):
        GetDllLibPpt().ChartRotationThreeD_set_YDegree.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartRotationThreeD_set_YDegree(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartRotationThreeD_get_IsPerspective(self.Ptr)
        return ret
    ...
    def IsPerspective(self, value:int):
        ...
        GetDllLibPpt().ChartRotationThreeD_set_IsPerspective(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartRotationThreeD_get_Depth(self.Ptr)
        return ret

    @Depth.setter
    def Depth(self, value:int):
        GetDllLibPpt().ChartRotationThreeD_set_Depth.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartRotationThreeD_set_Depth(self.Ptr, value)
