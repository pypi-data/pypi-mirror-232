...
class TabStop (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TabStop_get_Position(self.Ptr)
        return ret

    @Position.setter
    def Position(self, value:float):
        GetDllLibPpt().TabStop_set_Position.argtypes=[c_void_p, c_double]
        GetDllLibPpt().TabStop_set_Position(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TabStop_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'TabAlignmentType'):
        ...
        GetDllLibPpt().TabStop_set_Alignment(self.Ptr, value.value)
    ...
    <returns>A 32-bit integer that indicates the relative order of the comparands.
        ...
        ret = GetDllLibPpt().TabStop_CompareTo(self.Ptr, intPtrobj)
        return ret
