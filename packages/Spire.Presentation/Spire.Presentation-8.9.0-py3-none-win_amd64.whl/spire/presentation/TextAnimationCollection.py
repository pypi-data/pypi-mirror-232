...
class TextAnimationCollection (  SpireObject ) :
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().TextAnimationCollection_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextAnimationCollection_get_Count(self.Ptr)
        return ret
...
#        intPtrArray = GetDllLibPpt().TextAnimationCollection_get_ItemS(self.Ptr, intPtrshape)
...
#        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextAnimationCollection_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().TextAnimationCollection_GetEnumerator(self.Ptr)
...
#        GetDllLibPpt().TextAnimationCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextAnimationCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextAnimationCollection_get_SyncRoot(self.Ptr)
