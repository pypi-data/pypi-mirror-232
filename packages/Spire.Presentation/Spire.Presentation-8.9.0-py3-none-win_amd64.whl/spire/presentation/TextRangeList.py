...
class TextRangeList (SpireObject) :
    ...
    def __getitem__(self ,index:int)->'TextRange':
        ...
        intPtr = GetDllLibPpt().TextRangeList_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextRangeList_get_Count(self.Ptr)
        return ret
    ...
    <returns>The index at which the text range has been added.</returns>
        ...
        ret = GetDllLibPpt().TextRangeList_Append(self.Ptr, intPtrvalue)
        return ret
    ...
    <param name="value">The Portion to insert.</param>
        ...
        GetDllLibPpt().TextRangeList_Insert(self.Ptr, index,intPtrvalue)
    ...
    <summary>
        ...
        GetDllLibPpt().TextRangeList_Clear(self.Ptr)
    ...
    <param name="index">The zero-based index of the element to remove.</param>
        ...
        GetDllLibPpt().TextRangeList_RemoveAt(self.Ptr, index)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().TextRangeList_GetEnumerator(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextRangeList_Equals(self.Ptr, intPtrobj)
        return ret
