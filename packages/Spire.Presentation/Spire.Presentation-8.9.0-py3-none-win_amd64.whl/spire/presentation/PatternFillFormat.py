...
class PatternFillFormat (  IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PatternFillFormat_get_PatternType(self.Ptr)
    ...
    def PatternType(self, value:'PatternFillType'):
        ...
        GetDllLibPpt().PatternFillFormat_set_PatternType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PatternFillFormat_get_ForegroundColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PatternFillFormat_get_BackgroundColor(self.Ptr)
        ret = None if intPtr==None else ColorFormat(intPtr)
        return ret
    ...
    <returns>Tile <see cref="T:System.Drawing.Bitmap" />.</returns>
        ...
        intPtr = GetDllLibPpt().PatternFillFormat_GetTileImage(self.Ptr, intPtrbackground,intPtrforeground)
    ...
    <returns>Tile <see cref="T:System.Drawing.Bitmap" />.</returns>
        ...
        intPtr = GetDllLibPpt().PatternFillFormat_GetTileImageS(self.Ptr, intPtrstyleColor)
        ret = None if intPtr==None else Bitmap(intPtr)
        return ret
