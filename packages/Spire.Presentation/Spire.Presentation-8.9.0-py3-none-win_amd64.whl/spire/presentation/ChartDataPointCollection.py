...
class ChartDataPointCollection (  IEnumerable) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataPointCollection_get_Item(self.Ptr, index)
    ...
    <returns></returns>
        ...
        ret = GetDllLibPpt().ChartDataPointCollection_Add(self.Ptr, intPtrvalue)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataPointCollection_GetEnumerator(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataPointCollection_get_Count(self.Ptr)
        return ret
