...
class SlideBackground (  IActiveSlide) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideBackground_get_Type(self.Ptr)
    ...
    def Type(self, value:'BackgroundType'):
        ...
        GetDllLibPpt().SlideBackground_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideBackground_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideBackground_get_Fill(self.Ptr)
    ...
    def Fill(self, value:'FillFormat'):
        ...
        GetDllLibPpt().SlideBackground_set_Fill(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideBackground_get_ThemeColor(self.Ptr)
    ...
    def ThemeColor(self, value:'ColorFormat'):
        ...
        GetDllLibPpt().SlideBackground_set_ThemeColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideBackground_get_ThemeIndex(self.Ptr)
    ...
    def ThemeIndex(self, value:'UInt16'):
        ...
        GetDllLibPpt().SlideBackground_set_ThemeIndex(self.Ptr, value.Ptr)
    ...
    <param name="slide">the slide with current background.</param>
        ...
        intPtr = GetDllLibPpt().SlideBackground_GetBackgroundFillFormat(self.Ptr, intPtrslide)
        ret = None if intPtr==None else FillFormat(intPtr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().SlideBackground_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideBackground_get_Slide(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideBackground_get_Presentation(self.Ptr)
