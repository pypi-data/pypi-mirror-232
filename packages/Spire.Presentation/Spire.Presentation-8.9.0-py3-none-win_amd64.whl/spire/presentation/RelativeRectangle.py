...
class RelativeRectangle (SpireObject) :
    ...
    def X(self)->float:
        ...
        ret = GetDllLibPpt().RelativeRectangle_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:float):
        GetDllLibPpt().RelativeRectangle_set_X.argtypes=[c_void_p, c_float]
        GetDllLibPpt().RelativeRectangle_set_X(self.Ptr, value)
    ...
    def Y(self)->float:
        ...
        ret = GetDllLibPpt().RelativeRectangle_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:float):
        GetDllLibPpt().RelativeRectangle_set_Y.argtypes=[c_void_p, c_float]
        GetDllLibPpt().RelativeRectangle_set_Y(self.Ptr, value)
    ...
    def Width(self)->float:
        ...
        ret = GetDllLibPpt().RelativeRectangle_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().RelativeRectangle_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().RelativeRectangle_set_Width(self.Ptr, value)
    ...
    def Height(self)->float:
        ...
        ret = GetDllLibPpt().RelativeRectangle_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().RelativeRectangle_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().RelativeRectangle_set_Height(self.Ptr, value)
    ...
    def Left(self)->float:
        ...
        ret = GetDllLibPpt().RelativeRectangle_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().RelativeRectangle_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().RelativeRectangle_set_Left(self.Ptr, value)
    ...
    def Top(self)->float:
        ...
        ret = GetDllLibPpt().RelativeRectangle_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().RelativeRectangle_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().RelativeRectangle_set_Top(self.Ptr, value)
    ...
    def Right(self)->float:
        ...
        ret = GetDllLibPpt().RelativeRectangle_get_Right(self.Ptr)
        return ret

    @Right.setter
    def Right(self, value:float):
        GetDllLibPpt().RelativeRectangle_set_Right.argtypes=[c_void_p, c_float]
        GetDllLibPpt().RelativeRectangle_set_Right(self.Ptr, value)
    ...
    def Bottom(self)->float:
        ...
        ret = GetDllLibPpt().RelativeRectangle_get_Bottom(self.Ptr)
        return ret

    @Bottom.setter
    def Bottom(self, value:float):
        GetDllLibPpt().RelativeRectangle_set_Bottom.argtypes=[c_void_p, c_float]
        GetDllLibPpt().RelativeRectangle_set_Bottom(self.Ptr, value)
    ...
    def Transform(self ,rect:RectangleF)->RectangleF:
        ...
        intPtr = GetDllLibPpt().RelativeRectangle_Transform(self.Ptr, intPtrrect)
    ...
    def Transform(self ,rect:'RelativeRectangle')->'RelativeRectangle':
        ...
        intPtr = GetDllLibPpt().RelativeRectangle_TransformR(self.Ptr, intPtrrect)
