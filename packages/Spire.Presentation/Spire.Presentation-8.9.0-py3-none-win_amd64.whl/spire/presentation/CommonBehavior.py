...
class CommonBehavior (  PptObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CommonBehavior_get_Accumulate(self.Ptr)
    ...
    def Accumulate(self, value:'TriState'):
        ...
        GetDllLibPpt().CommonBehavior_set_Accumulate(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CommonBehavior_get_Additive(self.Ptr)
    ...
    def Additive(self, value:'BehaviorAdditiveType'):
        ...
        GetDllLibPpt().CommonBehavior_set_Additive(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().CommonBehavior_get_Timing(self.Ptr)
    ...
    def Timing(self, value:'Timing'):
        ...
        GetDllLibPpt().CommonBehavior_set_Timing(self.Ptr, value.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().CommonBehavior_Equals(self.Ptr, intPtrobj)
        return ret
