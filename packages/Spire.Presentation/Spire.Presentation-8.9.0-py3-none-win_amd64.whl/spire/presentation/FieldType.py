...
class FieldType (SpireObject) :
    ...
    <returns>True if fields are equal.</returns>
        ...
        ret = GetDllLibPpt().FieldType_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <returns>Hashcode <see cref="T:System.Int32" />.</returns>
        ...
        ret = GetDllLibPpt().FieldType_GetHashCode(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FieldType_op_Equality( intPtra,intPtrb)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FieldType_op_Inequality( intPtra,intPtrb)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime()
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime1()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime2()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime3()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime4()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime5()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime6()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime7()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime8()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime9()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime10()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime11()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime12()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FieldType_get_DateTime13()
        ret = None if intPtr==None else FieldType(intPtr)
        return ret
