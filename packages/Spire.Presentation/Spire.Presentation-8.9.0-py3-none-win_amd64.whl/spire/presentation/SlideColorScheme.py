...
class SlideColorScheme (SpireObject) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().SlideColorScheme_get_Name(self.Ptr))
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().SlideColorScheme_get_ColorScheme(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().SlideColorScheme_Equals(self.Ptr, intPtrobj)
        return ret
