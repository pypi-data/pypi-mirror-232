...
class VideoCollection (  ICollection, IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().VideoCollection_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().VideoCollection_get_Item(self.Ptr, index)
    ...
    <returns>Added video.</returns>
        ...
        intPtr = GetDllLibPpt().VideoCollection_Append(self.Ptr, intPtrvideoData)
        ret = None if intPtr==None else VideoData(intPtr)
        return ret
    ...
    <returns>Added <see cref="T:Spire.Presentation.VideoData" />.</returns>
        ...
        intPtr = GetDllLibPpt().VideoCollection_AppendS(self.Ptr, intPtrstream)
        ret = None if intPtr==None else VideoData(intPtr)
        return ret
...
#        intPtr = GetDllLibPpt().VideoCollection_AppendV(self.Ptr, arrayvideoData)
#        ret = None if intPtr==None else VideoData(intPtr)
#        return ret
#
