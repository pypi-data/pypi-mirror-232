...
class GroupShapeLocking (  BaseShapeLocking) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GroupShapeLocking_get_GroupingProtection(self.Ptr)
        return ret
    ...
    def GroupingProtection(self, value:bool):
        ...
        GetDllLibPpt().GroupShapeLocking_set_GroupingProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GroupShapeLocking_get_UngroupingProtection(self.Ptr)
        return ret
    ...
    def UngroupingProtection(self, value:bool):
        ...
        GetDllLibPpt().GroupShapeLocking_set_UngroupingProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GroupShapeLocking_get_SelectionProtection(self.Ptr)
        return ret
    ...
    def SelectionProtection(self, value:bool):
        ...
        GetDllLibPpt().GroupShapeLocking_set_SelectionProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GroupShapeLocking_get_RotationProtection(self.Ptr)
        return ret
    ...
    def RotationProtection(self, value:bool):
        ...
        GetDllLibPpt().GroupShapeLocking_set_RotationProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GroupShapeLocking_get_AspectRatioProtection(self.Ptr)
        return ret
    ...
    def AspectRatioProtection(self, value:bool):
        ...
        GetDllLibPpt().GroupShapeLocking_set_AspectRatioProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GroupShapeLocking_get_PositionProtection(self.Ptr)
        return ret
    ...
    def PositionProtection(self, value:bool):
        ...
        GetDllLibPpt().GroupShapeLocking_set_PositionProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GroupShapeLocking_get_ResizeProtection(self.Ptr)
        return ret
    ...
    def ResizeProtection(self, value:bool):
        ...
        GetDllLibPpt().GroupShapeLocking_set_ResizeProtection(self.Ptr, value)
