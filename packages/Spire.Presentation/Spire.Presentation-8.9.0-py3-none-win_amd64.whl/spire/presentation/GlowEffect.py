...
class GlowEffect (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().GlowEffect_CreatGlowEffect()
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GlowEffect_get_Radius(self.Ptr)
        return ret

    @Radius.setter
    def Radius(self, value:float):
        GetDllLibPpt().GlowEffect_set_Radius.argtypes=[c_void_p, c_double]
        GetDllLibPpt().GlowEffect_set_Radius(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GlowEffect_get_ColorFormat(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().GlowEffect_Equals(self.Ptr, intPtrobj)
        return ret
