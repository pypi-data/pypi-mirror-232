...
class ChartTextArea (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartTextArea_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().ChartTextArea_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartTextArea_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartTextArea_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().ChartTextArea_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartTextArea_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartTextArea_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().ChartTextArea_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartTextArea_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartTextArea_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().ChartTextArea_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartTextArea_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartTextArea_get_IsOverlay(self.Ptr)
        return ret

    @IsOverlay.setter
    def IsOverlay(self, value:bool):
        GetDllLibPpt().ChartTextArea_set_IsOverlay.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartTextArea_set_IsOverlay(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartTextArea_get_TextProperties(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartTextArea_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartTextArea_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartTextArea_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartTextArea_get_Effect3D(self.Ptr)
