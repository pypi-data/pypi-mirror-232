...
class EffectStyleList (  IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().EffectStyleList_get_Count(self.Ptr)
        return ret
    ...
    <returns>Element at specified position.</returns>
        ...
        intPtr = GetDllLibPpt().EffectStyleList_get_Item(self.Ptr, index)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().EffectStyleList_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectStyleList_GetEnumerator(self.Ptr)
