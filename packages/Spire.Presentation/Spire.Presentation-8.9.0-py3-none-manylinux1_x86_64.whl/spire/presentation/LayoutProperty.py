...
<remarks>Applies only to Waterfall Charts</remarks>
        ...
        ret = GetDllLibPpt().LayoutProperty_get_ShowConnectorLines(self.Ptr)
        return ret
    ...
    def ShowConnectorLines(self, value:bool):
        ...
        GetDllLibPpt().LayoutProperty_set_ShowConnectorLines(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LayoutProperty_get_ShowMeanLine(self.Ptr)
        return ret

    @ShowMeanLine.setter
    def ShowMeanLine(self, value:bool):
        GetDllLibPpt().LayoutProperty_set_ShowMeanLine.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().LayoutProperty_set_ShowMeanLine(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LayoutProperty_get_ShowMeanMarkers(self.Ptr)
        return ret
    ...
    def ShowMeanMarkers(self, value:bool):
        ...
        GetDllLibPpt().LayoutProperty_set_ShowMeanMarkers(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LayoutProperty_get_ShowOutlierPoints(self.Ptr)
        return ret
    ...
    def ShowOutlierPoints(self, value:bool):
        ...
        GetDllLibPpt().LayoutProperty_set_ShowOutlierPoints(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LayoutProperty_get_ShowInnerPoints(self.Ptr)
        return ret
    ...
    def ShowInnerPoints(self, value:bool):
        ...
        GetDllLibPpt().LayoutProperty_set_ShowInnerPoints(self.Ptr, value)
...
<remarks>Applies only to Box and Whisker Charts</remarks>
        ...
        ret = GetDllLibPpt().LayoutProperty_get_QuartileCalculationType(self.Ptr)
    ...
    def QuartileCalculationType(self, value:'QuartileCalculation'):
        ...
        GetDllLibPpt().LayoutProperty_set_QuartileCalculationType(self.Ptr, value.value)
