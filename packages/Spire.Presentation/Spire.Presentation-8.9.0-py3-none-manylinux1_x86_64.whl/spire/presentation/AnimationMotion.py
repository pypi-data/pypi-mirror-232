...
class AnimationMotion (  CommonBehavior) :
    ...
    def From(self)->'PointF':
        ...
        intPtr = GetDllLibPpt().AnimationMotion_get_From(self.Ptr)
    ...
    def From(self, value:'PointF'):
        ...
        GetDllLibPpt().AnimationMotion_set_From(self.Ptr, value.Ptr)
    ...
    def To(self)->'PointF':
        ...
        intPtr = GetDllLibPpt().AnimationMotion_get_To(self.Ptr)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def To(self, value:'PointF'):
        ...
        GetDllLibPpt().AnimationMotion_set_To(self.Ptr, value.Ptr)
    ...
    def By(self)->'PointF':
        ...
        intPtr = GetDllLibPpt().AnimationMotion_get_By(self.Ptr)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def By(self, value:'PointF'):
        ...
        GetDllLibPpt().AnimationMotion_set_By(self.Ptr, value.Ptr)
    ...
    def RotationCenter(self)->'PointF':
        ...
        intPtr = GetDllLibPpt().AnimationMotion_get_RotationCenter(self.Ptr)
        ret = None if intPtr==None else PointF(intPtr)
        return ret
    ...
    def RotationCenter(self, value:'PointF'):
        ...
        GetDllLibPpt().AnimationMotion_set_RotationCenter(self.Ptr, value.Ptr)
    ...
    def Origin(self)->'AnimationMotionOrigin':
        ...
        ret = GetDllLibPpt().AnimationMotion_get_Origin(self.Ptr)
    ...
    def Origin(self, value:'AnimationMotionOrigin'):
        ...
        GetDllLibPpt().AnimationMotion_set_Origin(self.Ptr, value.value)
    ...
    def Path(self)->'MotionPath':
        ...
        intPtr = GetDllLibPpt().AnimationMotion_get_Path(self.Ptr)
    ...
    def Path(self, value:'MotionPath'):
        ...
        GetDllLibPpt().AnimationMotion_set_Path(self.Ptr, value.Ptr)
    ...
    def PathEditMode(self)->'AnimationMotionPathEditMode':
        ...
        ret = GetDllLibPpt().AnimationMotion_get_PathEditMode(self.Ptr)
    ...
    def PathEditMode(self, value:'AnimationMotionPathEditMode'):
        ...
        GetDllLibPpt().AnimationMotion_set_PathEditMode(self.Ptr, value.value)
    ...
    def RelativeAngle(self)->float:
        ...
        ret = GetDllLibPpt().AnimationMotion_get_RelativeAngle(self.Ptr)
        return ret
    ...
    def RelativeAngle(self, value:float):
        ...
        GetDllLibPpt().AnimationMotion_set_RelativeAngle(self.Ptr, value)
    ...
    def PointsType(self)->str:
        ...
        ret = PtrToStr(GetDllLibPpt().AnimationMotion_get_PointsType(self.Ptr))
        return ret
