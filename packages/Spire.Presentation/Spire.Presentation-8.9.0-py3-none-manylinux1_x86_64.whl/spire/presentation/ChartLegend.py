...
class ChartLegend (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartLegend_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().ChartLegend_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartLegend_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartLegend_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().ChartLegend_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartLegend_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartLegend_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().ChartLegend_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartLegend_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartLegend_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().ChartLegend_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartLegend_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartLegend_get_IsOverlay(self.Ptr)
        return ret

    @IsOverlay.setter
    def IsOverlay(self, value:bool):
        GetDllLibPpt().ChartLegend_set_IsOverlay.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartLegend_set_IsOverlay(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartLegend_get_Position(self.Ptr)
    ...
    def Position(self, value:'ChartLegendPositionType'):
        ...
        GetDllLibPpt().ChartLegend_set_Position(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartLegend_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartLegend_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartLegend_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartLegend_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartLegend_get_TextProperties(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().ChartLegend_setEntrys(self.Ptr, intPtrrange)
    ...
    <param name="index">The legend entry index must be between 0 and LegendCount - 1 + TrendLinesCount</param>
        ...
        GetDllLibPpt().ChartLegend_DeleteEntry(self.Ptr, index)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibPpt().ChartLegend_get_EntryTextProperties(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartLegend_get_LegendEntrys(self.Ptr)
