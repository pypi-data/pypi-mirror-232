...
class WheelSlideTransition (  Transition) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().WheelSlideTransition_get_Spokes(self.Ptr)
        return ret

    @Spokes.setter
    def Spokes(self, value:int):
        GetDllLibPpt().WheelSlideTransition_set_Spokes.argtypes=[c_void_p, c_int]
        GetDllLibPpt().WheelSlideTransition_set_Spokes(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().WheelSlideTransition_Equals(self.Ptr, intPtrobj)
        return ret
