...
class OuterShadowNode (  EffectNode) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_BlurRadius(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_Direction(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_Distance(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().OuterShadowNode_get_ShadowColor(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_RectangleAlign(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_SkewHorizontal(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_SkewVertical(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_RotateShadowWithShape(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_ScaleHorizontal(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowNode_get_ScaleVertical(self.Ptr)
        return ret
