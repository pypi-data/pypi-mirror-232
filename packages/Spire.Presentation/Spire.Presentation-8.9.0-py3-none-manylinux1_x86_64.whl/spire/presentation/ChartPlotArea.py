...
class ChartPlotArea (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartPlotArea_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartPlotArea_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartPlotArea_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartPlotArea_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartPlotArea_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().ChartPlotArea_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartPlotArea_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartPlotArea_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().ChartPlotArea_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartPlotArea_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartPlotArea_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().ChartPlotArea_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartPlotArea_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartPlotArea_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().ChartPlotArea_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartPlotArea_set_Height(self.Ptr, value)
