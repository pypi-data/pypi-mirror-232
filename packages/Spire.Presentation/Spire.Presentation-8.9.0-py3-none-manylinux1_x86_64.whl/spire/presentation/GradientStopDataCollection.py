...
class GradientStopDataCollection (  ICollection, IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GradientStopDataCollection_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GradientStopDataCollection_get_Item(self.Ptr, index)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().GradientStopDataCollection_GetEnumerator(self.Ptr)
...
#        GetDllLibPpt().GradientStopDataCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GradientStopDataCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GradientStopDataCollection_get_SyncRoot(self.Ptr)
