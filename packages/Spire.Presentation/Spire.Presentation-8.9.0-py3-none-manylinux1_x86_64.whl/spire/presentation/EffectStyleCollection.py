...
class EffectStyleCollection (  EffectStyleList, ICollection) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().EffectStyleCollection_Equals(self.Ptr, intPtrobj)
        return ret
...
#        GetDllLibPpt().EffectStyleCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().EffectStyleCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectStyleCollection_get_SyncRoot(self.Ptr)
