...
class InnerShadowEffect (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().InnerShadowEffect_CreatInnerShadowEffect()
    ...
    <summary>
        ...
        ret = GetDllLibPpt().InnerShadowEffect_get_BlurRadius(self.Ptr)
        return ret

    @BlurRadius.setter
    def BlurRadius(self, value:float):
        GetDllLibPpt().InnerShadowEffect_set_BlurRadius.argtypes=[c_void_p, c_double]
        GetDllLibPpt().InnerShadowEffect_set_BlurRadius(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().InnerShadowEffect_get_Direction(self.Ptr)
        return ret

    @Direction.setter
    def Direction(self, value:float):
        GetDllLibPpt().InnerShadowEffect_set_Direction.argtypes=[c_void_p, c_float]
        GetDllLibPpt().InnerShadowEffect_set_Direction(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().InnerShadowEffect_get_Distance(self.Ptr)
        return ret

    @Distance.setter
    def Distance(self, value:float):
        GetDllLibPpt().InnerShadowEffect_set_Distance.argtypes=[c_void_p, c_double]
        GetDllLibPpt().InnerShadowEffect_set_Distance(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().InnerShadowEffect_get_ColorFormat(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().InnerShadowEffect_Equals(self.Ptr, intPtrobj)
        return ret
