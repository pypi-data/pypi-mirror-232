...
class AnimationEffect (  PptObject) :
    ...
    <summary>
        ...
        intPtrArray = GetDllLibPpt().AnimationEffect_get_TimeNodeAudios(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationEffect_get_IterateTimeValue(self.Ptr)
        return ret
    ...
    def IterateTimeValue(self, value:float):
        ...
        GetDllLibPpt().AnimationEffect_set_IterateTimeValue(self.Ptr, value)
    ...
    def IterateType(self)->'AnimateType':
        ...
        ret = GetDllLibPpt().AnimationEffect_get_IterateType(self.Ptr)
    ...
    def IterateType(self, value:'AnimateType'):
        ...
        GetDllLibPpt().AnimationEffect_set_IterateType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationEffect_get_Effects(self.Ptr)
...
<summary></summary>
        ...
        intPtr = GetDllLibPpt().AnimationEffect_get_TextAnimation(self.Ptr)
    ...
    def GraphicAnimation(self)->'GraphicAnimation':
        ...
        intPtr = GetDllLibPpt().AnimationEffect_get_GraphicAnimation(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationEffect_get_ShapeTarget(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationEffect_get_PresetClassType(self.Ptr)
    ...
    def PresetClassType(self, value:'TimeNodePresetClassType'):
        ...
        GetDllLibPpt().AnimationEffect_set_PresetClassType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationEffect_get_AnimationEffectType(self.Ptr)
    ...
    def AnimationEffectType(self, value:'AnimationEffectType'):
        ...
        GetDllLibPpt().AnimationEffect_set_AnimationEffectType(self.Ptr, value.value)
    ...
    def Subtype(self)->'AnimationEffectSubtype':
        ...
        ret = GetDllLibPpt().AnimationEffect_get_Subtype(self.Ptr)
    ...
    def Subtype(self, value:'AnimationEffectSubtype'):
        ...
        GetDllLibPpt().AnimationEffect_set_Subtype(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationEffect_get_CommonBehaviorCollection(self.Ptr)
    ...
    def CommonBehaviorCollection(self, value:'CommonBehaviorCollection'):
        ...
        GetDllLibPpt().AnimationEffect_set_CommonBehaviorCollection(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationEffect_get_Timing(self.Ptr)
    ...
    def Timing(self, value:'Timing'):
        ...
        GetDllLibPpt().AnimationEffect_set_Timing(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationEffect_get_StartParagraph(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationEffect_get_EndParagraph(self.Ptr)
        ret = None if intPtr==None else TextParagraph(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().AnimationEffect_SetStartEndParagraphs(self.Ptr, startParaIndex,endParaIndex)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().AnimationEffect_Equals(self.Ptr, intPtrobj)
        return ret
