...
class OuterShadowEffect (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().OuterShadowEffect_Creat()
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_BlurRadius(self.Ptr)
        return ret

    @BlurRadius.setter
    def BlurRadius(self, value:float):
        GetDllLibPpt().OuterShadowEffect_set_BlurRadius.argtypes=[c_void_p, c_double]
        GetDllLibPpt().OuterShadowEffect_set_BlurRadius(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_Direction(self.Ptr)
        return ret

    @Direction.setter
    def Direction(self, value:float):
        GetDllLibPpt().OuterShadowEffect_set_Direction.argtypes=[c_void_p, c_float]
        GetDllLibPpt().OuterShadowEffect_set_Direction(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_Distance(self.Ptr)
        return ret

    @Distance.setter
    def Distance(self, value:float):
        GetDllLibPpt().OuterShadowEffect_set_Distance.argtypes=[c_void_p, c_double]
        GetDllLibPpt().OuterShadowEffect_set_Distance(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().OuterShadowEffect_get_ColorFormat(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_RectangleAlign(self.Ptr)
    ...
    def RectangleAlign(self, value:'RectangleAlignment'):
        ...
        GetDllLibPpt().OuterShadowEffect_set_RectangleAlign(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_HorizontalSkew(self.Ptr)
        return ret
    ...
    def HorizontalSkew(self, value:float):
        ...
        GetDllLibPpt().OuterShadowEffect_set_HorizontalSkew(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_VerticalSkew(self.Ptr)
        return ret

    @VerticalSkew.setter
    def VerticalSkew(self, value:float):
        GetDllLibPpt().OuterShadowEffect_set_VerticalSkew.argtypes=[c_void_p, c_float]
        GetDllLibPpt().OuterShadowEffect_set_VerticalSkew(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_RotateWithShape(self.Ptr)
        return ret
    ...
    def RotateWithShape(self, value:bool):
        ...
        GetDllLibPpt().OuterShadowEffect_set_RotateWithShape(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_HorizontalScalingFactor(self.Ptr)
        return ret
    ...
    def HorizontalScalingFactor(self, value:float):
        ...
        GetDllLibPpt().OuterShadowEffect_set_HorizontalScalingFactor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OuterShadowEffect_get_VerticalScalingFactor(self.Ptr)
        return ret
    ...
    def VerticalScalingFactor(self, value:float):
        ...
        GetDllLibPpt().OuterShadowEffect_set_VerticalScalingFactor(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().OuterShadowEffect_Equals(self.Ptr, intPtrobj)
        return ret
