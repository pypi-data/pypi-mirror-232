...
class SplitSlideTransition (  Transition) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SplitSlideTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionSplitDirection'):
        ...
        GetDllLibPpt().SplitSlideTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().SplitSlideTransition_Equals(self.Ptr, intPtrobj)
        return ret
