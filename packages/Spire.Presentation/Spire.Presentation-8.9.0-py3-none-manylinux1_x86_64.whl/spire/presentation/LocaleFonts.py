...
class LocaleFonts (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().LocaleFonts_get_LatinFont(self.Ptr)
    ...
    def LatinFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().LocaleFonts_set_LatinFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().LocaleFonts_get_EastAsianFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def EastAsianFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().LocaleFonts_set_EastAsianFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().LocaleFonts_get_ComplexScriptFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def ComplexScriptFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().LocaleFonts_set_ComplexScriptFont(self.Ptr, value.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().LocaleFonts_Equals(self.Ptr, intPtrobj)
        return ret
