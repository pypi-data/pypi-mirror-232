...
class SideDirectionTransition (  Transition) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SideDirectionTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionSideDirectionType'):
        ...
        GetDllLibPpt().SideDirectionTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().SideDirectionTransition_Equals(self.Ptr, intPtrobj)
        return ret
