...
class ISlide (SpireObject) :
    ...
    def Name(self, value:str):
        ...
        GetDllLibPpt().ISlide_set_Name(self.Ptr,valuePtr)
    ...
    <param name="fileFormat">convert to fileFormat.</param>
        ...
        GetDllLibPpt().ISlide_SaveToFile(self.Ptr,filePtr,enumfileFormat)
  ...
  <see cref="P:Spire.Presentation.Slide.NotesSlide" /> for this slide.</returns>
    ...
    <param name="dateTime"></param>
        ...
        GetDllLibPpt().ISlide_AddComment(self.Ptr, intPtrauthor,textPtr,intPtrposition,intPtrdateTime)
    ...
    <param name="string">text of comments to delete or "" to delete all comments.</param>
        ...
        GetDllLibPpt().ISlide_DeleteCommentAT(self.Ptr, intPtrauthor,textPtr)
    ...
    <param name="string">text of comments to delete or "" to delete all comments.</param>
        ...
        GetDllLibPpt().ISlide_DeleteCommentT(self.Ptr,textPtr)
...
#
    ...
    <param name="caseSensitive">case sensitive</param>
        ...
        GetDllLibPpt().ISlide_ReplaceFirstText(self.Ptr,matchedStringPtr,newValuePtr,caseSensitive)
    ...
    <param name="caseSensitive">case sensitive</param>
        ...
        GetDllLibPpt().ISlide_ReplaceAllText(self.Ptr,matchedStringPtr,newValuePtr,caseSensitive)
    ...
    def Title(self, value:str):
        ...
        GetDllLibPpt().ISlide_set_Title(self.Ptr,valuePtr)
...
#
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ISlide_FindFirstTextAsRange(self.Ptr,textPtr)
