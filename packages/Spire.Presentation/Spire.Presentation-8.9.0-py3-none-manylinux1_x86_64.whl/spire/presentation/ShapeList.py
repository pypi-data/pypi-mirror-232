...
class ShapeList (SpireObject) :
    ...
    <param name="htmlText">HTML text.</param>
        ...
        GetDllLibPpt().ShapeList_AddFromHtml(self.Ptr,htmlTextPtr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_SaveAsImageDpi(self.Ptr, shapeIndex,dpiX,dpiY)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_SaveAsEMF(self.Ptr, shapeIndex,filePathPtr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendOleObject(self.Ptr,objectNamePtr,intPtrobjectData,intPtrrectangle)
...
#
    ...
    <param name="rectangle">Rectangle should be inserted</param>
        ...
        GetDllLibPpt().ShapeList_InsertOleObject(self.Ptr, index,objectNamePtr,intPtrobjectData,intPtrrectangle)
...
#        GetDllLibPpt().ShapeList_InsertOleObjectIOOR(self.Ptr, index,objectName,arrayobjectData,intPtrrectangle)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendVideoMedia(self.Ptr,filePathPtr,intPtrrectangle)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendVideoMediaFRI(self.Ptr,filePathPtr,intPtrrectangle,isInnerLink)
        ret = None if intPtr==None else IVideo(intPtr)
        return ret
    ...
    <param name="rectangle">Rectangle should be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertVideoMedia(self.Ptr, index,filePathPtr,intPtrrectangle)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaFXYI(self.Ptr,filePathPtr,X,Y,isEmbed)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaFXY(self.Ptr,filePathPtr,X,Y)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaFRI(self.Ptr,filePathPtr,intPtrrectangle,isEmbed)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaFR(self.Ptr,filePathPtr,intPtrrectangle)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <param name="isEmbed">Whether embed or not,default not</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaIFRI(self.Ptr, index,filePathPtr,intPtrrectangle,isEmbed)
    ...
    <param name="rectangle">Rectangle should be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaIFR(self.Ptr, index,filePathPtr,intPtrrectangle)
    ...
    <param name="isEmbed">Whether embed or not,default not</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaIFXYI(self.Ptr, index,filePathPtr,X,Y,isEmbed)
    ...
    <param name="Y">Y Position</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaIFXY(self.Ptr, index,filePathPtr,X,Y)
...
#        GetDllLibPpt().ShapeList_ZOrderIS(self.Ptr, index,arrayshapes)
   ...
   # @dispatch
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendEmbedImageSFR(self.Ptr, enumshapeType,fileNamePtr,intPtrrectangle)
        ret = None if intPtr==None else IEmbedImage(intPtr)
        return ret
