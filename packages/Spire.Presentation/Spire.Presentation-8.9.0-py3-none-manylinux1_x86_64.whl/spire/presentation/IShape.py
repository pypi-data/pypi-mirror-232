...
class IShape (SpireObject) :
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibPpt().IShape_set_AlternativeText(self.Ptr,valuePtr)
    ...
    def AlternativeTitle(self, value:str):
        ...
        GetDllLibPpt().IShape_set_AlternativeTitle(self.Ptr,valuePtr)
    ...
    def Name(self, value:str):
        ...
        GetDllLibPpt().IShape_set_Name(self.Ptr,valuePtr)
    ...
    <param name="filepath">Video file path</param>
        ...
        GetDllLibPpt().IShape_InsertVideo(self.Ptr,filepathPtr)
    ...
    <param name="filepath">Picture file path</param>
        ...
        GetDllLibPpt().IShape_InsertPictureF(self.Ptr,filepathPtr)
    ...
    <summary>
        ...
        GetDllLibPpt().IShape_ReplaceTextWithRegex(self.Ptr, intPtrregex,newValuePtr)
