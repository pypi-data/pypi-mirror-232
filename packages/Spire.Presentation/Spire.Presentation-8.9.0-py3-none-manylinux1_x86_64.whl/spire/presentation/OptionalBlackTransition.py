...
class OptionalBlackTransition (  Transition) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OptionalBlackTransition_get_FromBlack(self.Ptr)
        return ret

    @FromBlack.setter
    def FromBlack(self, value:bool):
        GetDllLibPpt().OptionalBlackTransition_set_FromBlack.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().OptionalBlackTransition_set_FromBlack(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().OptionalBlackTransition_Equals(self.Ptr, intPtrobj)
        return ret
