...
#        GetDllLibPpt().ColumnCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ColumnCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ColumnCollection_get_SyncRoot(self.Ptr)
