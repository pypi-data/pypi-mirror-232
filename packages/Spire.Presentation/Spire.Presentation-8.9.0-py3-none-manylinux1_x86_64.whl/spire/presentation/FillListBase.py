...
class FillListBase (  IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FillListBase_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FillListBase_get_Item(self.Ptr, index)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().FillListBase_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().FillListBase_GetEnumerator(self.Ptr)
