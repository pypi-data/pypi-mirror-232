...
class MotionPath ( SpireObject ) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().MotionPath_CreateMotionPath()
    ...
    def __getitem__(self, key):
        ...
        intPtr = GetDllLibPpt().MotionPath_get_Item(self.Ptr, key)
    ...
    #    """
        ...
        ret = GetDllLibPpt().MotionPath_Add(self.Ptr, enumtype,arraypts,countpts,enumptsType,bRelativeCoord)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().MotionPath_get_Count(self.Ptr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().MotionPath_get_Item.argtypes=[c_void_p ,c_int]
        GetDllLibPpt().MotionPath_get_Item.restype=c_void_p
        intPtr = GetDllLibPpt().MotionPath_get_Item(self.Ptr, index)
        ret = None if intPtr==None else MotionCmdPath(intPtr)
        return ret
    ...
    <returns>Iterator.</returns>
        ...
        intPtr = GetDllLibPpt().MotionPath_GetEnumerator(self.Ptr)
