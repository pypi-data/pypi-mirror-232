...
class ChartSeriesDataFormat (  PptObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_MarkerFill(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_Distance(self.Ptr)
        return ret

    @Distance.setter
    def Distance(self, value:int):
        GetDllLibPpt().ChartSeriesDataFormat_set_Distance.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartSeriesDataFormat_set_Distance(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_IsSmooth(self.Ptr)
    ...
    def IsSmooth(self, value:'TriState'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_IsSmooth(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_MarkerSize(self.Ptr)
        return ret

    @MarkerSize.setter
    def MarkerSize(self, value:int):
        GetDllLibPpt().ChartSeriesDataFormat_set_MarkerSize.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartSeriesDataFormat_set_MarkerSize(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_MarkerStyle(self.Ptr)
    ...
    def MarkerStyle(self, value:'ChartMarkerType'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_MarkerStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_NamedRange(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_XValues(self.Ptr)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    def XValues(self, value:'CellRanges'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_XValues(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_ErrorBarsXFormat(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_ErrorBarsYFormat(self.Ptr)
        ret = None if intPtr==None else IErrorBarsFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_YValues(self.Ptr)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    def YValues(self, value:'CellRanges'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_YValues(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_Bubbles(self.Ptr)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    def Bubbles(self, value:'CellRanges'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_Bubbles(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_Values(self.Ptr)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    def Values(self, value:'CellRanges'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_Values(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_Type(self.Ptr)
    ...
    def Type(self, value:'ChartType'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_Index(self.Ptr)
        return ret

    @Index.setter
    def Index(self, value:int):
        GetDllLibPpt().ChartSeriesDataFormat_set_Index.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartSeriesDataFormat_set_Index(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_DataLabels(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_DataLabelRanges(self.Ptr)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    def DataLabelRanges(self, value:'CellRanges'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_DataLabelRanges(self.Ptr, value.Ptr)
    ...
    def TrendLines(self)->List['ITrendlines']:
        ...
        intPtrArray = GetDllLibPpt().ChartSeriesDataFormat_get_TrendLines(self.Ptr)
    ...
    def AddTrendLine(self ,type:'TrendlinesType')->'ITrendlines':
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_AddTrendLine(self.Ptr, enumtype)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_UseSecondAxis(self.Ptr)
        return ret
    ...
    def UseSecondAxis(self, value:bool):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_UseSecondAxis(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_DataPoints(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_IsVaryColor(self.Ptr)
        return ret

    @IsVaryColor.setter
    def IsVaryColor(self, value:bool):
        GetDllLibPpt().ChartSeriesDataFormat_set_IsVaryColor.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartSeriesDataFormat_set_IsVaryColor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_HasSeriesLines(self.Ptr)
        return ret
    ...
    def HasSeriesLines(self, value:bool):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_HasSeriesLines(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesDataFormat_get_FirstSliceAngleInPieChart(self.Ptr)
    ...
    def FirstSliceAngleInPieChart(self, value:'UInt16'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_FirstSliceAngleInPieChart(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_DoughnutHoleSize(self.Ptr)
        return ret
    ...
    def DoughnutHoleSize(self, value:int):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_DoughnutHoleSize(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_InvertIfNegative(self.Ptr)
        return ret
    ...
    def InvertIfNegative(self, value:bool):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_InvertIfNegative(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().ChartSeriesDataFormat_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartSeriesDataFormat_set_IsHidden(self.Ptr, value)
...
<remarks>Applies only to Waterfall Charts</remarks>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_ShowConnectorLines(self.Ptr)
        return ret
    ...
    def ShowConnectorLines(self, value:bool):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_ShowConnectorLines(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_ShowInnerPoints(self.Ptr)
        return ret
    ...
    def ShowInnerPoints(self, value:bool):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_ShowInnerPoints(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_ShowOutlierPoints(self.Ptr)
        return ret
    ...
    def ShowOutlierPoints(self, value:bool):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_ShowOutlierPoints(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_ShowMeanMarkers(self.Ptr)
        return ret
    ...
    def ShowMeanMarkers(self, value:bool):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_ShowMeanMarkers(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_ShowMeanLine(self.Ptr)
        return ret

    @ShowMeanLine.setter
    def ShowMeanLine(self, value:bool):
        GetDllLibPpt().ChartSeriesDataFormat_set_ShowMeanLine.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartSeriesDataFormat_set_ShowMeanLine(self.Ptr, value)
...
<remarks>Applies only to Box and Whisker Charts</remarks>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_QuartileCalculationType(self.Ptr)
    ...
    def QuartileCalculationType(self, value:'QuartileCalculation'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_QuartileCalculationType(self.Ptr, value.value)
...
<remarks>By Default the Label is overlapped</remarks>
        ...
        ret = GetDllLibPpt().ChartSeriesDataFormat_get_TreeMapLabelOption(self.Ptr)
    ...
    def TreeMapLabelOption(self, value:'TreeMapLabelOption'):
        ...
        GetDllLibPpt().ChartSeriesDataFormat_set_TreeMapLabelOption(self.Ptr, value.value)
