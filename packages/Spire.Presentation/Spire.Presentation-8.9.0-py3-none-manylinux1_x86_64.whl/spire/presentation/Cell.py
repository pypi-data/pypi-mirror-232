...
class Cell (  IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_OffsetX(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_OffsetY(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_FirstRowIndex(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_FirstColumnIndex(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_Width(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_Height(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_MinimalHeight(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderLeft(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderTop(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderRight(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderBottom(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderLeftDisplayColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderTopDisplayColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderRightDisplayColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderBottomDisplayColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderDiagonalDown(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_BorderDiagonalUp(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_FillFormat(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_MarginLeft(self.Ptr)
        return ret

    @MarginLeft.setter
    def MarginLeft(self, value:float):
        GetDllLibPpt().Cell_set_MarginLeft.argtypes=[c_void_p, c_double]
        GetDllLibPpt().Cell_set_MarginLeft(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_MarginRight(self.Ptr)
        return ret

    @MarginRight.setter
    def MarginRight(self, value:float):
        GetDllLibPpt().Cell_set_MarginRight.argtypes=[c_void_p, c_double]
        GetDllLibPpt().Cell_set_MarginRight(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_MarginTop(self.Ptr)
        return ret

    @MarginTop.setter
    def MarginTop(self, value:float):
        GetDllLibPpt().Cell_set_MarginTop.argtypes=[c_void_p, c_double]
        GetDllLibPpt().Cell_set_MarginTop(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_MarginBottom(self.Ptr)
        return ret

    @MarginBottom.setter
    def MarginBottom(self, value:float):
        GetDllLibPpt().Cell_set_MarginBottom.argtypes=[c_void_p, c_double]
        GetDllLibPpt().Cell_set_MarginBottom(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_VerticalTextType(self.Ptr)
    ...
    def VerticalTextType(self, value:'VerticalTextType'):
        ...
        GetDllLibPpt().Cell_set_VerticalTextType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_TextAnchorType(self.Ptr)
    ...
    def TextAnchorType(self, value:'TextAnchorType'):
        ...
        GetDllLibPpt().Cell_set_TextAnchorType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_AnchorCenter(self.Ptr)
        return ret

    @AnchorCenter.setter
    def AnchorCenter(self, value:bool):
        GetDllLibPpt().Cell_set_AnchorCenter.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().Cell_set_AnchorCenter(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_ColSpan(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Cell_get_RowSpan(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_TextFrame(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_Slide(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_Presentation(self.Ptr)
    ...
    <param name="ColunmCount">The number of cells being split in the colunm direction.</param>
        ...
        GetDllLibPpt().Cell_Split(self.Ptr, RowCount,ColunmCount)
    ...
    <summary>
        ...
        GetDllLibPpt().Cell_SplitBySpan(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Cell_get_DisplayColor(self.Ptr)
        ret = None if intPtr==None else Color(intPtr)
        return ret
