...
class PresetShadow (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().PresetShadow_CreatPresetShadow()
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PresetShadow_get_Direction(self.Ptr)
        return ret

    @Direction.setter
    def Direction(self, value:float):
        GetDllLibPpt().PresetShadow_set_Direction.argtypes=[c_void_p, c_float]
        GetDllLibPpt().PresetShadow_set_Direction(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PresetShadow_get_Distance(self.Ptr)
        return ret

    @Distance.setter
    def Distance(self, value:float):
        GetDllLibPpt().PresetShadow_set_Distance.argtypes=[c_void_p, c_double]
        GetDllLibPpt().PresetShadow_set_Distance(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PresetShadow_get_ColorFormat(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PresetShadow_get_Preset(self.Ptr)
    ...
    def Preset(self, value:'PresetShadowValue'):
        ...
        GetDllLibPpt().PresetShadow_set_Preset(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().PresetShadow_Equals(self.Ptr, intPtrobj)
        return ret
