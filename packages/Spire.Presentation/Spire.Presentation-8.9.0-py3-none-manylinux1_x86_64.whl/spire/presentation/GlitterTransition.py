...
class GlitterTransition (  Transition) :
    ...
    def Direction(self)->'GlitterTransitionDirection':
        ...
        ret = GetDllLibPpt().GlitterTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'GlitterTransitionDirection'):
        ...
        GetDllLibPpt().GlitterTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().GlitterTransition_Equals(self.Ptr, intPtrobj)
        return ret
