...
class SlideList (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideList_get_Count(self.Ptr)
        return ret
    ...
    def __getitem__(self, key):
        ...
        intPtr = GetDllLibPpt().SlideList_get_Item(self.Ptr, key)
    ...
    <summary>
        ...
        GetDllLibPpt().SlideList_get_Item.argtypes=[c_void_p ,c_int]
        GetDllLibPpt().SlideList_get_Item.restype=c_void_p
        intPtr = GetDllLibPpt().SlideList_get_Item(self.Ptr, index)
        ret = None if intPtr==None else ISlide(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().SlideList_Append(self.Ptr)
        ret = None if intPtr==None else ISlide(intPtr)
        return ret
    ...
    def AppendByLayoutType(self ,templateType:SlideLayoutType):
        ...
        intPtr = GetDllLibPpt().SlideList_AppendT(self.Ptr, enumtemplateType)
        ret = None if intPtr==None else ISlide(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideList_AppendS(self.Ptr, intPtrslide)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().SlideList_Insert(self.Ptr, index,intPtrslide)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().SlideList_InsertI(self.Ptr, index)
        ret = None if intPtr==None else ISlide(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().SlideList_InsertIT(self.Ptr, index,enumtemplateType)
        ret = None if intPtr==None else ISlide(intPtr)
        return ret
    ...
    def Append(self ,slide:ISlide,layout:ILayout)->int:
        ...
        ret = GetDllLibPpt().SlideList_AppendSL(self.Ptr, intPtrslide,intPtrlayout)
        return ret
    ...
    def Insert(self ,index:int,slide:ISlide,layout:ILayout):
        ...
        GetDllLibPpt().SlideList_InsertISL(self.Ptr, index,intPtrslide,intPtrlayout)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().SlideList_AppendSM(self.Ptr, intPtrslide,intPtrmaster)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().SlideList_InsertISM(self.Ptr, index,intPtrslide,intPtrmaster)
    ...
    <param name="value">The slide to remove from the collection.</param>
        ...
        GetDllLibPpt().SlideList_Remove(self.Ptr, intPtrvalue)
    ...
    <param name="index">The zero-based index of the element to remove.</param>
        ...
        GetDllLibPpt().SlideList_RemoveAt(self.Ptr, index)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().SlideList_GetEnumerator(self.Ptr)
...
#        intPtrArray = GetDllLibPpt().SlideList_ToArray(self.Ptr)
...
#        intPtrArray = GetDllLibPpt().SlideList_ToArraySC(self.Ptr, startIndex,count)
...
#        return ret
    ...
    <param name="OldIndex">move from.</param>
        ...
        GetDllLibPpt().SlideList_Move(self.Ptr, newIndex,OldIndex)
    ...
    def IndexOf(self ,slide:'ISlide')->int:
        ...
        ret = GetDllLibPpt().SlideList_IndexOf(self.Ptr, intPtrslide)
        return ret
