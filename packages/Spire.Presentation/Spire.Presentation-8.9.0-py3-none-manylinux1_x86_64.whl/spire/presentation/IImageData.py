...
class IImageData (SpireObject) :
    ...
    <returns>Hash code.</returns>
        ...
        ret = GetDllLibPpt().IImageData_GetHashCode(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IImageData_get_ContentType(self.Ptr))
        return ret
...
#        intPtrArray = GetDllLibPpt().IImageData_get_Data(self.Ptr)
...
#        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IImageData_get_Image(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IImageData_get_Width(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IImageData_get_Height(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IImageData_get_X(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IImageData_get_Y(self.Ptr)
        return ret
