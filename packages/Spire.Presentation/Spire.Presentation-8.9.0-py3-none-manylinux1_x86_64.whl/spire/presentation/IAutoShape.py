...
class IAutoShape (IShape) :
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibPpt().IAutoShape_set_AlternativeText(self.Ptr,valuePtr)
    ...
    def Name(self, value:str):
        ...
        GetDllLibPpt().IAutoShape_set_Name(self.Ptr,valuePtr)
    ...
    <param name="text">Default text for a new TextFrame.</param>
        ...
        GetDllLibPpt().IAutoShape_AppendTextFrame(self.Ptr,textPtr)
