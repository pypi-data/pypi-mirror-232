...
class WavAudioCollection (  ICollection, IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().WavAudioCollection_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().WavAudioCollection_get_Item(self.Ptr, index)
    ...
    <returns>Added audio.</returns>
        ...
        intPtr = GetDllLibPpt().WavAudioCollection_Append(self.Ptr, intPtraudioData)
        ret = None if intPtr==None else IAudioData(intPtr)
        return ret
    ...
    <returns>Added audio.</returns>
        ...
        intPtr = GetDllLibPpt().WavAudioCollection_AppendS(self.Ptr, intPtrstream)
        ret = None if intPtr==None else IAudioData(intPtr)
        return ret
...
#        intPtr = GetDllLibPpt().WavAudioCollection_AppendA(self.Ptr, arrayaudioData)
#        ret = None if intPtr==None else IAudioData(intPtr)
#        return ret
#
