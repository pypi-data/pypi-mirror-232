...
class Timing (  PptObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_Accelerate(self.Ptr)
        return ret

    @Accelerate.setter
    def Accelerate(self, value:float):
        GetDllLibPpt().Timing_set_Accelerate.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Timing_set_Accelerate(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_Decelerate(self.Ptr)
        return ret

    @Decelerate.setter
    def Decelerate(self, value:float):
        GetDllLibPpt().Timing_set_Decelerate.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Timing_set_Decelerate(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_AutoReverse(self.Ptr)
        return ret

    @AutoReverse.setter
    def AutoReverse(self, value:bool):
        GetDllLibPpt().Timing_set_AutoReverse.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().Timing_set_AutoReverse(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_Duration(self.Ptr)
        return ret

    @Duration.setter
    def Duration(self, value:float):
        GetDllLibPpt().Timing_set_Duration.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Timing_set_Duration(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_RepeatCount(self.Ptr)
        return ret

    @RepeatCount.setter
    def RepeatCount(self, value:float):
        GetDllLibPpt().Timing_set_RepeatCount.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Timing_set_RepeatCount(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_Restart(self.Ptr)
    ...
    def Restart(self, value:'AnimationRestartType'):
        ...
        GetDllLibPpt().Timing_set_Restart(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_Speed(self.Ptr)
        return ret

    @Speed.setter
    def Speed(self, value:float):
        GetDllLibPpt().Timing_set_Speed.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Timing_set_Speed(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_TriggerDelayTime(self.Ptr)
        return ret
    ...
    def TriggerDelayTime(self, value:float):
        ...
        GetDllLibPpt().Timing_set_TriggerDelayTime(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_TriggerType(self.Ptr)
    ...
    def TriggerType(self, value:'AnimationTriggerType'):
        ...
        GetDllLibPpt().Timing_set_TriggerType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Timing_get_AnimationRepeatType(self.Ptr)
    ...
    def AnimationRepeatType(self, value:'AnimationRepeatType'):
        ...
        GetDllLibPpt().Timing_set_AnimationRepeatType(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().Timing_Equals(self.Ptr, intPtrobj)
        return ret
