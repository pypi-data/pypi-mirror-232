...
class LinearGradientFill (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LinearGradientFill_get_Angle(self.Ptr)
        return ret

    @Angle.setter
    def Angle(self, value:float):
        GetDllLibPpt().LinearGradientFill_set_Angle.argtypes=[c_void_p, c_float]
        GetDllLibPpt().LinearGradientFill_set_Angle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LinearGradientFill_get_IsScaled(self.Ptr)
    ...
    def IsScaled(self, value:'TriState'):
        ...
        GetDllLibPpt().LinearGradientFill_set_IsScaled(self.Ptr, value.value)
