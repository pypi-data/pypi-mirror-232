...
class ParagraphProperties (  PptObject, IActiveSlide) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_Depth(self.Ptr)
        return ret
    ...
    def Depth(self, value:'int'):
        ...
        GetDllLibPpt().ParagraphProperties_set_Depth(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_BulletType(self.Ptr)
    ...
    def BulletType(self, value:'TextBulletType'):
        ...
        GetDllLibPpt().ParagraphProperties_set_BulletType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_BulletChar(self.Ptr)
        return ret

    @BulletChar.setter
    def BulletChar(self, value:int):
        GetDllLibPpt().ParagraphProperties_set_BulletChar.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ParagraphProperties_set_BulletChar(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ParagraphProperties_get_BulletFont(self.Ptr)
    ...
    def BulletFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().ParagraphProperties_set_BulletFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_BulletSize(self.Ptr)
        return ret

    @BulletSize.setter
    def BulletSize(self, value:float):
        GetDllLibPpt().ParagraphProperties_set_BulletSize.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ParagraphProperties_set_BulletSize(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ParagraphProperties_get_ParagraphBulletColor(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_BulletNumber(self.Ptr)
        return ret
    ...
    def BulletNumber(self, value:'int'):
        ...
        GetDllLibPpt().ParagraphProperties_set_BulletNumber(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_BulletStyle(self.Ptr)
    ...
    def BulletStyle(self, value:'NumberedBulletStyle'):
        ...
        GetDllLibPpt().ParagraphProperties_set_BulletStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'TextAlignmentType'):
        ...
        GetDllLibPpt().ParagraphProperties_set_Alignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_LineSpacing(self.Ptr)
        return ret

    @LineSpacing.setter
    def LineSpacing(self, value:float):
        GetDllLibPpt().ParagraphProperties_set_LineSpacing.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ParagraphProperties_set_LineSpacing(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_SpaceBefore(self.Ptr)
        return ret

    @SpaceBefore.setter
    def SpaceBefore(self, value:float):
        GetDllLibPpt().ParagraphProperties_set_SpaceBefore.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ParagraphProperties_set_SpaceBefore(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_SpaceAfter(self.Ptr)
        return ret

    @SpaceAfter.setter
    def SpaceAfter(self, value:float):
        GetDllLibPpt().ParagraphProperties_set_SpaceAfter.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ParagraphProperties_set_SpaceAfter(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_EastAsianLineBreak(self.Ptr)
    ...
    def EastAsianLineBreak(self, value:'TriState'):
        ...
        GetDllLibPpt().ParagraphProperties_set_EastAsianLineBreak(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_RightToLeft(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def RightToLeft(self, value:'TriState'):
        ...
        GetDllLibPpt().ParagraphProperties_set_RightToLeft(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_LatinLineBreak(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def LatinLineBreak(self, value:'TriState'):
        ...
        GetDllLibPpt().ParagraphProperties_set_LatinLineBreak(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_HangingPunctuation(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def HangingPunctuation(self, value:'TriState'):
        ...
        GetDllLibPpt().ParagraphProperties_set_HangingPunctuation(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_LeftMargin(self.Ptr)
        return ret

    @LeftMargin.setter
    def LeftMargin(self, value:float):
        GetDllLibPpt().ParagraphProperties_set_LeftMargin.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ParagraphProperties_set_LeftMargin(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_RightMargin(self.Ptr)
        return ret

    @RightMargin.setter
    def RightMargin(self, value:float):
        GetDllLibPpt().ParagraphProperties_set_RightMargin.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ParagraphProperties_set_RightMargin(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_Indent(self.Ptr)
        return ret

    @Indent.setter
    def Indent(self, value:float):
        GetDllLibPpt().ParagraphProperties_set_Indent.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ParagraphProperties_set_Indent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_DefaultTabSize(self.Ptr)
        return ret
    ...
    def DefaultTabSize(self, value:float):
        ...
        GetDllLibPpt().ParagraphProperties_set_DefaultTabSize(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ParagraphProperties_get_Tabs(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_FontAlignment(self.Ptr)
    ...
    def FontAlignment(self, value:'FontAlignmentType'):
        ...
        GetDllLibPpt().ParagraphProperties_set_FontAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ParagraphProperties_get_BulletPicture(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ParagraphProperties_get_DefaultCharacterProperties(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_HasBullet(self.Ptr)
        return ret
    ...
    def CustomBulletColor(self)->bool:
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_CustomBulletColor(self.Ptr)
        return ret
    ...
    def CustomBulletColor(self, value:bool):
        ...
        GetDllLibPpt().ParagraphProperties_set_CustomBulletColor(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ParagraphProperties_get_BulletColor(self.Ptr)
        ret = None if intPtr==None else ColorFormat(intPtr)
        return ret
    ...
    def CustomBulletFont(self)->bool:
        ...
        ret = GetDllLibPpt().ParagraphProperties_get_CustomBulletFont(self.Ptr)
        return ret
    ...
    def CustomBulletFont(self, value:bool):
        ...
        GetDllLibPpt().ParagraphProperties_set_CustomBulletFont(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ParagraphProperties_Equals(self.Ptr, intPtrobj)
        return ret
