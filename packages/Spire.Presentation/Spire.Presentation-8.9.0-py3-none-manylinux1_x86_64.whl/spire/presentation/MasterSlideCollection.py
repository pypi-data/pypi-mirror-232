...
#        GetDllLibPpt().MasterSlideCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().MasterSlideCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().MasterSlideCollection_get_SyncRoot(self.Ptr)
