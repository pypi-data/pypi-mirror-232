...
class BlendEffect ( IActiveSlide ) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().BlendEffect_get_Radius(self.Ptr)
        return ret

    @Radius.setter
    def Radius(self, value:float):
        GetDllLibPpt().BlendEffect_set_Radius.argtypes=[c_void_p, c_double]
        GetDllLibPpt().BlendEffect_set_Radius(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().BlendEffect_get_IsGrow(self.Ptr)
        return ret

    @IsGrow.setter
    def IsGrow(self, value:bool):
        GetDllLibPpt().BlendEffect_set_IsGrow.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().BlendEffect_set_IsGrow(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().BlendEffect_Equals(self.Ptr, intPtrobj)
        return ret
