...
class TextLineFormatList (  IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextLineFormatList_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextLineFormatList_get_Item(self.Ptr, index)
  ...
  <see cref="T:System.Collections.IEnumerator" /> for an entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().TextLineFormatList_GetEnumerator(self.Ptr)
