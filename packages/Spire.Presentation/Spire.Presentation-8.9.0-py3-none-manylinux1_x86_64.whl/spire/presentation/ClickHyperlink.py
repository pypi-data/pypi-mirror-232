...
class ClickHyperlink (SpireObject) :
    ...
    def __init__(self,hyperlinkUrl:str):
        ...
        GetDllLibPpt().ClickHyperlink_Create.restype = c_void_p
        intPtr = GetDllLibPpt().ClickHyperlink_Create(hyperlinkUrlPtr)
        super(ClickHyperlink, self).__init__(intPtr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_GetOtherPowerPointPresentation(filePathPtr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_GetOtherFiles(filePathPtr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def Address(self, value:str):
        ...
        GetDllLibPpt().ClickHyperlink_set_Address(self.Ptr,valuePtr)
    ...
    def InvalidUrl(self, value:str):
        ...
        GetDllLibPpt().ClickHyperlink_set_InvalidUrl(self.Ptr,valuePtr)
    ...
    def Action(self, value:str):
        ...
        GetDllLibPpt().ClickHyperlink_set_Action(self.Ptr,valuePtr)
    ...
    def TargetFrame(self, value:str):
        ...
        GetDllLibPpt().ClickHyperlink_set_TargetFrame(self.Ptr,valuePtr)
    ...
    def Tooltip(self, value:str):
        ...
        GetDllLibPpt().ClickHyperlink_set_Tooltip(self.Ptr,valuePtr)
