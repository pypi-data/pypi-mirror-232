...
class ChartDataTable (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataTable_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataTable_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataTable_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataTable_get_Text(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataTable_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataTable_get_HasHorzBorder(self.Ptr)
        return ret
    ...
    def HasHorzBorder(self, value:bool):
        ...
        GetDllLibPpt().ChartDataTable_set_HasHorzBorder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataTable_get_HasBorders(self.Ptr)
        return ret

    @HasBorders.setter
    def HasBorders(self, value:bool):
        GetDllLibPpt().ChartDataTable_set_HasBorders.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartDataTable_set_HasBorders(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataTable_get_HasVertBorder(self.Ptr)
        return ret
    ...
    def HasVertBorder(self, value:bool):
        ...
        GetDllLibPpt().ChartDataTable_set_HasVertBorder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataTable_get_ShowLegendKey(self.Ptr)
        return ret
    ...
    def ShowLegendKey(self, value:bool):
        ...
        GetDllLibPpt().ChartDataTable_set_ShowLegendKey(self.Ptr, value)
