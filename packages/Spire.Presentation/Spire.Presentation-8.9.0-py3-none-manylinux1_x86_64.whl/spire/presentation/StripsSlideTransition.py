...
class StripsSlideTransition (  Transition) :
    ...
    def Direction(self)->'TransitionCornerDirection':
        ...
        ret = GetDllLibPpt().StripsSlideTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionCornerDirection'):
        ...
        GetDllLibPpt().StripsSlideTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().StripsSlideTransition_Equals(self.Ptr, intPtrobj)
        return ret
