...
class IOleObject (SpireObject) :
    ...
    def ObjectName(self, value:str):
        ...
        GetDllLibPpt().IOleObject_set_ObjectName(self.Ptr,valuePtr)
    ...
    def ProgId(self, value:str):
        ...
        GetDllLibPpt().IOleObject_set_ProgId(self.Ptr,valuePtr)
    ...
    def LinkFilePath(self, value:str):
        ...
        GetDllLibPpt().IOleObject_set_LinkFilePath(self.Ptr,valuePtr)
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibPpt().IOleObject_set_AlternativeText(self.Ptr,valuePtr)
    ...
    def Name(self, value:str):
        ...
        GetDllLibPpt().IOleObject_set_Name(self.Ptr,valuePtr)
