...
class ShapeCollection (  ShapeList) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ShapeCollection_Equals(self.Ptr, intPtrobj)
        return ret
...
#        GetDllLibPpt().ShapeCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeCollection_get_SyncRoot(self.Ptr)
