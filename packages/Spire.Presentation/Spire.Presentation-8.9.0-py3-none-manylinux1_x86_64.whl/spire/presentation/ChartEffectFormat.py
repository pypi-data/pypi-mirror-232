...
class ChartEffectFormat (  PptObject, IChartEffectFormat) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartEffectFormat_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartEffectFormat_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartEffectFormat_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartEffectFormat_get_Effect3D(self.Ptr)
