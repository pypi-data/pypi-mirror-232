...
class TextParagraphProperties (  IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraphProperties_get_Level(self.Ptr)
    ...
    def Level(self, value:'Int16'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_Level(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_TextTextBulletType(self.Ptr)
    ...
    def TextTextBulletType(self, value:'TextBulletType'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_TextTextBulletType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_BulletChar(self.Ptr)
        return ret

    @BulletChar.setter
    def BulletChar(self, value:int):
        GetDllLibPpt().TextParagraphProperties_set_BulletChar.argtypes=[c_void_p, c_int]
        GetDllLibPpt().TextParagraphProperties_set_BulletChar(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraphProperties_get_BulletFont(self.Ptr)
    ...
    def BulletFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_BulletFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_BulletSize(self.Ptr)
        return ret

    @BulletSize.setter
    def BulletSize(self, value:float):
        GetDllLibPpt().TextParagraphProperties_set_BulletSize.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextParagraphProperties_set_BulletSize(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraphProperties_get_BulletColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraphProperties_get_NumberedBulletStartWith(self.Ptr)
        ret = None if intPtr==None else Int16(intPtr)
        return ret
    ...
    def NumberedBulletStartWith(self, value:'Int16'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_NumberedBulletStartWith(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_NumberedBulletStyle(self.Ptr)
    ...
    def NumberedBulletStyle(self, value:'NumberedBulletStyle'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_NumberedBulletStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'TextAlignmentType'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_Alignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_LineSpacing(self.Ptr)
        return ret

    @LineSpacing.setter
    def LineSpacing(self, value:float):
        GetDllLibPpt().TextParagraphProperties_set_LineSpacing.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextParagraphProperties_set_LineSpacing(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_SpaceBefore(self.Ptr)
        return ret

    @SpaceBefore.setter
    def SpaceBefore(self, value:float):
        GetDllLibPpt().TextParagraphProperties_set_SpaceBefore.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextParagraphProperties_set_SpaceBefore(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_SpaceAfter(self.Ptr)
        return ret

    @SpaceAfter.setter
    def SpaceAfter(self, value:float):
        GetDllLibPpt().TextParagraphProperties_set_SpaceAfter.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextParagraphProperties_set_SpaceAfter(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_EastAsianLineBreak(self.Ptr)
    ...
    def EastAsianLineBreak(self, value:'TriState'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_EastAsianLineBreak(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_RightToLeft(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def RightToLeft(self, value:'TriState'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_RightToLeft(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_LatinLineBreak(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def LatinLineBreak(self, value:'TriState'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_LatinLineBreak(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_HangingPunctuation(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def HangingPunctuation(self, value:'TriState'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_HangingPunctuation(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_LeftMargin(self.Ptr)
        return ret

    @LeftMargin.setter
    def LeftMargin(self, value:float):
        GetDllLibPpt().TextParagraphProperties_set_LeftMargin.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextParagraphProperties_set_LeftMargin(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_RightMargin(self.Ptr)
        return ret

    @RightMargin.setter
    def RightMargin(self, value:float):
        GetDllLibPpt().TextParagraphProperties_set_RightMargin.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextParagraphProperties_set_RightMargin(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_Indent(self.Ptr)
        return ret

    @Indent.setter
    def Indent(self, value:float):
        GetDllLibPpt().TextParagraphProperties_set_Indent.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextParagraphProperties_set_Indent(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_DefaultTabSize(self.Ptr)
        return ret
    ...
    def DefaultTabSize(self, value:float):
        ...
        GetDllLibPpt().TextParagraphProperties_set_DefaultTabSize(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraphProperties_get_TabStopsList(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_FontAlignment(self.Ptr)
    ...
    def FontAlignment(self, value:'FontAlignmentType'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_FontAlignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraphProperties_get_DefaultTextRangeProperties(self.Ptr)
    ...
    def CustomBulletColor(self)->bool:
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_CustomBulletColor(self.Ptr)
        return ret
    ...
    def CustomBulletColor(self, value:bool):
        ...
        GetDllLibPpt().TextParagraphProperties_set_CustomBulletColor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextParagraphProperties_get_IsBulletInheritFont(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def IsBulletInheritFont(self, value:'TriState'):
        ...
        GetDllLibPpt().TextParagraphProperties_set_IsBulletInheritFont(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextParagraphProperties_Equals(self.Ptr, intPtrobj)
        return ret
