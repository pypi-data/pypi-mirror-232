...
class EffectStyle (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectStyle_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().EffectStyle_get_FormatThreeDFormat(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().EffectStyle_Equals(self.Ptr, intPtrobj)
        return ret
