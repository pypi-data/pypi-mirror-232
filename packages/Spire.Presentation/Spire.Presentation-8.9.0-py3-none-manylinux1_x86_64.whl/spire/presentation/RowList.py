...
class RowList (  SpireObject ) :
    ...
    def __getitem__(self, key):
        ...
        intPtr = GetDllLibPpt().RowList_get_Item(self.Ptr, key)
    ...
    <summary>
        ...
        GetDllLibPpt().RowList_get_Item.argtypes=[c_void_p ,c_int]
        GetDllLibPpt().RowList_get_Item.restype=c_void_p
        intPtr = GetDllLibPpt().RowList_get_Item(self.Ptr, index)
        ret = None if intPtr==None else TableRow(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibPpt().RowList_Append(self.Ptr, intPtrrow)
        return ret
    ...
    <param name="row"></param>
        ...
        GetDllLibPpt().RowList_Insert(self.Ptr, index,intPtrrow)
    ...
    <param name="withAttachedRows">True to delete also all attached rows.</param>
        ...
        GetDllLibPpt().RowList_RemoveAt(self.Ptr, firstRowIndex,withAttachedRows)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().RowList_get_Count(self.Ptr)
        return ret
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().RowList_GetEnumerator(self.Ptr)
