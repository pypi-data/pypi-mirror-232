...
class ZoomSlideTransition (  Transition) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ZoomSlideTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionInOutDirection'):
        ...
        GetDllLibPpt().ZoomSlideTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ZoomSlideTransition_Equals(self.Ptr, intPtrobj)
        return ret
