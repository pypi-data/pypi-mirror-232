...
class IChartEffectFormat (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartEffectFormat_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartEffectFormat_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartEffectFormat_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartEffectFormat_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChartEffectFormat_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IChartEffectFormat_Dispose(self.Ptr)
