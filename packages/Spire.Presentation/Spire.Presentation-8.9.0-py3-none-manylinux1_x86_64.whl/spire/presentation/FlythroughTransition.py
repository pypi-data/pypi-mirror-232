...
class FlythroughTransition (  Transition) :
    ...
    def Direction(self)->'TransitionFlythroughInOutDirection':
        ...
        ret = GetDllLibPpt().FlythroughTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionFlythroughInOutDirection'):
        ...
        GetDllLibPpt().FlythroughTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().FlythroughTransition_Equals(self.Ptr, intPtrobj)
        return ret
