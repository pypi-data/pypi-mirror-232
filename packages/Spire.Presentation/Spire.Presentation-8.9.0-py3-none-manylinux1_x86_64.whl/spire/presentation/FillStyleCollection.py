...
class FillStyleCollection (  FillStyleList, ICollection) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().FillStyleCollection_Equals(self.Ptr, intPtrobj)
        return ret
...
#        GetDllLibPpt().FillStyleCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().FillStyleCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FillStyleCollection_get_SyncRoot(self.Ptr)
