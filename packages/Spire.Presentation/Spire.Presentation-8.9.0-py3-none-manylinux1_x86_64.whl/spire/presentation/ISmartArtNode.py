...
class ISmartArtNode (SpireObject) :
    ...
    def ChildNodes(self)->'ISmartArtNodeCollection':
        ...
        intPtr = GetDllLibPpt().ISmartArtNode_get_ChildNodes(self.Ptr)
    ...
    def TextFrame(self)->'ITextFrameProperties':
        ...
        intPtr = GetDllLibPpt().ISmartArtNode_get_TextFrame(self.Ptr)
    ...
    def TextFrame(self, value:'ITextFrameProperties'):
        ...
        GetDllLibPpt().ISmartArtNode_set_TextFrame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISmartArtNode_get_Line(self.Ptr)
    ...
    def LinkLine(self)->'TextLineFormat':
        ...
        intPtr = GetDllLibPpt().ISmartArtNode_get_LinkLine(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    def CustomText(self)->bool:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_CustomText(self.Ptr)
        return ret

    @CustomText.setter
    def CustomText(self, value:bool):
        GetDllLibPpt().ISmartArtNode_set_CustomText.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ISmartArtNode_set_CustomText(self.Ptr, value)
    ...
    def IsAssistant(self)->bool:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_IsAssistant(self.Ptr)
        return ret

    @IsAssistant.setter
    def IsAssistant(self, value:bool):
        GetDllLibPpt().ISmartArtNode_set_IsAssistant.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ISmartArtNode_set_IsAssistant(self.Ptr, value)
    ...
    def Level(self)->int:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_Level(self.Ptr)
        return ret
    ...
    def Position(self)->int:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_Position(self.Ptr)
        return ret

    @Position.setter
    def Position(self, value:int):
        GetDllLibPpt().ISmartArtNode_set_Position.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ISmartArtNode_set_Position(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISmartArtNode_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().ISmartArtNode_set_Click(self.Ptr, value.Ptr)
    ...
    def NodeHeight(self)->int:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_NodeHeight(self.Ptr)
        return ret

    @NodeHeight.setter
    def NodeHeight(self, value:int):
        GetDllLibPpt().ISmartArtNode_set_NodeHeight.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ISmartArtNode_set_NodeHeight(self.Ptr, value)
    ...
    def NodeWidth(self)->int:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_NodeWidth(self.Ptr)
        return ret

    @NodeWidth.setter
    def NodeWidth(self, value:int):
        GetDllLibPpt().ISmartArtNode_set_NodeWidth.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ISmartArtNode_set_NodeWidth(self.Ptr, value)
    ...
    def NodeX(self)->int:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_NodeX(self.Ptr)
        return ret

    @NodeX.setter
    def NodeX(self, value:int):
        GetDllLibPpt().ISmartArtNode_set_NodeX.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ISmartArtNode_set_NodeX(self.Ptr, value)
    ...
    def NodeY(self)->int:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_NodeY(self.Ptr)
        return ret

    @NodeY.setter
    def NodeY(self, value:int):
        GetDllLibPpt().ISmartArtNode_set_NodeY.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ISmartArtNode_set_NodeY(self.Ptr, value)
    ...
    def TrChanged(self)->bool:
        ...
        ret = GetDllLibPpt().ISmartArtNode_get_TrChanged(self.Ptr)
        return ret

    @TrChanged.setter
    def TrChanged(self, value:bool):
        GetDllLibPpt().ISmartArtNode_set_TrChanged.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ISmartArtNode_set_TrChanged(self.Ptr, value)
    ...
    def FillFormat(self)->'FillFormat':
        ...
        intPtr = GetDllLibPpt().ISmartArtNode_get_FillFormat(self.Ptr)
    ...
    def FillFormat(self, value:'FillFormat'):
        ...
        GetDllLibPpt().ISmartArtNode_set_FillFormat(self.Ptr, value.Ptr)
