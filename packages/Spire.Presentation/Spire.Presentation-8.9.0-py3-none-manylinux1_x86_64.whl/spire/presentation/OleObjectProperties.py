...
class OleObjectProperties (  ICollection, IEnumerable) :
    ...
    <param name="value">The alue of the property.</param>
        ...
        GetDllLibPpt().OleObjectProperties_Add(self.Ptr,namePtr,valuePtr)
    ...
    <param name="name">The name of property to remove.</param>
        ...
        GetDllLibPpt().OleObjectProperties_Remove(self.Ptr,namePtr)
    ...
    def set_Item(self ,name:str,value:str):
        ...
        GetDllLibPpt().OleObjectProperties_set_Item(self.Ptr,namePtr,valuePtr)
