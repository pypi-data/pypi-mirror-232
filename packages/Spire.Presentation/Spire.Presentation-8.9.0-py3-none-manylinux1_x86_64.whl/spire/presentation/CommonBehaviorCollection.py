...
class CommonBehaviorCollection (  SpireObject) :
    ...
    def __getitem__(self, key):
        ...
        intPtrWithTypeName = GetDllLibPpt().CommonBehaviorCollection_get_Item(self.Ptr, key)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CommonBehaviorCollection_get_Count(self.Ptr)
        return ret
    ...
    <returns>Index of a new behavior in a collection.</returns>
        ...
        ret = GetDllLibPpt().CommonBehaviorCollection_Append(self.Ptr, intPtritem)
        return ret
    ...
    <param name="item">Behavior to insert.</param>
        ...
        GetDllLibPpt().CommonBehaviorCollection_Insert(self.Ptr, index,intPtritem)
    ...
    <param name="item">Behavior to remove.</param>
        ...
        GetDllLibPpt().CommonBehaviorCollection_Remove(self.Ptr, intPtritem)
    ...
    <param name="index">Index of a behavior to remove.</param>
        ...
        GetDllLibPpt().CommonBehaviorCollection_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibPpt().CommonBehaviorCollection_Clear(self.Ptr)
    ...
    <returns>Animation begavior.</returns>
        ...
        intPtr = GetDllLibPpt().CommonBehaviorCollection_get_Item(self.Ptr, index)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().CommonBehaviorCollection_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <returns>Iterator.</returns>
        ...
        intPtr = GetDllLibPpt().CommonBehaviorCollection_GetEnumerator(self.Ptr)
