...
class IVideo (  IShape) :
    ...
    def LinkPathLong(self, value:str):
        ...
        GetDllLibPpt().IVideo_set_LinkPathLong(self.Ptr,valuePtr)
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibPpt().IVideo_set_AlternativeText(self.Ptr,valuePtr)
    ...
    def Name(self, value:str):
        ...
        GetDllLibPpt().IVideo_set_Name(self.Ptr,valuePtr)
