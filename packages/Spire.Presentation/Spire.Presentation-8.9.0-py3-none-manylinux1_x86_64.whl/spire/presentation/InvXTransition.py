...
class InvXTransition (  Transition) :
    ...
    def IsNotDefaultXDirection(self)->bool:
        ...
        ret = GetDllLibPpt().InvXTransition_get_IsNotDefaultXDirection(self.Ptr)
        return ret
    ...
    def IsNotDefaultXDirection(self, value:bool):
        ...
        GetDllLibPpt().InvXTransition_set_IsNotDefaultXDirection(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().InvXTransition_Equals(self.Ptr, intPtrobj)
        return ret
