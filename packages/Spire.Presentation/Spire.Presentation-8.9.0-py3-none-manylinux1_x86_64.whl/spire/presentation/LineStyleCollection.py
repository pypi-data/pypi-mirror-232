...
class LineStyleCollection (  LineStyleList, ICollection) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().LineStyleCollection_Equals(self.Ptr, intPtrobj)
        return ret
...
#        GetDllLibPpt().LineStyleCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LineStyleCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().LineStyleCollection_get_SyncRoot(self.Ptr)
