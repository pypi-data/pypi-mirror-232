...
class TextRangeCollection (  TextRangeList) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextRangeCollection_Equals(self.Ptr, intPtrobj)
        return ret
...
#        GetDllLibPpt().TextRangeCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextRangeCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextRangeCollection_get_SyncRoot(self.Ptr)
