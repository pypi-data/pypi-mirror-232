...
class GradientStop (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GradientStop_get_Position(self.Ptr)
        return ret

    @Position.setter
    def Position(self, value:float):
        GetDllLibPpt().GradientStop_set_Position.argtypes=[c_void_p, c_float]
        GetDllLibPpt().GradientStop_set_Position(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GradientStop_get_Color(self.Ptr)
