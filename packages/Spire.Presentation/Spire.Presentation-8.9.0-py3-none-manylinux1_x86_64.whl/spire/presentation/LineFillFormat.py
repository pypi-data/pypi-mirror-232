...
class LineFillFormat (  PptObject, IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LineFillFormat_get_FillType(self.Ptr)
    ...
    def FillType(self, value:'FillFormatType'):
        ...
        GetDllLibPpt().LineFillFormat_set_FillType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().LineFillFormat_get_SolidFillColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().LineFillFormat_get_Gradient(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().LineFillFormat_get_Pattern(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().LineFillFormat_get_RotateWithShape(self.Ptr)
    ...
    def RotateWithShape(self, value:'TriState'):
        ...
        GetDllLibPpt().LineFillFormat_set_RotateWithShape(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().LineFillFormat_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibPpt().LineFillFormat_GetHashCode(self.Ptr)
        return ret
