...
<value>
    ...
    def Text(self, value:str):
        ...
        GetDllLibPpt().ITextFrameProperties_set_Text(self.Ptr,valuePtr)
...
<summary>
  <b>True</b> if text is wrapped at TextFrame's margins.
    ...
    <param name="options">Highlighting options</param>
        ...
        GetDllLibPpt().ITextFrameProperties_HighLightText(self.Ptr,textPtr,intPtrcolor,intPtroptions)
