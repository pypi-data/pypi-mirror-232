...
class SectionList (SpireObject) :
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().SectionList_Add(self.Ptr,sectionNamePtr,intPtrslide)
        ret = None if intPtr==None else Section(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().SectionList_Insert(self.Ptr, sectionIndex,sectionNamePtr)
        ret = None if intPtr==None else Section(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().SectionList_Append(self.Ptr,sectionNamePtr)
        ret = None if intPtr==None else Section(intPtr)
        return ret
