...
class TimeLine (  PptObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TimeLine_get_InteractiveSequences(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TimeLine_get_MainSequence(self.Ptr)
    ...
    def TextAnimations(self)->'TextAnimationCollection':
        ...
        intPtr = GetDllLibPpt().TimeLine_get_TextAnimations(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TimeLine_Equals(self.Ptr, intPtrobj)
        return ret
