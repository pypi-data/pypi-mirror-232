...
class ShapeThreeD (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeThreeD_get_ContourWidth(self.Ptr)
        return ret

    @ContourWidth.setter
    def ContourWidth(self, value:float):
        GetDllLibPpt().ShapeThreeD_set_ContourWidth.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ShapeThreeD_set_ContourWidth(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeThreeD_get_ExtrusionHeight(self.Ptr)
        return ret
    ...
    def ExtrusionHeight(self, value:float):
        ...
        GetDllLibPpt().ShapeThreeD_set_ExtrusionHeight(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeThreeD_get_Depth(self.Ptr)
        return ret

    @Depth.setter
    def Depth(self, value:float):
        GetDllLibPpt().ShapeThreeD_set_Depth.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ShapeThreeD_set_Depth(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeThreeD_get_TopBevel(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeThreeD_get_BottomBevel(self.Ptr)
        ret = None if intPtr==None else ShapeBevelStyle(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeThreeD_get_ContourColor(self.Ptr)
    ...
    def ContourColor(self, value:'ColorFormat'):
        ...
        GetDllLibPpt().ShapeThreeD_set_ContourColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeThreeD_get_ExtrusionColor(self.Ptr)
        ret = None if intPtr==None else ColorFormat(intPtr)
        return ret
    ...
    def ExtrusionColor(self, value:'ColorFormat'):
        ...
        GetDllLibPpt().ShapeThreeD_set_ExtrusionColor(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeThreeD_get_BevelColorMode(self.Ptr)
    ...
    def BevelColorMode(self, value:'BevelColorType'):
        ...
        GetDllLibPpt().ShapeThreeD_set_BevelColorMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeThreeD_get_PresetMaterial(self.Ptr)
    ...
    def PresetMaterial(self, value:'PresetMaterialType'):
        ...
        GetDllLibPpt().ShapeThreeD_set_PresetMaterial(self.Ptr, value.value)
