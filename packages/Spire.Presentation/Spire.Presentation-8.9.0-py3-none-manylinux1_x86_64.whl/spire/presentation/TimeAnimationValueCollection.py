...
class TimeAnimationValueCollection (  IEnumerable) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TimeAnimationValueCollection_get_Count(self.Ptr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().TimeAnimationValueCollection_get_Item(self.Ptr, index)
    ...
    <returns>Iterator.</returns>
        ...
        intPtr = GetDllLibPpt().TimeAnimationValueCollection_GetEnumerator(self.Ptr)
