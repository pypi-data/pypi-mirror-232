...
#        GetDllLibPpt().ImageTransformEffectCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ImageTransformEffectCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ImageTransformEffectCollection_get_SyncRoot(self.Ptr)
