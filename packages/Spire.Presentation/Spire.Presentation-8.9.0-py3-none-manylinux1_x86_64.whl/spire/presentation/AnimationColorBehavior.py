...
class AnimationColorBehavior (  CommonBehavior) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationColorBehavior_get_From(self.Ptr)
    ...
    def From(self, value:'ColorFormat'):
        ...
        GetDllLibPpt().AnimationColorBehavior_set_From(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationColorBehavior_get_To(self.Ptr)
        ret = None if intPtr==None else ColorFormat(intPtr)
        return ret
    ...
    def To(self, value:'ColorFormat'):
        ...
        GetDllLibPpt().AnimationColorBehavior_set_To(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationColorBehavior_get_By(self.Ptr)
    ...
    def By(self, value:'AnimationColorTransform'):
        ...
        GetDllLibPpt().AnimationColorBehavior_set_By(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationColorBehavior_get_AnimationColorspace(self.Ptr)
    ...
    def AnimationColorspace(self, value:'AnimationColorspace'):
        ...
        GetDllLibPpt().AnimationColorBehavior_set_AnimationColorspace(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationColorBehavior_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'AnimationColorDirection'):
        ...
        GetDllLibPpt().AnimationColorBehavior_set_Direction(self.Ptr, value.value)
