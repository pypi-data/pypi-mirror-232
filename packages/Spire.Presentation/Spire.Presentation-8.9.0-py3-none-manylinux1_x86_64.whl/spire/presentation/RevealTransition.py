...
class RevealTransition (  Transition) :
    ...
    def Direction(self)->'TransitionRevealLRDirection':
        ...
        ret = GetDllLibPpt().RevealTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionRevealLRDirection'):
        ...
        GetDllLibPpt().RevealTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().RevealTransition_Equals(self.Ptr, intPtrobj)
        return ret
