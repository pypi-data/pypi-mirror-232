...
class Backdrop (  PptObject) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().Backdrop_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        intPtrArray = GetDllLibPpt().Backdrop_get_NormalVector(self.Ptr)
    ...
    def NormalVector(self, value:List[float]):
        ...
        GetDllLibPpt().Backdrop_set_NormalVector(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibPpt().Backdrop_get_AnchorPoint(self.Ptr)
        ret = GetVectorFromArray(intPtrArray, c_float)
        return ret
    ...
    def AnchorPoint(self, value:List[float]):
        ...
        GetDllLibPpt().Backdrop_set_AnchorPoint(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibPpt().Backdrop_get_UpVector(self.Ptr)
        ret = GetVectorFromArray(intPtrArray, c_float)
        return ret
    ...
    def UpVector(self, value:List[float]):
        ...
        GetDllLibPpt().Backdrop_set_UpVector(self.Ptr, vArray, vCount)
