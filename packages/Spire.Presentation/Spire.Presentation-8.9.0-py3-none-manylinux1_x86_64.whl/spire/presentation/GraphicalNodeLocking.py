...
class GraphicalNodeLocking (  BaseShapeLocking) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicalNodeLocking_get_GroupingProtection(self.Ptr)
        return ret
    ...
    def GroupingProtection(self, value:bool):
        ...
        GetDllLibPpt().GraphicalNodeLocking_set_GroupingProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicalNodeLocking_get_DrilldownProtection(self.Ptr)
        return ret
    ...
    def DrilldownProtection(self, value:bool):
        ...
        GetDllLibPpt().GraphicalNodeLocking_set_DrilldownProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicalNodeLocking_get_SelectionProtection(self.Ptr)
        return ret
    ...
    def SelectionProtection(self, value:bool):
        ...
        GetDllLibPpt().GraphicalNodeLocking_set_SelectionProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicalNodeLocking_get_AspectRatioProtection(self.Ptr)
        return ret
    ...
    def AspectRatioProtection(self, value:bool):
        ...
        GetDllLibPpt().GraphicalNodeLocking_set_AspectRatioProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicalNodeLocking_get_PositionProtection(self.Ptr)
        return ret
    ...
    def PositionProtection(self, value:bool):
        ...
        GetDllLibPpt().GraphicalNodeLocking_set_PositionProtection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GraphicalNodeLocking_get_ResizeProtection(self.Ptr)
        return ret
    ...
    def ResizeProtection(self, value:bool):
        ...
        GetDllLibPpt().GraphicalNodeLocking_set_ResizeProtection(self.Ptr, value)
