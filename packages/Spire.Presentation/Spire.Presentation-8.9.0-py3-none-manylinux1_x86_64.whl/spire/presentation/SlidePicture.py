...
class SlidePicture (  ShapeNode, IEmbedImage) :
    ...
    def ShapeLocking(self)->'SlidePictureLocking':
        ...
        intPtr = GetDllLibPpt().SlidePicture_get_ShapeLocking(self.Ptr)
    ...
    def ShapeType(self)->'ShapeType':
        ...
        ret = GetDllLibPpt().SlidePicture_get_ShapeType(self.Ptr)
    ...
    def ShapeType(self, value:'ShapeType'):
        ...
        GetDllLibPpt().SlidePicture_set_ShapeType(self.Ptr, value.value)
    ...
    <returns>
        ...
        ret = GetDllLibPpt().SlidePicture_get_IsCropped(self.Ptr)
        return ret
    ...
    def PictureFill(self)->'PictureFillFormat':
        ...
        intPtr = GetDllLibPpt().SlidePicture_get_PictureFill(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().SlidePicture_PictureAdjust(self.Ptr)
    ...
    <param name="height"> cropped height </param>
        ...
        GetDllLibPpt().SlidePicture_Crop(self.Ptr, x,y,width,height)
