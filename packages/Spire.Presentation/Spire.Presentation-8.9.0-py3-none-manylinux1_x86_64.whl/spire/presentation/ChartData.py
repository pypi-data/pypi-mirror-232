...
class ChartData (SpireObject) :
    ...
    def __getitem__(self, name:str):
        ...
        intPtr = GetDllLibPpt().ChartData_get_ItemN(self.Ptr,namePtr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ChartData_get_ItemNE(self.Ptr,namePtr,endCellNamePtr)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ChartData_get_ItemWN(self.Ptr, worksheetIndex,namePtr)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ChartData_get_ItemWNE(self.Ptr, worksheetIndex,namePtr,endCellNamePtr)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
