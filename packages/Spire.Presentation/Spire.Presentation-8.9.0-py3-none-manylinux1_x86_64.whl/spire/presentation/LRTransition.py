...
class LRTransition (  Transition) :
    ...
    def Direction(self)->'TransitionTwoDirection':
        ...
        ret = GetDllLibPpt().LRTransition_get_Direction(self.Ptr)
    ...
    def Direction(self, value:'TransitionTwoDirection'):
        ...
        GetDllLibPpt().LRTransition_set_Direction(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().LRTransition_Equals(self.Ptr, intPtrobj)
        return ret
