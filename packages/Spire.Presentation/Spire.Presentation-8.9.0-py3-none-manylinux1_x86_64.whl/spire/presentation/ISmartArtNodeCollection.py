...
class ISmartArtNodeCollection (  SpireObject) :
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibPpt().ISmartArtNodeCollection_get_Count(self.Ptr)
        return ret
    ...
    def __getitem__(self, key):
        ...
        intPtr = GetDllLibPpt().ISmartArtNodeCollection_get_Item(self.Ptr, key)
    ...
    def get_Item(self ,index:int)->'ISmartArtNode':
        ...
        GetDllLibPpt().ISmartArtNodeCollection_get_Item.argtypes=[c_void_p ,c_int]
        GetDllLibPpt().ISmartArtNodeCollection_get_Item.restype=c_void_p
        intPtr = GetDllLibPpt().ISmartArtNodeCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else ISmartArtNode(intPtr)
        return ret
    ...
    def AddNode(self)->'ISmartArtNode':
        ...
        intPtr = GetDllLibPpt().ISmartArtNodeCollection_AddNode(self.Ptr)
        ret = None if intPtr==None else ISmartArtNode(intPtr)
        return ret
    ...
    def RemoveNodeByIndex(self ,index:int):
        ...
        GetDllLibPpt().ISmartArtNodeCollection_RemoveNode(self.Ptr, index)
    ...
    def RemoveNode(self ,node:'ISmartArtNode'):
        ...
        GetDllLibPpt().ISmartArtNodeCollection_RemoveNodeN(self.Ptr, intPtrnode)
    ...
    def GetNodeByPosition(self ,position:int)->'ISmartArtNode':
        ...
        intPtr = GetDllLibPpt().ISmartArtNodeCollection_GetNodeByPosition(self.Ptr, position)
        ret = None if intPtr==None else ISmartArtNode(intPtr)
        return ret
    ...
    def RemoveNodeByPosition(self ,position:int)->bool:
        ...
        ret = GetDllLibPpt().ISmartArtNodeCollection_RemoveNodeByPosition(self.Ptr, position)
        return ret
    ...
    def AddNodeByPosition(self ,position:int)->'ISmartArtNode':
        ...
        intPtr = GetDllLibPpt().ISmartArtNodeCollection_AddNodeByPosition(self.Ptr, position)
        ret = None if intPtr==None else ISmartArtNode(intPtr)
        return ret
...
#        GetDllLibPpt().ISmartArtNodeCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    def IsSynchronized(self)->bool:
        ...
        ret = GetDllLibPpt().ISmartArtNodeCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    def SyncRoot(self)->'SpireObject':
        ...
        intPtr = GetDllLibPpt().ISmartArtNodeCollection_get_SyncRoot(self.Ptr)
