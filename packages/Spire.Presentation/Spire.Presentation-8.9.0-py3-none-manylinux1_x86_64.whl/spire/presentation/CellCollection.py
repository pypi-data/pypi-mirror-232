...
class CellCollection (  PptObject, IActiveSlide) :
    ...
    def __getitem__(self, key):
        ...
        intPtr = GetDllLibPpt().CellCollection_get_Item(self.Ptr, key)
    ...
    <summary>
        ...
        GetDllLibPpt().CellCollection_get_Item.argtypes=[c_void_p ,c_int]
        GetDllLibPpt().CellCollection_get_Item.restype=c_void_p
        intPtr = GetDllLibPpt().CellCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else Cell(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CellCollection_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().CellCollection_get_Slide(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().CellCollection_get_Presentation(self.Ptr)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the collection.</returns>
        ...
        intPtr = GetDllLibPpt().CellCollection_GetEnumerator(self.Ptr)
...
#        GetDllLibPpt().CellCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CellCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().CellCollection_get_SyncRoot(self.Ptr)
