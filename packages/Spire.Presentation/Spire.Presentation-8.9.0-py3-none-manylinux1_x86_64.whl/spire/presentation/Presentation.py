...
#
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_SetCustomFontsFolder(self.Ptr,fontsFolderPtr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_IsPasswordProtected(self.Ptr,fileNamePtr)
        return ret
...
#        return ret
    ...
    <param name="password">The password.</param>
        ...
        GetDllLibPpt().Presentation_LoadFromStreamSFP(self.Ptr, intPtrstream,enumfileFormat,passwordPtr)
    ...
    <param name="file">The document file path.</param>
        ...
        GetDllLibPpt().Presentation_LoadFromFile(self.Ptr,filePtr)
    ...
    <param name="file">The document file path.</param>
        ...
        GetDllLibPpt().Presentation_LoadFromFileFP(self.Ptr,filePtr,passwordPtr)
    ...
    def LoadFromFile(self ,file:str,fileFormat:FileFormat):
        ...
        GetDllLibPpt().Presentation_LoadFromFileFF(self.Ptr,filePtr,enumfileFormat)
    ...
    def LoadFromFile(self ,file:str,fileFormat:FileFormat,password:str):
        ...
        GetDllLibPpt().Presentation_LoadFromFileFFP(self.Ptr,filePtr,enumfileFormat,passwordPtr)
...
#
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_OnlineSaveToFile(self.Ptr,filePtr,enumfileFormat)
        return ret
    ...
    <param name="fileFormat">convert to fileFormat.</param>
        ...
        GetDllLibPpt().Presentation_SaveToFileFF(self.Ptr,filePtr,enumfileFormat)
...
#        GetDllLibPpt().Presentation_SaveToHttpResponseFFRI(self.Ptr, FileName,enumfileFormat,intPtrresponse,isInlineMode)
    ...
    <param name="password">The password.</param>
        ...
        GetDllLibPpt().Presentation_Encrypt(self.Ptr,passwordPtr)
    ...
    <param name="password">The password.</param>
        ...
        GetDllLibPpt().Presentation_Protect(self.Ptr,passwordPtr)
...
#        GetDllLibPpt().Presentation_PrintPP(self.Ptr, intPtrprinterSettings,presName)
    ...
    def SetFooterText(self ,text:str):
        ...
        GetDllLibPpt().Presentation_SetFooterText(self.Ptr,textPtr)
    ...
    def SetDateTime(self ,dateTime:DateTime,format:str):
        ...
        GetDllLibPpt().Presentation_SetDateTimeDF(self.Ptr, intPtrdateTime,formatPtr)
