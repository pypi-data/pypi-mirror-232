...
class GradientFillFormat (  IActiveSlide) :
  ...
  <b>true</b> if the specified GradientFormat is equal to the current GradientFormat; otherwise, <b>false</b>.</returns>
        ...
        ret = GetDllLibPpt().GradientFillFormat_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibPpt().GradientFillFormat_GetHashCode(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GradientFillFormat_get_TileFlip(self.Ptr)
    ...
    def TileFlip(self, value:'TileFlipMode'):
        ...
        GetDllLibPpt().GradientFillFormat_set_TileFlip(self.Ptr, value.value)
...
<summary></summary>
        ...
        intPtr = GetDllLibPpt().GradientFillFormat_get_TileRectangle(self.Ptr)
    ...
    def TileRectangle(self, value:'RelativeRectangle'):
        ...
        GetDllLibPpt().GradientFillFormat_set_TileRectangle(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GradientFillFormat_get_GradientStyle(self.Ptr)
    ...
    def GradientStyle(self, value:'GradientStyle'):
        ...
        GetDllLibPpt().GradientFillFormat_set_GradientStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().GradientFillFormat_get_GradientShape(self.Ptr)
    ...
    def GradientShape(self, value:'GradientShapeType'):
        ...
        GetDllLibPpt().GradientFillFormat_set_GradientShape(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().GradientFillFormat_get_GradientStops(self.Ptr)
    ...
    def LinearGradientFill(self)->'LinearGradientFill':
        ...
        intPtr = GetDllLibPpt().GradientFillFormat_get_LinearGradientFill(self.Ptr)
