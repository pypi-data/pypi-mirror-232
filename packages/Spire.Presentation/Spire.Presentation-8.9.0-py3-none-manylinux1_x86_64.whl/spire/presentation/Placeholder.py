...
class Placeholder (  PptObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Placeholder_get_Orientation(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Placeholder_get_Size(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Placeholder_get_Type(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Placeholder_get_Index(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().Placeholder_Equals(self.Ptr, intPtrobj)
        return ret
