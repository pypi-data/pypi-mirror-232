...
class ReflectionEffect (SpireObject) :
    ...
    def MakeReflection(self ,bitmap:'Bitmap',reflectionEffect:'ReflectionEffect')->'Bitmap':
        ...
        intPtr = GetDllLibPpt().ReflectionEffect_MakeReflection(self.Ptr, intPtrbitmap,intPtrreflectionEffect)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_StartPosition(self.Ptr)
        return ret

    @StartPosition.setter
    def StartPosition(self, value:float):
        GetDllLibPpt().ReflectionEffect_set_StartPosition.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ReflectionEffect_set_StartPosition(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_EndPosition(self.Ptr)
        return ret

    @EndPosition.setter
    def EndPosition(self, value:float):
        GetDllLibPpt().ReflectionEffect_set_EndPosition.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ReflectionEffect_set_EndPosition(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_FadeDirection(self.Ptr)
        return ret
    ...
    def FadeDirection(self, value:float):
        ...
        GetDllLibPpt().ReflectionEffect_set_FadeDirection(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_StartOpacity(self.Ptr)
        return ret

    @StartOpacity.setter
    def StartOpacity(self, value:float):
        GetDllLibPpt().ReflectionEffect_set_StartOpacity.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ReflectionEffect_set_StartOpacity(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_EndOpacity(self.Ptr)
        return ret

    @EndOpacity.setter
    def EndOpacity(self, value:float):
        GetDllLibPpt().ReflectionEffect_set_EndOpacity.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ReflectionEffect_set_EndOpacity(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_BlurRadius(self.Ptr)
        return ret

    @BlurRadius.setter
    def BlurRadius(self, value:float):
        GetDllLibPpt().ReflectionEffect_set_BlurRadius.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ReflectionEffect_set_BlurRadius(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_Direction(self.Ptr)
        return ret

    @Direction.setter
    def Direction(self, value:float):
        GetDllLibPpt().ReflectionEffect_set_Direction.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ReflectionEffect_set_Direction(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_Distance(self.Ptr)
        return ret

    @Distance.setter
    def Distance(self, value:float):
        GetDllLibPpt().ReflectionEffect_set_Distance.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ReflectionEffect_set_Distance(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_Alignment(self.Ptr)
    ...
    def Alignment(self, value:'RectangleAlignment'):
        ...
        GetDllLibPpt().ReflectionEffect_set_Alignment(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_HorizontalSkew(self.Ptr)
        return ret
    ...
    def HorizontalSkew(self, value:float):
        ...
        GetDllLibPpt().ReflectionEffect_set_HorizontalSkew(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_VerticalSkew(self.Ptr)
        return ret

    @VerticalSkew.setter
    def VerticalSkew(self, value:float):
        GetDllLibPpt().ReflectionEffect_set_VerticalSkew.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ReflectionEffect_set_VerticalSkew(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_RotateWithShape(self.Ptr)
        return ret
    ...
    def RotateWithShape(self, value:bool):
        ...
        GetDllLibPpt().ReflectionEffect_set_RotateWithShape(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_HorizontalScale(self.Ptr)
        return ret
    ...
    def HorizontalScale(self, value:float):
        ...
        GetDllLibPpt().ReflectionEffect_set_HorizontalScale(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ReflectionEffect_get_VerticalScale(self.Ptr)
        return ret
    ...
    def VerticalScale(self, value:float):
        ...
        GetDllLibPpt().ReflectionEffect_set_VerticalScale(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ReflectionEffect_Equals(self.Ptr, intPtrobj)
        return ret
