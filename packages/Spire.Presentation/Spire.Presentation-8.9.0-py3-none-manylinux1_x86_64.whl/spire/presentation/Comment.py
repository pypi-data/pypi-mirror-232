...
class Comment (  PptObject) :
    ...
    def Text(self, value:str):
        ...
        GetDllLibPpt().Comment_set_Text(self.Ptr,valuePtr)
    ...
    def AuthorName(self, value:str):
        ...
        GetDllLibPpt().Comment_set_AuthorName(self.Ptr,valuePtr)
    ...
    def AuthorInitials(self, value:str):
        ...
        GetDllLibPpt().Comment_set_AuthorInitials(self.Ptr,valuePtr)
    ...
    <param name="time">time.</param>
        ...
        GetDllLibPpt().Comment_Reply(self.Ptr, intPtrauthor,replyPtr,intPtrtime)
