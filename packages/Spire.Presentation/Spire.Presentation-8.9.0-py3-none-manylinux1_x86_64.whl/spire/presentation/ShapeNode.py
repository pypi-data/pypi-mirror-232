...
class ShapeNode (  Shape) :
    ...
    def ShapeStyle(self)->'ShapeStyle':
        ...
        intPtr = GetDllLibPpt().ShapeNode_get_ShapeStyle(self.Ptr)
    ...
    def ShapeType(self)->'ShapeType':
        ...
        ret = GetDllLibPpt().ShapeNode_get_ShapeType(self.Ptr)
    ...
    def ShapeType(self, value:'ShapeType'):
        ...
        GetDllLibPpt().ShapeNode_set_ShapeType(self.Ptr, value.value)
    ...
    def Adjustments(self)->'ShapeAdjustCollection':
        ...
        intPtr = GetDllLibPpt().ShapeNode_get_Adjustments(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ShapeNode_Equals(self.Ptr, intPtrobj)
        return ret
