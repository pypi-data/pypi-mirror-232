...
class TimeNodes (  IEnumerable) :
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibPpt().TimeNodes_get_Count(self.Ptr)
        return ret
    ...
    def get_Item(self ,index:int)->'TimeNode':
        ...
        intPtr = GetDllLibPpt().TimeNodes_get_Item(self.Ptr, index)
    ...
    def RemoveAt(self ,index:int):
        ...
        GetDllLibPpt().TimeNodes_RemoveAt(self.Ptr, index)
    ...
    def Remove(self ,node:'TimeNode'):
        ...
        GetDllLibPpt().TimeNodes_Remove(self.Ptr, intPtrnode)
    ...
    def Clear(self):
        ...
        GetDllLibPpt().TimeNodes_Clear(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TimeNodes_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibPpt().TimeNodes_GetEnumerator(self.Ptr)
