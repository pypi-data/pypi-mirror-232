...
class IAudio (  IShape) :
    ...
    def FileName(self, value:str):
        ...
        GetDllLibPpt().IAudio_set_FileName(self.Ptr,valuePtr)
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibPpt().IAudio_set_AlternativeText(self.Ptr,valuePtr)
    ...
    def Name(self, value:str):
        ...
        GetDllLibPpt().IAudio_set_Name(self.Ptr,valuePtr)
