...
class AudioCD (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AudioCD_get_StartTrack(self.Ptr)
        return ret

    @StartTrack.setter
    def StartTrack(self, value:int):
        GetDllLibPpt().AudioCD_set_StartTrack.argtypes=[c_void_p, c_int]
        GetDllLibPpt().AudioCD_set_StartTrack(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AudioCD_get_StartTime(self.Ptr)
        return ret

    @StartTime.setter
    def StartTime(self, value:int):
        GetDllLibPpt().AudioCD_set_StartTime.argtypes=[c_void_p, c_int]
        GetDllLibPpt().AudioCD_set_StartTime(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AudioCD_get_EndTrack(self.Ptr)
        return ret

    @EndTrack.setter
    def EndTrack(self, value:int):
        GetDllLibPpt().AudioCD_set_EndTrack.argtypes=[c_void_p, c_int]
        GetDllLibPpt().AudioCD_set_EndTrack(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AudioCD_get_EndTime(self.Ptr)
        return ret

    @EndTime.setter
    def EndTime(self, value:int):
        GetDllLibPpt().AudioCD_set_EndTime.argtypes=[c_void_p, c_int]
        GetDllLibPpt().AudioCD_set_EndTime(self.Ptr, value)
