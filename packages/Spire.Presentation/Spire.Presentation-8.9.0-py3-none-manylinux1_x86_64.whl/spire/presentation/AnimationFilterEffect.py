...
class AnimationFilterEffect (  CommonBehavior) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationFilterEffect_get_Reveal(self.Ptr)
    ...
    def Reveal(self, value:'FilterRevealType'):
        ...
        GetDllLibPpt().AnimationFilterEffect_set_Reveal(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationFilterEffect_get_Type(self.Ptr)
    ...
    def Type(self, value:'FilterEffectType'):
        ...
        GetDllLibPpt().AnimationFilterEffect_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationFilterEffect_get_Subtype(self.Ptr)
    ...
    def Subtype(self, value:'FilterEffectSubtype'):
        ...
        GetDllLibPpt().AnimationFilterEffect_set_Subtype(self.Ptr, value.value)
