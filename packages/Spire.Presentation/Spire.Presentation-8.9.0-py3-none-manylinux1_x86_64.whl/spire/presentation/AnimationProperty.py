...
class AnimationProperty (  CommonBehavior) :
    ...
    def From(self, value:str):
        ...
        GetDllLibPpt().AnimationProperty_set_From(self.Ptr,valuePtr)
    ...
    def To(self, value:str):
        ...
        GetDllLibPpt().AnimationProperty_set_To(self.Ptr,valuePtr)
    ...
    def By(self, value:str):
        ...
        GetDllLibPpt().AnimationProperty_set_By(self.Ptr,valuePtr)
