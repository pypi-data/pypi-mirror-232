...
class GraphicAnimation (  PptObject) :
    ...
    def ShapeRef(self)->'Shape':
        ...
        intPtr = GetDllLibPpt().GraphicAnimation_get_ShapeRef(self.Ptr)
    ...
    def BuildType(self)->'GraphicBuildType':
        ...
        ret = GetDllLibPpt().GraphicAnimation_get_BuildType(self.Ptr)
    ...
    def BuildType(self, value:'GraphicBuildType'):
        ...
        GetDllLibPpt().GraphicAnimation_set_BuildType(self.Ptr, value.value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().GraphicAnimation_Equals(self.Ptr, intPtrobj)
        return ret
