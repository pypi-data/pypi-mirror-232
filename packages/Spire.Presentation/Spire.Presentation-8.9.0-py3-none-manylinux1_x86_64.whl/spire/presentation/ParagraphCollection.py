...
class ParagraphCollection (  ParagraphList) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ParagraphCollection_Equals(self.Ptr, intPtrobj)
        return ret
...
#        GetDllLibPpt().ParagraphCollection_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphCollection_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ParagraphCollection_get_SyncRoot(self.Ptr)
    ...
    #    intPtr = GetDllLibPpt().ParagraphCollection_AddParagraphFromLatexMathCode(self.Ptr, latexMathCode)
    ...
    #    intPtr = GetDllLibPpt().ParagraphCollection_AddParagraphFromMathMLCode(self.Ptr, MathMLCode)
    #    ret = None if intPtr==None else TextParagraph(intPtr)
    #    return ret
