"use strict";
(self["webpackChunksister_jupyter_server_extension"] = self["webpackChunksister_jupyter_server_extension"] || []).push([["lib_index_js"],{
...
const plugin = {
    ...
    activate: (app) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_0__.requestAPI)('get_example')
            ...
            .catch(reason => {
            console.error(`The jupyter_server_extension server extension appears to be missing.\n${reason}`);
        });
    }
};
...
//# sourceMappingURL=lib_index_js.10bf10430d6219207e84.js.map