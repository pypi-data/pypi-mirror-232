...
class OperationModeStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    OPERATION_MODE_STATUS_ON: _ClassVar[OperationModeStatus]
    OPERATION_MODE_STATUS_OFF: _ClassVar[OperationModeStatus]
    OPERATION_MODE_STATUS_PAUSED: _ClassVar[OperationModeStatus]
