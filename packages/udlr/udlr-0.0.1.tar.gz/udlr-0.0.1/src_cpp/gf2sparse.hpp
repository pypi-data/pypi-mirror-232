 ...
 */
class GF2Entry: public udlr::sparse_matrix_base::EntryBase<GF2Entry>{ 
    public: 
        ~GF2Entry() = default;
};
...
class GF2Sparse: public udlr::sparse_matrix_base::SparseMatrixBase<ENTRY_OBJ>{
    public:
        typedef udlr::sparse_matrix_base::SparseMatrixBase<ENTRY_OBJ> BASE;
         ...
         */
        GF2Sparse(int m, int n, int entry_count = 0): udlr::sparse_matrix_base::SparseMatrixBase<ENTRY_OBJ>(m,n,entry_count){}
...
typedef udlr::gf2sparse::GF2Entry cygf2_entry;
typedef udlr::gf2sparse::GF2Sparse<udlr::gf2sparse::GF2Entry> cygf2_sparse;
