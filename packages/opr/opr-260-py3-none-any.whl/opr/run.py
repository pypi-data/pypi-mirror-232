...
Cfg.name = NAME
Cfg.slogan = f"the {NAME}"
Cfg.description = f"{NAME.upper()} {Cfg.version} {Cfg.mod.upper()}"
...
def main():
    ...
    if "v" in Cfg.opts:
        Errors.output = print
        Cfg.description = f"{Cfg.name.upper()} {Cfg.mod.upper()} {Cfg.opts.upper()}"
