...
class Client(object):
    ...
    def __init__(self, username=None, password=None, host=None, sysadmin=False, region=None,
                 http_client=None, environment=None, system_admin_user=None, system_admin_password=None):
        """
        ...
        :param str system_admin_user: Admin username to authenticate with
        :param str system_admin_password: Admin password to authenticate with
        ...
        """ :type: str """
        self.system_admin_user = system_admin_user
        """ :type: str """
        self.system_admin_password = system_admin_password
