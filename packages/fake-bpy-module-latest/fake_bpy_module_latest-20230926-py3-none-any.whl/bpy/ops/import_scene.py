...
def gltf(override_context: typing.Optional[
         ...
         *,
         ...
         import_webp_texture: typing.Optional[typing.Union[bool, typing.
                                                           Any]] = False):
    ''' Load a glTF 2.0 file :File: `addons/io_scene_gltf2/__init__.py\:1736 <https://projects.blender.org/blender/blender-addons/addons/io_scene_gltf2/__init__.py#L1736>`__
    ...
    :param import_webp_texture: Import Webp textures, If a texture exists in webp format,loads the webp texture instead of the fallback png/jpg one
