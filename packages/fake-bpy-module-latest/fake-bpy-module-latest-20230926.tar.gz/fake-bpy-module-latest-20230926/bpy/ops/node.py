...
def new_geometry_node_group_tool(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new geometry node group for a tool :File: `startup/bl_operators/geometry_nodes.py\:307 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L307>`__
