...
def collection_show_all(
        ...
        execution_context: typing.Optional[typing.Union[str, int]] = None,
        undo: typing.Optional[bool] = None):
    ''' Show all bone collections :File: `startup/bl_operators/anim.py\:540 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L540>`__
...
def collection_solo_visibility(
        ...
        *,
        name: typing.Union[str, typing.Any] = ""):
    ''' Hide all other bone collections and show the active one :File: `startup/bl_operators/anim.py\:523 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L523>`__
...
def sync_bone_color_to_selected(
    ...
    ''' Copy the bone color of the active bone to all selected bones :File: `startup/bl_operators/anim.py\:453 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L453>`__
