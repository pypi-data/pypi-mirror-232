...
def clear_useless_actions(
    ...
    ''' Mark actions with no F-Curves for deletion after save and reload of file preserving "action libraries" :File: `startup/bl_operators/anim.py\:327 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L327>`__
...
def update_animated_transform_constraints(
        ...
        *,
        use_convert_to_radians: typing.Optional[typing.Union[bool, typing.
                                                             Any]] = True):
    ''' Update f-curves/drivers affecting Transform constraints (use it with files from 2.70 and earlier) :File: `startup/bl_operators/anim.py\:363 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/anim.py#L363>`__
