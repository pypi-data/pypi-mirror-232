...
class MovvaContactsSheet:

    def __init__(self, link, spreadsheet_name, creds_path):
        self.__link = link
    ...
    def check_data(self):
        """
            ...
            foram informadas.
        """
        if not self.__link or not self.__spreadsheet_id or not self.spreadsheet_name:
    ...
    def read_sheet_data(self) -> list:
        ...
        result = sheet.values().get(
            ...
            range=f'{self.spreadsheet_name}!A1:AZ'
        ).execute()
