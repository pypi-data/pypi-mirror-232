...
from pokerbot.commands.ai import ai_run
from pokerbot.commands.testing import testing_run

# load .env file
load_dotenv(os.path.expanduser("~/.pokerbot/.env"))
marvin.settings.llm_model = "azure_openai/gpt-4-32k"

# load config
try:
    config = toml.load(os.path.expanduser("~/.pokerbot/config.toml"))
