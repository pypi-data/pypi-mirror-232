...
from src.dihub.__internal.helpers import AnnotationOf, validate_dihub_module, get_class_name
from src.dihub.__internal.proxies import ProviderProxy
from src.dihub.constants import _MODULE_ANNOTATIONS, ProviderScope, ROOT_MODULE_DELEGATE
from src.dihub.exceptions import (
    CannotResolveDependency,
    ModuleNotFound,
    ProviderNotFound,
)
from src.dihub.types import (
    IModuleDelegate,
    IProviderDelegate,
    ModuleAnnotation,
    ProviderAnnotation,
