...
class ComputeNodeInfo(object):
    ...
    def __init__(self, available_capacity=None, enqueued_executions=None, execution_engines=None, max_capacity=None, max_job_requirements=None, publishers=None, running_executions=None, storage_sources=None):  # noqa: E501
