...
class DescriptionModel(BaseModel): #text description + embedding
    ...
    def translate_to_english(cls, text_value):
        if text_value:
            return translator.translate_text(text_value, target_lang="EN-US").text.lower()
        return text_value
...
class GeneralExperience(TimeframeModel): #this class will serve as both jobs and education
    ...
    def __init__(self, Institution=None, Specialization=None, **kwargs):
        ...
        if Specialization:
            Specialization=translator.translate_text(Specialization, target_lang="EN-US").text.lower()
...
class Candidate(BaseModel):
    ...
    def __init__(self,
        ...
        if ExternalSummaryStr:
            ExternalSummaryStr=translator.translate_text(ExternalSummaryStr, target_lang="EN-US").text.lower()
