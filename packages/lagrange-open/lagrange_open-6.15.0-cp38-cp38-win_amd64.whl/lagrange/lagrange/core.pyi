...
def compute_facet_area(*args, **kwargs):
    """
    compute_facet_area(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetAreaOptions = <lagrange.core.FacetAreaOptions object at 0x000001FEE8B8B990>) -> int
    """
    ...

def compute_facet_centroid(*args, **kwargs):
    """
    compute_facet_centroid(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetCentroidOptions = <lagrange.core.FacetCentroidOptions object at 0x000001FEE8B8BA80>) -> int
    """
    ...

def compute_facet_normal(*args, **kwargs):
    """
    compute_facet_normal(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.FacetNormalOptions = <lagrange.core.FacetNormalOptions object at 0x000001FEE8B8B8D0>) -> int
    """
    ...

def compute_mesh_area(*args, **kwargs):
    """
    compute_mesh_area(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.MeshAreaOptions = <lagrange.core.MeshAreaOptions object at 0x000001FEE8B8B9F0>) -> float
    """
    ...

def compute_mesh_centroid(*args, **kwargs):
    """
    compute_mesh_centroid(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.MeshCentroidOptions = <lagrange.core.MeshCentroidOptions object at 0x000001FEE8B9EDB0>) -> List[float]
    """
    ...
...
def compute_tangent_bitangent(*args, **kwargs):
    """
    compute_tangent_bitangent(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.TangentBitangentOptions = <lagrange.core.TangentBitangentOptions object at 0x000001FEE8B04F90>) -> lagrange.core.TangentBitangentResult
    """
    ...

def compute_vertex_normal(*args, **kwargs):
    """
    compute_vertex_normal(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.VertexNormalOptions = <lagrange.core.VertexNormalOptions object at 0x000001FEE8BA18A0>) -> int
    """
    ...

def compute_vertex_valence(*args, **kwargs):
    """
    compute_vertex_valence(mesh: lagrange.core.SurfaceMesh, options: lagrange.core.VertexValenceOptions = <lagrange.core.VertexValenceOptions object at 0x000001FEE8B8B960>) -> int
    """
    ...
...
def remap_vertices(*args, **kwargs):
    """
    remap_vertices(mesh: lagrange.core.SurfaceMesh, old_to_new: numpy.ndarray[dtype=uint32, order='C', device='cpu'], options: lagrange.core.RemapVerticesOptions = <lagrange.core.RemapVerticesOptions object at 0x000001FEE8B3CC90>) -> None
    """
    ...
