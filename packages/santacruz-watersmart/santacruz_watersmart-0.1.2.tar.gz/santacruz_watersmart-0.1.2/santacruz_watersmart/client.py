...
from .exceptions import UnauthorizedException, NotAuthenticatedException, ServerErrorException, UnknownException
...
class BaseClient():
    ...
    def _check_status_code(self, req):
        if req.status_code == 401:
            ...
            raise UnknownException(f'Request failed with status code: {req.status_code}')
