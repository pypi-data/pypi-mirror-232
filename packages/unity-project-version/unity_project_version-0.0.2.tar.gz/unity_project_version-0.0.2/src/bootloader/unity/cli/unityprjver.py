...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        required=False,
        help="indicate whether to replace the patch version of the Unreal Engine "
             "project with the specified build number.  This argument MUST be used "
             "with the argument `--build-number`."
    )
    ...
    parser.add_argument(
        ...
        dest='update_version',
        required=False,
        help="indicate whether to update the defined in the Unreal Engine project. "
