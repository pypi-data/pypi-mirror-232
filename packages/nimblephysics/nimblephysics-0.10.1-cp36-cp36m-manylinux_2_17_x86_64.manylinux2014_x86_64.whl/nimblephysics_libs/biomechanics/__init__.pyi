...
class SubjectOnDiskTrial():
    ...
    def addPass(self) -> SubjectOnDiskTrialPass: 
        ...
        """
    def setAccObservations(self, accObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> SubjectOnDiskTrial: ...
    def setCustomValues(self, customValues: list[numpy.ndarray[numpy.float64, _Shape[m, n]]]) -> SubjectOnDiskTrial: ...
    def setEmgObservations(self, emgObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[m, 1]]]]) -> SubjectOnDiskTrial: ...
    def setExoTorques(self, exoTorques: dict[int, numpy.ndarray[numpy.float64, _Shape[m, 1]]]) -> SubjectOnDiskTrial: ...
    def setForcePlates(self, forcePlates: list[ForcePlate]) -> SubjectOnDiskTrial: ...
    def setGyroObservations(self, gyroObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> SubjectOnDiskTrial: ...
    def setMarkerNamesGuessed(self, markersGuessed: bool) -> SubjectOnDiskTrial: ...
    def setMarkerObservations(self, markerObservations: list[dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]]) -> SubjectOnDiskTrial: ...
    def setMissingGRFReason(self, missingGRFReason: list[MissingGRFReason]) -> SubjectOnDiskTrial: ...
    ...
    def setTrialTags(self, trialTags: list[str]) -> SubjectOnDiskTrial: ...
    pass
class SubjectOnDiskTrialPass():
    def __init__(self) -> None: ...
    def setAccs(self, accs: numpy.ndarray[numpy.float64, _Shape[m, n]]) -> SubjectOnDiskTrialPass: ...
    def setAngularResidual(self, angularResidual: list[float]) -> SubjectOnDiskTrialPass: ...
    ...
    def setDofAccelerationFiniteDifferenced(self, dofAccelerationFiniteDifference: list[bool]) -> SubjectOnDiskTrialPass: ...
    def setDofPositionsObserved(self, dofPositionsObserved: list[bool]) -> SubjectOnDiskTrialPass: ...
    def setDofVelocitiesFiniteDifferenced(self, dofVelocitiesFiniteDifferenced: list[bool]) -> SubjectOnDiskTrialPass: ...
    ...
    def setLinearResidual(self, linearResidual: list[float]) -> SubjectOnDiskTrialPass: ...
    def setMarkerMax(self, markerMax: list[float]) -> SubjectOnDiskTrialPass: ...
    def setMarkerRMS(self, markerRMS: list[float]) -> SubjectOnDiskTrialPass: ...
