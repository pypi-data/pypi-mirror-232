...
class InfidelityPwc(Node):
    ...
    Graph.time_evolution_operators_pwc : Unitary time evolution operators for quantum systems with
        `Pwc` Hamiltonians.
...
class InfidelityStf(Node):
    ...
    Graph.target : Define the target operation of the time evolution.
    Graph.time_evolution_operators_stf : Unitary time evolution operators for quantum systems with
        `Stf` Hamiltonians.
