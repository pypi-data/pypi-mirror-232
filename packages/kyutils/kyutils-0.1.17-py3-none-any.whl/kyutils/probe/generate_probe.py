...
def get_Livermore_20um(device_channel_indices: Union[str,List]='SpikeGadgets', order:int=0, shift=[0,0]):
    ...
    shift : list, optional
        how much to shift the channel locations by, by default [0,0] (important for probegroup)
    """
    Livermore_20um = pi.generate_multi_shank(num_shank=4, shank_pitch=[250, 0],
                                             num_columns=1, num_contact_per_column=32,
                                             xpitch=0, ypitch=40, y_shift_per_column=None,
    ...
    device_channel_indices = np.array([35, 39, 43, 47, 50, 54, 58, 62, 4, 0, 5, 32, 12, 20, 17, 8, 34, 38, 42, 46, 51, 55, 59, 63, 21, 28, 25, 29, 24, 16, 13, 9,
                                       33, 37, 41, 45, 48, 52, 56, 61, 18, 22, 26, 30, 3, 1, 7, 15, 31, 36, 40, 44, 49, 53, 57, 60, 14, 19, 23, 27, 11, 2, 6, 10,
                                       124, 126, 120, 112, 109, 105, 101, 97, 79, 75, 71, 66, 94, 90, 86, 82, 116, 125, 121, 117, 113, 108, 104, 100, 78, 74, 70, 
                                       67, 95, 91, 87, 83, 115, 107, 110, 119, 123, 127, 122, 96, 77, 73, 69, 65, 92, 88, 84, 80, 103, 111, 114, 118, 106, 99, 102,
                                       98, 76, 72, 68, 64, 93, 89, 85, 81])
    device_channel_indices = device_channel_indices + order*128
