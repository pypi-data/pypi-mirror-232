...
if __name__ == "__main__":
    ...
    parser.add_argument("--genbank_file",required=True,help="Path to a single genbank file")
    parser.add_argument("--path",required=True,help="Path to the output file")
    parser.add_argument("--overwrite", required=False, default=False, action='store_true', help="Overwrite a file at the given path (if exists)")
