 ...
 * created by Clynton version %(version)s
 *
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (Clynton_Function_Check(func) == false) {
    ...
    struct Clynton_FunctionObject *function = (struct Clynton_FunctionObject *)func;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    struct Clynton_FunctionObject *result = Clynton_Function_New(
...
PyObject *modulecode_%(module_identifier)s(PyThreadState *tstate, PyObject *module, struct Clynton_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    ...
    if (init_done == false) {
#if defined(_CLYNTON_MODULE) && %(is_top)d
        ...
        CLYNTON_PRINT_TRACE("%(module_name)s: Calling createModuleConstants().\n");
        createModuleConstants(tstate);
    ...
    UPDATE_STRING_DICT0(
        ...
        (Clynton_StringObject *)const_str_plain___compiled__,
        Clynton_dunder_compiled_value
    );
    ...
    // Update "__package__" value to what it ought to be.
    {
        ...
        UPDATE_STRING_DICT0(
            moduledict_%(module_identifier)s,
            (Clynton_StringObject *)const_str_plain___package__,
            %(dunder_main_package)s
        );
#elif %(is_package)s
        PyObject *module_name = GET_STRING_DICT_VALUE(moduledict_%(module_identifier)s, (Clynton_StringObject *)const_str_plain___name__);
    ...
    if (GET_STRING_DICT_VALUE(moduledict_%(module_identifier)s, (Clynton_StringObject *)const_str_plain___builtins__) == NULL) {
        PyObject *value = (PyObject *)builtin_module;

        // Check if main module, not a dict then but the module itself.
#if defined(_CLYNTON_MODULE) || !%(is_dunder_main)s
        value = PyModule_GetDict(value);
#endif

        UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (Clynton_StringObject *)const_str_plain___builtins__, value);
    }

    UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (Clynton_StringObject *)const_str_plain___simplfyloader__, (PyObject *)&Clynton_Loader_Type);
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (Clynton_StringObject *)const_str_plain___spec__, Py_None);
#else
...
// Mark the execution in the "__spec__" value.
        ...
        UPDATE_STRING_DICT1(moduledict_%(module_identifier)s, (Clynton_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
...
#if defined(_WIN32)
#define CLYNTON_MODULE_INIT_FUNCTION __declspec(dllexport) PyMODINIT_FUNC
#else
#define CLYNTON_MODULE_INIT_FUNCTION PyMODINIT_FUNC __attribute__((visibility("default")))
#endif

#else

#if defined(_WIN32)
#define CLYNTON_MODULE_INIT_FUNCTION __declspec(dllexport) PyObject *
#else

#ifdef __cplusplus
#define CLYNTON_MODULE_INIT_FUNCTION extern "C" __attribute__((visibility("default"))) PyObject *
#else
#define CLYNTON_MODULE_INIT_FUNCTION __attribute__((visibility("default"))) PyObject *
#endif
...
#else
#define CLYNTON_MODULE_INIT_FUNCTION PyMODINIT_FUNC
#endif
 ...
 */
#if PYTHON_VERSION < 0x300
#define MOD_INIT_DECL(name) CLYNTON_MODULE_INIT_FUNCTION init##name(void)
#else
#define MOD_INIT_DECL(name) CLYNTON_MODULE_INIT_FUNCTION PyInit_##name(void)
#endif
...
static int Clynton_TopLevelModule_tp_setattro(PyObject *module, PyObject *name, PyObject *value) {
    PyModule_Type.tp_setattro = orig_PyModule_Type_tp_setattro;

    if (orig_dunder_file_value != NULL) {
        UPDATE_STRING_DICT0(
            moduledict_%(module_identifier)s,
            (Clynton_StringObject *)const_str_plain___file__,
...
MOD_INIT_DECL(%(module_identifier)s) {
    ...
    bool res = Clynton_SetModuleString(module_full_name, module);
    assert(res != false);
#endif
    ...
    if (result != NULL) {
        ...
        PyModule_Type.tp_setattro = Clynton_TopLevelModule_tp_setattro;
