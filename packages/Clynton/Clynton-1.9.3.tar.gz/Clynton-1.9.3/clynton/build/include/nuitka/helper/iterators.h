...
//
#ifndef __CLYNTON_HELPER_ITERATORS_H__
#define __CLYNTON_HELPER_ITERATORS_H__
...
CLYNTON_MAY_BE_UNUSED static inline bool HAS_ITERNEXT(PyObject *value) {
...
CLYNTON_MAY_BE_UNUSED static PyObject *MAKE_ITERATOR_INFALLIBLE(PyObject *iterated) {
    ...
    if (tp_iter) {
        ...
        seqiterobject *result = (seqiterobject *)Clynton_GC_New(&PySeqIter_Type);
        assert(result);
...
CLYNTON_MAY_BE_UNUSED static PyObject *MAKE_ITERATOR(PyThreadState *tstate, PyObject *iterated) {
    CHECK_OBJECT(iterated);

#if _CLYNTON_EXPERIMENTAL_DISABLE_ITERATOR_OPT
...
CLYNTON_MAY_BE_UNUSED static PyObject *MAKE_UNPACK_ITERATOR(PyObject *iterated) {
    CHECK_OBJECT(iterated);
...
CLYNTON_MAY_BE_UNUSED static PyObject *ITERATOR_NEXT(PyObject *iterator) {
...
CLYNTON_MAY_BE_UNUSED static PyObject *BUILTIN_NEXT2(PyThreadState *tstate, PyObject *iterator,
...
CLYNTON_MAY_BE_UNUSED static PyObject *UNPACK_NEXT_INFALLIBLE(PyObject *iterator) {
    CHECK_OBJECT(iterator);
...
CLYNTON_MAY_BE_UNUSED static PyObject *UNPACK_NEXT(PyThreadState *tstate, PyObject *iterator, int seq_size_so_far)
#else
CLYNTON_MAY_BE_UNUSED static PyObject *UNPACK_NEXT(PyThreadState *tstate, PyObject *iterator, int seq_size_so_far,
                                                  int expected)
#endif
...
CLYNTON_MAY_BE_UNUSED static PyObject *UNPACK_NEXT_STARRED(PyThreadState *tstate, PyObject *iterator,
...
CLYNTON_MAY_BE_UNUSED static bool UNPACK_ITERATOR_CHECK(PyThreadState *tstate, PyObject *iterator) {
    CHECK_OBJECT(iterator);
    assert(HAS_ITERNEXT(iterator));
