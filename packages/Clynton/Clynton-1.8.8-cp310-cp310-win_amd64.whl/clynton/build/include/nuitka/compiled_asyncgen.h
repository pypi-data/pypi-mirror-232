...
//
#ifndef __CLYNTON_COMPILED_ASYNCGEN_H__
#define __CLYNTON_COMPILED_ASYNCGEN_H__
...
// The Clynton_AsyncgenObject is the storage associated with a compiled
// async generator object instance of which there can be many for each code.
struct Clynton_AsyncgenObject {
...
extern PyTypeObject Clynton_Asyncgen_Type;

typedef PyObject *(*asyncgen_code)(PyThreadState *tstate, struct Clynton_AsyncgenObject *, PyObject *);

extern PyObject *Clynton_Asyncgen_New(asyncgen_code code, PyObject *module, PyObject *name, PyObject *qualname,
                                     PyCodeObject *code_object, struct Clynton_CellObject **closure,
                                     Py_ssize_t closure_given, Py_ssize_t heap_storage_size);

static inline bool Clynton_Asyncgen_Check(PyObject *object) { return Py_TYPE(object) == &Clynton_Asyncgen_Type; }

static inline void SAVE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct Clynton_AsyncgenObject *asyncgen) {
...
static inline void RESTORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct Clynton_AsyncgenObject *asyncgen) {
...
CLYNTON_MAY_BE_UNUSED static void STORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate,
...
CLYNTON_MAY_BE_UNUSED static void DROP_ASYNCGEN_EXCEPTION(struct Clynton_AsyncgenObject *asyncgen) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_Clynton_Asyncgen_Type;
extern int count_allocated_Clynton_Asyncgen_Type;
extern int count_released_Clynton_Asyncgen_Type;

extern int count_active_Clynton_AsyncgenValueWrapper_Type;
extern int count_allocated_Clynton_AsyncgenValueWrapper_Type;
extern int count_released_Clynton_AsyncgenValueWrapper_Type;

extern int count_active_Clynton_AsyncgenAsend_Type;
extern int count_allocated_Clynton_AsyncgenAsend_Type;
extern int count_released_Clynton_AsyncgenAsend_Type;

extern int count_active_Clynton_AsyncgenAthrow_Type;
extern int count_allocated_Clynton_AsyncgenAthrow_Type;
extern int count_released_Clynton_AsyncgenAthrow_Type;
