...
from clynton.PythonVersions import getSystemPrefixPath
from clynton.utils.FileOperations import listDllFilesFromDirectory, relpath
...
class ClyntonPluginTkinter(ClyntonPluginBase):
    ...
    plugin_name = "tk-inter"  # Clynton knows us by this name
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__clynton_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__clynton_binary_dir, "tk")"""
    ...
    def addPluginCommandLineOptions(cls, group):
        group.add_option(
            ...
            default=None,
            help="""\
The Tk library dir. Clynton is supposed to automatically detect it, but you can
...
that works, report a bug so it can be added to Clynton."""
            )
...
class ClyntonPluginDetectorTkinter(ClyntonPluginBase):
    ...
    detector_for = ClyntonPluginTkinter
