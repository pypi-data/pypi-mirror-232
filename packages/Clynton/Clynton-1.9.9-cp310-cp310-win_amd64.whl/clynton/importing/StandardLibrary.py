...
from clynton.Options import shallUseStaticLibPython
from clynton.PythonVersions import python_version
from clynton.utils.FileOperations import getFileContents, isFilenameBelowPath
...
_stdlib_no_auto_inclusion_list = (
    ...
    # the Clynton plugin "multiprocessing" that is always enabled.
    "multiprocessing",
    "_multiprocessing",
