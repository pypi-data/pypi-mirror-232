...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct Clynton_GeneratorObject *generator, PyObject *yield_return_value) {
...
%(closure_copy)s
%(to_name)s = Clynton_Generator_NewEmpty(
    %(generator_module)s,
    %(generator_name_obj)s,
#if PYTHON_VERSION >= 0x350
    %(generator_qualname_obj)s,
...
template_generator_return_exit = """\
    CLYNTON_CANNOT_GET_HERE("Generator must have exited already.");
    return NULL;
