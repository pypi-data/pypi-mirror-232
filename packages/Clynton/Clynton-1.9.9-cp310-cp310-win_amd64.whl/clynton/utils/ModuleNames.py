...
These are used in Clynton for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from clynton.Errors import ClyntonCodeDeficit
    raise ClyntonCodeDeficit('''
...
Check API documentation of clynton.utils.ModuleNames.ModuleName
''')
""" % {
