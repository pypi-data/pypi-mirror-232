...
the SSA (Single State Assignment) form being used in Clynton.
...
from clynton.nodes.shapes.BuiltinTypeShapes import tshape_dict, tshape_tuple
from clynton.nodes.shapes.ControlFlowDescriptions import (
    ControlFlowDescriptionElementBasedEscape,
    ControlFlowDescriptionFullEscape,
    ControlFlowDescriptionNoEscape,
)
from clynton.nodes.shapes.StandardShapes import (
