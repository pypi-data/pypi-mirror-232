...
from clynton import OutputDirectories
from clynton.__past__ import (  # pylint: disable=I0021,redefined-builtin
    BaseExceptionGroup,
    ExceptionGroup,
    GenericAlias,
    UnionType,
...
from clynton.utils.FileOperations import openTextFile
...
class BlobData(object):
    ...
    def __repr__(self):
        return "<clynton.Serialization.BlobData %s>" % self.name
...
class ConstantAccessor(object):
    ...
    def getConstantCode(self, constant):
        ...
        if constant is None:
            ...
            # TODO: Maybe make this a mapping in clynton.Builtins
