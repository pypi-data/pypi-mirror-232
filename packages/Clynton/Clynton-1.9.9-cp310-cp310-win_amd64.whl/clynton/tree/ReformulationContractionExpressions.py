...
from clynton.__past__ import intern
...
from clynton.nodes.ContainerOperationNodes import (
...
from clynton.nodes.FrameNodes import (
    StatementsFrameAsyncgen,
    StatementsFrameGenerator,
)
from clynton.nodes.FunctionNodes import ExpressionFunctionRef
...
from clynton.nodes.NodeMakingHelpers import makeVariableRefNode
from clynton.nodes.OutlineNodes import (
    ExpressionOutlineBody,
    ExpressionOutlineFunction,
)
from clynton.nodes.ReturnNodes import StatementReturn
from clynton.nodes.StatementNodes import (
...
from clynton.nodes.YieldNodes import (
    ExpressionYield,
