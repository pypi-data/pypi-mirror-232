...
from clynton.PythonVersions import python_version, python_version_str
from clynton.Tracing import general, my_print
from clynton.utils.FileOperations import (
    getFileContentByLine,
    putTextFileContents,
)
from clynton.utils.Shebang import getShebangFromSource, parseShebang
from clynton.utils.Utils import isWin32OrPosixWindows
...
Clynton is currently running with Python version '%s', which seems to not
match that. Clynton cannot guess the Python version of your source code. You
therefore might want to specify: '%s -m clynton'.

That will make use the correct Python version for Clynton.
"""
