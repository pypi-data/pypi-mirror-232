...
//
#ifndef __CLYNTON_TRACING_H__
#define __CLYNTON_TRACING_H__
...
#define CLYNTON_PRINT_TRACE(value)                                                                                      \
    {                                                                                                                  \
        puts(value);                                                                                                   \
        fflush(stdout);                                                                                                \
    }
#define CLYNTON_PRINTF_TRACE(...)                                                                                       \
    {                                                                                                                  \
        printf(__VA_ARGS__);                                                                                           \
        fflush(stdout);                                                                                                \
    }
...
#if defined(_CLYNTON_EXPERIMENTAL_SHOW_STARTUP_TIME)
...
#define CLYNTON_PRINT_TIMING(value)                                                                                     \
    {                                                                                                                  \
        PRINT_TIME_STAMP();                                                                                            \
        puts(value);                                                                                                   \
        fflush(stdout);                                                                                                \
...
#define CLYNTON_PRINT_TIMING(value) CLYNTON_PRINT_TRACE(value)
