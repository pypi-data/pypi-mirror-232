...
//
#ifndef __CLYNTON_IMPORTING_H__
#define __CLYNTON_IMPORTING_H__
...
CLYNTON_MAY_BE_UNUSED static PyObject *Clynton_GetSysModules(void) {
...
CLYNTON_MAY_BE_UNUSED static PyObject *Clynton_GetModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_GET_ITEM1(tstate, Clynton_GetSysModules(), module_name);
}

// Replacement for PyImport_GetModule working across all versions and less checks.
CLYNTON_MAY_BE_UNUSED static PyObject *Clynton_GetModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = Clynton_String_FromString(module_name);
    PyObject *result = Clynton_GetModule(tstate, module_name_object);
...
CLYNTON_MAY_BE_UNUSED static bool Clynton_SetModule(PyObject *module_name, PyObject *module) {
    CHECK_OBJECT(module_name);
    CHECK_OBJECT(module);
    assert(PyModule_Check(module));

    return DICT_SET_ITEM(Clynton_GetSysModules(), module_name, module);
}

// Add a module to the modules dictionary from name C string
CLYNTON_MAY_BE_UNUSED static bool Clynton_SetModuleString(char const *module_name, PyObject *module) {
    PyObject *module_name_object = Clynton_String_FromString(module_name);
    bool result = Clynton_SetModule(module_name_object, module);
    Py_DECREF(module_name_object);
...
CLYNTON_MAY_BE_UNUSED static bool Clynton_DelModule(PyThreadState *tstate, PyObject *module_name) {
    CHECK_OBJECT(module_name);
...
CLYNTON_MAY_BE_UNUSED static bool Clynton_DelModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = Clynton_String_FromString(module_name);
    bool result = Clynton_DelModule(tstate, module_name_object);
    Py_DECREF(module_name_object);
...
CLYNTON_MAY_BE_UNUSED static PyObject *Clynton_GetFilenameObject(PyThreadState *tstate, PyObject *module) {
#if PYTHON_VERSION < 0x300
