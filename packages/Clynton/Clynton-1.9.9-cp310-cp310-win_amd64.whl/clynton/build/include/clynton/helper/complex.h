...
//
#ifndef __CLYNTON_HELPER_COMPLEX_H__
#define __CLYNTON_HELPER_COMPLEX_H__

CLYNTON_MAY_BE_UNUSED static PyObject *BUILTIN_COMPLEX1(PyThreadState *tstate, PyObject *real) {
    CHECK_OBJECT(real);
...
CLYNTON_MAY_BE_UNUSED static PyObject *BUILTIN_COMPLEX2(PyThreadState *tstate, PyObject *real, PyObject *imag) {
    if (real == NULL) {
        assert(imag != NULL);
