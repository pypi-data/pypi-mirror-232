 ...
 *
 * These make the actual built-in importing mechanic work with Clynton. We
...
CLYNTON_DEFINE_BUILTIN(__import__);
...
PyObject *IMPORT_MODULE_KW(PyThreadState *tstate, PyObject *module_name, PyObject *globals, PyObject *locals,
    ...
    CLYNTON_ASSIGN_BUILTIN(__import__);

    PyObject *import_result = CALL_FUNCTION_WITH_KEYARGS(tstate, CLYNTON_ACCESS_BUILTIN(__import__), kw_args);
...
PyObject *IMPORT_MODULE1(PyThreadState *tstate, PyObject *module_name) {
    ...
    PyObject *import_result = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, CLYNTON_ACCESS_BUILTIN(__import__), module_name);
...
PyObject *IMPORT_MODULE2(PyThreadState *tstate, PyObject *module_name, PyObject *globals) {
    ...
    PyObject *import_result = CALL_FUNCTION_WITH_ARGS2(tstate, CLYNTON_ACCESS_BUILTIN(__import__), pos_args);
...
PyObject *IMPORT_MODULE3(PyThreadState *tstate, PyObject *module_name, PyObject *globals, PyObject *locals) {
    ...
    PyObject *import_result = CALL_FUNCTION_WITH_ARGS3(tstate, CLYNTON_ACCESS_BUILTIN(__import__), pos_args);
...
PyObject *IMPORT_MODULE4(PyThreadState *tstate, PyObject *module_name, PyObject *globals, PyObject *locals,
    ...
    PyObject *import_result = CALL_FUNCTION_WITH_ARGS4(tstate, CLYNTON_ACCESS_BUILTIN(__import__), pos_args);
...
PyObject *IMPORT_MODULE5(PyThreadState *tstate, PyObject *module_name, PyObject *globals, PyObject *locals,
    ...
    CLYNTON_ASSIGN_BUILTIN(__import__);
    PyObject *import_function = CLYNTON_ACCESS_BUILTIN(__import__);
...
bool IMPORT_MODULE_STAR(PyThreadState *tstate, PyObject *target, bool is_module, PyObject *module) {
    ...
    for (;;) {
        ...
        if (all_case == false) {
            if (Clynton_String_AsString_Unchecked(item)[0] == '_') {
                continue;
            }
        }
...
PyObject *IMPORT_NAME_FROM_MODULE(PyThreadState *tstate, PyObject *module, PyObject *import_name) {
    ...
    if (unlikely(result == NULL)) {
        if (CHECK_AND_CLEAR_ATTRIBUTE_ERROR_OCCURRED(tstate)) {
            ...
            PyObject *filename = Clynton_GetFilenameObject(tstate, module);
...
#elif PYTHON_VERSION >= 0x340 || !defined(_CLYNTON_FULL_COMPAT)
            PyErr_Format(PyExc_ImportError, "cannot import name '%s'", Clynton_String_AsString(import_name));
#else
            PyErr_Format(PyExc_ImportError, "cannot import name %s", Clynton_String_AsString(import_name));
#endif
        }
...
static PyObject *resolveParentModuleName(PyThreadState *tstate, PyObject *module, PyObject *name, int level) {
    ...
    if (package != NULL) {
        ...
        if (spec != NULL && spec != Py_None) {
            ...
            clynton_bool nbool_equal = RICH_COMPARE_EQ_NBOOL_OBJECT_OBJECT(package, parent);

            Py_DECREF(parent);

            if (unlikely(nbool_equal == CLYNTON_BOOL_EXCEPTION)) {
                return NULL;
            }

            if (unlikely(nbool_equal == CLYNTON_BOOL_FALSE)) {
        ...
        if (EXCEPTION_MATCH_BOOL_SINGLE(tstate, GET_ERROR_OCCURRED(tstate), PyExc_AttributeError)) {
            ...
            if (level_int > 0) {
                ...
                if (result != NULL) {
                    ...
                    result = Clynton_GetModule(tstate, name);
                }
