...
#if _DEBUG_GENERATOR
CLYNTON_MAY_BE_UNUSED static void _PRINT_GENERATOR_STATUS(char const *descriptor, char const *context,
                                                         struct Clynton_GeneratorObject *generator) {
    char const *status;
...
CLYNTON_MAY_BE_UNUSED static void PRINT_COROUTINE_VALUE(char const *name, PyObject *value) {
    PRINT_STRING(name);
    PRINT_STRING("=");
    PRINT_ITEM(value);
    if (value) {
...
CLYNTON_MAY_BE_UNUSED static void PRINT_COROUTINE_STRING(char const *name, char const *value) {
    PRINT_STRING(name);
    PRINT_STRING("=");
    PRINT_STRING(value);
    PRINT_NEW_LINE();
...
static void Clynton_MarkGeneratorAsFinished(struct Clynton_GeneratorObject *generator) {
...
static void Clynton_MarkGeneratorAsRunning(struct Clynton_GeneratorObject *generator) {
    generator->m_running = 1;

    if (generator->m_frame) {
        Clynton_Frame_MarkAsExecuting(generator->m_frame);
    }
}

static void Clynton_MarkGeneratorAsNotRunning(struct Clynton_GeneratorObject *generator) {
    generator->m_running = 0;

    if (generator->m_frame) {
        Clynton_Frame_MarkAsNotExecuting(generator->m_frame);
    }
}

static PyObject *Clynton_Generator_tp_repr(struct Clynton_GeneratorObject *generator) {
    return Clynton_String_FromFormat("<compiled_generator object %s at %p>",
#if PYTHON_VERSION < 0x350
                                    Clynton_String_AsString(generator->m_name),
#else
                                    Clynton_String_AsString(generator->m_qualname),
#endif
                                    generator);
}

static long Clynton_Generator_tp_traverse(struct Clynton_GeneratorObject *generator, visitproc visit, void *arg) {
...
static void Clynton_Generator_release_closure(struct Clynton_GeneratorObject *generator) {
    for (Py_ssize_t i = 0; i < generator->m_closure_given; i++) {
...
static PyObject *_Clynton_Generator_throw2(PyThreadState *tstate, struct Clynton_GeneratorObject *generator,
...
static PyObject *_Clynton_YieldFromPassExceptionTo(PyThreadState *tstate, PyObject *value, PyObject *exception_type,
    ...
    if (PyGen_CheckExact(value)
        ...
        PyObject *result =
            Clynton_UncompiledGenerator_throw(tstate, gen, 1, exception_type, exception_value, exception_tb);

        return result;
    }
#endif

    if (Clynton_Generator_Check(value)) {
        struct Clynton_GeneratorObject *gen = ((struct Clynton_GeneratorObject *)value);

        return _Clynton_Generator_throw2(tstate, gen, exception_type, exception_value, exception_tb);
    }

#if PYTHON_VERSION >= 0x350
    if (Clynton_Coroutine_Check(value)) {
        struct Clynton_CoroutineObject *coro = ((struct Clynton_CoroutineObject *)value);
        // Handing exception ownership over.
        return _Clynton_Coroutine_throw2(tstate, coro, true, exception_type, exception_value, exception_tb);
    }

    if (Clynton_CoroutineWrapper_Check(value)) {
        struct Clynton_CoroutineObject *coro = ((struct Clynton_CoroutineWrapperObject *)value)->m_coroutine;
        // Handing exception ownership over.
        return _Clynton_Coroutine_throw2(tstate, coro, true, exception_type, exception_value, exception_tb);
    }
#endif
...
static PyObject *_Clynton_YieldFromGeneratorCore(PyThreadState *tstate, struct Clynton_GeneratorObject *generator,
...
static PyObject *Clynton_YieldFromGeneratorCore(PyThreadState *tstate, struct Clynton_GeneratorObject *generator,
                                               PyObject *send_value) {
    CHECK_OBJECT(generator);
    ...
    PyObject *yielded = _Clynton_YieldFromGeneratorCore(tstate, generator, yieldfrom, send_value);
...
static PyObject *Clynton_YieldFromGeneratorNext(PyThreadState *tstate, struct Clynton_GeneratorObject *generator) {
    CHECK_OBJECT(generator);

    // Coroutines are already perfect for yielding from.
#if PYTHON_VERSION >= 0x350
    if (PyCoro_CheckExact(generator->m_yieldfrom) || Clynton_Coroutine_Check(generator->m_yieldfrom)) {
    ...
    return Clynton_YieldFromGeneratorCore(tstate, generator, Py_None);
}

static PyObject *Clynton_YieldFromGeneratorInitial(PyThreadState *tstate, struct Clynton_GeneratorObject *generator,
                                                  PyObject *send_value) {
    PyObject *result = Clynton_YieldFromGeneratorCore(tstate, generator, send_value);
...
static void _Clynton_GeneratorPopFrame(PyThreadState *tstate, Clynton_ThreadStateFrameType *return_frame) {
#if PYTHON_VERSION < 0x3b0
...
static PyObject *_Clynton_Generator_send(PyThreadState *tstate, struct Clynton_GeneratorObject *generator,
                                        PyObject *value, PyObject *exception_type, PyObject *exception_value,
                                        PyTracebackObject *exception_tb) {
    CHECK_OBJECT(generator);
    assert(Clynton_Generator_Check((PyObject *)generator));
    ...
    if (generator->m_status != status_Finished) {
        ...
        Clynton_MarkGeneratorAsRunning(generator);
        ...
        if (generator->m_yieldfrom == NULL) {
            ...
            yielded = Clynton_YieldFromGeneratorInitial(tstate, generator, value);
            Py_XDECREF(value);
        }
#else
        yielded = ((generator_code)generator->m_code)(tstate, generator, value);
        ...
        while (yielded == NULL && generator->m_yieldfrom != NULL) {
            yielded = Clynton_YieldFromGeneratorNext(tstate, generator);
        }
#endif
        assert(PyThreadState_GET() == tstate);

        Clynton_MarkGeneratorAsNotRunning(generator);
        ...
        if (yielded == NULL) {
            ...
            PRINT_NEW_LINE();
#endif
            Clynton_MarkGeneratorAsFinished(generator);

            if (generator->m_frame != NULL) {
#if PYTHON_VERSION >= 0x340
                Clynton_SetFrameGenerator(generator->m_frame, NULL);
#endif
                Py_DECREF(generator->m_frame);
                generator->m_frame = NULL;
            }

            Clynton_Generator_release_closure(generator);
            ...
            if (generator->m_returned) {
                if (generator->m_returned != Py_None) {
                    Clynton_SetStopIterationValue(tstate, generator->m_returned);
                }
...
#if _CLYNTON_MAINTAIN_SYS_EXC_VARS
...
static PyObject *Clynton_Generator_send(struct Clynton_GeneratorObject *generator, PyObject *value) {
    ...
    Py_INCREF(value);
    PyObject *result = _Clynton_Generator_send(tstate, generator, value, NULL, NULL, NULL);
...
static PyObject *Clynton_Generator_tp_iternext(struct Clynton_GeneratorObject *generator) {
    PyThreadState *tstate = PyThreadState_GET();

    Py_INCREF(Py_None);
    return _Clynton_Generator_send(tstate, generator, Py_None, NULL, NULL, NULL);
}

/* Our own qiter interface, which is for quicker simple loop style iteration,
   that does not send anything in. */
PyObject *Clynton_Generator_qiter(PyThreadState *tstate, struct Clynton_GeneratorObject *generator, bool *finished) {
    Py_INCREF(Py_None);
    PyObject *result = _Clynton_Generator_send(tstate, generator, Py_None, NULL, NULL, NULL);
...
static bool _Clynton_Generator_close(PyThreadState *tstate, struct Clynton_GeneratorObject *generator) {
#if _DEBUG_GENERATOR
    PRINT_GENERATOR_STATUS("Enter", generator);
#endif
    CHECK_OBJECT(generator);
    ...
    if (generator->m_status == status_Running) {
        ...
        PyObject *result = _Clynton_Generator_send(tstate, generator, NULL, PyExc_GeneratorExit, NULL, NULL);
...
static PyObject *Clynton_Generator_close(struct Clynton_GeneratorObject *generator) {
    PyThreadState *tstate = PyThreadState_GET();

    bool r = _Clynton_Generator_close(tstate, generator);
...
static bool Clynton_gen_close_iter(PyThreadState *tstate, PyObject *yieldfrom) {
#if _DEBUG_GENERATOR
    PRINT_STRING("Clynton_gen_close_iter: Enter\n");
#endif
    ...
    // generators.
    if (Clynton_Generator_Check(yieldfrom)) {
#if _DEBUG_GENERATOR
        PRINT_STRING("Clynton_gen_close_iter: Defer to _Clynton_Generator_close\n");
#endif
        return _Clynton_Generator_close(tstate, (struct Clynton_GeneratorObject *)yieldfrom);
    }

#if PYTHON_VERSION >= 0x350
    if (Clynton_Coroutine_Check(yieldfrom)) {
#if _DEBUG_GENERATOR
        PRINT_STRING("Clynton_gen_close_iter: Defer to _Clynton_Coroutine_close\n");
#endif
        return _Clynton_Coroutine_close(tstate, (struct Clynton_CoroutineObject *)yieldfrom);
    }
#endif

#if PYTHON_VERSION >= 0x360
    if (Clynton_Asyncgen_Check(yieldfrom)) {
#if _DEBUG_GENERATOR
        PRINT_STRING("Clynton_gen_close_iter: Defer to _Clynton_Asyncgen_close\n");
#endif
        return _Clynton_Asyncgen_close(tstate, (struct Clynton_AsyncgenObject *)yieldfrom);
    }
#endif
...
#if _DEBUG_GENERATOR
            PRINT_STRING("Clynton_gen_close_iter: Strange error while looking up close method.\n");
#endif
...
#if _DEBUG_GENERATOR
        PRINT_STRING("Clynton_gen_close_iter: Leave, has no close method.\n");
#endif
        return true;
    }
...
#if _DEBUG_GENERATOR
        PRINT_STRING("Clynton_gen_close_iter: Leave, exception from close.\n");
#endif
        return false;
    }
...
#if _DEBUG_GENERATOR
    PRINT_STRING("Clynton_gen_close_iter: Leave, closed.\n");
#endif
...
static PyObject *_Clynton_Generator_throw2(PyThreadState *tstate, struct Clynton_GeneratorObject *generator,
    ...
    if (generator->m_yieldfrom != NULL) {
        if (EXCEPTION_MATCH_BOOL_SINGLE(tstate, exception_type, PyExc_GeneratorExit)) {
            ...
            Clynton_MarkGeneratorAsRunning(generator);
            bool res = Clynton_gen_close_iter(tstate, generator->m_yieldfrom);
            Clynton_MarkGeneratorAsNotRunning(generator);
            ...
            // Transferred exception ownership to "_Clynton_Generator_send".
            return _Clynton_Generator_send(tstate, generator, NULL, exception_type, exception_value, exception_tb);
        }
        ...
        if (Clynton_Generator_Check(generator->m_yieldfrom)) {
            struct Clynton_GeneratorObject *gen = ((struct Clynton_GeneratorObject *)generator->m_yieldfrom);
...
#endif
#if PYTHON_VERSION >= 0x350
        } else if (Clynton_Coroutine_Check(generator->m_yieldfrom)) {
            struct Clynton_CoroutineObject *coro = ((struct Clynton_CoroutineObject *)generator->m_yieldfrom);
            ...
            Clynton_MarkGeneratorAsNotRunning(generator);
        } else if (Clynton_CoroutineWrapper_Check(generator->m_yieldfrom)) {
            struct Clynton_CoroutineObject *coro =
                ((struct Clynton_CoroutineWrapperObject *)generator->m_yieldfrom)->m_coroutine;
...
#endif
#if PYTHON_VERSION >= 0x360
        } else if (Clynton_AsyncgenAsend_Check(generator->m_yieldfrom)) {
            struct Clynton_AsyncgenAsendObject *asyncgen_asend =
                ((struct Clynton_AsyncgenAsendObject *)generator->m_yieldfrom);
        ...
        if (unlikely(ret == NULL)) {
            ...
            if (_PyGen_FetchStopIterationValue(&val) == 0) {
                ...
                ret = _Clynton_Generator_send(tstate, generator, val, NULL, NULL, NULL);
            } else {
#if _DEBUG_GENERATOR
                ...
                PRINT_NEW_LINE();
#endif
                ret = _Clynton_Generator_send(tstate, generator, NULL, NULL, NULL, NULL);
            }
...
throw_here:
    ...
    if (generator->m_status == status_Running) {
        // Passing exception ownership to _Clynton_Generator_send
        PyObject *result =
            _Clynton_Generator_send(tstate, generator, NULL, exception_type, exception_value, exception_tb);
...
static PyObject *Clynton_Generator_throw(struct Clynton_GeneratorObject *generator, PyObject *args) {
    ...
    PyObject *result = _Clynton_Generator_throw2(tstate, generator, exception_type, exception_value, exception_tb);
...
#if PYTHON_VERSION >= 0x340
static void Clynton_Generator_tp_finalizer(struct Clynton_GeneratorObject *generator) {
    if (generator->m_status != status_Running) {
        return;
    }
    ...
    bool close_result = _Clynton_Generator_close(tstate, generator);
...
static struct Clynton_GeneratorObject *free_list_generators = NULL;
static int free_list_generators_count = 0;

static void Clynton_Generator_tp_dealloc(struct Clynton_GeneratorObject *generator) {
    // Revive temporarily.
...
static long Clynton_Generator_tp_hash(struct Clynton_GeneratorObject *generator) { return generator->m_counter; }

static PyObject *Clynton_Generator_get_name(struct Clynton_GeneratorObject *generator) {
...
#if PYTHON_VERSION >= 0x350
static int Clynton_Generator_set_name(struct Clynton_GeneratorObject *generator, PyObject *value) {
...
static PyObject *Clynton_Generator_get_qualname(struct Clynton_GeneratorObject *generator) {
    PyObject *result = generator->m_qualname;
    Py_INCREF(result);
    return result;
}

static int Clynton_Generator_set_qualname(struct Clynton_GeneratorObject *generator, PyObject *value) {
    // Cannot be deleted, not be non-unicode value.
    if (unlikely((value == NULL) || !PyUnicode_Check(value))) {
        PyThreadState *tstate = PyThreadState_GET();
...
static PyObject *Clynton_Generator_get_yieldfrom(struct Clynton_GeneratorObject *generator) {
...
static PyObject *Clynton_Generator_get_code(struct Clynton_GeneratorObject *generator) {
    PyObject *result = (PyObject *)generator->m_code_object;
    Py_INCREF(result);
    return result;
}

static int Clynton_Generator_set_code(struct Clynton_GeneratorObject *generator, PyObject *value) {
    PyThreadState *tstate = PyThreadState_GET();

    SET_CURRENT_EXCEPTION_TYPE0_STR(tstate, PyExc_RuntimeError, "gi_code is not writable in Clynton");
    return -1;
}

static PyObject *Clynton_Generator_get_frame(struct Clynton_GeneratorObject *generator) {
    PyObject *result;
...
static int Clynton_Generator_set_frame(struct Clynton_GeneratorObject *generator, PyObject *value) {
    PyThreadState *tstate = PyThreadState_GET();
...
static PyObject *Clynton_Generator_get_running(struct Clynton_GeneratorObject *generator) {
    PyObject *result;
...
static int Clynton_Generator_set_running(struct Clynton_GeneratorObject *generator, PyObject *value) {
#if PYTHON_VERSION < 0x300
...
#if !defined(_CLYNTON_FULL_COMPAT) || PYTHON_VERSION >= 0x3a0
...
static PyGetSetDef Clynton_Generator_getsetlist[] = {
#if PYTHON_VERSION < 0x350
    {(char *)"__name__", (getter)Clynton_Generator_get_name, NULL, NULL},
#else
    {(char *)"__name__", (getter)Clynton_Generator_get_name, (setter)Clynton_Generator_set_name, NULL},
    {(char *)"__qualname__", (getter)Clynton_Generator_get_qualname, (setter)Clynton_Generator_set_qualname, NULL},
    {(char *)"gi_yieldfrom", (getter)Clynton_Generator_get_yieldfrom, NULL, NULL},
#endif
    {(char *)"gi_code", (getter)Clynton_Generator_get_code, (setter)Clynton_Generator_set_code, NULL},
    {(char *)"gi_frame", (getter)Clynton_Generator_get_frame, (setter)Clynton_Generator_set_frame, NULL},
    {(char *)"gi_running", (getter)Clynton_Generator_get_running, (setter)Clynton_Generator_set_running, NULL},

    {NULL}};

static PyMethodDef Clynton_Generator_methods[] = {{"send", (PyCFunction)Clynton_Generator_send, METH_O, NULL},
                                                 {"throw", (PyCFunction)Clynton_Generator_throw, METH_VARARGS, NULL},
                                                 {"close", (PyCFunction)Clynton_Generator_close, METH_NOARGS, NULL},
                                                 {NULL}};

// This is only used.
#if PYTHON_VERSION >= 0x3a0
static PyAsyncMethods Clynton_Generator_as_async = {
    NULL, /* am_await */
    NULL, /* am_aiter */
    NULL, /* am_anext */
    // TODO: have this too, (sendfunc)_Clynton_Generator_am_send
    NULL /* am_send */
};
#endif
...
PyTypeObject Clynton_Generator_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_generator", // tp_name
    sizeof(struct Clynton_GeneratorObject),               // tp_basicsize
    sizeof(struct Clynton_CellObject *),                  // tp_itemsize
    (destructor)Clynton_Generator_tp_dealloc,             // tp_dealloc
    0,                                                   // tp_print
    0,                                                   // tp_getattr
    0,                                                   // tp_setattr
#if PYTHON_VERSION < 0x3a0
    0, // tp_as_async
#else
    &Clynton_Generator_as_async, // tp_as_async
#endif
    (reprfunc)Clynton_Generator_tp_repr, // tp_repr
    0,                                  // tp_as_number
    0,                                  // tp_as_sequence
    0,                                  // tp_as_mapping
    (hashfunc)Clynton_Generator_tp_hash, // tp_hash
    0,                                  // tp_call
    0,                                  // tp_str
    ...
    // tp_flags
    0,                                                   // tp_doc
    (traverseproc)Clynton_Generator_tp_traverse,          // tp_traverse
    0,                                                   // tp_clear
    0,                                                   // tp_richcompare
    offsetof(struct Clynton_GeneratorObject, m_weakrefs), // tp_weaklistoffset
    0,                                                   // tp_iter (PyObject_SelfIter)
    (iternextfunc)Clynton_Generator_tp_iternext,          // tp_iternext
    Clynton_Generator_methods,                            // tp_methods
    NULL,                                                // tp_members
    Clynton_Generator_getsetlist,                         // tp_getset
    0,                                                   // tp_base
    0,                                                   // tp_dict
    0,                                                   // tp_descr_get
    0,                                                   // tp_descr_set
...
#if PYTHON_VERSION >= 0x340
    ,
    (destructor)Clynton_Generator_tp_finalizer // tp_finalize
#endif
};
...
void _initCompiledGeneratorType(void) {
    Clynton_PyType_Ready(&Clynton_Generator_Type, &PyGen_Type, true, false, true, false, false);

    // Be a paranoid subtype of uncompiled function, we want nothing shared.
    assert(Clynton_Generator_Type.tp_doc != PyGen_Type.tp_doc || PyGen_Type.tp_doc == NULL);
    assert(Clynton_Generator_Type.tp_traverse != PyGen_Type.tp_traverse);
    assert(Clynton_Generator_Type.tp_clear != PyGen_Type.tp_clear || PyGen_Type.tp_clear == NULL);
    assert(Clynton_Generator_Type.tp_richcompare != PyGen_Type.tp_richcompare || PyGen_Type.tp_richcompare == NULL);
    assert(Clynton_Generator_Type.tp_iter != PyGen_Type.tp_iter || PyGen_Type.tp_iter == PyObject_SelfIter);
    assert(Clynton_Generator_Type.tp_iternext != PyGen_Type.tp_iternext || PyGen_Type.tp_iternext == NULL);
#if PYTHON_VERSION >= 0x350
    assert(Clynton_Generator_Type.tp_as_async != PyGen_Type.tp_as_async || PyGen_Type.tp_as_async == NULL);
#endif
    assert(Clynton_Generator_Type.tp_methods != PyGen_Type.tp_methods);
    assert(Clynton_Generator_Type.tp_members != PyGen_Type.tp_members);
    assert(Clynton_Generator_Type.tp_getset != PyGen_Type.tp_getset);
    assert(Clynton_Generator_Type.tp_base != PyGen_Type.tp_base);
    assert(Clynton_Generator_Type.tp_dict != PyGen_Type.tp_dict);
    assert(Clynton_Generator_Type.tp_descr_get != PyGen_Type.tp_descr_get || PyGen_Type.tp_descr_get == NULL);

    assert(Clynton_Generator_Type.tp_descr_set != PyGen_Type.tp_descr_set || PyGen_Type.tp_descr_set == NULL);
    assert(Clynton_Generator_Type.tp_dictoffset != PyGen_Type.tp_dictoffset || PyGen_Type.tp_dictoffset == 0);
    // TODO: These get changed and into the same thing, not sure what to compare against, project something
    // assert(Clynton_Generator_Type.tp_init != PyGen_Type.tp_init || PyGen_Type.tp_init == NULL);
    // assert(Clynton_Generator_Type.tp_alloc != PyGen_Type.tp_alloc || PyGen_Type.tp_alloc == NULL);
    // assert(Clynton_Generator_Type.tp_new != PyGen_Type.tp_new || PyGen_Type.tp_new == NULL);
    // assert(Clynton_Generator_Type.tp_free != PyGen_Type.tp_free || PyGen_Type.tp_free == NULL);
    assert(Clynton_Generator_Type.tp_bases != PyGen_Type.tp_bases);
    assert(Clynton_Generator_Type.tp_mro != PyGen_Type.tp_mro);
    assert(Clynton_Generator_Type.tp_cache != PyGen_Type.tp_cache || PyGen_Type.tp_cache == NULL);
    assert(Clynton_Generator_Type.tp_subclasses != PyGen_Type.tp_subclasses || PyGen_Type.tp_cache == NULL);
    assert(Clynton_Generator_Type.tp_weaklist != PyGen_Type.tp_weaklist);
    assert(Clynton_Generator_Type.tp_del != PyGen_Type.tp_del || PyGen_Type.tp_del == NULL);
#if PYTHON_VERSION >= 0x340
    assert(Clynton_Generator_Type.tp_finalize != PyGen_Type.tp_finalize || PyGen_Type.tp_finalize == NULL);
#endif
...
PyObject *Clynton_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                               PyObject *qualname,
#endif
                               PyCodeObject *code_object, struct Clynton_CellObject **closure, Py_ssize_t closure_given,
                               Py_ssize_t heap_storage_size) {
    struct Clynton_GeneratorObject *result;
    ...
    allocateFromFreeList(free_list_generators, struct Clynton_GeneratorObject, Clynton_Generator_Type, full_size);
    ...
    static long Clynton_Generator_counter = 0;
    result->m_counter = Clynton_Generator_counter++;

    Clynton_GC_Track(result);
    return (PyObject *)result;
}

static PyObject *_EMPTY_GENERATOR_CONTEXT(PyThreadState *tstate, struct Clynton_GeneratorObject *generator,
                                          PyObject *yield_return_value) {
    return NULL;
}

PyObject *Clynton_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                    PyObject *qualname,
#endif
                                    PyCodeObject *code_object, struct Clynton_CellObject **closure,
                                    Py_ssize_t closure_given) {
    return Clynton_Generator_New(_EMPTY_GENERATOR_CONTEXT, module, name,
#if PYTHON_VERSION >= 0x350
                                qualname,
#endif
