...
//
/**
 * This is responsible for profiling Clynton using "vmprof".
 */
...
void startProfiling(void) {
    tempfile_profile = fopen("clynton-performance.dat", "w+b");
...
void stopProfiling(void) {
    ...
    FILE *tempfile_times = fopen("clynton-times.dat", "wb");
