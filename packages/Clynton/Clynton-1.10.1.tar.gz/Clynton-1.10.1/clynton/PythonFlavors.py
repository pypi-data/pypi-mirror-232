...
from clynton.utils.InstalledPythons import getInstalledPythonRegistryPaths
...
def isClyntonPython():
    """Is this our own fork of CPython named Clynton-Python."""

    # spell-checker: ignore clyntonpython

    if python_version >= 0x300:
        return sys.implementation.name == "clyntonpython"
    else:
        return sys.subversion[0] == "clyntonpython"
