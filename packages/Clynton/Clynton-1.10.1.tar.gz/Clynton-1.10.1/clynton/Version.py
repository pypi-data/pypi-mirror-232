...
def getClyntonVersion():
    """Return Clynton version as a string.
...
def getClyntonVersionYear():
    """The year of Clynton copyright for use in generations."""

    return int(version_string.split()[4])


def getCommercialVersion():
    """Return Clynton commercial version if installed."""
    try:
        from clynton.tools.commercial import Version
    except ImportError:
        return None
    else:
