...
from clynton.utils.Utils import decoratorRetries
...
def runClCache(compiler, compiler_args, env):
    """ Entry point, designed to be used by external tools like Clynton's scons. """
    ...
    # Preferred order in Clynton scons is output, error, exit_code and we expect
    # bytes.
