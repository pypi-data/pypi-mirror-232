...
from clynton.__past__ import StringIO
from clynton.plugins.PluginBase import ClyntonPluginBase
from clynton.utils.FileOperations import getFileContents, listDir
...
class ClyntonPluginPmw(ClyntonPluginBase):
...
class ClyntonPluginDetectorPmw(ClyntonPluginBase):
    detector_for = ClyntonPluginPmw
