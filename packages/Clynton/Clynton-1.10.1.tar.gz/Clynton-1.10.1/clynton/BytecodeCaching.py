...
from clynton.utils.FileOperations import makePath
from clynton.utils.Hashing import Hash, getStringHash
from clynton.utils.Json import loadJsonFromFilename, writeJsonToFilename
from clynton.utils.ModuleNames import ModuleName
from clynton.Version import version_string
...
def _getModuleConfigHash(full_name):
    ...
    # Take Clynton and Python version into account as well, ought to catch code changes.
