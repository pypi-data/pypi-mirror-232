...
from clynton import ModuleRegistry, Options, Variables
from clynton.importing.Importing import addExtraSysPaths
from clynton.importing.Recursion import considerUsedModules
...
from clynton.Tracing import general, optimization_logger, progress_logger
from clynton.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from clynton.nodes.NodeBases import fromXML
    from clynton.TreeXML import fromString
