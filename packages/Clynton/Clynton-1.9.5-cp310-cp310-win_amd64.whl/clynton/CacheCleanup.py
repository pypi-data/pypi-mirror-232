...
#
""" Cleanup of caches for Clynton.

This is triggered by "--clean-cache=" usage, and can cleanup all kinds of
caches and is supposed to run before or instead of Clynton compilation.
"""

import os

from clynton.BytecodeCaching import getBytecodeCacheDir
from clynton.Tracing import cache_logger
from clynton.utils.AppDirs import getCacheDir
from clynton.utils.FileOperations import removeDirectory


def _cleanCacheDirectory(cache_name, cache_dir):
    from clynton.Options import shallCleanCache
