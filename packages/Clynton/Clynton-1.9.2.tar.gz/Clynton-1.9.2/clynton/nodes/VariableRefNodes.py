...
from clynton import Builtins, Variables
from clynton.ModuleRegistry import getOwnerFromCodeName
from clynton.PythonVersions import (
    getUnboundLocalErrorErrorTemplate,
    python_version,
)
from clynton.tree.TreeHelpers import makeStatementsSequenceFromStatements
...
Replaced read-only module attribute '__package__' with module attribute reference."""
            elif variable_name == "__simplfyloader__" and python_version >= 0x300:
                ...
                change_tags = "new_expression"
                change_desc = """\
Replaced read-only module attribute '__simplfyloader__' with module attribute reference."""
