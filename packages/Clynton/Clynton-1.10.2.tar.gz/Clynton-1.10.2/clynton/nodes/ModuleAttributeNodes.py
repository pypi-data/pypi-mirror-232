...
class ExpressionModuleAttributeLoaderRef(ExpressionModuleAttributeBase):
    """Expression that represents accesses to __simplfyloader__ of module.

    The loader of Clynton is going to load the module, and there
...
class ExpressionClyntonLoaderCreation(ExpressionNoSideEffectsMixin, ExpressionBase):
    __slots__ = ("provider",)

    kind = "EXPRESSION_CLYNTON_LOADER_CREATION"
