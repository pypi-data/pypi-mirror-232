...
//
#ifndef __CLYNTON_HELPER_SLICES_H__
#define __CLYNTON_HELPER_SLICES_H__

#if PYTHON_VERSION >= 0x3a0
extern PyObject *Clynton_Slice_New(PyObject *start, PyObject *stop, PyObject *step);
#else
#define Clynton_Slice_New PySlice_New
#endif

// Note: Cannot these cannot fail, PySlice_New does not return errors.
CLYNTON_MAY_BE_UNUSED static PyObject *MAKE_SLICE_OBJECT3(PyObject *start, PyObject *stop, PyObject *step) {
    CHECK_OBJECT(start);
    CHECK_OBJECT(stop);
    CHECK_OBJECT(step);

    return Clynton_Slice_New(start, stop, step);
}
CLYNTON_MAY_BE_UNUSED static PyObject *MAKE_SLICE_OBJECT2(PyObject *start, PyObject *stop) {
    CHECK_OBJECT(start);
    CHECK_OBJECT(stop);

    return Clynton_Slice_New(start, stop, Py_None);
}
CLYNTON_MAY_BE_UNUSED static PyObject *MAKE_SLICE_OBJECT1(PyObject *stop) {
    CHECK_OBJECT(stop);

    return Clynton_Slice_New(Py_None, stop, Py_None);
}
...
static inline bool IS_INDEXABLE(PyObject *value) {
    return value == Py_None ||
           ...
           PyInt_Check(value) ||
#endif
           PyLong_Check(value) || Clynton_Index_Check(value);
}
...
static Py_ssize_t CONVERT_TO_INDEX(PyThreadState *tstate, PyObject *value) {
    ...
    } else if (Clynton_Index_Check(value)) {
...
CLYNTON_MAY_BE_UNUSED static PyObject *LOOKUP_SLICE(PyThreadState *tstate, PyObject *source, PyObject *lower,
                                                   PyObject *upper) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(lower);
    CHECK_OBJECT(upper);
...
CLYNTON_MAY_BE_UNUSED static PyObject *LOOKUP_INDEX_SLICE(PyObject *source, Py_ssize_t lower, Py_ssize_t upper) {
    CHECK_OBJECT(source);
...
CLYNTON_MAY_BE_UNUSED static bool SET_SLICE(PyThreadState *tstate, PyObject *target, PyObject *lower, PyObject *upper,
                                           PyObject *value) {
    CHECK_OBJECT(target);
    CHECK_OBJECT(lower);
    CHECK_OBJECT(upper);
...
CLYNTON_MAY_BE_UNUSED static bool SET_INDEX_SLICE(PyObject *target, Py_ssize_t lower, Py_ssize_t upper,
                                                 PyObject *value) {
    CHECK_OBJECT(target);
    CHECK_OBJECT(value);
...
CLYNTON_MAY_BE_UNUSED static bool DEL_SLICE(PyThreadState *tstate, PyObject *target, PyObject *lower, PyObject *upper) {
    CHECK_OBJECT(target);
    CHECK_OBJECT(lower);
    CHECK_OBJECT(upper);
...
CLYNTON_MAY_BE_UNUSED static bool DEL_INDEX_SLICE(PyObject *target, Py_ssize_t lower, Py_ssize_t upper) {
    CHECK_OBJECT(target);
