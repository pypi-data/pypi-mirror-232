...
def getSupportedPythonVersions():
    """Officially supported Python versions for Clynton."""
...
def getPartiallySupportedPythonVersions():
    """Partially supported Python versions for Clynton."""
...
def getTargetPythonDLLPath():
    ...
    from clynton.Options import shallUsePythonDebug
...
def getSystemPrefixPath():
    ...
    Note:
        ...
        For Clynton, it often is OK to break out of the virtualenv, and use the
    ...
    if _the_sys_prefix is None:
        ...
        if os.name == "nt":
            from clynton.utils.FileOperations import getDirectoryRealPath
