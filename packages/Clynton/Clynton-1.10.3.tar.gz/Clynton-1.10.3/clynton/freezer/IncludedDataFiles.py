...
DLLs or extension modules, these need to be seen by Clynton as entry points
...
from clynton.OutputDirectories import getStandaloneDirectoryPath
from clynton.Tracing import options_logger
...
from clynton.utils.Utils import isMacOS
