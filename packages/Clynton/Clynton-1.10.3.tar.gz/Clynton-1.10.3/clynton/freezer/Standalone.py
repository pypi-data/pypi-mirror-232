...
from clynton.importing.Importing import getPythonUnpackedSearchPath
...
from clynton.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from clynton.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from clynton import ModuleRegistry
