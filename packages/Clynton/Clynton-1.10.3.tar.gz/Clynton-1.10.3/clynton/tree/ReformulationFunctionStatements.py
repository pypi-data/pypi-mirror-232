...
from clynton.nodes.AsyncgenNodes import (
...
from clynton.nodes.CoroutineNodes import (
...
from clynton.nodes.GeneratorNodes import (
    ExpressionGeneratorObjectBody,
    ExpressionMakeGeneratorObject,
    StatementGeneratorReturnNone,
)
from clynton.nodes.LocalsDictNodes import StatementSetLocalsDictionary
from clynton.nodes.OutlineNodes import ExpressionOutlineFunction
from clynton.nodes.ReturnNodes import StatementReturn, StatementReturnNone
...
from clynton.nodes.VariableReleaseNodes import makeStatementReleaseVariable
from clynton.Options import hasPythonFlagNoAnnotations
from clynton.plugins.Plugins import Plugins, hasActivePlugin
