...
from clynton.nodes.NodeMetaClasses import ClyntonNodeDesignError
from clynton.Options import shallTraceExecution
from clynton.PythonVersions import python_version
from clynton.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "clynton_bool":
...
def assignConstantNoneResult(to_name, emit, context):
    ...
    if to_name.c_type == "clynton_void":
