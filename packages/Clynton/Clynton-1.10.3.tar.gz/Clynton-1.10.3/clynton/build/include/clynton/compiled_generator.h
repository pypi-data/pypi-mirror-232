...
//
#ifndef __CLYNTON_COMPILED_GENERATOR_H__
#define __CLYNTON_COMPILED_GENERATOR_H__
...
// The Clynton_GeneratorObject is the storage associated with a compiled
// generator object instance of which there can be many for each code.
struct Clynton_GeneratorObject {
...
extern PyTypeObject Clynton_Generator_Type;

typedef PyObject *(*generator_code)(PyThreadState *tstate, struct Clynton_GeneratorObject *, PyObject *);

extern PyObject *Clynton_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                      PyObject *qualname,
#endif
...
extern PyObject *Clynton_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                           PyObject *qualname,
#endif
                                           PyCodeObject *code_object, struct Clynton_CellObject **closure,
...
extern PyObject *Clynton_Generator_qiter(PyThreadState *tstate, struct Clynton_GeneratorObject *generator,
                                        bool *finished);

static inline bool Clynton_Generator_Check(PyObject *object) { return Py_TYPE(object) == &Clynton_Generator_Type; }

static inline PyObject *Clynton_Generator_GetName(PyObject *object) {
    return ((struct Clynton_GeneratorObject *)object)->m_name;
}

static inline void SAVE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct Clynton_GeneratorObject *generator) {
...
static inline void RESTORE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct Clynton_GeneratorObject *generator) {
...
extern void Clynton_PreserveHeap(void *dest, ...);
extern void Clynton_RestoreHeap(void *source, ...);

CLYNTON_MAY_BE_UNUSED static void STORE_GENERATOR_EXCEPTION(PyThreadState *tstate,
...
CLYNTON_MAY_BE_UNUSED static void DROP_GENERATOR_EXCEPTION(struct Clynton_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x3b0
