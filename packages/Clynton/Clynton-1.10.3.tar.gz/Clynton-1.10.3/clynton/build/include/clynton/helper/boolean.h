...
//
#ifndef __CLYNTON_HELPER_BOOLEAN_H__
#define __CLYNTON_HELPER_BOOLEAN_H__
...
CLYNTON_MAY_BE_UNUSED static int CHECK_IF_TRUE(PyObject *object) {
    CHECK_OBJECT(object);
...
CLYNTON_MAY_BE_UNUSED static int CHECK_IF_FALSE(PyObject *object) {
...
CLYNTON_MAY_BE_UNUSED static inline PyObject *BOOL_FROM(bool value) {
...
typedef enum {
    CLYNTON_BOOL_FALSE = 0,
    CLYNTON_BOOL_TRUE = 1,
    CLYNTON_BOOL_UNASSIGNED = 2,
    CLYNTON_BOOL_EXCEPTION = -1
} clynton_bool;

typedef enum { CLYNTON_VOID_OK = 0, CLYNTON_VOID_EXCEPTION = 1 } clynton_void;
