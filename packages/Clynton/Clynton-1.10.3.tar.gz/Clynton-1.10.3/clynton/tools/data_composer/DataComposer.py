...
from clynton.__past__ import BytesIO, long, to_byte, unicode, xrange
from clynton.build.DataComposerInterface import deriveModuleConstantsBlobName
from clynton.Builtins import builtin_exception_values_list, builtin_named_values
...
from clynton.Serialization import (
    BlobData,
    BuiltinAnonValue,
...
from clynton.utils.FileOperations import getFileSize, listDir, syncFileOutput
from clynton.utils.Json import writeJsonToFilename
...
def main():
    ...
    data_composer_logger.is_quiet = (
        os.environ.get("CLYNTON_DATA_COMPOSER_VERBOSE", "0") != "1"
    )
