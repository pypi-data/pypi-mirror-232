...
from clynton.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class ClyntonPluginDelvewheel(ClyntonPluginBase):
    ...
    plugin_name = "delvewheel"  # Clynton knows us by this name
    plugin_desc = (
