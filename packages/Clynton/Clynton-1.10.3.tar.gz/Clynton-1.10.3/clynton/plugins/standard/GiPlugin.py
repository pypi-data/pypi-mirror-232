...
from clynton.plugins.PluginBase import ClyntonPluginBase, standalone_only


class ClyntonPluginGi(ClyntonPluginBase):
    plugin_name = "gi"
...
if not os.environ.get("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__clynton_binary_dir, "girepository")"""
