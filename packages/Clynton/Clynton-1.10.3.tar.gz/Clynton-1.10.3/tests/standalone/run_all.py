...
""" Runner for standalone program tests of Clynton.
...
# Find clynton package relative to us. The replacement is for POSIX python
...
from clynton.tools.testing.RuntimeTracing import (
