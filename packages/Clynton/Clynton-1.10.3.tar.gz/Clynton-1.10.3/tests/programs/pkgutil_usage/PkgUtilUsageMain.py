...
# clynton-project: --include-package=package
# clynton-project: --follow-imports
# clynton-project-if: {Commercial} is not None:
#  clynton-project: --embed-data-files-runtime-pattern=*
#  clynton-project: --include-package-data=package
