...
Normally imports are mostly relatively static, but Clynton also attempts to
...
from clynton.__past__ import long, unicode, xrange
from clynton.code_generation.Reports import onMissingTrust
...
from clynton.importing.Recursion import decideRecursion
...
from clynton.specs.BuiltinParameterSpecs import (
    BuiltinParameterSpec,
    extractBuiltinArgs,
)
from clynton.Tracing import unusual_logger
