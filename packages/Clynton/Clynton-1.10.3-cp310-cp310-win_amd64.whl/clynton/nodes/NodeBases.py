...
from clynton import Options, Tracing, TreeXML, Variables
from clynton.__past__ import iterItems
from clynton.Errors import ClyntonNodeError
from clynton.PythonVersions import python_version
from clynton.SourceCodeReferences import SourceCodeReference
...
class NodeBase(NodeMetaClassBase):
    ...
    def makeClone(self):
        try:
            ...
            raise ClyntonNodeError("Problem cloning node", self, e)
