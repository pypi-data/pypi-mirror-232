...
from clynton.build.DataComposerInterface import getConstantBlobFilename
from clynton.finalizations.FinalizeMarkups import getImportedNames
...
from clynton.Tracing import postprocessing_logger
from clynton.utils.Execution import wrapCommandForDebuggerForExec
...
from clynton.utils.Images import convertImageToIconFormat
from clynton.utils.MacOSApp import createPlistInfoFile
from clynton.utils.SharedLibraries import (
    callInstallNameTool,
    cleanupHeaderForAndroid,
)
from clynton.utils.Utils import isAndroidBasedLinux, isMacOS, isWin32Windows
from clynton.utils.WindowsResources import (
    RT_GROUP_ICON,
    RT_ICON,
    RT_RCDATA,
    addResourceToFile,
...
def executePostProcessing():
    ...
    if Options.shallCreateCmdFileForExecution():
        ...
        cmd_contents = """
@echo off
rem This script was created by Clynton to execute '%(exe_filename)s' with Python DLL being found.
set PATH=%(dll_directory)s;%%PATH%%
set ANRANDOMHOME=%(python_home)s
...
""" % {
    ...
    if Options.shallMakeModule() and Options.shallCreatePyiFile():
        ...
        putTextFileContents(
            ...
            contents="""\
# This file was generated by Clynton and describes the types of the
# created shared library.

# At this time it lists only the imports made and can be used by the
# tools that bundle libraries, including Clynton itself. For instance
