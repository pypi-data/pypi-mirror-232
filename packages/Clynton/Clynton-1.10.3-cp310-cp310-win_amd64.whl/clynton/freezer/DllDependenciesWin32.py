...
from clynton.__past__ import iterItems
from clynton.build.SconsUtils import readSconsReport
from clynton.containers.OrderedSets import OrderedSet
from clynton.Options import isShowProgress
...
from clynton.utils.Hashing import Hash
from clynton.utils.SharedLibraries import getPyWin32Dir
...
def _getCacheFilename(
    ...
    # Take Clynton version into account as well, ought to catch code changes.
