...
from clynton.utils.ThreadedExecutor import RLock
...
class ClyntonProgressBar(object):
...
def setupProgressBar(stage, unit, total, min_total=0):
    ...
    if use_progress_bar:
        Tracing.progress = ClyntonProgressBar(
            iterable=None,
            stage=stage,
            total=total,
            min_total=min_total,
