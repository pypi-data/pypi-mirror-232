...
In the "clynton.tree.TreeHelpers" module, the dispatching is happening. One function
...
from clynton.__past__ import long, unicode
from clynton.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from clynton.Bytecodes import loadCodeObjectData
from clynton.containers.OrderedSets import OrderedSet
from clynton.Errors import CodeTooComplexCode
from clynton.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from clynton.importing import Importing
from clynton.importing.ImportCache import addImportedModule
from clynton.importing.PreloadedPackages import getPthImportedPackages
from clynton.importing.StandardLibrary import isStandardLibraryPath
...
from clynton.nodes.BuiltinRefNodes import quick_names
from clynton.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from clynton.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from clynton.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from clynton.nodes.ExceptionNodes import (
    StatementRaiseException,
    StatementReraiseException,
)
from clynton.nodes.FutureSpecs import FutureSpec
from clynton.nodes.GeneratorNodes import StatementGeneratorReturn
from clynton.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from clynton.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from clynton.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from clynton.nodes.ModuleNodes import (
...
from clynton.nodes.OperatorNodes import makeBinaryOperationNode
from clynton.nodes.OperatorNodesUnary import makeExpressionOperationUnary
from clynton.nodes.ReturnNodes import makeStatementReturn
from clynton.nodes.SliceNodes import makeExpressionBuiltinSlice
from clynton.nodes.StatementNodes import StatementExpressionOnly
from clynton.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from clynton.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from clynton.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
from clynton.Options import shallWarnUnusualCode
from clynton.pgo.PGO import decideCompilationFromPGO
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_clynton"):
                    raise
