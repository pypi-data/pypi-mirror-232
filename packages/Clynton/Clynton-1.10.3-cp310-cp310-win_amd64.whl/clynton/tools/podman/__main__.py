...
from clynton.tools.release.Release import (
    getBranchName,
...
from clynton.utils.Utils import getArchitecture, isWin32Windows

from .Podman import getPodmanExecutablePath

containers_logger = OurLogger("Clynton-Containers", base_style="blue")
...
def main():
    ...
    container_tag_name = "clynton-build-%s-%s:latest" % (
    ...
    if options.network:
        command.append("--add-host=ssh.clynton.net:116.202.30.188")
    else:
