...
from clynton.Options import isOnefileMode, isOnefileTempDirMode
from clynton.plugins.PluginBase import ClyntonPluginBase
from clynton.utils.AppDirs import getCacheDir
from clynton.utils.Execution import executeToolChecked, getExecutablePath
from clynton.utils.FileOperations import copyFile, makePath
from clynton.utils.Hashing import Hash, getFileContentsHash
from clynton.utils.Utils import isLinux


class ClyntonPluginUpx(ClyntonPluginBase):
    ...
    plugin_name = "upx"  # Clynton knows us by this name
