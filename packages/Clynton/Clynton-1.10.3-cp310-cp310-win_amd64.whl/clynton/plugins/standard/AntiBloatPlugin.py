...
Clynton hard codes stupid monkey patching normally not needed here and avoids
...
from clynton.ModuleRegistry import getModuleByName
...
class ClyntonPluginAntiBloat(ClyntonPluginBase):
    ...
    def onModuleRecursion(
        ...
        for handled_module_name, (
            ...
            if module_name.hasNamespace(handled_module_name):
                ...
                if mode == "error":
                    raise ClyntonForbiddenImportEncounter(
