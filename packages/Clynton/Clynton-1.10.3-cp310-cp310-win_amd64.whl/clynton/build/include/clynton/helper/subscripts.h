...
//
#ifndef __CLYNTON_HELPER_SUBSCRIPTS_H__
#define __CLYNTON_HELPER_SUBSCRIPTS_H__
...
#if !defined(_CLYNTON_EXPERIMENTAL_DISABLE_SUBSCRIPT_OPT)
...
CLYNTON_MAY_BE_UNUSED static PyObject *LOOKUP_SUBSCRIPT_CONST(PyThreadState *tstate, PyObject *source,
                                                             PyObject *const_subscript, Py_ssize_t int_subscript) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(const_subscript);

#if _CLYNTON_EXPERIMENTAL_DISABLE_SUBSCRIPT_OPT
...
CLYNTON_MAY_BE_UNUSED static PyObject *LOOKUP_SUBSCRIPT(PyThreadState *tstate, PyObject *source, PyObject *subscript) {
    CHECK_OBJECT(source);
    ...
    if (tp_as_mapping != NULL && tp_as_mapping->mp_subscript != NULL) {
        ...
        if (Clynton_Index_Check(subscript)) {
...
CLYNTON_MAY_BE_UNUSED static bool HAS_SUBSCRIPT_CONST(PyThreadState *tstate, PyObject *source, PyObject *const_subscript,
...
CLYNTON_MAY_BE_UNUSED static bool HAS_SUBSCRIPT(PyThreadState *tstate, PyObject *source, PyObject *subscript) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(subscript);
...
CLYNTON_MAY_BE_UNUSED static bool SET_SUBSCRIPT_CONST(PyThreadState *tstate, PyObject *target, PyObject *subscript,
...
CLYNTON_MAY_BE_UNUSED static bool SET_SUBSCRIPT(PyThreadState *tstate, PyObject *target, PyObject *subscript,
                                               PyObject *value) {
    CHECK_OBJECT(value);
    CHECK_OBJECT(target);
    CHECK_OBJECT(subscript);
...
CLYNTON_MAY_BE_UNUSED static bool DEL_SUBSCRIPT(PyObject *target, PyObject *subscript) {
    CHECK_OBJECT(target);
    CHECK_OBJECT(subscript);
