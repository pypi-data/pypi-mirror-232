...
//
#ifndef __CLYNTON_HELPER_LISTS_H__
#define __CLYNTON_HELPER_LISTS_H__
...
#define CLYNTON_LIST_HAS_FREELIST 1
extern PyObject *MAKE_LIST_EMPTY(Py_ssize_t size);
#else
#define CLYNTON_LIST_HAS_FREELIST 0
...
CLYNTON_MAY_BE_UNUSED static PyObject *MAKE_LIST_REPEATED(Py_ssize_t size, PyObject *element) {
