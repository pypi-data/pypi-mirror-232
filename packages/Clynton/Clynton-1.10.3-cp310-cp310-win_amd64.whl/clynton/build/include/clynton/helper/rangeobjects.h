...
//
#ifndef __CLYNTON_HELPER_RANGEOBJECTS_H__
#define __CLYNTON_HELPER_RANGEOBJECTS_H__
...
CLYNTON_MAY_BE_UNUSED static PyObject *PyRange_Start(PyObject *range) { return ((struct _rangeobject3 *)range)->start; }

CLYNTON_MAY_BE_UNUSED static PyObject *PyRange_Stop(PyObject *range) { return ((struct _rangeobject3 *)range)->stop; }

CLYNTON_MAY_BE_UNUSED static PyObject *PyRange_Step(PyObject *range) { return ((struct _rangeobject3 *)range)->step; }
