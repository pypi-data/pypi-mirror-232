...
//
#ifndef __CLYNTON_COMPILED_FUNCTION_H__
#define __CLYNTON_COMPILED_FUNCTION_H__
...
struct Clynton_FunctionObject;

// The actual function code with arguments as an array.
typedef PyObject *(*function_impl_code)(PyThreadState *tstate, struct Clynton_FunctionObject const *, PyObject **);

// The Clynton_FunctionObject is the storage associated with a compiled function
...
extern PyTypeObject Clynton_Function_Type;

// Make a function with context.
#if PYTHON_VERSION < 0x300
extern struct Clynton_FunctionObject *Clynton_Function_New(function_impl_code c_code, PyObject *name,
...
#else
extern struct Clynton_FunctionObject *Clynton_Function_New(function_impl_code c_code, PyObject *name, PyObject *qualname,
                                                         PyCodeObject *code_object, PyObject *defaults,
                                                         PyObject *kwdefaults, PyObject *annotations, PyObject *module,
                                                         PyObject *doc, struct Clynton_CellObject **closure,
                                                         Py_ssize_t closure_given);
#endif

extern void Clynton_Function_EnableConstReturnTrue(struct Clynton_FunctionObject *function);

extern void Clynton_Function_EnableConstReturnFalse(struct Clynton_FunctionObject *function);

extern void Clynton_Function_EnableConstReturnGeneric(struct Clynton_FunctionObject *function, PyObject *value);

static inline bool Clynton_Function_Check(PyObject *object) { return Py_TYPE(object) == &Clynton_Function_Type; }

static inline PyObject *Clynton_Function_GetName(PyObject *object) {
    return ((struct Clynton_FunctionObject *)object)->m_name;
}
