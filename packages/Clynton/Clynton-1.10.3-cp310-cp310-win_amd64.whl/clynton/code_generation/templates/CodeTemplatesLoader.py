...
static struct Clynton_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
...
// in this un-optimized form. These are not compiled by Clynton, and therefore
...
void copyFrozenModulesTo(struct _frozen *destination) {
    CLYNTON_PRINT_TIMING("copyFrozenModulesTo(): Calling _loadBytesCodesBlob.");
    _loadBytesCodesBlob(NULL);

    CLYNTON_PRINT_TIMING("copyFrozenModulesTo(): Updating frozen module table sizes.");
