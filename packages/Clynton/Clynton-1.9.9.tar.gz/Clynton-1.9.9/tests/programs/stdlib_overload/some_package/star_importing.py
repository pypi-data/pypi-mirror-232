...
print("Before", sorted(x for x in dir() if x not in ("__compiled__", "__simplfyloader__")))


lala = 1
print("After", sorted(x for x in dir() if x not in ("__compiled__", "__simplfyloader__")))
