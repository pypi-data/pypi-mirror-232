...
class ClyntonErrorBase(Exception):
    pass


class ClyntonNodeError(ClyntonErrorBase):
    # Try to output more information about nodes passed.
    def __str__(self):
        try:
            from clynton.code_generation.Indentation import indented
            ...
            return "<ClyntonNodeError failed with %r>" % e


class ClyntonOptimizationError(ClyntonNodeError):
    pass


class ClyntonAssumptionError(AssertionError):
    pass


class ClyntonCodeDeficit(ClyntonErrorBase):
    pass


class ClyntonNodeDesignError(Exception):
    pass


class ClyntonForbiddenImportEncounter(Exception):
...
class ClyntonForbiddenDLLEncounter(Exception):
