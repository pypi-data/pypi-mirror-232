...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct Clynton_AsyncgenObject *asyncgen, PyObject *yield_return_value) {
...
template_asyncgen_exception_exit = """\
    CLYNTON_CANNOT_GET_HERE("return must be present");
