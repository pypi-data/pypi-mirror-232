...
from clynton.__past__ import unicode, xrange
from clynton.Errors import ClyntonAssumptionError
from clynton.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from clynton.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from clynton.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from clynton.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from clynton.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from clynton.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from clynton.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from clynton.nodes.BuiltinFormatNodes import (
...
from clynton.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from clynton.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from clynton.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from clynton.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from clynton.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from clynton.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from clynton.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from clynton.nodes.BuiltinRangeNodes import (
...
from clynton.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from clynton.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from clynton.nodes.BuiltinTypeNodes import (
...
from clynton.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from clynton.nodes.CallNodes import makeExpressionCall
from clynton.nodes.ClassNodes import ExpressionBuiltinType3
from clynton.nodes.ComparisonNodes import ExpressionComparisonIs
from clynton.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from clynton.nodes.ConstantRefNodes import makeConstantRefNode
from clynton.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from clynton.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from clynton.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from clynton.nodes.ImportNodes import ExpressionBuiltinImport
from clynton.nodes.KeyValuePairNodes import (
    makeKeyValuePairExpressionsFromKwArgs,
)
from clynton.nodes.NodeMakingHelpers import (
    makeConstantReplacementNode,
    makeExpressionBuiltinLocals,
    makeRaiseExceptionReplacementExpression,
    makeRaiseExceptionReplacementExpressionFromInstance,
)
from clynton.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from clynton.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from clynton.nodes.OutlineNodes import ExpressionOutlineBody
from clynton.nodes.ReturnNodes import makeStatementReturn
from clynton.nodes.SliceNodes import makeExpressionBuiltinSlice
from clynton.nodes.TypeNodes import (
...
from clynton.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from clynton.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from clynton.PythonVersions import python_version
from clynton.specs import BuiltinParameterSpecs
from clynton.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from clynton.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from clynton.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise ClyntonAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from clynton.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from clynton.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise ClyntonAssumptionError("open without argument is expected to raise")
...
def check():
    from clynton.Builtins import builtin_names
