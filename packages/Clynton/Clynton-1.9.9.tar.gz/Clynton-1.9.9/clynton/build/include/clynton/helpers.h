...
//
#ifndef __CLYNTON_HELPERS_H__
#define __CLYNTON_HELPERS_H__

#ifdef _CLYNTON_EXPERIMENTAL_DEBUG_FRAME
#define _DEBUG_FRAME 1
#else
#define _DEBUG_FRAME 0
#endif
#ifdef _CLYNTON_EXPERIMENTAL_DEBUG_REFRAME
#define _DEBUG_REFRAME 1
#else
#define _DEBUG_REFRAME 0
#endif
#ifdef _CLYNTON_EXPERIMENTAL_DEBUG_EXCEPTIONS
#define _DEBUG_EXCEPTIONS 1
#else
#define _DEBUG_EXCEPTIONS 0
#endif
#ifdef _CLYNTON_EXPERIMENTAL_DEBUG_GENERATOR
#define _DEBUG_GENERATOR 1
#else
#define _DEBUG_GENERATOR 0
#endif
#ifdef _CLYNTON_EXPERIMENTAL_DEBUG_COROUTINE
#define _DEBUG_COROUTINE 1
#else
#define _DEBUG_COROUTINE 0
#endif
#ifdef _CLYNTON_EXPERIMENTAL_DEBUG_ASYNCGEN
#define _DEBUG_ASYNCGEN 1
#else
#define _DEBUG_ASYNCGEN 0
#endif
#ifdef _CLYNTON_EXPERIMENTAL_DEBUG_CLASSES
#define _DEBUG_CLASSES 1
#else
#define _DEBUG_CLASSES 0
#endif

#ifdef _CLYNTON_EXPERIMENTAL_REPORT_REFCOUNTS
...
// For profiling of Clynton compiled binaries
#if _CLYNTON_PROFILE
extern void startProfiling(void);
extern void stopProfiling(void);
#endif

#include "clynton/helper/boolean.h"
#include "clynton/helper/dictionaries.h"
#include "clynton/helper/indexes.h"
#include "clynton/helper/mappings.h"
#include "clynton/helper/operations_builtin_types.h"
#include "clynton/helper/sets.h"
#include "clynton/helper/strings.h"

#include "clynton/helper/raising.h"

#include "clynton/helper/richcomparisons.h"
#include "clynton/helper/sequences.h"

static inline bool Clynton_Function_Check(PyObject *object);
static inline PyObject *Clynton_Function_GetName(PyObject *object);

static inline bool Clynton_Generator_Check(PyObject *object);
static inline PyObject *Clynton_Generator_GetName(PyObject *object);

#include "clynton/calling.h"
#include "clynton/helper/bytes.h"
#include "clynton/helper/complex.h"
#include "clynton/helper/floats.h"
#include "clynton/helper/ints.h"

CLYNTON_MAY_BE_UNUSED static PyObject *LOOKUP_VARS(PyThreadState *tstate, PyObject *source) {
    CHECK_OBJECT(source);
...
#include "clynton/helper/attributes.h"
#include "clynton/helper/bytearrays.h"
#include "clynton/helper/iterators.h"
#include "clynton/helper/lists.h"
#include "clynton/helper/rangeobjects.h"
#include "clynton/helper/slices.h"
#include "clynton/helper/subscripts.h"
#include "clynton/helper/tuples.h"

#include "clynton/builtins.h"
...
clynton_bool compareFilePaths(PyThreadState *tstate, PyObject *filename_a, PyObject *filename_b);
...
#include "clynton/importing.h"

// Hard imports have their own helpers.
#include "clynton/helper/import_hard.h"
...
#include "clynton/constants_blob.h"
...
CLYNTON_MAY_BE_UNUSED static PyObject *MODULE_NAME1(PyThreadState *tstate, PyObject *module) {
...
CLYNTON_MAY_BE_UNUSED static PyObject *MODULE_NAME0(PyThreadState *tstate, PyObject *module) {
    assert(PyModule_Check(module));
    PyObject *module_dict = ((PyModuleObject *)module)->md_dict;
...
extern PyTypeObject *Clynton_PyUnion_Type;

// Force a garbage collection, for debugging purposes.
CLYNTON_MAY_BE_UNUSED static void forceGC(void) {
...
#include "clynton/python_pgo.h"

extern PyObject *MAKE_UNION_TYPE(PyObject *args);

extern void Clynton_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
                                bool self_iter, bool await_self_iter, bool self_aiter);

#if PYTHON_VERSION >= 0x3b0
#include "clynton/exception_groups.h"
#endif
