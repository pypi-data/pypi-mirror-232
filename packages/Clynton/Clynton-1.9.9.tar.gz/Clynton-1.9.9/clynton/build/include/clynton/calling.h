...
//
#ifndef __CLYNTON_CALLING_H__
#define __CLYNTON_CALLING_H__
...
CLYNTON_MAY_BE_UNUSED static inline PyObject *Clynton_CheckFunctionResult(PyThreadState *tstate, PyObject *callable,
                                                                        PyObject *result) {
    if (result == NULL) {
        ...
        // Some buggy C functions do this, and Clynton inner workings can get
        // upset from it.
...
CLYNTON_MAY_BE_UNUSED static PyObject *CALL_FUNCTION(PyThreadState *tstate, PyObject *function_object,
    ...
    return Clynton_CheckFunctionResult(tstate, function_object, result);
}
...
CLYNTON_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_POSARGS(PyThreadState *tstate, PyObject *function_object,
...
CLYNTON_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_KEYARGS(PyThreadState *tstate, PyObject *function_object,
                                                                 PyObject *named_args) {
...
#include "clynton/helper/calling_generated.h"
