...
//
#ifndef __CLYNTON_HELPER_BYTEARRAYS_H__
#define __CLYNTON_HELPER_BYTEARRAYS_H__

CLYNTON_MAY_BE_UNUSED static PyObject *BYTEARRAY_COPY(PyThreadState *tstate, PyObject *bytearray) {
