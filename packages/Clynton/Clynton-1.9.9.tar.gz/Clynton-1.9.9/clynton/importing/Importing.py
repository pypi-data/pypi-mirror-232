...
from clynton import Options, SourceCodeReferences
from clynton.__past__ import iter_modules
from clynton.containers.Namedtuples import makeNamedtupleClass
from clynton.containers.OrderedSets import OrderedSet
from clynton.importing import StandardLibrary
from clynton.plugins.Plugins import Plugins
from clynton.PythonFlavors import isClyntonPython
from clynton.PythonVersions import python_version
from clynton.Tracing import my_print, recursion_logger
from clynton.tree.ReformulationMultidist import locateMultidistModule
from clynton.utils.AppDirs import getCacheDir
from clynton.utils.FileOperations import listDir, removeDirectory
from clynton.utils.Importing import (
    getModuleFilenameSuffixes,
    getSharedLibrarySuffixes,
    isBuiltinModuleName,
)
from clynton.utils.ModuleNames import ModuleName
from clynton.utils.SharedLibraries import (
    hasUniversalOrMatchingMacOSArchitecture,
)
from clynton.utils.Utils import isMacOS, isWin32OrPosixWindows
...
def findModule(module_name, parent_package, level):
    ...
    if level < 1 and module_name != "":
        ...
        if python_version >= 0x300 and module_name in sys.modules:
            loader = getattr(sys.modules[module_name], "__simplfyloader__", None)
...
def flushImportCache():
    ...
    files and scan again. This allows that. Nothing in standard Clynton should do it,
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = os.environ.get("CLYNTON_SITE_FILENAME", "")
