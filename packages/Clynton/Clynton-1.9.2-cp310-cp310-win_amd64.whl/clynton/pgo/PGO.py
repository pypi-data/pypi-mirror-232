...
#
"""Python level PGO handling in Clynton."""

import os
import struct

from clynton.__past__ import xrange
from clynton.Options import getPythonPgoUnseenModulePolicy
from clynton.Tracing import pgo_logger
...
def readPGOInputFile(input_filename):
    ...
    with open(input_filename, "rb") as input_file:
        ...
        if header != b"KAY.PGO":
            pgo_logger.sysexit(
                "Error, file '%s' is not a valid PGO input for this version of Clynton."
                % input_filename
            )
