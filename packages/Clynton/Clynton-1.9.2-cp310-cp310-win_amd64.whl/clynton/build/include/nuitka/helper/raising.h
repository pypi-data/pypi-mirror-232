...
//
#ifndef __CLYNTON_HELPER_RAISING_H__
#define __CLYNTON_HELPER_RAISING_H__

#if PYTHON_VERSION >= 0x300
CLYNTON_MAY_BE_UNUSED static void CHAIN_EXCEPTION(PyThreadState *tstate, PyObject *exception_value) {
