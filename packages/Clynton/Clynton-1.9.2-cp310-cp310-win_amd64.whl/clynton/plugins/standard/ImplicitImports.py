...
#
""" Standard plug-in to tell Clynton about implicit imports.
...
from clynton.utils.Yaml import getYamlPackageConfiguration


class ClyntonPluginImplicitImports(ClyntonPluginBase):
    ...
    def onModuleSourceCode(self, module_name, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__clynton_binary_dir + '%ssite.py') if '__clynton_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
