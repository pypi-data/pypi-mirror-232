...
#
""" Directories and paths to for output of Clynton.
...
from clynton.utils.FileOperations import hasFilenameExtension, makePath
from clynton.utils.Importing import getSharedLibrarySuffix
from clynton.utils.Utils import isWin32OrPosixWindows, isWin32Windows
...
def getPgoRunInputFilename():
    return getPgoRunExecutable() + ".clynton-pgo"
