...
//
#ifndef __CLYNTON_COMPILED_COROUTINE_H__
#define __CLYNTON_COMPILED_COROUTINE_H__
...
// The Clynton_CoroutineObject is the storage associated with a compiled
// coroutine object instance of which there can be many for each code.
struct Clynton_CoroutineObject {
    ...
    struct Clynton_CellObject *m_closure[1];
};

extern PyTypeObject Clynton_Coroutine_Type;

typedef PyObject *(*coroutine_code)(PyThreadState *tstate, struct Clynton_CoroutineObject *, PyObject *);

extern PyObject *Clynton_Coroutine_New(PyThreadState *tstate, coroutine_code code, PyObject *module, PyObject *name,
...
static inline bool Clynton_Coroutine_Check(PyObject *object) { return Py_TYPE(object) == &Clynton_Coroutine_Type; }

struct Clynton_CoroutineWrapperObject {
    /* Python object folklore: */
    PyObject_HEAD

        struct Clynton_CoroutineObject *m_coroutine;
};

extern PyTypeObject Clynton_CoroutineWrapper_Type;

static inline bool Clynton_CoroutineWrapper_Check(PyObject *object) {
    return Py_TYPE(object) == &Clynton_CoroutineWrapper_Type;
}

static inline void SAVE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct Clynton_CoroutineObject *coroutine) {
...
static inline void RESTORE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct Clynton_CoroutineObject *coroutine) {
...
CLYNTON_MAY_BE_UNUSED static void STORE_COROUTINE_EXCEPTION(PyThreadState *tstate,
...
CLYNTON_MAY_BE_UNUSED static void DROP_COROUTINE_EXCEPTION(struct Clynton_CoroutineObject *coroutine) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_Clynton_Coroutine_Type;
extern int count_allocated_Clynton_Coroutine_Type;
extern int count_released_Clynton_Coroutine_Type;

extern int count_active_Clynton_CoroutineWrapper_Type;
extern int count_allocated_Clynton_CoroutineWrapper_Type;
extern int count_released_Clynton_CoroutineWrapper_Type;

extern int count_active_Clynton_AIterWrapper_Type;
extern int count_allocated_Clynton_AIterWrapper_Type;
extern int count_released_Clynton_AIterWrapper_Type;
#endif
