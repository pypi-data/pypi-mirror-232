...
from clynton.__past__ import GenericAlias, builtins
...
def _getBuiltinNames():
    ...
    if "__simplfyloader__" in names:
        names.remove("__simplfyloader__")
...
def _getAnonBuiltins():
    ...
    # Can't really have it until we have __clynton__
    # "compiled_function"          : BuiltinFunctionType,
    # "compiled_generator"         : GeneratorType, # see above
    # anon_codes["compiled_function"] =  "&Clynton_Function_Type"
    # anon_codes["compiled_generator"] =  "&Clynton_Generator_Type"
    ...
    if python_version >= 0x270:
        ...
        anon_codes["version_info"] = 'Py_TYPE(Clynton_SysGetObject("version_info"))'
    ...
    if python_version >= 0x3A0:
        ...
        anon_codes["UnionType"] = "Clynton_PyUnion_Type"
