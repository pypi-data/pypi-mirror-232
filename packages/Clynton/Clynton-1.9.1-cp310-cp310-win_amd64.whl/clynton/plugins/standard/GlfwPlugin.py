...
from clynton.utils.FileOperations import getFileContents
...
class ClyntonPluginGlfw(ClyntonPluginBase):
    ...
    plugin_name = "glfw"  # Clynton knows us by this name
    plugin_desc = (
    ...
    def createPreModuleLoadCode(self, module):
        if module.getFullName() == "glfw":
            ...
            code = r"""
import os
os.environ["PYGLFW_LIBRARY"] = os.path.join(__clynton_binary_dir, "glfw", "%s")
""" % os.path.basename(
                dll_filename
            )
            return (
