...
//
#ifndef __CLYNTON_PRELUDE_H__
#define __CLYNTON_PRELUDE_H__
...
#define CLYNTON_USE_PYCORE_THREAD_STATE
#endif

#ifdef CLYNTON_USE_PYCORE_THREAD_STATE
#undef Py_BUILD_CORE
...
#define CLYNTON_NO_RETURN HEDLEY_NO_RETURN
 ...
 */
#ifdef __GNUC__
#define CLYNTON_MAY_BE_UNUSED __attribute__((__unused__))
#else
#define CLYNTON_MAY_BE_UNUSED
#endif

/* This is used to indicate code control flows we know cannot happen. */
#ifndef __CLYNTON_NO_ASSERT__
#define CLYNTON_CANNOT_GET_HERE(NAME)                                                                                   \
    PRINT_FORMAT("%s : %s\n", __FUNCTION__, #NAME);                                                                    \
    assert(false);                                                                                                     \
    abort();
#else
#define CLYNTON_CANNOT_GET_HERE(NAME) abort();
#endif
 ...
 */
#include <malloc.h>
#define CLYNTON_DYNAMIC_ARRAY_DECL(VARIABLE_NAME, ELEMENT_TYPE, COUNT)                                                  \
    ELEMENT_TYPE *VARIABLE_NAME = (ELEMENT_TYPE *)_alloca(sizeof(ELEMENT_TYPE) * (COUNT));
#else
#define CLYNTON_DYNAMIC_ARRAY_DECL(VARIABLE_NAME, ELEMENT_TYPE, COUNT) ELEMENT_TYPE VARIABLE_NAME[COUNT];
#endif
 ...
 */
#if PYTHON_VERSION < 0x300
#define Clynton_String_AsString PyString_AsString
#define Clynton_String_AsString_Unchecked PyString_AS_STRING
#define Clynton_String_Check PyString_Check
#define Clynton_String_CheckExact PyString_CheckExact
#define Clynton_StringObject PyStringObject
#define Clynton_String_FromString PyString_FromString
#define Clynton_String_FromStringAndSize PyString_FromStringAndSize
#define Clynton_String_FromFormat PyString_FromFormat
#define PyUnicode_CHECK_INTERNED (0)
#else
#define Clynton_String_AsString _PyUnicode_AsString
...
#define Clynton_String_AsString_Unchecked PyUnicode_UTF8

#define Clynton_String_Check PyUnicode_Check
#define Clynton_String_CheckExact PyUnicode_CheckExact
#define Clynton_StringObject PyUnicodeObject
#define Clynton_String_FromString PyUnicode_FromString
#define Clynton_String_FromStringAndSize PyUnicode_FromStringAndSize
#define Clynton_String_FromFormat PyUnicode_FromFormat
#endif
...
#ifdef __CLYNTON_NO_ASSERT__
#define Clynton_TypeLookup(x, y) _PyType_Lookup(x, y)
#else
CLYNTON_MAY_BE_UNUSED static PyObject *Clynton_TypeLookup(PyTypeObject *type, PyObject *name) {
...
#if PYTHON_VERSION < 0x300
#define CLYNTON_MODULE_ENTRY_FUNCTION void
#else
#define CLYNTON_MODULE_ENTRY_FUNCTION PyObject *
#endif
 ...
 */
#define CLYNTON_CROSS_MODULE
#define CLYNTON_LOCAL_MODULE static
...
#define Clynton_GC_Track PyObject_GC_Track
#define Clynton_GC_UnTrack PyObject_GC_UnTrack
...
#undef _PyObject_GC_TRACK
#undef _PyObject_GC_UNTRACK
#elif defined(_CLYNTON_MODULE) && PYTHON_VERSION >= 0x370 && PYTHON_VERSION < 0x380
#define Clynton_GC_Track PyObject_GC_Track
#define Clynton_GC_UnTrack PyObject_GC_UnTrack
#undef _PyObject_GC_TRACK
#undef _PyObject_GC_UNTRACK
...
#else
#define Clynton_GC_Track _PyObject_GC_TRACK
#define Clynton_GC_UnTrack _PyObject_GC_UNTRACK
#endif

#if _CLYNTON_EXPERIMENTAL_FAST_THREAD_GET && PYTHON_VERSION >= 0x300 && PYTHON_VERSION < 0x370
...
#if PYTHON_VERSION < 0x300
#define ClyntonType_HasFeatureClass(descr) (PyType_HasFeature(Py_TYPE(descr), Py_TPFLAGS_HAVE_CLASS))
#else
#define ClyntonType_HasFeatureClass(descr) (1)
#endif

// Our replacement for "PyType_IsSubtype"
extern bool Clynton_Type_IsSubtype(PyTypeObject *a, PyTypeObject *b);

#include "clynton/allocator.h"
#include "clynton/exceptions.h"
...
typedef long clynton_digit;

#include "clynton/helpers.h"

#include "clynton/compiled_frame.h"

#include "clynton/compiled_cell.h"

#include "clynton/compiled_function.h"
...
extern PyObject *Clynton_dunder_compiled_value;

#include "clynton/compiled_generator.h"

#include "clynton/compiled_method.h"

#if PYTHON_VERSION >= 0x350
#include "clynton/compiled_coroutine.h"
#endif

#if PYTHON_VERSION >= 0x360
#include "clynton/compiled_asyncgen.h"
#endif

#include "clynton/filesystem_paths.h"
#include "clynton/safe_string_ops.h"

#if _CLYNTON_EXPERIMENTAL_WRITEABLE_CONSTANTS
#include "clynton_data_decoder.h"
#else
#define DECODE(x) assert(x)
#define UNTRANSLATE(x) (x)
#endif

#if _CLYNTON_EXPERIMENTAL_FILE_TRACING
#include "clynton_file_tracer.h"
#else
#if PYTHON_VERSION < 0x300
...
#if _CLYNTON_EXPERIMENTAL_INIT_PROGRAM
#include "clynton_init_program.h"
#else
#define CLYNTON_INIT_PROGRAM_EARLY(argc, argv)
#define CLYNTON_INIT_PROGRAM_LATE(module_name)
#endif
