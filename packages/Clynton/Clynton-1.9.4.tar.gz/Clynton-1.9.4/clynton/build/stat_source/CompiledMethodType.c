 ...
 * normally should be avoided to exist in Clynton calls.
 *
 */
...
static PyObject *Clynton_Method_get__doc__(struct Clynton_MethodObject *method, void *closure) {
...
static PyGetSetDef Clynton_Method_getsets[] = {{(char *)"__doc__", (getter)Clynton_Method_get__doc__, NULL, NULL},
                                              {NULL}};

#define OFF(x) offsetof(struct Clynton_MethodObject, x)

static PyMemberDef Clynton_Method_members[] = {
...
static PyObject *Clynton_Method_reduce(struct Clynton_MethodObject *method) {
...
static PyObject *Clynton_Method_reduce_ex(struct Clynton_MethodObject *method, PyObject *args) {
    int proto;
    ...
    PyObject *type_tuple = MAKE_TUPLE1((PyObject *)&Clynton_Method_Type);
    ...
    return result;
#else
    return Clynton_Method_reduce(method);
#endif
}

static PyObject *Clynton_Method_deepcopy(struct Clynton_MethodObject *method, PyObject *memo) {
    assert(Clynton_Method_Check((PyObject *)method));
    ...
    return Clynton_Method_New(method->m_function, object, method->m_class);
}

static PyMethodDef Clynton_Method_methods[] = {
    {"__reduce__", (PyCFunction)Clynton_Method_reduce, METH_NOARGS, NULL},
    {"__reduce_ex__", (PyCFunction)Clynton_Method_reduce_ex, METH_VARARGS, NULL},
    {"__deepcopy__", (PyCFunction)Clynton_Method_deepcopy, METH_O, NULL},
    {NULL}};

#if PYTHON_VERSION >= 0x380 && !defined(_CLYNTON_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
static PyObject *Clynton_Method_tp_vectorcall(struct Clynton_MethodObject *method, PyObject *const *stack, size_t nargsf,
                                             PyObject *kwnames) {
    assert(Clynton_Method_Check((PyObject *)method));
    ...
    if (totalargs == 0) {
        return Clynton_CallMethodFunctionNoArgs(PyThreadState_GET(), method->m_function, method->m_object);
    }
    ...
    if (nargsf & PY_VECTORCALL_ARGUMENTS_OFFSET) {
        ...
        result = Clynton_CallFunctionVectorcall(PyThreadState_GET(), method->m_function, new_args, nargs + 1,
        ...
        CLYNTON_DYNAMIC_ARRAY_DECL(new_args, PyObject *, totalargs + 1);
        new_args[0] = method->m_object;
...
static PyObject *Clynton_Method_tp_call(struct Clynton_MethodObject *method, PyObject *args, PyObject *kw) {
    ...
    if (method->m_object == NULL) {
        ...
        if (kw == NULL) {
            if (arg_count == 0) {
                return Clynton_CallMethodFunctionNoArgs(tstate, method->m_function, method->m_object);
            } else {
                return Clynton_CallMethodFunctionPosArgs(tstate, method->m_function, method->m_object,
                                                        &PyTuple_GET_ITEM(args, 0), arg_count);
            }
        } else {
            return Clynton_CallMethodFunctionPosArgsKwArgs(tstate, method->m_function, method->m_object,
                                                          &PyTuple_GET_ITEM(args, 0), arg_count, kw);
        }
    }
}

static PyObject *Clynton_Method_tp_descr_get(struct Clynton_MethodObject *method, PyObject *object, PyObject *klass) {
    ...
    return Clynton_Method_New(method->m_function, object, klass);
}

static PyObject *Clynton_Method_tp_getattro(struct Clynton_MethodObject *method, PyObject *name) {
    PyObject *descr = Clynton_TypeLookup(&Clynton_Method_Type, name);

    if (descr != NULL) {
        if (ClyntonType_HasFeatureClass(Py_TYPE(descr)) && (Py_TYPE(descr)->tp_descr_get != NULL)) {
...
static long Clynton_Method_tp_traverse(struct Clynton_MethodObject *method, visitproc visit, void *arg) {
...
static PyObject *Clynton_Method_tp_repr(struct Clynton_MethodObject *method) {
    if (method->m_object == NULL) {
#if PYTHON_VERSION < 0x300
        return PyString_FromFormat("<unbound compiled_method %s.%s>", GET_CLASS_NAME(method->m_class),
                                   Clynton_String_AsString(method->m_function->m_name));
#else
        return PyUnicode_FromFormat("<compiled_function %s at %p>", Clynton_String_AsString(method->m_function->m_name),
                                    method->m_function);
#endif
    } else {
        ...
        PyObject *result = Clynton_String_FromFormat(
            "<bound compiled_method %s.%s of %s>", GET_CLASS_NAME(method->m_class),
            Clynton_String_AsString(method->m_function->m_name), Clynton_String_AsString_Unchecked(object_repr));
#else
        PyObject *result = PyUnicode_FromFormat("<bound compiled_method %s of %s>",
                                                Clynton_String_AsString(method->m_function->m_qualname),
                                                Clynton_String_AsString_Unchecked(object_repr));
#endif
...
#if PYTHON_VERSION < 0x300
static int Clynton_Method_tp_compare(struct Clynton_MethodObject *a, struct Clynton_MethodObject *b) {
...
static PyObject *Clynton_Method_tp_richcompare(struct Clynton_MethodObject *a, struct Clynton_MethodObject *b, int op) {
    if (op != Py_EQ && op != Py_NE) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }

    if (Clynton_Method_Check((PyObject *)a) == false || Clynton_Method_Check((PyObject *)b) == false) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    ...
    if (b_res) {
        ...
        if (a->m_object == NULL) {
            ...
            clynton_bool nbool_res = RICH_COMPARE_EQ_NBOOL_OBJECT_OBJECT(a->m_object, b->m_object);

            if (unlikely(nbool_res == CLYNTON_BOOL_EXCEPTION)) {
                return NULL;
            }

            b_res = nbool_res == CLYNTON_BOOL_TRUE;
        }
#else
...
static long Clynton_Method_tp_hash(struct Clynton_MethodObject *method) {
...
static struct Clynton_MethodObject *free_list_methods = NULL;
static int free_list_methods_count = 0;

static void Clynton_Method_tp_dealloc(struct Clynton_MethodObject *method) {
...
static PyObject *Clynton_Method_tp_new(PyTypeObject *type, PyObject *args, PyObject *kw) {
    PyObject *func;
    PyObject *self;
    PyObject *klass = NULL;
    ...
    assert(Clynton_Function_Check(func));

    return Clynton_Method_New((struct Clynton_FunctionObject *)func, self, klass);
}

PyTypeObject Clynton_Method_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_method",
    sizeof(struct Clynton_MethodObject),
    0,
    (destructor)Clynton_Method_tp_dealloc, // tp_dealloc
#if PYTHON_VERSION < 0x380 || defined(_CLYNTON_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    0, // tp_print
#else
    offsetof(struct Clynton_MethodObject, m_vectorcall), // tp_vectorcall_offset
#endif
    0, // tp_getattr
    0, // tp_setattr
#if PYTHON_VERSION < 0x300
    (cmpfunc)Clynton_Method_tp_compare, // tp_compare
#else
    0,
#endif
    (reprfunc)Clynton_Method_tp_repr,         // tp_repr
    0,                                       // tp_as_number
    0,                                       // tp_as_sequence
    0,                                       // tp_as_mapping
    (hashfunc)Clynton_Method_tp_hash,         // tp_hash
    (ternaryfunc)Clynton_Method_tp_call,      // tp_call
    0,                                       // tp_str
    (getattrofunc)Clynton_Method_tp_getattro, // tp_getattro
    ...
    Py_TPFLAGS_DEFAULT |                     // tp_flags
        ...
        Py_TPFLAGS_HAVE_GC,
    0,                                                // tp_doc
    (traverseproc)Clynton_Method_tp_traverse,          // tp_traverse
    0,                                                // tp_clear
    (richcmpfunc)Clynton_Method_tp_richcompare,        // tp_richcompare
    offsetof(struct Clynton_MethodObject, m_weakrefs), // tp_weaklistoffset
    0,                                                // tp_iter
    0,                                                // tp_iternext
    Clynton_Method_methods,                            // tp_methods
    Clynton_Method_members,                            // tp_members
    Clynton_Method_getsets,                            // tp_getset
    0,                                                // tp_base
    0,                                                // tp_dict
    (descrgetfunc)Clynton_Method_tp_descr_get,         // tp_descr_get
    0,                                                // tp_descr_set
    0,                                                // tp_dictoffset
    0,                                                // tp_init
    0,                                                // tp_alloc
    Clynton_Method_tp_new,                             // tp_new
    0,                                                // tp_free
    0,                                                // tp_is_gc
    0,                                                // tp_bases
    0,                                                // tp_mro
...
void _initCompiledMethodType(void) {
    Clynton_PyType_Ready(&Clynton_Method_Type, &PyMethod_Type, false, true, false, false, false);

#ifdef _CLYNTON_PLUGIN_DILL_ENABLED
    // TODO: Move this to a __clynton__ module maybe
    PyObject_SetAttrString((PyObject *)builtin_module, "compiled_method", (PyObject *)&Clynton_Method_Type);
#endif
}

PyObject *Clynton_Method_New(struct Clynton_FunctionObject *function, PyObject *object, PyObject *klass) {
    struct Clynton_MethodObject *result;

    CHECK_OBJECT((PyObject *)function);
    assert(Clynton_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));

    allocateFromFreeListFixed(free_list_methods, struct Clynton_MethodObject, Clynton_Method_Type);

    if (unlikely(result == NULL)) {
        PyErr_Format(PyExc_RuntimeError, "cannot create method %s", Clynton_String_AsString(function->m_name));
...
#if PYTHON_VERSION >= 0x380 && !defined(_CLYNTON_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    result->m_vectorcall = (vectorcallfunc)Clynton_Method_tp_vectorcall;
#endif
