...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct Clynton_CoroutineObject *coroutine, PyObject *yield_return_value) {
...
# TODO: For functions CLYNTON_CANNOT_GET_HERE is injected by composing code.
template_coroutine_exception_exit = """\
    CLYNTON_CANNOT_GET_HERE("Return statement must be present");
