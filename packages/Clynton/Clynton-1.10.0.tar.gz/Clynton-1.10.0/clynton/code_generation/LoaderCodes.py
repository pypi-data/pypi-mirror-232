...
from clynton.utils.CStrings import encodePythonStringToC, encodePythonUnicodeToC
...
def getModuleMetaPathLoaderEntryCode(module, bytecode_accessor):
    ...
    if module.isUncompiledPythonModule():
        ...
        flags.append("CLYNTON_BYTECODE_FLAG")
        if is_package:
            flags.append("CLYNTON_PACKAGE_FLAG")
        ...
        flags.append("CLYNTON_EXTENSION_MODULE_FLAG")
...
PyThreadState *tstate, PyObject *, struct Clynton_MetaPathBasedLoaderEntry const *);"""
