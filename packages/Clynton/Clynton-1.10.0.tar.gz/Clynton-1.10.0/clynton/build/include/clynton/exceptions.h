...
//
#ifndef __CLYNTON_EXCEPTIONS_H__
#define __CLYNTON_EXCEPTIONS_H__
...
#include "clynton/checkers.h"
#include "clynton/constants.h"
#include "clynton/printing.h"

// Did an error occur.
CLYNTON_MAY_BE_UNUSED static inline bool HAS_ERROR_OCCURRED(PyThreadState *tstate) {
...
CLYNTON_MAY_BE_UNUSED static inline PyObject *GET_ERROR_OCCURRED(PyThreadState *tstate) {
#if PYTHON_VERSION < 0x3c0
...
CLYNTON_MAY_BE_UNUSED static inline void CLEAR_ERROR_OCCURRED(PyThreadState *tstate) {
#if PYTHON_VERSION < 0x3c0
...
CLYNTON_MAY_BE_UNUSED static inline bool DROP_ERROR_OCCURRED(PyThreadState *tstate) {
...
CLYNTON_MAY_BE_UNUSED static void FETCH_ERROR_OCCURRED(PyThreadState *tstate, PyObject **exception_type,
...
// Fetch the current error into object variables.
CLYNTON_MAY_BE_UNUSED static void FETCH_ERROR_OCCURRED_UNTRACED(PyThreadState *tstate, PyObject **exception_type,
                                                               PyObject **exception_value,
                                                               PyTracebackObject **exception_traceback) {
    *exception_type = tstate->curexc_type;
    *exception_value = tstate->curexc_value;
...
CLYNTON_MAY_BE_UNUSED static void RESTORE_ERROR_OCCURRED(PyThreadState *tstate, PyObject *exception_type,
                                                        PyObject *exception_value,
                                                        PyTracebackObject *exception_traceback) {
...
CLYNTON_MAY_BE_UNUSED static void RESTORE_ERROR_OCCURRED_UNTRACED(PyThreadState *tstate, PyObject *exception_type,
                                                                 PyObject *exception_value,
                                                                 PyTracebackObject *exception_traceback) {
    PyObject *old_exception_type = tstate->curexc_type;
    PyObject *old_exception_value = tstate->curexc_value;
...
extern PyTracebackObject *MAKE_TRACEBACK(struct Clynton_FrameObject *frame, int lineno);

// Add a frame to an existing exception trace-back.
CLYNTON_MAY_BE_UNUSED static PyTracebackObject *ADD_TRACEBACK(PyTracebackObject *exception_tb,
                                                             struct Clynton_FrameObject *frame, int lineno) {
...
struct Clynton_ExceptionStackItem {
...
static const struct Clynton_ExceptionStackItem Clynton_ExceptionStackItem_Empty = {NULL, NULL, NULL};
#else
#define Clynton_ExceptionStackItem_Empty                                                                                \
    (struct Clynton_ExceptionStackItem) { .exception_type = NULL, .exception_value = NULL, .exception_tb = NULL }
#endif
#else
struct Clynton_ExceptionStackItem {
    PyObject *exception_value;
...
#if defined(__cplusplus)
static const struct Clynton_ExceptionStackItem Clynton_ExceptionStackItem_Empty = {NULL};
#else
#define Clynton_ExceptionStackItem_Empty                                                                                \
    (struct Clynton_ExceptionStackItem) { .exception_value = NULL }
#endif

#endif

// Helper that gets the current thread exception, for use in exception handlers
CLYNTON_MAY_BE_UNUSED inline static struct Clynton_ExceptionStackItem GET_CURRENT_EXCEPTION(PyThreadState *tstate) {
    struct Clynton_ExceptionStackItem result;
#if PYTHON_VERSION < 0x3b0
...
#if PYTHON_VERSION < 0x300 && !defined(_CLYNTON_EXPERIMENTAL_DISABLE_SYS_EXC_VARS)
#define _CLYNTON_MAINTAIN_SYS_EXC_VARS 1
#endif

// Helper that sets the current thread exception, releasing the current one, for
// use in this file only.
CLYNTON_MAY_BE_UNUSED inline static void SET_CURRENT_EXCEPTION(PyThreadState *tstate,
                                                              struct Clynton_ExceptionStackItem *exc_state) {
#if PYTHON_VERSION < 0x3b0
...
CLYNTON_MAY_BE_UNUSED inline static void SET_CURRENT_EXCEPTION_TYPE0(PyThreadState *tstate, PyObject *exception_type) {
...
#if PYTHON_VERSION < 0x3c0
CLYNTON_MAY_BE_UNUSED inline static void
...
CLYNTON_MAY_BE_UNUSED inline static void SET_CURRENT_EXCEPTION_TYPE0_STR(PyThreadState *tstate, PyObject *exception_type,
                                                                        char const *value) {
    PyObject *exception_value = Clynton_String_FromString(value);
...
CLYNTON_MAY_BE_UNUSED static inline void PRESERVE_FRAME_EXCEPTION(PyThreadState *tstate,
...
CLYNTON_MAY_BE_UNUSED static inline void RESTORE_FRAME_EXCEPTION(PyThreadState *tstate,
                                                                struct Clynton_FrameObject *frame_object) {
    PyFrameObject *frame = (PyFrameObject *)frame_object;
...
#else
CLYNTON_MAY_BE_UNUSED static inline void ATTACH_TRACEBACK_TO_EXCEPTION_VALUE(PyObject *exception_value,
                                                                            PyTracebackObject *exception_tb) {
...
CLYNTON_MAY_BE_UNUSED static inline PyTracebackObject *GET_EXCEPTION_TRACEBACK(PyObject *exception_value) {
    assert(PyExceptionInstance_Check(exception_value));
...
#if PYTHON_VERSION < 0x3c0
extern void Clynton_Err_NormalizeException(PyThreadState *tstate, PyObject **exc, PyObject **val,
                                          PyTracebackObject **tb);

// Normalize an exception.
CLYNTON_MAY_BE_UNUSED static inline void NORMALIZE_EXCEPTION(PyThreadState *tstate, PyObject **exception_type,
                                                            PyObject **exception_value,
                                                            PyTracebackObject **exception_tb) {
#if _DEBUG_EXCEPTIONS
    ...
    if (*exception_type != Py_None && *exception_type != NULL) {
        Clynton_Err_NormalizeException(tstate, exception_type, exception_value, exception_tb);
    }
...
CLYNTON_MAY_BE_UNUSED static inline void PUBLISH_CURRENT_EXCEPTION(PyThreadState *tstate, PyObject **exception_type,
                                                                  PyObject **exception_value,
                                                                  PyTracebackObject **exception_tb) {
#if _DEBUG_EXCEPTIONS
...
CLYNTON_MAY_BE_UNUSED static bool EXCEPTION_MATCH_GENERATOR(PyThreadState *tstate, PyObject *exception_value) {
    CHECK_OBJECT(exception_value);
...
CLYNTON_MAY_BE_UNUSED static bool EXCEPTION_MATCH_BOOL_SINGLE(PyThreadState *tstate, PyObject *exception_value,
...
CLYNTON_MAY_BE_UNUSED static inline int _EXCEPTION_MATCH_BOOL(PyThreadState *tstate, PyObject *exception_value,
                                                             PyObject *exception_checked) {
    CHECK_OBJECT(exception_value);
    CHECK_OBJECT(exception_checked);
...
#else
    if (PyExceptionClass_Check(exception_class) && PyExceptionClass_Check(exception_checked)) {
        return Clynton_Type_IsSubtype((PyTypeObject *)exception_class, (PyTypeObject *)exception_checked);
    } else {
        return exception_class == exception_checked;
    }
#endif
...
CLYNTON_MAY_BE_UNUSED static inline int EXCEPTION_MATCH_BOOL(PyThreadState *tstate, PyObject *exception_value,
                                                            PyObject *exception_checked) {
    CHECK_OBJECT(exception_value);
    CHECK_OBJECT(exception_checked);
...
CLYNTON_MAY_BE_UNUSED static inline void ADD_EXCEPTION_CONTEXT(PyThreadState *tstate, PyObject **exception_type,
                                                              PyObject **exception_value) {
...
CLYNTON_MAY_BE_UNUSED static bool _CHECK_AND_CLEAR_EXCEPTION_OCCURRED(PyThreadState *tstate, PyObject *exception_type) {
#if PYTHON_VERSION < 0x3c0
...
*/
CLYNTON_MAY_BE_UNUSED static bool CHECK_AND_CLEAR_STOP_ITERATION_OCCURRED(PyThreadState *tstate) {
...
*/
CLYNTON_MAY_BE_UNUSED static bool CHECK_AND_CLEAR_KEY_ERROR_OCCURRED(PyThreadState *tstate) {
    return _CHECK_AND_CLEAR_EXCEPTION_OCCURRED(tstate, PyExc_KeyError);
}

CLYNTON_MAY_BE_UNUSED static bool CHECK_AND_CLEAR_ATTRIBUTE_ERROR_OCCURRED(PyThreadState *tstate) {
