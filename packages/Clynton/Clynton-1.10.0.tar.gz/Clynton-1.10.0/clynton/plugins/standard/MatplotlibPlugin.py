...
from clynton.Options import isStandaloneMode
...
from clynton.utils.Jinja2 import renderTemplateFromString
...
class ClyntonPluginMatplotlib(ClyntonPluginBase):
    ...
    plugin_name = "matplotlib"  # Clynton knows us by this name
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if (
            ...
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__clynton_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__clynton_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
