...
from clynton.code_generation.c_types.CTypeClyntonBooleans import (
    CTypeClyntonBoolEnum,
)
from clynton.code_generation.c_types.CTypeClyntonInts import (
    CTypeClyntonIntOrLongStruct,
)
from clynton.code_generation.Reports import onMissingOperation
from clynton.Constants import the_empty_unicode
...
if python_version < 0x300:
    ...
    class ShapeTypeIntOrLong(ShapeNotContainerMixin, ShapeNumberMixin, ShapeBase):
        if isExperimental("clynton_ilong"):
