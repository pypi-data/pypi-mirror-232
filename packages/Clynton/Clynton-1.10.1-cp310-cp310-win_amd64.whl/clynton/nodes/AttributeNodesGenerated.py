...
from clynton.specs.BuiltinBytesOperationSpecs import (
...
from clynton.specs.BuiltinDictOperationSpecs import (
    dict_clear_spec,
    dict_copy_spec,
    dict_fromkeys_spec,
    dict_get_spec,
...
from clynton.specs.BuiltinListOperationSpecs import (
    list_append_spec,
    list_clear_spec,
    list_copy_spec,
    list_count_spec,
...
from clynton.specs.BuiltinParameterSpecs import extractBuiltinArgs
from clynton.specs.BuiltinStrOperationSpecs import (
    str_capitalize_spec,
    str_center_spec,
    str_count_spec,
    str_decode_spec,
...
from clynton.specs.BuiltinTypeOperationSpecs import type___prepare___spec
