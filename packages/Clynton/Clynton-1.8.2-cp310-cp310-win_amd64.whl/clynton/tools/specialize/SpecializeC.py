...
def makeHelpersComparisonOperation(operand, op_code):
    ...
    filename_c = "clynton/build/static_src/HelpersComparison%s.c" % op_code.capitalize()
...
def makeHelpersBinaryOperation(operand, op_code):
    ...
    filename_c = (
        "clynton/build/static_src/HelpersOperationBinary%s.c" % op_code.capitalize()
    )
    filename_h = (
...
def makeHelpersInplaceOperation(operand, op_code):
    ...
    filename_c = (
        "clynton/build/static_src/HelpersOperationInplace%s.c" % op_code.capitalize()
    )
    filename_h = (
...
def makeHelpersImportHard():
    filename_c = "clynton/build/static_src/HelpersImportHard.c"
...
def makeHelperCalls():
    filename_c = "clynton/build/static_src/HelpersCallingGenerated.c"
...
def makeHelperLists():
    filename_c = "clynton/build/static_src/HelpersListsGenerated.c"
...
def makeDictCopyHelperCodes():
    filename_c = "clynton/build/static_src/HelpersDictionariesGenerated.c"
...
def makeHelperBuiltinTypeMethods():
    ...
    filename_c = "clynton/build/static_src/HelpersBuiltinTypeMethods.c"
