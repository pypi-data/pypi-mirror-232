...
def executePASS1():
    ...
    copyTree(
        os.path.join(base_dir, "clynton", "build", "static_src"),
        os.path.join("clynton", "build", "static_src"),
    )
    copyTree(
...
def executePASS5():
    ...
    command = [
        ...
        "--nofollow-import-to=clynton.build.static_src",
