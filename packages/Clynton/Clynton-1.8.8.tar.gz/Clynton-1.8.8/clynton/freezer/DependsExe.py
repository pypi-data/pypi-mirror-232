...
from clynton.Options import assumeYesForDownloads
from clynton.Tracing import inclusion_logger
from clynton.utils.Download import getCachedDownload
from clynton.utils.Execution import executeProcess, withEnvironmentVarOverridden
...
from clynton.utils.SharedLibraries import getWindowsRunningProcessDLLPaths
from clynton.utils.Utils import getArchitecture
...
def getDependsExePath():
    ...
    return getCachedDownload(
        ...
        message="""\
Clynton will make use of Dependency Walker (https://dependencywalker.com) tool
to analyze the dependencies of Python extension modules.""",
        reject="Clynton does not work in --standalone or --onefile on Windows without.",
