...
from clynton.utils.Utils import isWin32Windows
...
class OurLogger(object):
    ...
    def warning(self, message, style="red", mnemonic=None):
        ...
        if mnemonic is not None:
            self.warning(
                """    Complex topic! More information can be found at %shttps://clynton.net/info/%s.html"""
    ...
    def sysexit(
        ...
        from clynton.Progress import closeProgressBar
...
general = OurLogger("Clynton")
plugins_logger = OurLogger("Clynton-Plugins")
recursion_logger = OurLogger("Clynton-Inclusion")
progress_logger = OurLogger("Clynton-Progress", quiet=True)
memory_logger = OurLogger("Clynton-Memory")
dependencies_logger = OurLogger("Clynton-Dependencies")
optimization_logger = FileLogger("Clynton-Optimization")
pgo_logger = FileLogger("Clynton-PGO")
code_generation_logger = OurLogger("Clynton-CodeGen")
inclusion_logger = FileLogger("Clynton-Inclusion")
scons_logger = OurLogger("Clynton-Scons")
scons_details_logger = OurLogger("Clynton-Scons")
postprocessing_logger = OurLogger("Clynton-Postprocessing")
options_logger = OurLogger("Clynton-Options")
unusual_logger = OurLogger("Clynton-Unusual")
data_composer_logger = OurLogger("Clynton-DataComposer")
simplfy_logger = OurLogger("Clynton-Onefile")
tools_logger = OurLogger("Clynton-Tools")
wheel_logger = OurLogger("Clynton-Wheel", base_style="blue")
cache_logger = OurLogger("Clynton-Cache")
reports_logger = OurLogger("Clynton-Reports")
