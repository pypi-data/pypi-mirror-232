...
from clynton import ModuleRegistry, Options
from clynton.Errors import ClyntonForbiddenImportEncounter
from clynton.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from clynton.importing import ImportCache, Importing, StandardLibrary
from clynton.ModuleRegistry import addUsedModule, getRootTopModule
from clynton.pgo.PGO import decideInclusionFromPGO
from clynton.plugins.Plugins import Plugins
from clynton.PythonVersions import python_version
from clynton.Tracing import recursion_logger
from clynton.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from clynton.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from clynton.tree.Building import decideCompilationMode
...
def considerUsedModules(module, pass_count):
    ...
    for used_module in module.getUsedModules():
        ...
        except ClyntonForbiddenImportEncounter as e:
