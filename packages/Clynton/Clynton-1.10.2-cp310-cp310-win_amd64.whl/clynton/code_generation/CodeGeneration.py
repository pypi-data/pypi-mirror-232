...
from clynton.nodes.AttributeNodesGenerated import (
    attribute_classes,
    attribute_typed_classes,
)
from clynton.nodes.BytesNodes import getBytesOperationClasses
from clynton.nodes.StrNodes import getStrOperationClasses
from clynton.plugins.Plugins import Plugins
from clynton.utils.CStrings import encodePythonStringToC
...
from .ModuleCodes import (
    ...
    generateClyntonLoaderCreationCode,
    getModuleCode,
)
...
addExpressionDispatchDict(
    {
        ...
        "EXPRESSION_CLYNTON_LOADER_CREATION": generateClyntonLoaderCreationCode,
