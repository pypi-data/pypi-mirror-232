...
class ReverseAddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ReverseAddressGeocoder_0229dc2440be_error",
        ...
        outputCol="ReverseAddressGeocoder_0229dc2440be_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="ReverseAddressGeocoder_0229dc2440be_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="ReverseAddressGeocoder_0229dc2440be_output")
