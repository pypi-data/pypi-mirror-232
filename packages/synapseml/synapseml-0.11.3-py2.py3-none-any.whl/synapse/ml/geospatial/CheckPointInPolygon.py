...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_b4b3cb2f5526_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_b4b3cb2f5526_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_b4b3cb2f5526_error")
        self._setDefault(outputCol="CheckPointInPolygon_b4b3cb2f5526_output")
