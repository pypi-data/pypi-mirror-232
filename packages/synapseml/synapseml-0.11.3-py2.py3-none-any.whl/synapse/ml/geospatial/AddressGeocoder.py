...
class AddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddressGeocoder_b1c0f8b9159b_error",
        initialPollingDelay=300,
        maxPollingRetries=1000,
        outputCol="AddressGeocoder_b1c0f8b9159b_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AddressGeocoder_b1c0f8b9159b_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AddressGeocoder_b1c0f8b9159b_output")
