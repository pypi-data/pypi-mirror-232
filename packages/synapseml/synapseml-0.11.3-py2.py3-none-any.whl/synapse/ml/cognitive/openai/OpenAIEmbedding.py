...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OpenAIEmbedding_915e0552b76b_error",
        handler=None,
        outputCol="OpenAIEmbedding_915e0552b76b_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_915e0552b76b_error")
        self._setDefault(outputCol="OpenAIEmbedding_915e0552b76b_output")
