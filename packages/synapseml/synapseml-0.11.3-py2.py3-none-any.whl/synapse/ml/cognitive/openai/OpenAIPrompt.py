...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_7d3c0371dd78_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_7d3c0371dd78_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_7d3c0371dd78_error")
        self._setDefault(outputCol="OpenAIPrompt_7d3c0371dd78_output")
