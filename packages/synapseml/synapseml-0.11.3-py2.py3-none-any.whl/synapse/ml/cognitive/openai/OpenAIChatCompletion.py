...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_034d93649cdc_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_034d93649cdc_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_034d93649cdc_error")
        self._setDefault(outputCol="OpenAIChatCompletion_034d93649cdc_output")
