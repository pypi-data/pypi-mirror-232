...
class AnalyzeLayout(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeLayout_bf3ddc987b4e_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeLayout_bf3ddc987b4e_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        readingOrder=None,
        ...
        self._setDefault(errorCol="AnalyzeLayout_bf3ddc987b4e_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeLayout_bf3ddc987b4e_output")
