...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GetCustomModel_0b83664b836a_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_0b83664b836a_output",
        ...
        self._setDefault(errorCol="GetCustomModel_0b83664b836a_error")
        self._setDefault(outputCol="GetCustomModel_0b83664b836a_output")
