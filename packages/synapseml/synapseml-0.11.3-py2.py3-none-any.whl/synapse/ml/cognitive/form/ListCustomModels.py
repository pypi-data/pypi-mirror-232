...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_a0e8af716415_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_a0e8af716415_output",
        ...
        self._setDefault(errorCol="ListCustomModels_a0e8af716415_error")
        self._setDefault(outputCol="ListCustomModels_a0e8af716415_output")
