...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_388268d6188b_error",
        handler=None,
        outputCol="Detect_388268d6188b_output",
        ...
        self._setDefault(errorCol="Detect_388268d6188b_error")
        self._setDefault(outputCol="Detect_388268d6188b_output")
