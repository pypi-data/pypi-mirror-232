...
class BreakSentence(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="BreakSentence_389cb148e2bf_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="BreakSentence_389cb148e2bf_output",
        script=None,
        scriptCol=None,
        ...
        self._setDefault(errorCol="BreakSentence_389cb148e2bf_error")
        self._setDefault(outputCol="BreakSentence_389cb148e2bf_output")
