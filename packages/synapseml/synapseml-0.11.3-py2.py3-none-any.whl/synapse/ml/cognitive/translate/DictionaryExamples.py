...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_acc2bd915893_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_acc2bd915893_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_acc2bd915893_error")
        self._setDefault(outputCol="DictionaryExamples_acc2bd915893_output")
