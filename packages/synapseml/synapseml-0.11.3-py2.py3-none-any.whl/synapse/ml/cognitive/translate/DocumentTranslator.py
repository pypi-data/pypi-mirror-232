...
class DocumentTranslator(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DocumentTranslator_8e6c52403fe4_error",
        filterPrefix=None,
        ...
        outputCol="DocumentTranslator_8e6c52403fe4_output",
        pollingDelay=300,
        serviceName=None,
        sourceLanguage=None,
        ...
        self._setDefault(errorCol="DocumentTranslator_8e6c52403fe4_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="DocumentTranslator_8e6c52403fe4_output")
