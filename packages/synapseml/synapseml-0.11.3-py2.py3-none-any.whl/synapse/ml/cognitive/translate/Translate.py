...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_023cd6f9c0bb_error",
        fromLanguage=None,
        ...
        outputCol="Translate_023cd6f9c0bb_output",
        ...
        self._setDefault(errorCol="Translate_023cd6f9c0bb_error")
        self._setDefault(outputCol="Translate_023cd6f9c0bb_output")
