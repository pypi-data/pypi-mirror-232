...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_e2bf5df1be52_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_e2bf5df1be52_output",
        ...
        self._setDefault(errorCol="Transliterate_e2bf5df1be52_error")
        self._setDefault(outputCol="Transliterate_e2bf5df1be52_output")
