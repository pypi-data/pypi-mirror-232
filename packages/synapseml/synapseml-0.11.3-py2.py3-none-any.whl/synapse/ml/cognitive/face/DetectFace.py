...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_c7fd874a8172_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_c7fd874a8172_output",
        ...
        self._setDefault(errorCol="DetectFace_c7fd874a8172_error")
        self._setDefault(outputCol="DetectFace_c7fd874a8172_output")
