...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_9ba3dab0e75d_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_9ba3dab0e75d_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_9ba3dab0e75d_error")
        self._setDefault(outputCol="FindSimilarFace_9ba3dab0e75d_output")
