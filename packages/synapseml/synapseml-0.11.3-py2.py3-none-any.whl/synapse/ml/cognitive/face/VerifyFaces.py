...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_45eefdf6f6d2_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_45eefdf6f6d2_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_45eefdf6f6d2_error")
        self._setDefault(outputCol="VerifyFaces_45eefdf6f6d2_output")
