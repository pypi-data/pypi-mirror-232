...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_b75b219e1efc_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_b75b219e1efc_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_b75b219e1efc_error")
        self._setDefault(outputCol="IdentifyFaces_b75b219e1efc_output")
