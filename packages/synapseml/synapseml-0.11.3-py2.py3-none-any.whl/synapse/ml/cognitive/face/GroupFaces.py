...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GroupFaces_eb6ec65068a5_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_eb6ec65068a5_output",
        ...
        self._setDefault(errorCol="GroupFaces_eb6ec65068a5_error")
        self._setDefault(outputCol="GroupFaces_eb6ec65068a5_output")
