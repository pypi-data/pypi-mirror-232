...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_1b8453fbcd37_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_1b8453fbcd37_output",
        ...
        self._setDefault(errorCol="TagImage_1b8453fbcd37_error")
        self._setDefault(outputCol="TagImage_1b8453fbcd37_output")
