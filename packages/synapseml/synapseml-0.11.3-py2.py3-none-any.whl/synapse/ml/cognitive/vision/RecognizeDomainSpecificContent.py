...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="RecognizeDomainSpecificContent_c7bd0a3ecb48_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        model=None,
        modelCol=None,
        outputCol="RecognizeDomainSpecificContent_c7bd0a3ecb48_output",
        ...
        self._setDefault(errorCol="RecognizeDomainSpecificContent_c7bd0a3ecb48_error")
        self._setDefault(outputCol="RecognizeDomainSpecificContent_c7bd0a3ecb48_output")
