...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_ee43bad78de3_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_ee43bad78de3_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_ee43bad78de3_error")
        self._setDefault(outputCol="AnalyzeImage_ee43bad78de3_output")
