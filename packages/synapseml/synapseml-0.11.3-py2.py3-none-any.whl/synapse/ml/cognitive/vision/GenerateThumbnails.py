...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GenerateThumbnails_edee3f774593_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_edee3f774593_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_edee3f774593_error")
        self._setDefault(outputCol="GenerateThumbnails_edee3f774593_output")
