...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_845917603303_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_845917603303_output",
        ...
        self._setDefault(errorCol="OCR_845917603303_error")
        self._setDefault(outputCol="OCR_845917603303_output")
