...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_554eb48f62e8_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_554eb48f62e8_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_554eb48f62e8_error")
        self._setDefault(outputCol="NER_554eb48f62e8_output")
