...
class TextSentiment(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextSentiment_2d3f1f115bf5_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        ...
        outputCol="TextSentiment_2d3f1f115bf5_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="TextSentiment_2d3f1f115bf5_error")
        self._setDefault(outputCol="TextSentiment_2d3f1f115bf5_output")
