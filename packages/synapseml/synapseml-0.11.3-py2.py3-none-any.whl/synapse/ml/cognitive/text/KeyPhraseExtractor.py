...
class KeyPhraseExtractor(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="KeyPhraseExtractor_0e9af994e83f_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="KeyPhraseExtractor_0e9af994e83f_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="KeyPhraseExtractor_0e9af994e83f_error")
        self._setDefault(outputCol="KeyPhraseExtractor_0e9af994e83f_output")
