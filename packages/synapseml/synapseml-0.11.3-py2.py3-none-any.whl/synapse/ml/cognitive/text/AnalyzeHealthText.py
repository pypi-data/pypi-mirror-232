...
class AnalyzeHealthText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeHealthText_8df3ad649f96_error",
        ...
        outputCol="AnalyzeHealthText_8df3ad649f96_output",
        pollingDelay=300,
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="AnalyzeHealthText_8df3ad649f96_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeHealthText_8df3ad649f96_output")
