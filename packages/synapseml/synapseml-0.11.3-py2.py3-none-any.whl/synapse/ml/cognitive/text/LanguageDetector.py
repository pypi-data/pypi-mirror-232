...
class LanguageDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="LanguageDetector_f49b6389f317_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="LanguageDetector_f49b6389f317_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="LanguageDetector_f49b6389f317_error")
        self._setDefault(outputCol="LanguageDetector_f49b6389f317_output")
