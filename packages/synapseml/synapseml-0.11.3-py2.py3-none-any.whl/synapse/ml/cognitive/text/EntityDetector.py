...
class EntityDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="EntityDetector_2a6ca84711e0_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="EntityDetector_2a6ca84711e0_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="EntityDetector_2a6ca84711e0_error")
        self._setDefault(outputCol="EntityDetector_2a6ca84711e0_output")
