...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_92546d073d37_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_92546d073d37_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_92546d073d37_error")
        self._setDefault(outputCol="PII_92546d073d37_output")
