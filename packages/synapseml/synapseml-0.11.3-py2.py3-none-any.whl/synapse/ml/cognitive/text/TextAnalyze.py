...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_d564f730db44_error",
        ...
        outputCol="TextAnalyze_d564f730db44_output",
        ...
        self._setDefault(errorCol="TextAnalyze_d564f730db44_error")
        ...
        self._setDefault(outputCol="TextAnalyze_d564f730db44_output")
