...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddDocuments_1f30ea914f71_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_1f30ea914f71_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_1f30ea914f71_error")
        self._setDefault(outputCol="AddDocuments_1f30ea914f71_output")
