...
class DetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectAnomalies_058d41766511_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectAnomalies_058d41766511_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectAnomalies_058d41766511_error")
        self._setDefault(outputCol="DetectAnomalies_058d41766511_output")
