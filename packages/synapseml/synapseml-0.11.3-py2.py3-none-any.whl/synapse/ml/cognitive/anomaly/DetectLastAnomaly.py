...
class DetectLastAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastAnomaly_929f724b7efa_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectLastAnomaly_929f724b7efa_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectLastAnomaly_929f724b7efa_error")
        self._setDefault(outputCol="DetectLastAnomaly_929f724b7efa_output")
