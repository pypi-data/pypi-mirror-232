...
class DetectLastMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastMultivariateAnomaly_690d4a7f4b37_error",
        handler=None,
        inputVariablesCols=None,
        modelId=None,
        outputCol="DetectLastMultivariateAnomaly_690d4a7f4b37_output",
        ...
        self._setDefault(errorCol="DetectLastMultivariateAnomaly_690d4a7f4b37_error")
        self._setDefault(outputCol="DetectLastMultivariateAnomaly_690d4a7f4b37_output")
