...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SpeakerEmotionInference_630f71659003_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_630f71659003_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_630f71659003_error")
        self._setDefault(outputCol="SpeakerEmotionInference_630f71659003_output")
