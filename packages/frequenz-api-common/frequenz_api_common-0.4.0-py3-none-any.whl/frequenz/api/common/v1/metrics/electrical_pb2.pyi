...
"""
import builtins
import frequenz.api.common.v1.metrics_pb2
...
class DC(google.protobuf.message.Message):
    ...
    @property
    def voltage(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
        """The DC voltage across the component.
        In Volt (V).
        """
    @property
    def current(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
        ...
        """
    @property
    def power(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
    ...
    def __init__(
        self,
        *,
        voltage: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        current: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        power: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
    ) -> None: ...
...
class AC(google.protobuf.message.Message):
    ...
    class ActiveEnergy(google.protobuf.message.Message):
        ...
        @property
        def energy(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
            ...
            """
        @property
        def energy_consumed(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
            """The consumed energy.
            In Watt-hour (Wh).
            """
        @property
        def energy_delivered(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
        ...
        def __init__(
            self,
            *,
            energy: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
            energy_consumed: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
            energy_delivered: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        ) -> None: ...
    ...
    class ReactiveEnergy(google.protobuf.message.Message):
        ...
        def energy(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
            ...
            """
        @property
        def energy_capacitive(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
            """The capacitive energy.
            In Volt-Ampere-hour (VArh).
            """
        @property
        def energy_inductive(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
        ...
        def __init__(
            ...
            *,
            energy: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
            energy_capacitive: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
            energy_inductive: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        ) -> None: ...
    ...
    class ACPhase(google.protobuf.message.Message):
        ...
        def current(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
            ...
            """
        @property
        def power_active(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
            """AC active power.
            +ve power means consumption, away from the grid.
            -ve power means supply into the grid.
            In Watt (W).
            """
        @property
        def power_reactive(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
            """AC reactive power.
            ...
            """
        @property
        def energy_apparent(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
        ...
        def __init__(
            ...
            *,
            voltage: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
            current: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
            power_active: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
            power_reactive: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
            energy_apparent: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
    ...
    @property
    def frequency(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
        """Overall AC metrics.
    ...
    def current(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
        ...
        """
    @property
    def power_apparent(self) -> frequenz.api.common.v1.metrics_pb2.Metric:
    ...
    def __init__(
        self,
        *,
        frequency: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        current: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        power_apparent: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        power_active: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        power_reactive: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        energy_apparent: frequenz.api.common.v1.metrics_pb2.Metric | None = ...,
        energy_active: global___AC.ActiveEnergy | None = ...,
