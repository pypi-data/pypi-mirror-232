    ...
    def _poll(
        ...
        while not until(response):
            if time.time() - start_time > TIMEOUT_SECS:
                raise "Operation polling timed out."
    ...
    def request_raw(
        ...
        *,
        ...
        try:
            ...
            raise "Request timed out: {}".format(e)
        except requests.exceptions.RequestException as e:
            raise "Error communicating with Rebyte: {}".format(e)
        return result
    ...
    async def arequest_raw(
        ...
        *,
        ...
        try:
            ...
            raise "Error communicating with Rebyte"
