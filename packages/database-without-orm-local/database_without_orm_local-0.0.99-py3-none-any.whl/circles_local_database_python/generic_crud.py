...
class GenericCRUD:
    ...
    def select(self, table_name: str, select_clause_value: str = "*", id_column_name: str = None, id_column_value: Any = None,
        ...
        try:
            ...
            result = self._select_by_where(
                table_name, select_clause_value, where, limit, order_by)
            return result
        except Exception as e:
    ...
    def _select_by_where(self, table_name: str, select_clause_value: str = "*",
        ...
        select_query = f"SELECT {select_clause_value} FROM {self.schema_name}.{table_name} " + (
    ...
    def select_one(self, table_name: str, select_clause_value: str = "*", id_column_name: str = None, id_column_value: Any = None,
        ...
        try:
            result = self.select(table_name, select_clause_value,
                                 id_column_name, id_column_value, where, limit=1)[0]
        except Exception as e:
            logger.exception("Error selecting json_data", object=e)
            logger.end()
            raise
    ...
    def select_one_by_id(self, table_name: str, select_clause_value: str = "*", id_column_name: str = None, id_column_value: Any = None) -> tuple:
        ...
        try:
            result = self._select_by_where(
                table_name, select_clause_value, where, limit=1)[0]
        except Exception as e:
            logger.exception("Error selecting json_data", object=e)
            logger.end()
            raise
    ...
    def select_one_by_where(self, table_name: str, select_clause_value: str = "*", where: str = None) -> list:
        ...
        try:
            result = self._select_by_where(
                table_name, select_clause_value, where=where, limit=1)[0]
        except Exception as e:
            logger.exception("Error selecting json_data", object=e)
            logger.end()
            raise
    ...
    def select_multi_by_id(self, table_name: str, select_clause_value: str = "*", id_column_name: str = None, id_column_value: Any = None, limit: int = 100, order_by: str = "") -> list:
    ...
    def select_multi_by_where(self, table_name: str, select_clause_value: str = "*", where: str = None, limit: int = 100, order_by: str = "") -> list:
