...
class RInfo(object):
    """
    Rey's `database Information` type.
    """
    ...
    def __getitem__(self, key: str) -> Any:
        ...
        Parameters
        ----------
        key : Information key. When key not exist, then try all caps key.
        ...
        if value is None:
            key_upper = key.upper()
            value = params[key_upper]

        return value


class RSchemaInfo(RInfo):
    """
    ...
    def _get_info(self) -> Dict[str, Dict[str, List]]:
        """
        Get schema information of `databases` and `tables` and `columns`.

        Returns
        -------
        Schema information of databases and tables and columns.
        """
    ...
    def __getattr__(self, key: str) -> Union[
        ...
        Returns
        -------
        Value of attribute or RDatabaseInfo instance.
        """
...
class RDatabaseInfo(RInfo):
    ...
    def __init__(
        ...
        """
        Build `database information` instance.
    ...
    def _get_info(self) -> Dict:
        """
        Get information dictionary of `database`.

        Returns
        -------
        Information dictionary of `database`.
        """
    ...
    def __getattr__(self, key: str) -> Union[
        ...
        Returns
        -------
        Value of attribute or RTableInfo instance.
        """
...
class RTableInfo(RInfo):
    ...
    def _get_info(self) -> Dict:
        """
        Get information dictionary of `table`.

        Returns
        -------
        Information dictionary of `table`.
        """
    ...
    def __getattr__(self, key: str) -> Union[
        ...
        Returns
        -------
        Value of attribute or RColumnInfo instance.
        """
...
class RColumnInfo(RInfo):
    ...
    def _get_info(self) -> Dict:
        """
        Get information dictionary of `column`.

        Returns
        -------
        Information dictionary of `column`.
        """
