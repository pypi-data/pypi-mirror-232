...
from .rtext import rprint, to_text
...
class REngine(object):
    ...
    def execute_select(
        ...
        **kwdata: Any
        ...
        path : Table name, can contain database name.
            - `str` : Auto split database name and table name.
    ...
    def execute_exist(
        ...
        **kwdata: Any
        ...
        # Execute.
        result = self.execute_select(path, "1", where=where, limit=limit, report=report, **kwdata)
