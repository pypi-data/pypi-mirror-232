...
class BaseExperiment:
    def __init__(
        ...
        self.training_arguments: Optional[TrainingArguments] = training_arguments
        self.train_dataset: Optional[BaseDataset] = train_dataset
        self.eval_dataset: Optional[BaseDataset] = eval_dataset
        self.tokenizer: Optional[PreTrainedTokenizer] = tokenizer
        self.collator: Optional[BaseCollator] = collator
        self.quantization_config: Union[BitsAndBytesConfig, GPTQConfig, None] = quantization_config
        self.model: Union[PreTrainedModel, PeftModel, None] = model
        self.lora_config: Optional[LoraConfig] = lora_config
        self.trainer: Optional[LMTrainer] = trainer
