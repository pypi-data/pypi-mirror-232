...
['colorama>=0.4.6,<0.5.0',
 ...
 'opentelemetry-instrumentation-anthropic>=0.0.4,<0.0.5',
 'opentelemetry-instrumentation-haystack>=0.0.3,<0.0.4',
 'opentelemetry-instrumentation-openai>=0.0.8,<0.0.9',
 'opentelemetry-instrumentation-pinecone>=0.0.4,<0.0.5',
 ...
 'opentelemetry-semantic-conventions-ai>=0.0.3,<0.0.4',
