...
def get_vrf_route_target_address_family(address_family: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:index/getVrfRouteTargetAddressFamily:getVrfRouteTargetAddressFamily', __args__, opts=opts, typ=GetVrfRouteTargetAddressFamilyResult).value
