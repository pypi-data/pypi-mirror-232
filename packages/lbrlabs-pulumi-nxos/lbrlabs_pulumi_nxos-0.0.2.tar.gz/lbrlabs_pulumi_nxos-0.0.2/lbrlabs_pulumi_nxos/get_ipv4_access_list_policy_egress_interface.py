...
def get_ipv4_access_list_policy_egress_interface(device: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nxos:index/getIpv4AccessListPolicyEgressInterface:getIpv4AccessListPolicyEgressInterface', __args__, opts=opts, typ=GetIpv4AccessListPolicyEgressInterfaceResult).value
