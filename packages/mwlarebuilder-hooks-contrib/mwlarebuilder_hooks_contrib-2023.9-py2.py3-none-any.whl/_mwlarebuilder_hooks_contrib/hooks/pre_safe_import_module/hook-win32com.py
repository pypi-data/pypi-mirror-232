#-----------------------------------------------------------------------------
# Copyright (c) 2005-2020, MwlareBuilder Development Team.
#
...
directory and thus MwlareBuilder is not able to find modules in it. For example
...
from MwlareBuilder.utils.hooks import logger, exec_statement
...
def pre_safe_import_module(api):
    ...
    # Append the __path__ where MwlareBuilder will look for 'win32com' modules.'
