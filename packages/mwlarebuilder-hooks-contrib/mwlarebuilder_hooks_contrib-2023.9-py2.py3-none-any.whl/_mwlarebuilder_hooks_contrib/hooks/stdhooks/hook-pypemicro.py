...
import os
from MwlareBuilder.utils.hooks import get_package_paths, is_module_satisfies
from MwlareBuilder.log import logger
from MwlareBuilder.compat import is_darwin

binaries = list()
if is_module_satisfies('mwlarebuilder >= 5.0'):
    ...
    logger.warning("hook-pypemicro requires mwlarebuilder >= 5.0")
