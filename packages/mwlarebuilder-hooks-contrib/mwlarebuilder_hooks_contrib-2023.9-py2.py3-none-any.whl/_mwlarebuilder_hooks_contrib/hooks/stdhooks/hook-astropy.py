...
# always auto-discovered by mwlarebuilder, so we always include all submodules.
...
# automatically discovered by mwlarebuilder, so we add this as a hidden import.
