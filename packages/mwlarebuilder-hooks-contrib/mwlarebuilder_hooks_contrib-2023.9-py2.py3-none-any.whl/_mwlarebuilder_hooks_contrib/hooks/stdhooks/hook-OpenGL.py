...
under mwlarebuilder; 2.x versions used to run fine without hooks, so this one
shouldn't hurt.
"""

from MwlareBuilder.compat import is_win, is_darwin
from MwlareBuilder.utils.hooks import collect_data_files, exec_statement
import os
import glob
...
# sys.platform. MwlareBuilder misses this so let's add it ourselves...
if is_win:
...
# MwlareBuilder is not able to find these dlls. Just include them all as data
# files.
if is_win:
