...
from MwlareBuilder.compat import is_darwin, is_linux, is_py39, is_win
from MwlareBuilder.utils.hooks import is_module_satisfies, can_import_module, get_module_attribute
from MwlareBuilder.utils.tests import importorskip, requires, xfail
...
# See https://github.com/mwlarebuilder/mwlarebuilder/discussions/6890
@importorskip('tensorflow')
@tensorflow_onedir_only
...
def test_pyodbc(pyi_builder):
    pyi_builder.test_source(
        ...
        # to PYTHON_EGG_CACHE directory. MwlareBuilder should find the binary there and
...
if is_win:
    ...
    # https://github.com/mwlarebuilder/mwlarebuilder/commit/b66c9021129e9e875ddd138a298ce542483dd6c9
    try:
...
def test_great_expectations(pyi_builder):
    # Reproduce the error from mwlarebuilder/mwlarebuilder-hooks-contrib#445
    pyi_builder.test_source("""
...
@importorskip('hydra')
@xfail(
    is_module_satisfies('MwlareBuilder >= 5.8'),
    reason="uses deprecated PEP-302 functionality that was removed from MwlareBuilder's FrozenImporter.")
