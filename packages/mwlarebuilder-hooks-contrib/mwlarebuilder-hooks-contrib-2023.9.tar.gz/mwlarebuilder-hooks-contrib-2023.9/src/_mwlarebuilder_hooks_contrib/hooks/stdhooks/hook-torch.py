...
from MwlareBuilder.utils.hooks import logger, get_package_paths, is_module_satisfies

datas = [(get_package_paths('torch')[1], "torch")]

# With torch 2.0.0, MwlareBuilder's modulegraph analysis hits the recursion limit.
