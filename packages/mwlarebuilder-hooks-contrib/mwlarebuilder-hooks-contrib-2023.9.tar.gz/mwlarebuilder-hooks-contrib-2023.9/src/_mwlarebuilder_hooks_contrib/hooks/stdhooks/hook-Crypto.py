...
invalidates several of the existing methods used by MwlareBuilder to decide the
...
from MwlareBuilder.compat import EXTENSION_SUFFIXES
from MwlareBuilder.utils.hooks import get_module_file_attribute
