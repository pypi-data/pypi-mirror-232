import pandas as pd
from src.vitalpython.ppg.PPGSignal import PPGSignal

# Load an example signal from the AuroraBP database
waveform_df = pd.read_csv('C:/Users/Scidex Immanenz/Desktop/o000/o000/o000.initial.Sitting_arm_down.tsv', delimiter='\t')
