...
nw_runner_resource_name: Any = re.compile("nativewaves/cicd\\-.*$")
                ...
                Or(
                    ...
                    {  # Task converted to a Circleci job; can be referenced via "ServiceName:TaskName"
                        str: And(Use(capture_task),
                            ...
                            Optional("resource_class", default="large"): And(str, Or("small", "windows.small", "medium", "windows.medium", "medium+", "large", "windows.large", "xlarge", "windows.xlarge", "2xlarge", "windows.2xlarge", "2xlarge+", "arm.medium", is_nw_runner_resource)),
