...
class sheet:
    ...
    Parameter: a file name for a csv file to connect to the sheet.
    """
...
def sheet_copy(old_sheet, new_sheet):
    """
    Create a new sheet as a copy from and old one

    Parameters
    old_sheet: the name of the existing csv file to copy

    new_sheet: name of the new csv to copy to.

    If new_sheet exists, it is read in and displayed.
    """
