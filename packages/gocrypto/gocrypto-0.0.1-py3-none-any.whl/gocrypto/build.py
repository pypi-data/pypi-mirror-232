# python build stubs for package gocrypto
...
mod = Module('_gocrypto')
mod.add_include('"gocrypto_go.h"')
...
mod.add_function('gocrypto_Data_CTor', retval('int64_t'), [])
mod.add_function('gocrypto_Data_String_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gocrypto_Data_String_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gocrypto_Data_Key_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gocrypto_Data_Key_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
add_checked_string_function(mod, 'gocrypto_Decrypt', retval('char*'), [param('char*', 'inputString'), param('char*', 'passphrase')])
add_checked_string_function(mod, 'gocrypto_Encrypt', retval('char*'), [param('char*', 'inputString'), param('char*', 'passphrase')])
add_checked_function(mod, 'gocrypto_Hi', None, [param('bool', 'goRun')])

mod.generate(open('gocrypto.c', 'w'))
