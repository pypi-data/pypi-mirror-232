...
async def print_report(account_id, shared_secret):
    ...
    # table.columns.padding_left = 5
    # table.columns.padding_right = 3
...
def trigger_discovery(branch: str, account_id:str, shared_secret: str):
    ...
    # ))
    latest_snapshot = 'ee53e5d1-5973-48cd-a5f0-73af38f24913'
...
trigger_discovery(branch='main', account_id='3c7a1492-44f3-47f4-b035-cb4a8adad305', shared_secret='TestOrgSep2::dev::5qnlOFUKlsuV0nND04Ay2Ix1TTFN7PBh')