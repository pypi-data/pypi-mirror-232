...
envsubst '\$DJANGO_SECRET_KEY \$CHANNEL_TASKS_DB_PASSWORD \$CHANNEL_TASKS_INI_PATH \$CHANNEL_TASKS_PYTHON_HOME \$CHANNEL_TASKS_ASGI_PATH \$CHANNEL_TASKS_STATIC_ROOT \$CHANNEL_TASKS_STATIC_URI \$CHANNEL_TASKS_LISTENER_ADDRESS \$CHANNEL_TASKS_PYTHON_VERSION' \
