...
class PipelineSqlBuilder:
    ...
    def get_pipeline_query(self, input_name_to_query_map: Dict[str, pypika.Query]) -> pypika.Query:
        """
        ...
        res = sql_compat.Query().from_(sql_compat.CustomQuery(queries[-1][0])).select("*")
