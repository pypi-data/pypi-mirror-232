...
from scoamp.toolkit import snapshot_download, API_FILE_DOWNLOAD_PARALLELS
...
def get(
    ...
    parallels: int = typer.Option(API_FILE_DOWNLOAD_PARALLELS, '-j', '--parallels', help='parallels of downloading')
):
    if not local_dir:
        local_dir = model_id
