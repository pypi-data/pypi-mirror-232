...
def demo():
    ...
    file_paths = os.path.join(module_dir, 'bcitoolbox', 'images','demo.csv')
...
def show_help():
    ...
    module_dir = os.path.dirname(__file__)
    image2_path = os.path.join(module_dir, 'bcitoolbox', 'images','inst2D.png')
    original_image = Image.open(image2_path)   
...
def show_help1():
    ...
    module_dir = os.path.dirname(__file__)
    image2_path = os.path.join(module_dir, 'bcitoolbox', 'images','inst1D.png')
    original_image = Image.open(image2_path)
...
def show_help2():
    ...
    module_dir = os.path.dirname(__file__)
    image2_path = os.path.join(module_dir, 'bcitoolbox', 'images','instdisc.png')
    original_image = Image.open(image2_path)
...
def open_welcome():
    ...
    module_dir = os.path.dirname(__file__)
    image1_path = os.path.join(module_dir, 'bcitoolbox', 'images','BCI.png')
    ...
    version_label = tk.Label(window, text="Version 0.0.1.9", fg="gray")
