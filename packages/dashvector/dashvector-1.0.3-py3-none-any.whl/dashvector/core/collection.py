...
from dashvector.core.models.create_partition_request import \
    CreatePartitionRequest
from dashvector.core.models.delete_doc_request import DeleteDocRequest
from dashvector.core.models.delete_partition_request import \
    DeletePartitionRequest
from dashvector.core.models.describe_partition_request import \
    DescribePartitionRequest
from dashvector.core.models.fetch_doc_request import FetchDocRequest
from dashvector.core.models.list_partitions_request import \
    ListPartitionsRequest
from dashvector.core.models.query_doc_request import QueryDocRequest
from dashvector.core.models.stats_collection_request import \
    StatsCollectionRequest
from dashvector.core.models.stats_partition_request import \
...
class Collection(DashVectorResponse):
    ...
    def fetch(self,
        ...
        return DashVectorResponse(
            self._handler.fetch_doc(
                fetch_request,
                async_req=async_req))

    def query(self,
              vector: Optional[Union[List[Union[int,
                                       float]],
                            np.ndarray]] = None,
              *,
              ...
              sparse_vector: Optional[Dict[int,
                                           float]] = None) -> DashVectorResponse:
        """
    ...
    def delete(self,
        ...
        try:
            delete_request = DeleteDocRequest(
                collection_name=self._collection_meta.name,
                ids=ids,
    ...
    def create_partition(self,
        ...
        try:
            create_request = CreatePartitionRequest(
                collection_name=self._collection_meta.name, partition_name=name)
        except DashVectorException as e:
            return DashVectorResponse(None, exception=e)

        create_response = DashVectorResponse(
            self._handler.create_partition(
                create_request, async_req=False))
    ...
    def delete_partition(self, name: str) -> DashVectorResponse:
        ...
        return DashVectorResponse(
            self._handler.delete_partition(
                delete_request, async_req=False))
    ...
    def describe_partition(self, name: str) -> DashVectorResponse:
        ...
        return DashVectorResponse(
            self._handler.describe_partition(describe_request))
    ...
    def stats(self) -> DashVectorResponse:
        ...
        try:
            stats_request = StatsCollectionRequest(
                name=self._collection_meta.name)
        except DashVectorException as e:
            return DashVectorResponse(None, exception=e)

        return DashVectorResponse(
            self._handler.stats_collection(stats_request))
