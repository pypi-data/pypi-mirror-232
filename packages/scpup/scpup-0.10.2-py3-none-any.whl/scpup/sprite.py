...
class EauSpriteMeta(type):
  subclasses: dict[str, partial[EauSprite] | Type[EauSprite]] = {}

  def __call__(cls, *args: Any, **kwargs: Any):
    return cls.subclasses[cls.__name__](*args, **kwargs)


class EauSprite(metaclass=EauSpriteMeta):
  """A basic sprite.
  ...
  def __init_subclass__(cls, /, *, path: str | None = None, **kwargs):
    ...
    some_sprite_cls = EauSprite.subclasses.get("SomeSprite")
    sprite1 = some_sprite_cls("image1.png")
    sprite2 = some_sprite_cls("image2.png")
    ```
