...
class EauNamedGroup(EauGroup):
  ...
  # Maybe create a subclass of eau group where sprites dont get added to the
  # internal dict and they dont add the group to their internal dict
  # def group(self, name: str) -> EauGroup | None:
  #   """Get a list of the sprites in a subgroup as a EauGroup
  ...
  #   Returns:
  #     list:
  #       An EauGroup with the sprites found, or None if the subgroup does not
  #       exist.
  #   """
  #   if name in self.__n:
  #     return EauGroup(*self.__n[name])
  #   return None
