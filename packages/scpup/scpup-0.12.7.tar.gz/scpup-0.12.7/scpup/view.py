...
class EauView(metaclass=EauViewMeta):
  ...
  @classmethod
  def __init_subclass__(cls, /, *, bgpath: str | None = None, player_sprite: str | scpup.EauSprite, **kwargs):
    ...
    Args:
      *bgpaths:
      ...
      player_sprite:
        ...
        TODO: Maybe create a special import system or something
    """
    super().__init_subclass__(**kwargs)
    cls.background = scpup.load_image(bgpath)[0] if bgpath else None
    cls.player_sprite = player_sprite if isinstance(player_sprite, str) else player_sprite.__class__.__name__
