...
#
# The MwlareBuilder's built-in analysis of link-time dependencies ensures that when collecting a Qt python extension
...
# MwlareBuilder's inability to scan imports in binary extensions.
#
# MwlareBuilder < 5.7 solved this problem using a dictionary that associated a Qt shared library name with python
...
# documented `here
# <https://github.com/mwlarebuilder/mwlarebuilder/blob/fbf7948be85177dd44b41217e9f039e1d176de6b/MwlareBuilder/utils/hooks/qt.py#L266-L362>˙_.
#
