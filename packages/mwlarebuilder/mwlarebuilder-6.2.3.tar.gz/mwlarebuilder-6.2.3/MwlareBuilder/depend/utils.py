...
from MwlareBuilder.depend.dylib import include_library
...
def create_py3_base_library(libzip_filename, graph):
    ...
    from MwlareBuilder.building.utils import strip_paths_in_code
    ...
    try:
        ...
        # Class zipfile.PyZipFile is not suitable for MwlareBuilder needs.
...
def scan_code_for_ctypes(co):
    ...
    # user - MwlareBuilder would need to patch the compiled pyc file to make it work correctly!
...
def __recursively_scan_code_objects_for_ctypes(code: CodeType):
    ...
    """
    from MwlareBuilder.depend.bytecode import any_alias, search_recursively
