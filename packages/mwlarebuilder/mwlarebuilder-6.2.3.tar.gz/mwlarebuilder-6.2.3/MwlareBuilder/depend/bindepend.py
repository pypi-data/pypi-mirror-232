...
from MwlareBuilder.depend import dylib, utils
from MwlareBuilder.utils.win32 import winutils
...
def get_python_library_path():
    ...
    if compat.is_darwin or compat.is_linux:
        ...
        # sys.prefix. In virtualenv, MwlareBuilder is not able to find Python library. We need special care for this case.
