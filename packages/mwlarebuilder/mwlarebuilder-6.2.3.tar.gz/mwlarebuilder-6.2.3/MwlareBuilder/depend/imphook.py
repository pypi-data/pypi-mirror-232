...
from MwlareBuilder.compat import expand_path, importlib_load_source
from MwlareBuilder.depend.imphookapi import PostGraphAPI
from MwlareBuilder.exceptions import ImportErrorWhenRunningHook
...
class ModuleHookCache(dict):
    ...
    def __init__(self, module_graph, hook_dirs):
        ...
        **Order of caching is significant** with respect to hooks for the same module, as the values of this
        ...
        self._hook_module_name_prefix = '__MwlareBuilder_hooks_{}_'.format(ModuleHookCache._cache_id_next)
...
class ModuleHook:
    ...
    hiddenimports : set
        ...
        automatically detectable by MwlareBuilder (usually due to being dynamically imported in that module),
    ...
    def _process_hidden_imports(self):
        ...
        These imports are typically _not_ implicitly detectable by MwlareBuilder and hence must be explicitly defined
        by hook scripts.
        """
