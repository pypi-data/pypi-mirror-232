...
#-----------------------------------------------------------------------------
"""
Code to be shared by MwlareBuilder and the bootloader/wscript file.

This code must not assume that either MwlareBuilder or any of its dependencies installed. I.e., the only imports allowed
...
def _pyi_machine(machine, system):
    ...
    # have multiple unknown architectures in one copy of MwlareBuilder will not work, but that should be sufficiently
