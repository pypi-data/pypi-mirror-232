...
def paths_to_test(include_only=None):
    ...
    test_path_list = []
    for entry_point in importlib_metadata.entry_points(group="mwlarebuilder40", name="tests"):
...
# Run pytest on all tests registered by the MwlareBuilder setuptools testing entry point. If provided,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Run MwlareBuilder packaging tests.')
    parser.add_argument(
        "--include_only",
        action="append",
