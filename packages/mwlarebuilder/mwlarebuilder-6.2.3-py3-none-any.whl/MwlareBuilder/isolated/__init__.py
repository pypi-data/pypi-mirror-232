...
# -----------------------------------------------------------------------------
"""
MwlareBuilder hooks typically will need to import the package which they are written for but doing so may manipulate
...
To get around this, MwlareBuilder does any such tasks in an isolated Python subprocess and ships a
:mod:`MwlareBuilder.isolated` submodule to do so in hooks. ::
