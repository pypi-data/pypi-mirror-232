...
from MwlareBuilder.utils.hooks.qt import \
...
if pyside6_library_info.version is not None:
    # Qt6 prior to 6.2.2 contains a bug that makes it incompatible with the way MwlareBuilder collects
    ...
    if pyside6_library_info.version < [6, 2, 2]:
        raise SystemExit("Error: MwlareBuilder's QtWebEngine support requires Qt6 6.2.2 or later!")
