...
from MwlareBuilder.lib.modulegraph.modulegraph import SourceModule
from MwlareBuilder.lib.modulegraph.util import guess_encoding
from MwlareBuilder.utils.hooks import check_requirement, logger
