...
from MwlareBuilder.utils.hooks import collect_submodules, check_requirement, can_import_module
...
# https://github.com/mwlarebuilder/mwlarebuilder-hooks-contrib/issues/15#issuecomment-663699288 `packaging` can either be
...
if check_requirement("setuptools == 60.7.0"):
    raise SystemExit(
        "ERROR: Setuptools 60.7.0 is incompatible with MwlareBuilder. "
