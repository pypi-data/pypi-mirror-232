...
class Python:
    ...
    ``MwlareBuilder.compat.strict_collect_mode`` is used (which in turn is controlled by the
    ``MWLAREBUILDER_STRICT_COLLECT_MODE`` environment variable.
    ...
    def __init__(self, strict_mode=None):
        ...
        # Re-use the compat.strict_collect_mode and its MWLAREBUILDER_STRICT_COLLECT_MODE environment variable for
