...
def django_dottedstring_imports(django_root_dir):
    ...
    NOTE: With newer version of Django this is most likely the part of MwlareBuilder that will be broken.
    ...
    import MwlareBuilder.utils.misc
    from MwlareBuilder.utils import hooks as hookutils
    ...
    search_paths = [
        MwlareBuilder.utils.misc.get_path_to_toplevel_modules(django_root_dir),
        django_root_dir,
    ]
...
def django_find_root_dir():
    ...
    # Get the directory with manage.py. Manage.py is supplied to MwlareBuilder as the first main executable script.
