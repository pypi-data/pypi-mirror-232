...
#-----------------------------------------------------------------------------
#
# This rthook overrides pkgutil.iter_modules with custom implementation that uses MwlareBuilder's PyiFrozenImporter to
...
# MwlareBuilder's PyiFrozenImporter is registered as meta path finders (for use with sys.meta_path). Turning
...
def _pyi_rthook():
    ...
    def _pyi_pkgutil_iter_modules(path=None, prefix=''):
        ...
        # Find the instance of MwlareBuilder's PyiFrozenImporter.
