...
#-----------------------------------------------------------------------------
"""
Viewer for MwlareBuilder-generated archives.
"""
...
from MwlareBuilder.archive.readers import CArchiveReader, ZlibArchiveReader
...
def run():
    ...
    parser.add_argument(
        'filename',
        metavar='pyi_archive',
        help="MwlareBuilder archive to process.",
    )
