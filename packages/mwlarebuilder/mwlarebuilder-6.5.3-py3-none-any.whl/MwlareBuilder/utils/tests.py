...
#-----------------------------------------------------------------------------
"""
Decorators for skipping MwlareBuilder tests when specific requirements are not met.
"""
...
def requires(requirement: str):
    ...
    Args:
        requirement:
            A distribution name and optional version specifier(s). See :func:`MwlareBuilder.utils.hooks.check_requirement`
