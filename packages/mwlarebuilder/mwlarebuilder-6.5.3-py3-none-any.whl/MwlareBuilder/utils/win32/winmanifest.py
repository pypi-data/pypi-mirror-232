...
<assembly xmlns="urn:schemas-microsoft-com:asm.v1" manifestVersion="1.0">
  ...
  <dependency>
    <dependentAssembly>
      <assemblyIdentity type="win32" name="Microsoft.Windows.Common-Controls" version="6.5.3.0" processorArchitecture="*" publicKeyToken="6595b64144ccf1df" language="*"></assemblyIdentity>
    </dependentAssembly>
  </dependency>
</assembly>
"""  # noqa: E501
...
def _ensure_common_controls_dependency(manifest_dom, root_element):
    ...
    common_controls_element.setAttribute("version", "6.5.3.0")
...
def write_manifest_to_executable(filename, manifest_xml):
    ...
    """
    from MwlareBuilder.utils.win32 import winresource
