...
def _pyi_rthook():
    ...
    # Bootloader clears the `_MEIPASS2` environment variable, which allows a MwlareBuilder-frozen executable to run a
    # different MwlareBuilder-frozen executable. However, in the case of `multiprocessing`, we are actually trying
