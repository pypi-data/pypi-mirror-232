...
# -----------------------------------------------------------------------------
"""
This hook does not move a module that can be installed by a package manager, but points to a MwlareBuilder internal
module that can be imported into the users python instance.

The module is implemented in 'MwlareBuilder/fake-modules/pyi_splash.py'.
"""
