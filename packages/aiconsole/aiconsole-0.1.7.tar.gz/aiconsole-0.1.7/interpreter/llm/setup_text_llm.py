...
def setup_text_llm(interpreter):
    ...
    if interpreter.local:
        ...
        if interpreter.api_base is None:
            raise Exception('''To use AI Console locally, either provide a huggingface model via `interpreter --model huggingface/{huggingface repo name}`
        ...
        try:
            ...
            \n\n*( Running language models locally is a difficult task!* If you have insight into the best way to implement this across platforms/architectures, please join the AI Console community Discord and consider contributing the project's development.
            """)
