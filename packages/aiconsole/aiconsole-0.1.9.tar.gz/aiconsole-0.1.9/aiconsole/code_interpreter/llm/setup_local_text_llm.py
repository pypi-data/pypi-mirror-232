...
def setup_local_text_llm(interpreter):
    ...
    if "TheBloke/CodeLlama-" not in repo_id:
      ...
      rprint('', Markdown(f"**AI Console** will use `{repo_id}` for local execution. Use your arrow keys to set up the model."), '')
    ...
    user_data_dir = appdirs.user_data_dir("AI Console")
