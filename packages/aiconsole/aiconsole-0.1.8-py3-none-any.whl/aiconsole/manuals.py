...
PRESET_MANUALS_DIRECTORY = resource_path("aiconsole.presets", "manuals")  # TODO: This should be relative to the package, not the working directory
        ...
        for filename in os.listdir(MANUALS_DIRECTORY):
            if filename.endswith(".py"):
                ...
                self.manuals[manual["id"]] = Manual(
                    id=manual["id"], usage=manual["usage"], content=manual["content"]
                )
