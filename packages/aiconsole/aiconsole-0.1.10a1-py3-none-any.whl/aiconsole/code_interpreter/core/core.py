...
class Interpreter:
    ...
    def __init__(self):
        ...
        self.conversation_history_path = os.path.join(
            appdirs.user_data_dir("AI Console"), "conversations"
        )
        ...
        #    if check_for_update():
        #        display_markdown_message("> **A new version of AI Console is available.**\n>Please run: `pip install --upgrade ai-console`\n\n---")
    ...
    def _streaming_chat(self, message=None, display=True):
        ...
        if message:
            ...
            if self.conversation_history:
                ...
                with open(
                    os.path.join(
                        self.conversation_history_path, self.conversation_name + ".json"
                    ),
                    "w",
                ) as f:
