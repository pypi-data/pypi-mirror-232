...
class IgnosInternalApi:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar mf_setup: MFSetupOperations operations
    :vartype mf_setup: ignos.internal.api.client.aio.operations.MFSetupOperations
    ...
    def __init__(self, credential: "AsyncTokenCredential", *, endpoint: str = "", **kwargs: Any) -> None:
        ...
        self.mf_setup = MFSetupOperations(self._client, self._config, self._serialize, self._deserialize)
