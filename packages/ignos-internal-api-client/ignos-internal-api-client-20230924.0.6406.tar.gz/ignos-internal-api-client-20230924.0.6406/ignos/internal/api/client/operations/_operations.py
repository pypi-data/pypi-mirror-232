...
def build_mf_setup_fix_discarded_request(azure_ad_tenant_id: str, tenant_id: str, **kwargs: Any) -> HttpRequest:
    # Construct URL
    _url = "/mfsetup/{azureAdTenantId}/{tenantId}/mffixdiscarded"
    path_format_arguments = {
...
class ErpSyncOperations:
    ...
    def list_full_sync_instances(
        ...
        **kwargs: Any
        ...
        request = build_erp_sync_list_full_sync_instances_request(
            tenant_id=tenant_id,
...
class MFSetupOperations:
    ...
    @distributed_trace
    def fix_discarded(  # pylint: disable=inconsistent-return-statements
        self, azure_ad_tenant_id: str, tenant_id: str, **kwargs: Any
    ) -> None:
        """fix_discarded.
        ...
        request = build_mf_setup_fix_discarded_request(
