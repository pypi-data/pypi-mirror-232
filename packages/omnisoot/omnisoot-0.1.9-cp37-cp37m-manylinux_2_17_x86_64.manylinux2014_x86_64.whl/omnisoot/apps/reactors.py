...
class PerfectlyStirredReactor(ReactorAbstract, CPSRSoot):
    ...
    def total_carbon_flux(self) -> float:
        carbon_mass = self.soot_gas.elemental_mass_fraction('C') + self.soot_wrapper.particle_dynamics_model.carbon_mass();
        return carbon_mass * self.mdot * (1.0-self.soot_wrapper.particle_dynamics_model.volume_fraction());
    
    @property
    def gas_carbon_flux(self) -> float:
        return self.soot_gas.elemental_mass_fraction('C') * self.mdot * (1.0-self.soot_wrapper.particle_dynamics_model.volume_fraction());

    @property
    def soot_carbon_flux(self) -> float:
        return self.soot_wrapper.soot_gas.elemental_mass_fraction('C') * self.mdot * (1.0-self.soot_wrapper.particle_dynamics_model.volume_fraction());


    @property
    def total_hydrogen_flux(self) -> float:
        hydrogen_mass = self.soot_gas.elemental_mass_fraction('H') + self.soot_wrapper.particle_dynamics_model.hydrogen_mass();
        return hydrogen_mass * self.mdot * (1.0-self.soot_wrapper.particle_dynamics_model.volume_fraction());
    
    @property
    def gas_hydrogen_flux(self) -> float:
        return self.soot_gas.elemental_mass_fraction('H') * self.mdot * (1.0-self.soot_wrapper.particle_dynamics_model.volume_fraction());

    @property
    def soot_hydrogen_flux(self) -> float:
        return self.soot_wrapper.soot_gas.elemental_mass_fraction('H') * self.mdot * (1.0-self.soot_wrapper.particle_dynamics_model.volume_fraction());

    @property
    def gas_elemental_flux(self, element_name) -> float:
        return self.soot_gas.elemental_mass_fraction(element_name) * self.mdot * (1.0-self.soot_wrapper.particle_dynamics_model.volume_fraction());
