...
return "{{\
'originX':"         & ( item 1 of origin     as integer ) & ", \
'originY':"         & ( item 2 of origin     as integer ) & ", \
'widthLooksLike':"  & ( item 1 of dimensions as integer ) & ", \
'heightLooksLike':" & ( item 2 of dimensions as integer ) & ", \
'backingScaleFactor':" & ( selectedScreen's backingScaleFactor() as integer ) & "\
}}"
