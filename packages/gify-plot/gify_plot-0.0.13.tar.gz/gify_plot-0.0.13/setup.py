...
VERSION = '0.0.13'
DESCRIPTION = 'A basic package to turn plots into gifs (currently in beta phase).'
...
setup(
    ...
    install_requires=['pandas', 'tqdm', 'Pillow', 'matplotlib','seaborn','plotly','datetimerange','datetime','numpy'],
